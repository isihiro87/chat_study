...
const ERA_DISPLAY_NAMES: Record<string, { name: string; icon: string; period: string }> = {
  ...
  'math-g3-similarity': { name: '相似な図形', icon: '🔺', period: '中3 図形' },
  'math-g3-circle': { name: '円', icon: '⭕', period: '中3 図形' },
  'math-g3-pythagorean': { name: '三平方の定理', icon: '📐', period: '中3 図形' },
  'math-g3-sampling': { name: '標本調査', icon: '📊', period: '中3 データの活用' },
