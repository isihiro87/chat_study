...
| `VITE_LINE_AUTH_LIFF_FN_URL` | `https://asia-northeast1-chatstudy-63477.cloudfunctions.net/createLiffFirebaseToken`（LIFF ID トークン → Firebase custom token 変換、LIFF webview の fast-path 認証用） |
...
| `VITE_LIFF_ID_HELP` | `2009587166-VVVVVVV5`（無料版「使い方」flex の「使い方を詳しく見る」ボタン用、Endpoint = `/liff/help`） |
| `VITE_MODE` | `line` |
