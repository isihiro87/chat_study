      ...
      <main className="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8 leading-relaxed text-gray-800">
        ...
        <Section title="第2条（利用登録）">
          <ol className="list-decimal list-inside space-y-1">
            <li>
              本サービスは、LINE
              プラットフォーム上の公式アカウント友だち追加および LINE Login
              による認証を経て利用できます。
            </li>
            <li>
            ...
            <li>
              <strong>未成年者の方</strong>
              は、本サービスの利用にあたって保護者の同意を得たうえでご利用いただくことを推奨します。中学生など本サービスの主な対象層は、利用前に必ず保護者の方とご確認ください。
            </li>
            <li>
        ...
        <Section title="第3条（アカウント情報の管理）">
          <ol className="list-decimal list-inside space-y-1">
            <li>
              ユーザーは、自己の責任において LINE
              アカウントを管理するものとします。
            </li>
            <li>
              LINE
              アカウントに紐づく学習データの第三者による利用、不正使用に対し、運営者は一切の責任を負いません。
            </li>
          </ol>
        </Section>
        ...
        <Section title="第4条（本サービスの提供内容）">
          <p>
            本サービスは、中学生向けの学習コンテンツを公式 LINE および Web
            上で提供するものです。主な機能:
          </p>
        ...
        <Section title="第5条（料金）">
          <ol className="list-decimal list-inside space-y-1">
            ...
            <li>
              料金体系・課金方法・解約方法の詳細は、サービス内の案内または決済ページに表示します。
              ユーザーは案内された手順に従って登録・解約を行うものとします。
            </li>
            <li>すでに支払われた料金は、原則として返金しません。</li>
          </ol>
        </Section>
        ...
        <Section title="第6条（禁止事項）">
          ...
          <ol className="list-decimal list-inside space-y-0.5 text-sm">
            ...
            <li>
              運営者または第三者の知的財産権・プライバシー・名誉等を侵害する行為
            </li>
            <li>
              本サービスの内容・コンテンツを無断で複製・転載・販売する行為
            </li>
            <li>
          ...
          <ol className="list-decimal list-inside space-y-1">
            <li>
              ...
              <ul className="list-disc list-inside ml-4 mt-1 text-sm">
                ...
                <li>
                  地震、火災、停電、天災等の不可抗力により提供が困難となった場合
                </li>
                <li>
                  LINE プラットフォーム・Firebase
                  等の外部サービスに障害が発生した場合
                </li>
        ...
        <Section title="第13条（お問い合わせ）">
          <p>本規約に関するお問い合わせは、以下の窓口までお願いします。</p>
          <ul className="list-disc list-inside ml-4 mt-1 text-sm">
            <li>屋号: ぐっとスクール</li>
            <li>代表者: 石本大貴</li>
            <li>
