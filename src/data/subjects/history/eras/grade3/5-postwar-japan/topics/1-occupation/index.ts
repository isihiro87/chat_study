...
export const occupation: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'fc3', front: '東京裁判', explanation: '正式名称は極東国際軍事裁判。A級戦犯が裁かれた。', back: '1946年から1948年にかけて日本の戦争指導者を裁いた国際裁判は？', difficulty: 'basic' },
      { id: 'fc4', front: 'ポツダム宣言', explanation: '日本の軍国主義の排除と民主化を求める内容だった。', back: '1945年に日本に無条件降伏を求めた連合国の宣言は？', difficulty: 'basic' },
      { id: 'fc5', front: '間接統治', explanation: '日本の行政機構を活用し、言語や文化の壁を乗り越えて改革を進めた。', back: 'GHQが日本政府を通じて改革の指令を出す統治方法を何という？', difficulty: 'basic' },
      { id: 'fc6', front: '女性参政権', explanation: '1946年の総選挙で初めて女性が投票し、39人の女性議員が誕生した。', back: '戦後の選挙法改正で初めて実現した、女性が選挙に参加できる権利は？', difficulty: 'basic' },
      ...
      { id: 'fc9', front: '自作農', explanation: '農地改革前は全農家の約半数が小作農だったが、改革後は自作農が大多数に。', back: '農地改革の結果増加した、自分の土地を持つ農民を何という？', difficulty: 'standard' },
      { id: 'fc10', front: '労働組合法', explanation: '団結権・団体交渉権・争議権の労働三権を法律で保障した。', back: '労働者の団結権や団体交渉権を認めた法律は？', difficulty: 'standard' },
      { id: 'fc11', front: '労働基準法', explanation: '1日8時間労働や最低賃金などの基準を定め、労働者を保護した。', back: '賃金や労働時間など労働条件の最低基準を定めた法律は？', difficulty: 'standard' },
      ...
      { id: 'fc14', front: '民主化', explanation: '政治・経済・社会の全面にわたる改革で日本を平和国家に変えた。', back: 'GHQが占領下で進めた、軍国主義の排除や財閥解体など日本社会を変える改革の総称は？', difficulty: 'standard' },
      { id: 'fc15', front: '極東国際軍事裁判', explanation: '連合国が日本の指導者の戦争責任を追及した国際裁判。', back: '東京裁判の正式名称は？', difficulty: 'standard' },
