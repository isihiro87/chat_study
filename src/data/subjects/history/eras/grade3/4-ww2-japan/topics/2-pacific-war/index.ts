...
export const pacificWar: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '真珠湾攻撃', explanation: '宣戦布告が遅れたため「奇襲」となり、アメリカの戦意を大いに高めた。', back: '1941年12月8日に日本海軍がハワイで行った奇襲攻撃は？', difficulty: 'basic' },
      { id: 'fc2', front: '太平洋戦争', explanation: '日本では「大東亜戦争」とも呼ばれた。1945年8月の日本の降伏で終結。', back: '1941年から1945年まで、日本とアメリカを中心に太平洋地域で戦われた戦争は？', difficulty: 'basic' },
      ...
      { id: 'fc6', front: '1941年12月8日', explanation: '日本時間の12月8日（アメリカ時間では12月7日）に攻撃が行われた。', back: '真珠湾攻撃が行われ、太平洋戦争が始まった日は？', difficulty: 'standard' },
      { id: 'fc7', front: 'B-29', explanation: '当時世界最大の爆撃機で、高高度から大規模な爆撃を行った。', back: 'アメリカ軍が日本本土への空襲に使用した大型爆撃機は？', difficulty: 'standard' },
      ...
      { id: 'fc10', front: '制空権・制海権', explanation: 'これを失うと敵の爆撃や上陸を阻止できなくなる。', back: '日本が失ったことで本土空襲を許し、敗戦が決定的になった二つの支配権は？', difficulty: 'advanced' },
      { id: 'fc11', front: 'ハワイ', explanation: 'アメリカ太平洋艦隊の主要基地があった。', back: '真珠湾攻撃が行われた場所はどこか？', difficulty: 'basic' },
      ...
      { id: 'fc14', front: 'ガダルカナル島', explanation: '日本軍は補給が途絶え、多くの餓死者を出して撤退した。', back: 'ミッドウェー海戦後にアメリカ軍が反攻し、激戦が繰り広げられた太平洋の島は？', difficulty: 'standard' },
      { id: 'fc15', front: '主力空母4隻', explanation: '赤城・加賀・蒼龍・飛龍の4隻を一度に失った。', back: 'ミッドウェー海戦で日本海軍が失ったものは？', difficulty: 'standard' },
      { id: 'fc16', front: '1942年', explanation: '開戦からわずか半年で戦局の転換点を迎えた。', back: 'ミッドウェー海戦が行われた年は？', difficulty: 'standard' },
      { id: 'fc17', front: 'マレー半島', explanation: 'イギリス領マラヤへの上陸で、東南アジア侵攻の足がかりとした。', back: '真珠湾攻撃と同時に日本軍が上陸した東南アジアの半島は？', difficulty: 'standard' },
      { id: 'fc18', front: '石油', explanation: '軍艦・航空機の燃料として不可欠であり、日本の最大の弱点だった。', back: 'ABCD包囲網で日本への輸出が禁止された最も重要な資源は？', difficulty: 'basic' },
      { id: 'fc19', front: '1945年3月10日', explanation: '焼夷弾による空襲で下町一帯が焼き尽くされた。', back: '東京大空襲が行われた日付は？', difficulty: 'advanced' },
