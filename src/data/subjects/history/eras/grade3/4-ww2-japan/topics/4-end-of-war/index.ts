    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: [
            '航空機から投下され広範囲に爆風が広がる点',
            '爆発音が従来の爆弾より非常に大きく遠くまで聞こえる点',
            '一発で都市を壊滅させ放射線被害が長期間続く点',
            '海上の艦艇にも使用できる水中爆発が可能な点',
],
          correctIndex: 2,
          explanation:
        ...
        },
        {
          ...
          options: [
            '島の周囲での海戦のみで陸上に戦火が及ばなかった',
            '民間人の住む地域で地上戦が行われ住民が巻き込まれた',
            '日本軍が米軍を撃退し防衛に成功した最後の勝利だった',
            '両軍合わせて数百人の犠牲で終結した比較的小規模な戦いだった',
          ],
          correctIndex: 1,
          explanation:
        ...
        },
        {
          ...
          options: [
            '宣言の文書が届かず内容を把握できていなかったから',
            'ドイツが再起して連合国に反攻すると強く期待していたから',
            '天皇制の存続が保証されるか不明だったから',
            'アメリカから有利な条件での和平交渉の提案があったから',
],
          correctIndex: 2,
          explanation:
