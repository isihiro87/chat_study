...
export const endOfWar: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'fc2', front: 'ポツダム宣言', explanation: '軍隊の武装解除や戦争犯罪人の処罰などを含む降伏条件を示した。', back: '1945年7月にアメリカ・イギリス・中国が日本に無条件降伏を求めた宣言は？', difficulty: 'basic' },
      { id: 'fc3', front: '広島', explanation: 'ウラン型原爆「リトルボーイ」が投下され、約14万人が犠牲になった。', back: '1945年8月6日に世界で初めて実戦で原子爆弾が投下された都市は？', difficulty: 'basic' },
      { id: 'fc4', front: '長崎', explanation: 'プルトニウム型原爆「ファットマン」が投下され、約7万人が犠牲になった。', back: '1945年8月9日に二つ目の原子爆弾が投下された都市は？', difficulty: 'basic' },
      { id: 'fc5', front: '玉音放送', explanation: '天皇自らの肉声でポツダム宣言受け入れを国民に伝えた歴史的な放送。', back: '1945年8月15日に天皇がラジオで国民に終戦を伝えた放送は？', difficulty: 'standard' },
      { id: 'fc6', front: '8月15日', explanation: '現在も「終戦の日」として全国戦没者追悼式が行われる。', back: '日本が終戦を迎えた日は何月何日？', difficulty: 'standard' },
      { id: 'fc7', front: 'ソ連参戦', back: '1945年8月8日に日ソ中立条約を破って満州に侵攻した国は？', explanation: 'ソ連の参戦が日本の降伏決定を早めた。', difficulty: 'standard' },
      { id: 'fc8', front: '日ソ中立条約', explanation: '互いに攻撃しないと約束したが、ヤルタ密約に基づきソ連が破棄した。', back: '1941年に日本とソ連が結び、ソ連が1945年に破った条約は？', difficulty: 'standard' },
      ...
      { id: 'fc10', front: '8月6日と8月9日', explanation: 'わずか3日間で2発の原爆が投下された。', back: '広島と長崎にそれぞれ原爆が投下された日付は？', difficulty: 'advanced' },
      { id: 'fc11', front: 'イタリア降伏', explanation: 'ムッソリーニが失脚し、新政府が連合国に降伏した。', back: '1943年に枢軸国で最初に降伏した国は？', difficulty: 'basic' },
      { id: 'fc12', front: 'スターリングラードの戦い', explanation: '1942〜43年に行われ、ドイツ軍約30万人が包囲され降伏した。', back: 'ソ連がドイツに反撃し勝利した戦いは？', difficulty: 'basic' },
      { id: 'fc13', front: 'ノルマンディー上陸作戦', back: '1944年に連合国がフランス北部に上陸した作戦は？', explanation: '西部戦線が開かれドイツは東西から挟撃された。', difficulty: 'standard' },
      { id: 'fc14', front: 'サイパン島陥落', explanation: 'B-29爆撃機の航続距離内に日本本土が入り、空襲が本格化した。', back: '1944年に陥落し、日本本土空襲の拠点となった島の陥落は？', difficulty: 'standard' },
      ...
      { id: 'fc17', front: '昭和天皇', explanation: '戦争終結の御前会議でポツダム宣言受け入れの「聖断」を下した。', back: '玉音放送を行い、国民に終戦を伝えた人物は？', difficulty: 'basic' },
      { id: 'fc18', front: 'B-29', explanation: 'サイパン島を拠点に日本各地を爆撃した当時最大級の爆撃機。', back: 'アメリカ軍が日本本土空襲に使用した大型爆撃機は？', difficulty: 'standard' },
      { id: 'fc19', front: '約20万人', explanation: '軍人・民間人あわせての犠牲者数で、沖縄県民の約4分の1にあたる。', back: '沖縄戦でおよそ何人が犠牲になったか？', difficulty: 'standard' },
      { id: 'fc20', front: '1945年5月', explanation: 'ヒトラーの自殺後にドイツが無条件降伏した。', back: 'ドイツが降伏した年月は？', difficulty: 'advanced' },
      ...
      { id: 'fc23', front: '集団自決', explanation: '軍から「捕虜になるな」と教え込まれた住民が追い詰められた結果起きた。', back: '沖縄戦で追い詰められた住民が行った悲惨な行為は？', difficulty: 'advanced' },
      { id: 'fc24', front: '1945年8月6日', explanation: '午前8時15分にウラン型原爆が投下された。', back: '広島に原爆が投下された正確な日付は？', difficulty: 'basic' },
      { id: 'fc25', front: '1945年8月15日', explanation: '正午に玉音放送が流れ、国民は初めて終戦を知った。', back: '玉音放送により終戦が国民に伝えられた日付は？', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
