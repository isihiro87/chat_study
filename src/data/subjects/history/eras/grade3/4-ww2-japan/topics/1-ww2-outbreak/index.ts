...
export const ww2Outbreak: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: 'ポーランド侵攻', explanation: 'ドイツが電撃戦で侵攻し、英仏が宣戦布告して大戦が始まった。', back: '1939年にドイツが行い、第二次世界大戦のきっかけとなった軍事行動は？', difficulty: 'basic' },
      { id: 'fc2', front: '日独伊三国同盟', explanation: '枢軸国としてアメリカ・イギリスなどの連合国と対立する体制を築いた。', back: '1940年に日本・ドイツ・イタリアが結んだ軍事同盟は？', difficulty: 'basic' },
      { id: 'fc3', front: '枢軸国', explanation: '連合国（アメリカ・イギリス・ソ連など）と対立した陣営。', back: '日本・ドイツ・イタリアを中心とする陣営を何という？', difficulty: 'basic' },
      ...
      { id: 'fc6', front: '独ソ不可侵条約', explanation: '1939年に締結されたが、1941年にドイツがソ連に侵攻して破棄された。', back: 'ドイツとソ連が結び、後にドイツが破った条約は？', difficulty: 'standard' },
      { id: 'fc7', front: '南進', back: '日本が東南アジアに向けて勢力を拡大した政策を何という？', explanation: '石油やゴムなどの資源確保が目的だった。', difficulty: 'standard' },
      { id: 'fc8', front: '連合国', explanation: '枢軸国に対抗した陣営で、最終的に勝利した。', back: 'アメリカ・イギリス・ソ連・中国などを中心とする陣営を何という？', difficulty: 'standard' },
      ...
      { id: 'fc11', front: '電撃戦', explanation: '戦車と航空機を組み合わせた高速攻撃でポーランドやフランスを短期間で制圧した。', back: 'ドイツが素早い攻撃で次々とヨーロッパ諸国を占領した戦法は？', difficulty: 'basic' },
      { id: 'fc12', front: 'フランスの降伏', explanation: 'わずか6週間でドイツに敗れ、パリも占領された。', back: '1940年にドイツの電撃戦により占領・降伏した大国は？', difficulty: 'basic' },
      { id: 'fc13', front: 'レジスタンス', explanation: 'フランスのド・ゴール将軍などが亡命先から指揮を執った。', back: 'ヨーロッパ各地でドイツの支配に対して行われた抵抗運動を何という？', difficulty: 'standard' },
      { id: 'fc14', front: '強制収容所', explanation: 'アウシュビッツが最も有名で、多くのユダヤ人が命を落とした。', back: 'ナチス・ドイツがユダヤ人を送った施設を何という？', difficulty: 'standard' },
      ...
      { id: 'fc17', front: '石油輸出禁止', explanation: '日本の石油備蓄は約2年分しかなく、開戦決意の大きな要因となった。', back: 'ABCD包囲陣で日本に対して行われた最も深刻な経済制裁は？', difficulty: 'standard' },
      ...
      { id: 'fc21', front: 'A=アメリカ B=イギリス C=中国 D=オランダ', explanation: 'Dutch（オランダ）の頭文字Dは蘭印（現インドネシア）の石油利権に関連。', back: 'ABCD包囲陣のA・B・C・Dはそれぞれどの国を指すか？', difficulty: 'standard' },
      { id: 'fc22', front: '東部戦線', explanation: 'ドイツは東西二正面作戦を強いられ、戦力が分散した。', back: 'ドイツが独ソ不可侵条約を破ってソ連に侵攻したことで開かれた戦線は？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
