...
export const politicalReform: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '護憲運動', explanation: '民衆が政治に声をあげ、藩閥政治を終わらせるきっかけとなった運動。', back: '藩閥政治を批判し、憲法に基づく政治を求めた運動は？', difficulty: 'basic' },
      { id: 'fc2', front: '桂太郎', explanation: '長州藩出身で3度首相を務めたが、第一次護憲運動で退陣した。', back: '第一次護憲運動で退陣に追い込まれた藩閥出身の首相は？', difficulty: 'basic' },
      { id: 'fc3', front: '米騒動', back: '1918年に米の価格高騰に怒った人々が起こした事件は？', explanation: '全国に広がり、寺内内閣の総辞職につながった。', difficulty: 'basic' },
      { id: 'fc4', front: '原敬', explanation: '爵位を持たない初の首相で、衆議院の多数党を基盤に内閣を組織した。', back: '「平民宰相」と呼ばれ、本格的な政党内閣を組織した首相は？', difficulty: 'basic' },
      { id: 'fc5', front: '大正デモクラシー', explanation: '護憲運動・普通選挙運動・社会運動など民主主義的な動きの総称。', back: '大正時代に広がった民主主義の風潮を何という？', difficulty: 'basic' },
      { id: 'fc6', front: '藩閥政治', explanation: '明治維新を主導した薩長の出身者が政治の実権を握り続けた体制。', back: '明治時代から続いた、薩摩・長州出身者が中心となって行った政治のあり方は？', difficulty: 'basic' },
      { id: 'fc7', front: '普通選挙法', explanation: '納税額による制限が撤廃され、男性の普通選挙が実現した。女性は対象外。', back: '1925年に成立し、25歳以上の男性に選挙権を与えた法律は？', difficulty: 'standard' },
      { id: 'fc8', front: '治安維持法', back: '1925年に普通選挙法と同時に制定された、社会主義運動を取り締まる法律は？', explanation: '「アメとムチ」の政策と言われた。', difficulty: 'standard' },
      { id: 'fc9', front: '吉野作造', explanation: '東京帝国大学教授で、大正デモクラシーの理論的な支柱となった。', back: '「民本主義」を唱え、民衆のための政治を主張した学者は？', difficulty: 'standard' },
      { id: 'fc10', front: '民本主義', explanation: '主権の在り処は問わず、政治は民衆のために行うべきとする考え方。', back: '吉野作造が唱えた、民衆のための政治を目指す考え方は？', difficulty: 'standard' },
      { id: 'fc11', front: '尾崎行雄', explanation: '「憲政の神様」と呼ばれ、議会政治の発展に尽力した。', back: '第一次護憲運動で中心的な役割を果たした立憲政友会の政治家は？', difficulty: 'standard' },
      { id: 'fc12', front: '大戦景気', explanation: 'ヨーロッパ列強が戦争に集中する中、日本の輸出が急増した。', back: '第一次世界大戦中に輸出の大幅増加で起きた日本の好景気は？', difficulty: 'standard' },
      { id: 'fc13', front: '成金', explanation: '造船業や鉄鋼業で巨利を得た人が多く、社会的批判も浴びた。', back: '大戦景気で急に大きな富を得た人々を何と呼んだ？', difficulty: 'standard' },
      { id: 'fc14', front: '寺内内閣', explanation: '米騒動を軍隊で鎮圧しようとしたが批判が高まり退陣した。', back: '米騒動の結果、総辞職した内閣は？', difficulty: 'standard' },
      { id: 'fc15', front: '1918年', explanation: '富山県の漁村の主婦たちの抗議が全国に波及した。', back: '米騒動が起きた年は？', difficulty: 'standard' },
      { id: 'fc16', front: '1925年', explanation: '加藤高明内閣のもとで両法が同時に成立した。', back: '普通選挙法と治安維持法が制定された年は？', difficulty: 'standard' },
      { id: 'fc17', front: '1912年', explanation: '大正元年にあたり、大正デモクラシーの始まりとされる。', back: '第一次護憲運動が起きた年は？', difficulty: 'standard' },
      ...
      { id: 'fc20', front: '天皇機関説', explanation: '天皇は国家そのものではなく国家の機関として統治するという解釈で、後に弾圧された。', back: '美濃部達吉が唱えた、天皇は国家の最高機関であるとする学説は？', difficulty: 'advanced' },
    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: [
            '国民に過度な特権を与えて甘やかしたため',
            '外国との外交交渉をセットで進めた政策だったため',
            '選挙権拡大と思想取り締まりをセットにしたため',
            '経済の自由化と軍事力の強化を同時に行ったため',
],
          correctIndex: 2,
          explanation:
        ...
        },
        {
          ...
          options: [
            '年齢が20歳以上に限定されていたこと',
            '女性には選挙権が認められなかった',
            '華族など一部の貴族だけに選挙権が与えられた',
            '一定額以上の納税者にしか選挙権がなかった',
          ],
          correctIndex: 1,
          explanation:
