...
export const socialMovements: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '労働争議', explanation: 'ストライキなどの手段で経営者に要求を突きつけた。大正時代に急増。', back: '労働者が賃上げや労働条件の改善を求めて起こした争いは？', difficulty: 'basic' },
      { id: 'fc2', front: '小作争議', explanation: '自分の土地を持たない農民が高い小作料の減額を地主に求めた。', back: '小作農が地主に対して小作料の引き下げなどを求めた争いは？', difficulty: 'basic' },
      { id: 'fc3', front: '全国水平社', back: '1922年に被差別部落の人々が差別撤廃を目指して結成した団体は？', explanation: '日本初の人権宣言と言われる水平社宣言を発表した。', difficulty: 'basic' },
      { id: 'fc4', front: '平塚らいてう', explanation: '青鞜社を結成し、のちに新婦人協会を設立して女性の権利向上を訴えた。', back: '「元始、女性は太陽であった」と宣言した女性解放運動の指導者は？', difficulty: 'basic' },
      { id: 'fc5', front: '普通選挙法', explanation: '納税額による選挙権の制限を撤廃したが、女性には選挙権が与えられなかった。', back: '1925年に成立し、満25歳以上の男子に選挙権を与えた法律は？', difficulty: 'basic' },
      { id: 'fc6', front: '治安維持法', explanation: '普通選挙法と同年に制定され、社会主義勢力の拡大を防ぐ目的があった。', back: '1925年に制定された、共産主義などの思想を取り締まる法律は？', difficulty: 'basic' },
      { id: 'fc7', front: 'メーデー', explanation: '5月1日に行われる国際的な労働者の祭典。日本初は上野公園で開催。', back: '1920年に日本で初めて行われた、労働者の祭典は？', difficulty: 'standard' },
      { id: 'fc8', front: '新婦人協会', explanation: '女性の政治集会への参加禁止撤廃などを求めて活動した。', back: '平塚らいてうや市川房枝が設立した、女性の政治参加を求めた団体は？', difficulty: 'standard' },
      { id: 'fc9', front: '日本農民組合', explanation: '1922年に結成され、小作料の減額交渉などを組織的に行った。', back: '小作農の権利を守るために結成された農民の全国組織は？', difficulty: 'standard' },
      { id: 'fc10', front: '水平社宣言', back: '全国水平社が発表した、日本初の人権宣言と言われるものは？', explanation: '「人の世に熱あれ、人間に光あれ」と結ばれている。', difficulty: 'standard' },
      { id: 'fc11', front: '青鞜社', explanation: '1911年に結成された女性の文学団体で、機関誌「青鞜」を発行した。', back: '平塚らいてうが結成した、女性の文芸・思想の団体は？', difficulty: 'standard' },
      { id: 'fc12', front: '市川房枝', explanation: '戦後は参議院議員として婦人参政権の実現に貢献した。', back: '新婦人協会を設立し、女性の政治参加の権利を求めて運動した人物は？', difficulty: 'standard' },
      ...
      { id: 'fc15', front: '「人の世に熱あれ、人間に光あれ」', explanation: '人間の尊厳と平等を力強く訴えた水平社宣言の結びの言葉。', back: '水平社宣言の有名な結びの言葉は？', difficulty: 'standard' },
      { id: 'fc16', front: '北海道アイヌ協会', explanation: 'アイヌ民族の生活改善や差別撤廃を目指して設立された。', back: '1930年に結成された、アイヌ民族の権利向上を目指す団体は？', difficulty: 'standard' },
      ...
      { id: 'fc18', front: '日本労働総同盟', explanation: '1921年に友愛会から改称し、労働運動の中心組織となった。', back: '労働者の権利を守るために結成された全国的な労働団体は？', difficulty: 'advanced' },
