...
export const sinoJapaneseWar: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '盧溝橋事件', explanation: '北京郊外の盧溝橋付近で起きた日中両軍の武力衝突事件。', back: '1937年に北京郊外で日本軍と中国軍が衝突し、日中戦争のきっかけとなった事件は？', difficulty: 'basic' },
      { id: 'fc2', front: '日中戦争', explanation: '宣戦布告なしに始まり、1945年の日本の敗戦まで8年間続いた。', back: '1937年に始まった日本と中国の全面戦争は？', difficulty: 'basic' },
      { id: 'fc3', front: '南京事件', explanation: '1937年12月の南京占領時に起きた。犠牲者数については諸説ある。', back: '日本軍が南京を占領した際に多くの捕虜や民間人を殺害した事件は？', difficulty: 'basic' },
      { id: 'fc4', front: '抗日民族統一戦線', explanation: '内戦中だった国民党と共産党が日本に対抗するため協力した。', back: '日本の侵略に対抗するため、国民党と共産党が手を結んで結成した組織は？', difficulty: 'basic' },
      { id: 'fc5', front: '蔣介石', explanation: '孫文の後継者として国民党を率い、重慶を拠点に長期抗戦を続けた。', back: '中国国民党の指導者で、首都を重慶に移して日本に抵抗した人物は？', difficulty: 'standard' },
      { id: 'fc6', front: '国家総動員法', explanation: '議会制民主主義を形骸化させ、戦時体制を確立する根拠となった法律。', back: '1938年に制定された、議会の承認なしに人や物資を動員できるようにした法律は？', difficulty: 'standard' },
      { id: 'fc7', front: '大政翼賛会', explanation: '1940年に結成され、国民を戦争協力に動員する体制が整えられた。', back: '全ての政党が解散して統合された組織は？', difficulty: 'standard' },
      ...
      { id: 'fc12', front: '重慶', explanation: '内陸の山間部に位置し、日本軍が容易に到達できない場所だった。', back: '蔣介石が南京陥落後に首都を移した内陸の都市は？', difficulty: 'basic' },
      { id: 'fc13', front: '毛沢東', explanation: '農民を基盤に勢力を広げ、戦後は中華人民共和国を建国した。', back: '中国共産党の指導者で、蔣介石と協力して抗日民族統一戦線を結成した人物は？', difficulty: 'standard' },
      { id: 'fc14', front: '1938年', explanation: '日中戦争の長期化に対応するため制定された。', back: '国家総動員法が制定された年は？', difficulty: 'standard' },
      { id: 'fc15', front: '配給制', explanation: '物資の不足が深刻化し、米や砂糖などが切符制で配られた。', back: '戦時中に食料や日用品を国が管理して分配した制度は？', difficulty: 'standard' },
      { id: 'fc16', front: '切符制', back: '配給で品物を受け取るために必要だった仕組みは？', explanation: '米や砂糖などの生活必需品が切符で配られた。', difficulty: 'standard' },
      { id: 'fc17', front: '創氏改名', explanation: '朝鮮の人々の民族的アイデンティティを否定する政策だった。', back: '皇民化政策で朝鮮の人々に日本式の姓名に変えさせたことを何というか？', difficulty: 'standard' },
      ...
      { id: 'fc20', front: '軍需品の優先生産', explanation: '鍋や釜などの金属製品も供出させられ、国民生活が犠牲になった。', back: '戦時中に兵器や軍用品の生産が優先され、国民の日用品が不足した政策は？', difficulty: 'advanced' },
      { id: 'fc21', front: '南京', explanation: '当時の中華民国の首都で、1937年12月に日本軍が占領した。', back: '日中戦争で日本軍が占領した中国の首都は？', difficulty: 'basic' },
