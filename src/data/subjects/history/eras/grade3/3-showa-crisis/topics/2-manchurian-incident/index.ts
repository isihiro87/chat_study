...
export const manchurianIncident: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '柳条湖事件', explanation: '関東軍が自作自演で線路を爆破し、中国軍の仕業として軍事行動を開始した。', back: '1931年に関東軍が南満州鉄道の線路を自ら爆破し、満州事変のきっかけとなった事件は？', difficulty: 'basic' },
      { id: 'fc2', front: '満州事変', explanation: '政府の不拡大方針を無視して関東軍が独断で行動した。', back: '1931年の柳条湖事件をきっかけに関東軍が中国東北部を占領した事件は？', difficulty: 'basic' },
      { id: 'fc3', front: '満州国', back: '1932年に日本が中国東北部に建国した国は？', explanation: '清の最後の皇帝・溥儀を元首にしたが実質は日本が支配した。', difficulty: 'basic' },
      { id: 'fc4', front: 'リットン調査団', explanation: 'イギリスのリットン伯爵を団長とし、満州国を日本の傀儡国家と報告した。', back: '国際連盟が満州事変を調査するために派遣した調査団は？', difficulty: 'basic' },
      ...
      { id: 'fc8', front: '二・二六事件', explanation: '約1400名の兵を率いたクーデターで、事件後は軍部の発言力がさらに増した。', back: '1936年に陸軍の青年将校がクーデターを起こし、政府要人を殺害した事件は？', difficulty: 'standard' },
      { id: 'fc9', front: '関東軍', explanation: '満州の権益を守るために駐留していたが、政府の統制を離れて暴走した。', back: '満州に駐留し、柳条湖事件や満州事変を起こした日本陸軍の部隊は？', difficulty: 'advanced' },
      ...
      { id: 'fc12', front: '溥儀', explanation: '1912年に退位した清朝最後の皇帝で、日本の傀儡として利用された。', back: '満州国の元首に据えられた清の最後の皇帝は？', difficulty: 'basic' },
      ...
      { id: 'fc16', front: 'ファシスト党', explanation: '「ファシズム」という言葉の語源となったイタリアの全体主義政党。', back: 'ムッソリーニが率いたイタリアの政党は？', difficulty: 'standard' },
      { id: 'fc17', front: 'エチオピア侵攻', explanation: '1935年に行われ、国際連盟はイタリアへの経済制裁を決議したが効果は薄かった。', back: 'ムッソリーニのイタリアが侵攻したアフリカの国への軍事行動は？', difficulty: 'standard' },
      { id: 'fc18', front: '政党内閣の終わり', explanation: '以後は軍人や官僚が首相となり、軍部主導の政治が続いた。', back: '五・一五事件の結果、終わりを迎えた日本の政治制度は？', difficulty: 'standard' },
      { id: 'fc19', front: '1932年5月15日', explanation: '事件名は日付から取られている。犬養毅首相が暗殺された。', back: '五・一五事件が起きた日付は？', difficulty: 'advanced' },
      { id: 'fc20', front: '1936年2月26日', explanation: '事件名は日付から取られている。東京中心部を占拠したが鎮圧された。', back: '二・二六事件が起きた日付は？', difficulty: 'advanced' },
      { id: 'fc21', front: '海軍の青年将校', explanation: '政党政治の腐敗に不満を持ち、武力による政治改革を目指した。', back: '五・一五事件を起こしたのはどのような人々か？', difficulty: 'standard' },
      { id: 'fc22', front: '陸軍の青年将校', explanation: '農村出身者が多く、昭和恐慌による農村の窮状に憤りを感じていた。', back: '二・二六事件を起こしたのはどのような人々か？', difficulty: 'standard' },
      { id: 'fc23', front: '「話せばわかる」', explanation: '青年将校は「問答無用」と応じ、犬養を射殺した。', back: '犬養毅首相が暗殺される直前に述べたとされる有名な言葉は？', difficulty: 'advanced' },
      { id: 'fc24', front: '国民社会主義ドイツ労働者党', explanation: 'ドイツ語の略称「NSDAP」からナチスと呼ばれた。', back: 'ヒトラーが率いたナチス（ナチ党）の正式名称は？', difficulty: 'advanced' },
      { id: 'fc25', front: 'ユダヤ人迫害', explanation: 'ユダヤ人をドイツの困難の原因とし、やがてホロコーストに至った。', back: 'ヒトラーが政権獲得後に推進した特定の民族に対する弾圧は？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
