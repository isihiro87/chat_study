...
export const greatDepression: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '世界恐慌', explanation: 'ニューヨーク株式市場の大暴落をきっかけに世界中に不況が広がった。', back: '1929年にアメリカから始まった世界的な経済危機は？', difficulty: 'basic' },
      { id: 'fc2', front: 'ニューディール政策', explanation: '政府が経済に積極的に介入する画期的な政策で、ダム建設などで雇用を創出した。', back: 'ルーズベルト大統領が世界恐慌に対して行った、公共事業中心の経済政策は？', difficulty: 'basic' },
      ...
      { id: 'fc11', front: 'ニューヨーク株式市場', explanation: 'ウォール街にあり、「暗黒の木曜日」と呼ばれる大暴落が起きた。', back: '1929年に株価の大暴落が起き、世界恐慌のきっかけとなった場所は？', difficulty: 'basic' },
      ...
      { id: 'fc17', front: '「持たざる国」', explanation: '資源や市場を確保できず、対外侵略に向かう要因となった。', back: '植民地が少なく、ブロック経済の外に置かれた日本・ドイツ・イタリアを指す言葉は？', difficulty: 'standard' },
      { id: 'fc18', front: '身売り', explanation: '農村の貧困が深刻化し、娘を都市の工場や遊郭に送る家庭が増えた。', back: '昭和恐慌のとき、貧しい家庭の娘が働かされることを指す言葉は？', difficulty: 'advanced' },
      { id: 'fc19', front: '欠食児童', explanation: '農村部を中心に弁当を持てない子どもが社会問題となった。', back: '昭和恐慌のとき、貧しさから食事がとれない子どもを指す言葉は？', difficulty: 'advanced' },
      { id: 'fc20', front: '生産調整', explanation: '供給過剰による価格暴落を防ぐため、政府が生産量を制限した。', back: 'ニューディール政策で行われた、農業や工業の生産量を調整して価格を安定させる政策は？', difficulty: 'advanced' },
      { id: 'fc21', front: '連鎖倒産', explanation: '銀行が倒産すると融資先の企業も資金が得られず連鎖的に破綻した。', back: '世界恐慌で銀行や企業が次々と倒れた現象を何というか？', difficulty: 'standard' },
