...
export const coldWarEnd: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: 'マルタ会談', explanation: '地中海のマルタ島で行われ、約44年間続いた冷戦の終わりが宣言された。', back: '1989年に米ソ首脳が冷戦の終結を宣言した会談は？', difficulty: 'basic' },
      { id: 'fc2', front: 'ゴルバチョフ', explanation: '冷戦終結に貢献しノーベル平和賞を受賞したが、ソ連解体も招いた。', back: 'ペレストロイカ（改革）やグラスノスチ（情報公開）を進めたソ連の指導者は？', difficulty: 'basic' },
      { id: 'fc3', front: 'ベルリンの壁崩壊', explanation: '1989年11月9日に市民が壁を壊し始め、冷戦終結を象徴する出来事となった。', back: '1989年に取り壊された、東西ドイツを隔てていた冷戦の象徴は？', difficulty: 'basic' },
      { id: 'fc4', front: 'ソ連解体', explanation: '15の共和国が独立し、ロシアが最大の後継国となった。', back: '1991年に多くの共和国が独立し消滅した国は？', difficulty: 'basic' },
      { id: 'fc5', front: 'ヨーロッパ連合（EU）', explanation: 'マーストリヒト条約に基づき発足し、共通通貨ユーロも導入された。', back: '1993年に発足したヨーロッパの地域統合組織は？', difficulty: 'basic' },
      ...
      { id: 'fc9', front: 'アフガニスタン侵攻', explanation: '10年に及ぶ泥沼の戦争でソ連の国力が大きく消耗した。', back: '1979年にソ連が軍事介入し、国力低下の原因となった出来事は？', difficulty: 'standard' },
      { id: 'fc10', front: 'ユーロ', explanation: '1999年に導入され、EU加盟国の多くで使用されている。', back: 'EUで導入されている共通通貨の名称は？', difficulty: 'standard' },
      { id: 'fc11', front: '湾岸戦争', explanation: '国連安保理決議に基づく多国籍軍がイラクを攻撃し、クウェートを解放した。', back: '1991年にイラクのクウェート侵攻に対し、多国籍軍がイラクを攻撃した戦争は？', difficulty: 'standard' },
      { id: 'fc12', front: '天安門事件', explanation: '天安門広場に集まった学生や市民の民主化要求が武力で鎮圧された。', back: '1989年に北京で民主化運動が弾圧された事件は？', difficulty: 'standard' },
      { id: 'fc13', front: 'アメリカ同時多発テロ', explanation: 'ハイジャックされた旅客機がニューヨークの世界貿易センタービルなどに突入した。', back: '2001年9月11日にアメリカで起きた大規模テロ事件は？', difficulty: 'standard' },
      ...
      { id: 'fc16', front: '東ヨーロッパの民主化', explanation: 'ポーランド・ハンガリー・チェコスロバキアなどで民主化が実現した。', back: '1989年に東ヨーロッパ諸国で共産党政権が次々と崩壊した動きを何という？', difficulty: 'standard' },
      { id: 'fc17', front: 'ブッシュ大統領', explanation: 'ジョージ・H・W・ブッシュ（父ブッシュ）。湾岸戦争も指揮した。', back: 'マルタ会談でゴルバチョフと冷戦終結を宣言したアメリカの大統領は？', difficulty: 'standard' },
