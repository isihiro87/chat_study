...
export const modernIssues: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'fc2', front: 'SDGs（持続可能な開発目標）', explanation: '貧困・教育・環境など幅広い分野を包括的にカバーする国際目標。', back: '2015年に国連で採択された、2030年までの達成を目指す17の国際目標は？', difficulty: 'basic' },
      { id: 'fc3', front: '少子高齢化', explanation: '年金や医療など社会保障制度の維持が困難になる深刻な問題。', back: '子供が減り、高齢者の割合が高まる日本の社会現象を何という？', difficulty: 'basic' },
      { id: 'fc4', front: '京都議定書', explanation: '日本の京都で開催されたCOP3で採択。先進国のみに削減義務を課した。', back: '1997年に採択された、先進国に温室効果ガスの削減義務を課した文書は？', difficulty: 'basic' },
      { id: 'fc5', front: '地球温暖化', explanation: 'CO2などの温室効果ガスが原因で、海面上昇や異常気象を引き起こしている。', back: '温室効果ガスの排出により起こる地球規模の環境問題は？', difficulty: 'basic' },
      { id: 'fc6', front: '持続可能な社会', explanation: '環境・経済・社会のバランスを取りながら発展を目指す考え方。', back: '将来の世代のことも考えた社会づくりを何という？', difficulty: 'basic' },
      ...
      { id: 'fc9', front: 'パリ協定', explanation: '京都議定書と異なり、発展途上国も含めた全ての国が削減目標を定めた。', back: '2015年に発展途上国も含め全ての国が温室効果ガス削減の目標を定めた合意は？', difficulty: 'standard' },
      { id: 'fc10', front: '再生可能エネルギー', explanation: '太陽光・風力・水力・地熱など、枯渇しないクリーンなエネルギー。', back: '東日本大震災後に導入が進んだ太陽光や風力などのエネルギーは？', difficulty: 'standard' },
      { id: 'fc11', front: '満18歳以上', explanation: '従来の20歳から引き下げられ、若者の政治参加が促された。', back: '2016年から引き下げられた選挙権の年齢は？', difficulty: 'standard' },
      { id: 'fc12', front: '多文化共生', explanation: '在日外国人の増加に伴い、互いの文化を尊重し合う社会づくりが求められている。', back: '異なる文化を持つ人々が共に生きる社会のあり方を何という？', difficulty: 'standard' },
      { id: 'fc13', front: '平和維持活動（PKO）', explanation: '停戦監視や選挙支援など、紛争地域の平和と安定を支える活動。', back: '国連が行う紛争解決のための活動を何という？', difficulty: 'standard' },
      { id: 'fc14', front: 'NGO（非政府組織）', explanation: '国境なき医師団や赤十字社などが代表的な例。', back: '民間の立場で国際協力を行う組織を何という？', difficulty: 'standard' },
      { id: 'fc15', front: '主要国首脳会議（サミット）', explanation: 'G7やG20の枠組みで、経済・環境・安全保障などを議論する。', back: '主要国の首脳が集まって国際問題を話し合う会議を何という？', difficulty: 'standard' },
      { id: 'fc16', front: '世界金融危機', explanation: 'アメリカの住宅バブル崩壊（リーマン・ショック）に端を発した。', back: '2008年に世界的な経済の混乱を引き起こした出来事は？', difficulty: 'standard' },
      { id: 'fc17', front: '核軍縮・核不拡散', explanation: '核拡散防止条約（NPT）を中心に取り組みが進められている。', back: '核兵器の削減と拡散防止を目指す世界的な課題は？', difficulty: 'standard' },
      { id: 'fc18', front: '情報化社会', explanation: 'SNSの普及で個人が情報を発信できるようになり、社会に大きな影響を与えている。', back: '携帯電話やインターネットの普及により進んだ社会の変化は？', difficulty: 'standard' },
      { id: 'fc19', front: '自由貿易', explanation: 'TPPやRCEPなどの自由貿易協定が各地域で締結されている。', back: 'グローバル化の進展により拡大した、関税などの障壁を減らす貿易を何という？', difficulty: 'standard' },
