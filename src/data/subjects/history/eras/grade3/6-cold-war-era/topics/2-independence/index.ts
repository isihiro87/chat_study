...
export const independence: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: 'サンフランシスコ平和条約', explanation: '48か国と締結し、日本は占領状態から独立国として国際社会に復帰した。', back: '1951年に日本が調印し、主権を回復した条約は？', difficulty: 'basic' },
      { id: 'fc2', front: '日米安全保障条約', explanation: '冷戦下の安全保障をアメリカに依存する体制の基礎となった。', back: 'サンフランシスコ平和条約と同時に結ばれた、アメリカ軍の日本駐留を定めた条約は？', difficulty: 'basic' },
      { id: 'fc3', front: '特需景気', explanation: '軍需物資の受注で日本の工業生産が急回復し、戦後復興のきっかけとなった。', back: '朝鮮戦争でアメリカ軍の物資調達により日本経済が潤ったことを何という？', difficulty: 'basic' },
      { id: 'fc4', front: '自衛隊', explanation: '警察予備隊から保安隊を経て発足。憲法第9条との関係が議論されている。', back: '1954年に設立された、日本の防衛を担う組織は？', difficulty: 'basic' },
      { id: 'fc5', front: '吉田茂', explanation: '戦後の日本外交の基本路線（日米同盟と軽武装・経済重視）を築いた。', back: 'サンフランシスコ平和条約に調印し、日本の独立回復を実現した首相は？', difficulty: 'basic' },
      { id: 'fc6', front: '警察予備隊', explanation: '朝鮮戦争で在日米軍が出動し、国内の防衛力が手薄になったため設立された。', back: '1950年にGHQの指令で設立された、自衛隊の前身となった組織は？', difficulty: 'basic' },
      { id: 'fc7', front: '48か国', explanation: 'ソ連・中国・インドなどは参加せず、「片面講和」と批判された。', back: 'サンフランシスコ平和条約で日本が締結した相手国の数は？', difficulty: 'basic' },
      ...
      { id: 'fc10', front: '安保闘争', explanation: '1960年に戦後最大規模の国民運動となり、岸首相は退陣した。', back: '日米安全保障条約の改定に反対する大規模な国民運動を何という？', difficulty: 'standard' },
      { id: 'fc11', front: '自由民主党', explanation: '自由党と日本民主党が合同して結成され、長期政権を担った。', back: '1955年に保守合同で結成され、長期政権を担った政党は？', difficulty: 'standard' },
      { id: 'fc12', front: '岸信介', explanation: '安保条約の改定を強行採決で進め、国民の激しい反発を招いた。', back: '安保闘争の際に日米安保条約の改定を進めた首相は？', difficulty: 'standard' },
      { id: 'fc13', front: '日ソ共同宣言', back: '1956年にソ連との国交を回復し、日本の国連加盟を実現させた宣言は？', explanation: 'ソ連が日本の国連加盟を支持したことで、国際連合への加盟が実現した。', difficulty: 'standard' },
      { id: 'fc14', front: '沖縄', back: 'サンフランシスコ平和条約後もアメリカの施政下に置かれた地域は？', explanation: '小笠原諸島とともに返還が課題だった。', difficulty: 'standard' },
      { id: 'fc15', front: '反核運動', explanation: '原水爆禁止世界大会の開催や署名運動として全国に広がった。', back: '第五福竜丸事件をきっかけに広がった、核兵器に反対する運動は？', difficulty: 'standard' },
      { id: 'fc16', front: '日韓基本条約', explanation: '日本が韓国政府を朝鮮半島唯一の合法政府と承認した。', back: '1965年に日本と韓国の国交を正常化した条約は？', difficulty: 'standard' },
    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: [
            'ソ連が北海道に侵攻する脅威が急激に高まったため',
            '日本国民が再軍備を強く求め議会で自衛隊設立を決議したため',
            'サンフランシスコ平和条約の締結条件として設立が義務付けられたため',
