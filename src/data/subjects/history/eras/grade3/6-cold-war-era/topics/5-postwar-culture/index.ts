...
export const postwarCulture: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '手塚治虫', explanation: '「鉄腕アトム」「ブラック・ジャック」など数多くの名作を生み出した。', back: '「漫画の神様」と呼ばれ、日本の漫画・アニメ文化の基礎を築いた人物は？', difficulty: 'basic' },
      { id: 'fc2', front: '湯川秀樹', explanation: '中間子理論の研究で受賞し、敗戦で自信を失った国民に希望を与えた。', back: '1949年に日本人として初めてノーベル賞（物理学賞）を受賞した科学者は？', difficulty: 'basic' },
      { id: 'fc3', front: '川端康成', back: '1968年にノーベル文学賞を受賞した日本の作家は？', explanation: '「雪国」「伊豆の踊子」などの名作で知られる。', difficulty: 'basic' },
      { id: 'fc4', front: '黒澤明', explanation: '「羅生門」がヴェネツィア国際映画祭金獅子賞を受賞し、日本映画を世界に知らしめた。', back: '「七人の侍」「羅生門」などで世界的に高い評価を受けた日本の映画監督は？', difficulty: 'basic' },
      { id: 'fc5', front: '特需景気', explanation: '繊維・金属などの軍需物資の受注で日本の工業生産が急回復した。', back: '朝鮮戦争でアメリカ軍の軍需物資を日本企業が大量生産し、経済が潤ったことを何という？', difficulty: 'basic' },
      { id: 'fc6', front: 'テレビ放送', explanation: 'NHKと日本テレビが1953年に放送を開始した。', back: '1953年に日本で始まった、戦後最大の娯楽メディアは？', difficulty: 'basic' },
      { id: 'fc7', front: '食糧不足', explanation: '闇市が各地にでき、買い出し列車で農村に食料を求める人々もいた。', back: '終戦直後の日本が直面した、国民生活の最大の問題は？', difficulty: 'basic' },
      { id: 'fc8', front: '鉄腕アトム', explanation: '毎週放送のテレビアニメの先駆けとなり、アニメ産業の発展につながった。', back: '手塚治虫の代表作で、1963年に放送された日本初の本格的テレビアニメは？', difficulty: 'standard' },
      { id: 'fc9', front: 'ゴジラ', back: '1954年に公開された、核の恐怖を描いた日本の怪獣映画は？', explanation: '第五福竜丸事件を背景に制作された。', difficulty: 'standard' },
      { id: 'fc10', front: '大江健三郎', explanation: '1994年に受賞。広島の被爆や障害をテーマにした作品で知られる。', back: '日本人として2人目のノーベル文学賞を受賞した作家は？', difficulty: 'standard' },
      { id: 'fc11', front: '中間子理論', explanation: '原子核の中で陽子と中性子を結びつける力を理論的に予測した。', back: '湯川秀樹がノーベル物理学賞を受賞した研究は？', difficulty: 'standard' },
      { id: 'fc12', front: '引きあげ', explanation: '満州や朝鮮半島などから約600万人以上が帰国した。', back: '終戦後、海外から多くの日本人が帰国したことを何という？', difficulty: 'standard' },
      { id: 'fc13', front: '大衆消費社会', explanation: '三種の神器の普及やスーパーマーケットの登場が象徴的だった。', back: '高度経済成長期に国民の所得が増加し、消費が活発になった社会を何という？', difficulty: 'standard' },
      ...
      { id: 'fc15', front: '羅生門', explanation: '1951年の受賞は日本映画が国際的に認められた画期的な出来事だった。', back: '黒澤明の代表作で、ヴェネツィア国際映画祭で金獅子賞を受賞した作品は？', difficulty: 'standard' },
