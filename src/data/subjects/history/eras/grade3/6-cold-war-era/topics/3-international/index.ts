...
export const international: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: 'アジア・アフリカ会議', explanation: '29か国が参加し、反植民地主義と平和十原則を採択した。', back: '1955年にインドネシアのバンドンで開かれた、植民地からの独立国が平和共存を訴えた会議は？', difficulty: 'basic' },
      { id: 'fc2', front: 'キューバ危機', explanation: 'ソ連がキューバにミサイル基地を建設しようとし、核戦争寸前の事態となった。', back: '1962年にアメリカとソ連が核戦争の瀬戸際に立った事件は？', difficulty: 'basic' },
      ...
      { id: 'fc6', front: '国際連合加盟', explanation: 'ソ連の拒否権が障害だったが、日ソ共同宣言で国交回復後に実現。', back: '1956年に日ソ共同宣言の後に実現した、日本の国際組織への加入は？', difficulty: 'basic' },
      { id: 'fc7', front: '日韓基本条約', explanation: '1965年に締結。賠償問題などは現在も議論が続いている。', back: '1965年に日本と韓国の国交を正常化した条約は？', difficulty: 'basic' },
      { id: 'fc8', front: '沖縄返還', back: '1972年にアメリカから日本に返還された地域は？', explanation: '佐藤栄作首相の時に実現。', difficulty: 'basic' },
      { id: 'fc9', front: '部分的核実験禁止条約', explanation: '大気圏・宇宙・水中での核実験を禁止したが、地下実験は除外された。', back: 'キューバ危機をきっかけに1963年に結ばれた、地下以外の核実験を禁止する条約は？', difficulty: 'standard' },
      { id: 'fc10', front: '日中平和友好条約', explanation: '日中共同声明を受けて、より正式な条約として締結された。', back: '1978年に日本と中国が結んだ、両国の友好関係を定めた条約は？', difficulty: 'standard' },
      ...
      { id: 'fc13', front: '田中角栄', explanation: '「日本列島改造論」でも知られ、日中国交正常化を実現した。', back: '1972年に訪中し日中共同声明を発表した首相は？', difficulty: 'standard' },
      { id: 'fc14', front: '鳩山一郎', explanation: '吉田茂の後を受け、ソ連との関係改善に取り組んだ。', back: '日ソ共同宣言を出し、ソ連との国交回復を実現した首相は？', difficulty: 'standard' },
      { id: 'fc15', front: '非核三原則', back: '核兵器を「持たず、作らず、持ちこませず」という日本の原則は？', explanation: '佐藤栄作首相が表明。', difficulty: 'standard' },
      { id: 'fc16', front: 'EU', explanation: '1993年にマーストリヒト条約により成立し、共通通貨ユーロも導入された。', back: 'EC（ヨーロッパ共同体）が発展して成立した、ヨーロッパの統合組織は？', difficulty: 'standard' },
      { id: 'fc17', front: '小笠原諸島', explanation: '沖縄より4年早く返還された。世界自然遺産にも登録されている。', back: '1968年にアメリカから日本に返還された太平洋の島々は？', difficulty: 'advanced' },
      { id: 'fc18', front: '佐藤栄作', back: '非核三原則を表明し、沖縄返還を実現してノーベル平和賞を受賞した首相は？', explanation: '非核三原則の表明と沖縄返還の功績により、1974年にノーベル平和賞を受賞した。', difficulty: 'advanced' },
