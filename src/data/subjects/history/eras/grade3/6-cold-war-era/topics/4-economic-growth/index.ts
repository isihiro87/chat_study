...
export const economicGrowth: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '高度経済成長', explanation: '年平均10%以上の経済成長を約20年間維持し、世界的にも「奇跡」と評された。', back: '1950年代半ばから1970年代初めにかけて日本が経験した急速な経済発展を何という？', difficulty: 'basic' },
      { id: 'fc2', front: '所得倍増計画', explanation: '実際には7年で目標を達成し、国民生活は大きく向上した。', back: '池田勇人首相が掲げた、10年間で国民所得を2倍にする計画は？', difficulty: 'basic' },
      { id: 'fc3', front: '三種の神器', explanation: '天皇家の三種の神器にちなんだ名称で、家電の普及を象徴する言葉。', back: '高度経済成長期に普及したテレビ・洗濯機・冷蔵庫の総称は？', difficulty: 'basic' },
      { id: 'fc4', front: '東海道新幹線', explanation: '東京オリンピックに合わせて開通し、日本の技術力を世界に示した。', back: '1964年に東京・大阪間で開通した、世界初の高速鉄道は？', difficulty: 'basic' },
      { id: 'fc5', front: '東京オリンピック', explanation: '戦後復興を世界に示し、インフラ整備で経済成長を加速させた。', back: '1964年にアジアで初めて開催されたオリンピックは？', difficulty: 'basic' },
      { id: 'fc6', front: '池田勇人', explanation: '安保闘争後の岸首相に代わり、経済重視の政策に転換した。', back: '所得倍増計画を掲げて高度経済成長を加速させた首相は？', difficulty: 'basic' },
      { id: 'fc7', front: '重化学工業', explanation: '太平洋ベルトに沿って工業地帯が形成された。', back: '高度経済成長期に大きく発展した、鉄鋼・化学・機械などの産業は？', difficulty: 'basic' },
      { id: 'fc8', front: '水俣病', explanation: 'チッソ工場の排水に含まれる有機水銀が原因。四大公害病の一つ。', back: '熊本県水俣市で発生した、有機水銀が原因の公害病は？', difficulty: 'standard' },
      { id: 'fc9', front: 'イタイイタイ病', explanation: '骨がもろくなり激しい痛みを伴う病気。四大公害病の一つ。', back: '富山県の神通川流域で発生した、カドミウムが原因の公害病は？', difficulty: 'standard' },
      { id: 'fc10', front: '四日市ぜんそく', explanation: '石油化学コンビナートから排出された亜硫酸ガスが原因。四大公害病の一つ。', back: '三重県四日市市で発生した、大気汚染が原因の公害病は？', difficulty: 'standard' },
      { id: 'fc11', front: 'エネルギー革命', explanation: '安価な石油への転換で炭鉱が次々と閉山し、産炭地域が衰退した。', back: '高度経済成長期に起きた、主要エネルギー源が石炭から石油に変わったことを何という？', difficulty: 'standard' },
      { id: 'fc12', front: '石油危機（オイル・ショック）', explanation: '産油国が石油価格を大幅に引き上げ、トイレットペーパー買い占め騒ぎも起きた。', back: '1973年に中東戦争をきっかけに石油価格が急騰し、高度経済成長が終わった出来事は？', difficulty: 'standard' },
      { id: 'fc13', front: '公害対策基本法', explanation: '企業の責任と国・地方自治体の対策義務を明確にした法律。', back: '1967年に制定された、公害防止のための基本的な法律は？', difficulty: 'standard' },
      { id: 'fc14', front: '日本万国博覧会（大阪万博）', explanation: '「人類の進歩と調和」をテーマに6400万人以上が来場した。', back: '1970年に大阪で開催された、アジア初の万国博覧会は？', difficulty: 'standard' },
      { id: 'fc15', front: '環境庁', explanation: '2001年に環境省に格上げされ、環境政策を一元的に担当している。', back: '1971年に設置された、環境行政を担当する機関は？', difficulty: 'standard' },
      { id: 'fc16', front: '石油化学コンビナート', explanation: '四日市などに建設され、大気汚染などの公害問題を引き起こした。', back: '石油を原料とする化学工場が集まった工業地帯を何という？', difficulty: 'standard' },
      { id: 'fc17', front: '第四次中東戦争', explanation: 'アラブ諸国がイスラエルに対して起こした戦争で、石油の武器化が行われた。', back: '1973年の石油危機のきっかけとなった戦争は？', difficulty: 'standard' },
      ...
      { id: 'fc19', front: '貿易摩擦', explanation: '特にアメリカとの間で自動車・半導体の輸出をめぐり摩擦が激化した。', back: '高度経済成長後、日本の輸出増加により諸外国との間に生じた経済的対立は？', difficulty: 'standard' },
      ...
      { id: 'fc21', front: '政府開発援助（ODA）', explanation: '日本は一時世界最大のODA供与国となり、国際貢献の柱とした。', back: '経済大国となった日本が発展途上国に対して行う経済的・技術的な支援は？', difficulty: 'advanced' },
