...
export const russianRevolution: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: 'ロシア革命', explanation: '大戦による疲弊と食糧不足が原因で、皇帝が退位し社会主義政権が誕生した。', back: '1917年にロシアで起きた、社会主義政府が誕生した革命は？', difficulty: 'basic' },
      { id: 'fc2', front: 'レーニン', explanation: 'マルクスの思想を実践に移し、ボリシェヴィキを率いて権力を握った。', back: 'ロシア革命を指導し、世界初の社会主義政府を樹立した人物は？', difficulty: 'basic' },
      { id: 'fc3', front: '社会主義', explanation: '生産手段を国有化し、利益を平等に分配することを目指す考え方。', back: '資本家ではなく労働者・農民が中心となって国を運営する考え方は？', difficulty: 'basic' },
      { id: 'fc4', front: 'シベリア出兵', back: 'ロシア革命の影響を恐れた日本などの列強がシベリアに軍隊を送ったことは？', explanation: '日本は1922年まで駐留を続けた。', difficulty: 'basic' },
      { id: 'fc5', front: '1917年', explanation: '第一次世界大戦中にロシアで二月革命と十月革命が起きた年。', back: 'ロシア革命が起きた年は？', difficulty: 'basic' },
      { id: 'fc6', front: 'ソビエト', explanation: 'ロシア語で「会議」の意味。革命の中核組織となった。', back: 'ロシア革命で各地に結成された労働者や兵士の代表会議は？', difficulty: 'basic' },
      ...
      { id: 'fc9', front: '五か年計画', explanation: '国家主導で経済目標を設定し、資源と労働力を計画的に配分した。', back: 'スターリンが実施した、重工業の発展と農業の集団化を進めた経済計画は？', difficulty: 'standard' },
      { id: 'fc10', front: '農業の集団化', back: 'スターリンが五か年計画で進めた、個人の農地を国の管理にまとめた政策は？', explanation: '多くの農民が犠牲になった。', difficulty: 'standard' },
      { id: 'fc11', front: '1922年', explanation: 'ロシア・ウクライナなど複数の共和国が連邦を形成した年。', back: 'ソ連が成立し、日本がシベリアから撤兵した年は？', difficulty: 'standard' },
      { id: 'fc12', front: '世界初の社会主義政府', explanation: '資本主義体制に代わる国家モデルとして世界に大きな影響を与えた。', back: 'ロシア革命で誕生した政府はどのような点で世界史上画期的だったか？', difficulty: 'standard' },
      { id: 'fc13', front: '第一次世界大戦の疲弊と食糧不足', explanation: '長期化する戦争で兵士や国民の不満が爆発し革命につながった。', back: 'ロシア革命が起きた主な原因を2つ挙げよ', difficulty: 'standard' },
      { id: 'fc14', front: '戦争からの離脱', explanation: 'ドイツとブレスト・リトフスク条約を結び単独講和した。', back: 'ロシア革命後、ロシアは第一次世界大戦に対してどのような対応をとった？', difficulty: 'standard' },
      { id: 'fc15', front: '重工業化', explanation: '鉄鋼・機械・電力などの分野に国家が資源を集中投入した。', back: '五か年計画で農業の集団化とともに推進された政策は？', difficulty: 'standard' },
