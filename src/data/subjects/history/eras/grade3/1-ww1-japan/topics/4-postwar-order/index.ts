...
export const postwarOrder: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'fc5', front: '三・一独立運動', back: '1919年に朝鮮で起きた、日本からの独立を求める運動は？', difficulty: 'basic' },
      ...
      { id: 'fc9', front: '1920年', back: '国際連盟が設立された年は？', difficulty: 'standard' },
      { id: 'fc10', front: 'ジュネーブ', back: '国際連盟の本部が置かれたスイスの都市は？', difficulty: 'standard' },
      { id: 'fc11', front: 'ワシントン会議', back: '1921年に開かれた、太平洋地域の現状維持や軍縮を取り決めた会議は？', explanation: '日英同盟の解消も決定された。', difficulty: 'standard' },
      { id: 'fc12', front: '日英同盟の解消', back: 'ワシントン会議で解消された同盟は？', difficulty: 'standard' },
      { id: 'fc13', front: 'アメリカの不参加', back: '国際連盟の設立を提案したにもかかわらず参加しなかった国は？', explanation: 'アメリカ議会の反対が理由。', difficulty: 'standard' },
      { id: 'fc14', front: '巨額の賠償金・植民地没収・軍備縮小', back: 'ベルサイユ条約でドイツに課された3つの条件は？', difficulty: 'standard' },
      { id: 'fc15', front: '京城（ソウル）', back: '三・一独立運動が始まった場所は？', difficulty: 'standard' },
      { id: 'fc16', front: '孫文', back: '五・四運動の後に中国国民党を結成した人物は？', difficulty: 'standard' },
      { id: 'fc17', front: '非暴力・不服従', back: 'ガンディーが唱えた、暴力を使わずに不当な支配に従わない運動方法は？', difficulty: 'standard' },
      { id: 'fc18', front: 'ワイマール憲法', back: 'ドイツで男女普通選挙や労働者の権利を定めた憲法は？', difficulty: 'standard' },
      { id: 'fc19', front: '中国の独立と領土保全', back: 'ワシントン会議で取り決められた中国に関する方針は？', difficulty: 'advanced' },
