...
export const ww1Outbreak: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '三国協商', explanation: '20世紀初めにドイツの勢力拡大に対抗して結ばれた協力関係。', back: 'イギリス・フランス・ロシアが結んだ協力関係は？', difficulty: 'basic' },
      { id: 'fc2', front: '三国同盟', explanation: '三国協商に対抗する陣営で、第一次世界大戦では同盟国側の中核となった。', back: 'ドイツ・オーストリア・イタリアが結んだ軍事同盟は？', difficulty: 'basic' },
      { id: 'fc3', front: 'サラエボ事件', explanation: 'ボスニアのサラエボでセルビア人青年がオーストリア皇太子夫妻を暗殺した事件。', back: '1914年にオーストリア皇太子が暗殺され、第一次世界大戦のきっかけとなった事件は？', difficulty: 'basic' },
      { id: 'fc4', front: '第一次世界大戦', explanation: 'サラエボ事件をきっかけに始まり、30か国以上が参戦した史上初の世界規模の戦争。', back: '1914年から1918年まで続いた、ヨーロッパ全体を巻き込んだ大戦争は？', difficulty: 'basic' },
      { id: 'fc5', front: '総力戦', explanation: '軍事だけでなく経済・産業・国民生活すべてが戦争のために動員される形態。', back: '国の全ての力（軍事・経済・国民生活）を動員して行う戦争のことを何という？', difficulty: 'basic' },
      { id: 'fc6', front: 'バルカン半島', explanation: 'オスマン帝国の衰退後、多民族が独立を目指し列強も介入して紛争が絶えなかった。', back: '多くの民族が住み、列強の利害が絡み合って「ヨーロッパの火薬庫」と呼ばれた地域は？', difficulty: 'basic' },
      ...
      { id: 'fc11', front: '植民地をめぐる対立', explanation: 'アフリカやアジアでの勢力圏獲得競争が列強間の緊張を高めた。', back: '20世紀初めのヨーロッパで2つの陣営の対立が深まった主な原因は？', difficulty: 'standard' },
      { id: 'fc12', front: 'セルビア人の青年', explanation: 'オーストリアに併合されたボスニアのセルビア系住民による犯行だった。', back: 'サラエボ事件でオーストリア皇太子を暗殺したのはどの国の人物？', difficulty: 'standard' },
      { id: 'fc13', front: '戦車・飛行機・毒ガス・潜水艦', explanation: 'これらの新兵器の登場により戦争の破壊力が飛躍的に増大した。', back: '第一次世界大戦で初めて実戦に投入された新兵器を4つ挙げよ', difficulty: 'standard' },
      { id: 'fc14', front: '軍備拡大競争', explanation: '列強が互いに軍事力を増強し合い、戦争のリスクを高めた。', back: '20世紀初めのヨーロッパで、各国が軍事力を競って増強した状況を何という？', difficulty: 'standard' },
