...
export const japanInWw1: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '日英同盟', explanation: '1902年に結ばれた日本とイギリスの軍事同盟。ロシアへの対抗が目的だった。', back: '日本が第一次世界大戦に参戦する理由となった同盟は？', difficulty: 'basic' },
      { id: 'fc2', front: '山東省', explanation: 'ドイツが租借していた青島を含む地域で、日本が軍事占領した。', back: '日本が第一次世界大戦中にドイツから奪った中国の地域は？', difficulty: 'basic' },
      { id: 'fc3', front: '二十一か条の要求', back: '1915年に日本が中国に突きつけた、中国の主権を侵害する要求は？', explanation: '袁世凱政府に対して出された。中国の反日感情が高まった。', difficulty: 'basic' },
      { id: 'fc4', front: '大戦景気', explanation: 'ヨーロッパ列強が戦争に集中する間にアジア市場への輸出が急増した。', back: '第一次世界大戦中にアジア市場への輸出が増えて起きた日本の好景気は？', difficulty: 'basic' },
      { id: 'fc5', front: '連合国側', explanation: '日英同盟を根拠に、イギリスの敵国ドイツに宣戦布告した。', back: '日本は第一次世界大戦でどちらの陣営で参戦したか？', difficulty: 'basic' },
      { id: 'fc6', front: '1915年', explanation: '列強が大戦に集中する隙にアジアでの権益拡大を図った。', back: '二十一か条の要求が出された年は？', difficulty: 'basic' },
      { id: 'fc7', front: '袁世凱', back: '二十一か条の要求を受けた中国の大統領は？', explanation: '中華民国の初代大統領で、日本の要求の大部分を受け入れた。', difficulty: 'standard' },
      { id: 'fc8', front: '成金', explanation: '特に造船業や鉄鋼業で巨利を得た実業家が多かった。', back: '大戦景気で急に大きな富を得た人々を何と呼んだ？', difficulty: 'standard' },
      { id: 'fc9', front: '権益', back: '条約などで認められた、ある地域での経済的・政治的な利益を何という？', explanation: '山東省のドイツ権益を日本が継承しようとした。', difficulty: 'standard' },
      { id: 'fc10', front: '南洋諸島', explanation: '戦後の国際連盟により日本の委任統治領となった。', back: '日本が第一次世界大戦中にドイツから占領した太平洋の島々は？', difficulty: 'standard' },
      { id: 'fc11', front: '造船業・鉄鋼業', explanation: 'ヨーロッパからの輸入が途絶え、国内生産と輸出が急拡大した。', back: '大戦景気で特に発展した日本の産業を2つ挙げよ', difficulty: 'standard' },
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            '中国の皇帝を廃位させ共和制に変えようとしたから',
            '中国の伝統文化や習慣を否定しようとしたから',
            '中国の軍隊を全て解散させ武装解除しようとしたから',
],
          correctIndex: 0,
          explanation:
