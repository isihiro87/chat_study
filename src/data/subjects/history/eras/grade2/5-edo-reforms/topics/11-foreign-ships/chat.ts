...
export const foreignShipsChat: HistoryChat = {
  ...
  content: [
    ...
    },
    {
      ...
      explanation:
        '<strong>正解はD「異国船打払令」</strong>です。外国船を見つけ次第砲撃して追い払う強硬な政策でした。',
    },
    {
      type: 'narrator',
    ...
    },
    {
      ...
      explanation:
        '<strong>正解はD「蛮社の獄」</strong>です。渡辺崋山や高野長英らが処罰され、幕府の厳しい姿勢が示されました。',
    },
    {
      type: 'date',
      text: '天保8年（1837年）',
    ...
    },
    {
      ...
      explanation:
        '<strong>正解はA「大塩平八郎」</strong>です。ききんに苦しむ民を救うため、元幕府役人が乱を起こしたことは大きな衝撃でした。',
    },
    {
      type: 'end',
      points: [
