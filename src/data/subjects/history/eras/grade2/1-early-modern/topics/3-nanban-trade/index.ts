...
export const nanbanTrade: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '鉄砲', back: '1543年に種子島へ伝来した新しい武器は？', difficulty: 'basic' },
      { id: 'fc2', front: 'ザビエル', back: '1549年にキリスト教を日本に伝えた人物は？', difficulty: 'basic' },
      { id: 'fc3', front: '南蛮貿易', back: '南欧人との間で行われた貿易の名称は？', difficulty: 'basic' },
      { id: 'fc4', front: 'キリシタン大名', back: '貿易の利益を得るため改宗した戦国大名は？', difficulty: 'basic' },
      { id: 'fc5', front: '国友', back: '刀鍛冶の技術で鉄砲生産地となった近江の都市は？', difficulty: 'standard' },
      { id: 'fc6', front: '生糸', back: '南蛮貿易で輸入された衣料の高級原料は？', difficulty: 'standard' },
      { id: 'fc7', front: '天正遣欧使節', back: '九州の大名が教皇のもとへ派遣した少年使節は？', difficulty: 'standard' },
      { id: 'fc8', front: '銀', back: '南蛮貿易において日本から輸出された主な品は？', difficulty: 'standard' },
      { id: 'fc9', front: '活版印刷術', back: '宣教師が持ち込み「平家物語」等を印刷した技術は？', difficulty: 'standard' },
      { id: 'fc10', front: '長崎', back: '1580年にイエズス会に寄進された港町は？', difficulty: 'standard' },
      { id: 'fc11', front: 'アンジロウ', back: 'ザビエルが鹿児島に上陸する契機となった日本人は？', difficulty: 'advanced' },
      { id: 'fc12', front: '種子島', back: '1543年に鉄砲が初めて伝来した九州南方の島は？', difficulty: 'basic' },
      { id: 'fc13', front: 'ポルトガル', back: '1543年に種子島に鉄砲を伝えた国は？', difficulty: 'basic' },
      { id: 'fc14', front: '大友宗麟', back: '九州のキリシタン大名として知られる豊後の大名は？', difficulty: 'standard' },
      { id: 'fc15', front: '鹿児島', back: '1549年にザビエルが最初に上陸した日本の地は？', difficulty: 'standard' },
      { id: 'fc16', front: '南蛮人', back: 'ポルトガル人やスペイン人を日本人が呼んだ呼び名は？', difficulty: 'standard' },
      { id: 'fc17', front: 'イエズス会', back: 'ザビエルが所属していたカトリックの修道会は？', difficulty: 'advanced' },
      { id: 'fc18', front: '大村純忠', back: '1580年に長崎をイエズス会に寄進したキリシタン大名は？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
        ...
        { id: 'q6', question: '1580年にイエズス会に寄進された港町は？', options: ['堺', '長崎', '平戸', '博多'], correctIndex: 1, explanation: '大村純忠が長崎をイエズス会に寄進し南蛮貿易の中心地となりました。', difficulty: 'standard' },
        ...
        { id: 'q8', question: '1582年にローマへ派遣された少年使節は？', options: ['遣唐使', '遣隋使', '天正遣欧使節', '朝鮮通信使'], correctIndex: 2, explanation: '天正遣欧使節はキリシタン大名が少年4人をローマに派遣した使節です。', difficulty: 'standard' },
        { id: 'q9', question: '鉄砲の生産地として発展した和泉の都市は？', options: ['国友', '堺', '長崎', '京都'], correctIndex: 1, explanation: '堺は鉄砲の量産地として発展し商業都市としても繁栄しました。', difficulty: 'standard' },
        ...
        { id: 'q14', question: '近江で鉄砲の生産地として発展した町は？', options: ['堺', '国友', '長崎', '平戸'], correctIndex: 1, explanation: '国友は刀鍛冶の技術を生かして鉄砲の生産地となりました。', difficulty: 'standard' },
