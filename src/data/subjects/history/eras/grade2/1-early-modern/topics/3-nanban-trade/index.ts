...
export const nanbanTrade: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '{鉄砲|てっぽう}', back: '1543年に種子島へ伝来した新しい武器は？', explanation: 'ポルトガル人が伝え、戦国時代の戦い方を劇的に変えた火器。', difficulty: 'basic' },
      { id: 'fc2', front: 'ザビエル', back: '1549年にキリスト教を日本に伝えた人物は？', explanation: 'イエズス会の宣教師で、アンジロウとの出会いがきっかけで来日した。', difficulty: 'basic' },
      { id: 'fc3', front: '{南蛮|なんばん}{貿易|ぼうえき}', back: '南欧人との間で行われた貿易の名称は？', explanation: 'ポルトガル・スペインを「南蛮」と呼んだことに由来する貿易の名称。', difficulty: 'basic' },
      { id: 'fc4', front: 'キリシタン{大名|だいみょう}', back: '貿易の利益を得るため改宗した戦国大名は？', explanation: '大友宗麟・大村純忠・有馬晴信などが代表的で、天正遣欧使節を派遣した。', difficulty: 'basic' },
      { id: 'fc5', front: '{国友|くにとも}', back: '刀鍛冶の技術で鉄砲生産地となった近江の都市は？', explanation: '堺とともに鉄砲の量産拠点となり、刀鍛冶の技術が鉄砲製造に生かされた。', difficulty: 'standard' },
      { id: 'fc6', front: '{生糸|きいと}', back: '南蛮貿易で輸入された衣料の高級原料は？', explanation: '中国産の生糸が主な輸入品で、日本の絹織物産業を支えた。', difficulty: 'standard' },
      { id: 'fc7', front: '{天正|てんしょう}{遣欧使節|けんおうしせつ}', back: '九州の大名が教皇のもとへ派遣した少年使節は？', explanation: '1582年に4人の少年がローマ教皇のもとへ派遣され、8年後に帰国した。', difficulty: 'standard' },
      { id: 'fc8', front: '{銀|ぎん}', back: '南蛮貿易において日本から輸出された主な品は？', explanation: '石見銀山などから産出され、当時世界の銀産出量の3分の1を占めたとされる。', difficulty: 'standard' },
      { id: 'fc9', front: '{活版|かっぱん}{印刷術|いんさつじゅつ}', back: '宣教師が持ち込み「平家物語」等を印刷した技術は？', explanation: '天草版平家物語がローマ字で印刷され、日本の印刷文化にも影響を与えた。', difficulty: 'standard' },
      { id: 'fc10', front: '{長崎|ながさき}', back: '1580年にイエズス会に寄進された港町は？', explanation: '大村純忠が寄進し、南蛮貿易の中心地として大いに繁栄した。', difficulty: 'standard' },
      { id: 'fc11', front: 'アンジロウ', back: 'ザビエルが鹿児島に上陸する契機となった日本人は？', explanation: 'マラッカでザビエルと出会い、日本への関心を高めた人物。', difficulty: 'advanced' },
      { id: 'fc12', front: '{種子島|たねがしま}', back: '1543年に鉄砲が初めて伝来した九州南方の島は？', explanation: 'ポルトガル人を乗せた中国船が漂着し、鉄砲2挺が伝えられた。', difficulty: 'basic' },
      { id: 'fc13', front: 'ポルトガル', back: '1543年に種子島に鉄砲を伝えた国は？', explanation: 'スペインとともに大航海時代を先導し、日本との南蛮貿易を行った。', difficulty: 'basic' },
      { id: 'fc14', front: '{大友宗麟|おおともそうりん}', back: '九州のキリシタン大名として知られる豊後の大名は？', explanation: '天正遣欧使節の派遣にも関わった、九州を代表するキリシタン大名。', difficulty: 'standard' },
      { id: 'fc15', front: '{鹿児島|かごしま}', back: '1549年にザビエルが最初に上陸した日本の地は？', explanation: 'ザビエルはここから布教を開始し、その後山口や豊後にも布教した。', difficulty: 'standard' },
      { id: 'fc16', front: '{南蛮人|なんばんじん}', back: 'ポルトガル人やスペイン人を日本人が呼んだ呼び名は？', explanation: '南方から来た外国人を指す呼び名で、南蛮貿易や南蛮文化の名の由来。', difficulty: 'standard' },
      { id: 'fc17', front: 'イエズス{会|かい}', back: 'ザビエルが所属していたカトリックの修道会は？', explanation: 'カトリックの対抗改革で設立され、アジアや南米への布教を積極的に行った。', difficulty: 'advanced' },
      { id: 'fc18', front: '{大村純忠|おおむらすみただ}', back: '1580年に長崎をイエズス会に寄進したキリシタン大名は？', explanation: '日本初のキリシタン大名とされ、長崎を南蛮貿易の拠点として発展させた。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
