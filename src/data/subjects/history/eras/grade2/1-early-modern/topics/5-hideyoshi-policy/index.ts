...
export const hideyoshiPolicy: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'fc1', front: '{太閤|たいこう}{検地|けんち}', back: '秀吉が土地の面積や収穫量を全国で調査した政策は？', explanation: '統一基準の京ますで全国の土地を測量し、年貢の基準を明確にした。', difficulty: 'basic' },
      { id: 'fc2', front: '{刀狩|かたながり}', back: '秀吉が一揆を防ぐため百姓から武器を奪った政策は？', explanation: '1588年に実施され、百姓の武装を解除して一揆を防止した。', difficulty: 'basic' },
      { id: 'fc3', front: '{兵農|へいのう}{分離|ぶんり}', back: '武士と農民の身分が明確に区別された社会状態は？', explanation: '太閤検地と刀狩により武士と農民の区別が確定し、近世社会の基盤となった。', difficulty: 'basic' },
      { id: 'fc4', front: '{石高|こくだか}', back: '検地によって示された米の予想収穫量の単位は？', explanation: '土地の生産力を米の量で表し、年貢の基準や大名の格式を決める尺度となった。', difficulty: 'basic' },
      { id: 'fc5', front: '{文禄|ぶんろく}の{役|えき}', back: '1592年に秀吉が明の征服を目指し朝鮮へ出兵した戦いは？', explanation: '約15万の大軍を派遣したが、朝鮮の抵抗や明の援軍で苦戦した。', difficulty: 'basic' },
      { id: 'fc6', front: '{李舜臣|りしゅんしん}', back: '朝鮮の水軍を率いて日本の補給路を断った英雄は？', explanation: '亀甲船を駆使して日本水軍を破り、韓国では今も英雄として尊敬されている。', difficulty: 'standard' },
      { id: 'fc7', front: '{有田焼|ありたやき}', back: '朝鮮出兵の際に連行された陶工が伝えた工芸品は？', explanation: '朝鮮の陶工が佐賀に伝えた技術が基となり、日本を代表する磁器となった。', difficulty: 'standard' },
      { id: 'fc8', front: '{亀甲船|きっこうせん}', back: '李舜臣が率いた甲板を鉄板で覆った軍船の名は？', explanation: '亀の甲羅のように上部を覆った構造で、敵兵の侵入を防ぎながら攻撃できた。', difficulty: 'standard' },
      { id: 'fc9', front: '{百姓|ひゃくしょう}', back: '検地により土地を耕作する権利を保障された身分は？', explanation: '耕作権を得る代わりに年貢を納める義務を負い、全人口の約85%を占めた。', difficulty: 'standard' },
      { id: 'fc10', front: '{慶長|けいちょう}の{役|えき}', back: '1597年に再び朝鮮へ大軍を派遣した二度目の戦いは？', explanation: '文禄の役に続く二度目の出兵で、秀吉の死により1598年に撤退した。', difficulty: 'advanced' },
      { id: 'fc11', front: '{京|きょう}ます', back: '秀吉が検地の際に基準として統一した計量器は？', explanation: '全国で異なっていた計量の基準を統一し、公平な年貢徴収を可能にした。', difficulty: 'advanced' },
      { id: 'fc12', front: '{明|みん}', back: '秀吉が朝鮮出兵で征服を目指した中国の王朝は？', explanation: '14世紀から17世紀まで続いた中国の王朝で、秀吉の野心の最終目標だった。', difficulty: 'basic' },
      { id: 'fc13', front: '{年貢|ねんぐ}', back: '検地により百姓が納める義務を負った税は？', explanation: '収穫した米などを領主に納める税で、百姓の生活を大きく左右した。', difficulty: 'basic' },
      { id: 'fc14', front: '{近世|きんせい}{社会|しゃかい}', back: '兵農分離により形成された武士と百姓が区別される社会は？', explanation: '中世の下剋上の時代から、身分が固定された安定した社会への転換点。', difficulty: 'standard' },
      { id: 'fc15', front: '1588年', back: '秀吉が刀狩を行った年は？', explanation: '「1588（いちごはは）ちにした刀狩」と覚えると年号を記憶しやすい。', difficulty: 'standard' },
      { id: 'fc16', front: '{土地|とち}の{耕作権|こうさくけん}', back: '太閤検地で百姓に保障された権利は？', explanation: '土地を耕作する権利と引き換えに年貢を納める義務を負う仕組みが確立された。', difficulty: 'standard' },
      { id: 'fc17', front: '約15万人', back: '文禄の役で朝鮮に送られた日本軍のおよその兵力は？', explanation: '当時としては極めて大規模な軍勢だったが、補給路を断たれ苦戦した。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
