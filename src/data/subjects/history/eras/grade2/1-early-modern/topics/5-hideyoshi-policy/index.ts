  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        { id: 'q4', question: '1592年に秀吉が朝鮮に大軍を送った最初の出兵は？', options: ['文禄の役', '慶長の役', '応仁の乱', '元寇'], correctIndex: 0, explanation: '文禄の役は1592年に秀吉が明の征服を目指して朝鮮に出兵した最初の戦いです。', difficulty: 'basic' },
        ...
        { id: 'q8', question: '太閤検地で統一された計量器は？', options: ['尺（しゃく）', '京ます', '枡（ます）', '貫（かん）'], correctIndex: 1, explanation: '京ますを統一基準とすることで全国の収穫量を公平に測量しました。', difficulty: 'standard' },
        ...
        { id: 'q14', question: '朝鮮出兵で日本軍が撤退した直接の理由は？', options: ['朝鮮との講和成立', '秀吉の死（1598年）', '明の大軍の到来', '国内での反乱発生'], correctIndex: 1, explanation: '1598年に秀吉が亡くなったため、日本軍は朝鮮から撤退しました。', difficulty: 'basic' },
