...
export const foreignRelations: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'fc10', front: '長崎奉行', back: '長崎での貿易を管理した幕府の役職は？', difficulty: 'basic' },
      { id: 'fc11', front: '薩摩藩', back: '鎖国下で琉球との窓口となった藩は？', difficulty: 'basic' },
      { id: 'fc12', front: '松前藩', back: '鎖国下でアイヌとの窓口となった藩は？', difficulty: 'basic' },
      { id: 'fc13', front: '四つの窓口', back: '鎖国下で外国と関係を維持した長崎・対馬・薩摩・松前を何と呼ぶ？', difficulty: 'standard' },
      { id: 'fc14', front: '釜山', back: '対馬藩が倭館を設けた朝鮮の港町は？', difficulty: 'standard' },
      { id: 'fc15', front: '12回', back: '朝鮮通信使が江戸時代を通じて来日した合計回数は？', difficulty: 'advanced' },
      { id: 'fc16', front: '1609年', back: '薩摩藩が琉球王国に侵攻した年は？', difficulty: 'advanced' },
      { id: 'fc17', front: '朝貢貿易', back: '薩摩藩の支配下でも琉球が中国に対して行っていた貿易形態は？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
