...
export const russoJapaneseWar: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      {
        id: 'fc7',
        front: '{日比谷|ひびや}{焼|や}き{討|う}ち{事件|じけん}',
      ...
      {
        id: 'fc18',
        front: 'アジアの{民族|みんぞく}{独立|どくりつ}{運動|うんどう}',
