  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        {
          id: 'q2',
          question: 'イギリス・インド・清の間で行われた、アヘンを密輸する貿易を何という？',
          options: ['自由貿易', '保護貿易', '三角貿易', '朝貢貿易'],
          correctIndex: 2,
          explanation:
        ...
        {
          id: 'q3',
          question: 'アヘン戦争後、清がイギリスと結んだ不平等条約は？',
          options: ['日米和親条約', '南京条約', 'パリ条約', '下関条約'],
          correctIndex: 1,
          explanation:
        ...
        {
          id: 'q6',
          question: 'アヘン戦争後にイギリスに割譲された中国南部の地域は？',
          options: ['上海', 'マカオ', '台湾', '香港'],
          correctIndex: 3,
          explanation:
