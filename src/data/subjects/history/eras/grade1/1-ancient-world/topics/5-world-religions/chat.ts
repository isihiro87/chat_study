...
export const worldReligionsChat: HistoryChat = {
  ...
  content: [
    ...
    },
    {
      ...
      characterId: 'student',
      expression: 'thinking',
      text: '<strong><span class="keyword"><ruby>ユダヤ教<rp>(</rp><rt>ゆだやきょう</rt><rp>)</rp></ruby></span></strong>とキリスト教は関係があるんですか？',
    },
    {
      type: 'message',
      side: 'left',
      characterId: 'teacher',
      expression: 'explaining',
      text: 'いい<ruby>質問<rp>(</rp><rt>しつもん</rt><rp>)</rp></ruby>だね。<strong>ユダヤ教</strong>は<ruby>唯一<rp>(</rp><rt>ゆいいつ</rt><rp>)</rp></ruby>の神だけを信じる<strong><span class="keyword"><ruby>一神教<rp>(</rp><rt>いっしんきょう</rt><rp>)</rp></ruby></span></strong>の<ruby>先駆<rp>(</rp><rt>さきが</rt><rp>)</rp></ruby>けなんだ。イエスはユダヤ教徒だったけど、新しい教えを説いたのがキリスト教の始まりだよ',
    },
    {
      type: 'message',
      side: 'right',
    ...
    },
    {
      ...
      characterId: 'teacher',
      expression: 'happy',
      text: '<strong><span class="keyword">ヒンドゥー<ruby>教<rp>(</rp><rt>きょう</rt><rp>)</rp></ruby></span></strong>だね。<ruby>多神教<rp>(</rp><rt>たしんきょう</rt><rp>)</rp></ruby>で、インドの<strong><span class="keyword">カースト<ruby>制度<rp>(</rp><rt>せいど</rt><rp>)</rp></ruby></span></strong>と結びついているんだ。仏教を<ruby>吸収<rp>(</rp><rt>きゅうしゅう</rt><rp>)</rp></ruby>して成立した<ruby>宗教<rp>(</rp><rt>しゅうきょう</rt><rp>)</rp></ruby>でもあるよ',
    },
    {
      type: 'message',
      side: 'right',
    ...
    {
      type: 'summary-point',
      text: '<span class="keyword">ユダヤ教</span>は<span class="keyword">一神教</span>の先駆け。<span class="keyword">エルサレム</span>は三宗教共通の聖地。<span class="keyword">ヒンドゥー教</span>はインドの多神教！',
    },
    {
      type: 'quiz',
