...
export const worldReligions: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      {
        id: 'fc2',
        front: 'シャカ', explanation: '紀元前5世紀頃のインドで苦しみからの解放を説いた。仏教の開祖。', back: '紀元前5世紀頃のインドで仏教を開いたのはだれ？',
        difficulty: 'basic',
      },
      {
        id: 'fc3',
        front: 'イエス', explanation: 'パレスチナで神の愛を説いた。十字架にかけられたが復活したと信じられている。', back: 'パレスチナで神の愛による救いを説いたのはだれ？',
        difficulty: 'basic',
      },
      {
        id: 'fc4',
        front: 'ムハンマド', explanation: '7世紀にアラビア半島でイスラームを創始。唯一の神アッラーへの信仰を説いた。', back: '7世紀のアラビア半島でイスラームを開いたのはだれ？',
        difficulty: 'basic',
      },
      {
        id: 'fc5',
        front: 'クルアーン(コーラン)', explanation: 'ムハンマドへの神の啓示をまとめた聖典。イスラームの信仰と生活の規範。', back: 'イスラームの聖典を何という？',
        difficulty: 'basic',
      },
      {
        id: 'fc6',
        front: 'エルサレム', explanation: 'ユダヤ教・キリスト教・イスラームの三宗教にとって重要な聖地。', back: 'ユダヤ教・キリスト教・イスラーム共通の聖地はどこ？',
        difficulty: 'basic',
      },
      {
        id: 'fc7',
      ...
      {
        id: 'fc13',
        front: 'アッラー', explanation: 'イスラームで信仰する唯一の神の名。アラビア語で「神」を意味する。', back: 'イスラームで信仰する唯一の神を何と呼ぶ？',
        difficulty: 'standard',
      },
      {
        id: 'fc14',
        front: 'ムスリム', explanation: 'イスラームの信者の呼び名。「神に帰依する者」という意味。', back: 'イスラームの信者を何と呼ぶ？',
        difficulty: 'standard',
      },
      {
        id: 'fc15',
      ...
      {
        id: 'fc18',
        front: 'メッカ', explanation: 'カーバ神殿がある都市。イスラーム最大の聖地で巡礼の目的地。', back: 'イスラーム最大の聖地はどこ？',
        difficulty: 'standard',
      },
      {
        id: 'fc19',
      ...
      {
        id: 'fc21',
        front: 'キリスト', explanation: '「救世主（メシア）」を意味する称号。イエスが神から遣わされた救い主であることを示す。', back: '「救世主（メシア）」という意味のイエスの称号は？',
        difficulty: 'standard',
      },
      {
        id: 'fc24',
        front: '1日5回', explanation: 'メッカの方角に向かって行う礼拝の回数。イスラームの五行の一つ。', back: 'イスラームの信者がメッカの方角に向かって行う礼拝の回数は？',
        difficulty: 'advanced',
      },
      {
        id: 'fc26',
