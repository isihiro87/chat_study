    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['座禅で精神を鍛える教えが武士の生き方に合っていたから', '念仏が簡単だったから', '朝廷が禅宗を推奨したから', '貿易で利益が得られたから'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['念仏「南無阿弥陀仏」を唱えて救われる', '座禅で悟りを開く', '法華経の題目を唱える', '厳しい修行で悟る'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['武士の戦い', '庶民の日常生活', '人生のはかなさや世の中の乱れ', '恋愛の歌'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['春はあけぼの', 'ゆく河の流れは絶えずして', 'つれづれなるままに', '祇園精舎の鐘の声、諸行無常の響きあり'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: ['貴族の優美な作品が多いから', '外国の影響が大きいから', '座禅の教えが中心だから', '金剛力士像のような写実的彫刻と平家物語のような軍記物語が生まれたから'],
          correctIndex: 3,
