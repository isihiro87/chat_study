    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['武士中心の文化', '貴族の文化と武士の文化が禅宗の影響で融合した', '外国の文化をそのまま取り入れた', '仏教を否定した文化'],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ['能が衰退した', '能が武士の間で広まった', '能が洗練された芸術として大成するきっかけとなった', '能が禁止された'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['日明貿易（勘合貿易）で得た莫大な富', '荘園からの年貢', '金山の開発', '朝廷からの支援'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['公家・武家・禅宗の文化の融合を象徴している', '建築技術が未熟だった', '費用を節約した', '異なる時代に建てられた'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['自ら能の演者だった', '能を禁止しようとした', '観阿弥・世阿弥を保護し能の発展を支えた', '狂言を好んで広めた'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['外国の文化を取り入れた', '農民の文化だった', '仏教中心の文化だった', '貴族・武士・禅宗の文化が混じり合った'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: ['雪舟と世阿弥', '法然と親鸞', '足利尊氏と足利義政', '観阿弥・世阿弥と足利義満'],
          correctIndex: 3,
