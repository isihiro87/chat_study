  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        {
          id: 'q4',
          question: '京都で自治を担い、応仁の乱で荒れた京都を復興させた裕福な商工業者を何という？',
          options: ['馬借', '地頭', '町衆', '御家人'],
          correctIndex: 2,
          explanation: '町衆は京都の裕福な商工業者で、町の自治を行い、祇園祭を復活させるなど京都の復興に大きな力を発揮しました。',
        },
        {
          id: 'q5',
          question: '室町時代に馬を利用して物資の運送を担った業者を何という？',
          options: ['座', '問屋', '馬借', '飛脚'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['三斎市', '六斎市', '朝市', '楽市'],
          correctIndex: 1,
          explanation: '六斎市は月に6回開かれる定期市で、鎌倉時代の月3回の三斎市からさらに増え、商業の発展を示しています。',
        },
      ],
    },
