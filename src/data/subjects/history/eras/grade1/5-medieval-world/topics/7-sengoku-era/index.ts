    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['領国の経済力を高め軍事力の基盤となる物資を確保するため', '文化を発展させるため', '朝廷に寄付するため', '僧侶を養うため'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['どちらも守護大名の支配に対抗し民衆が自治を行おうとした', '同じ宗教の運動', '同じ年に起きた', '同じ地域で起きた'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['内容が全く同じ', '分国法は朝廷が作った', '御成敗式目は全国向け、分国法は各大名の領国内だけに適用', '御成敗式目の方が新しい'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['鉱山は美しい景観だから', '仏教の聖地だったから', '朝廷が命じたから', '銀や金の産出が軍資金となり領国経営の財源だったから'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: ['さらに繁栄した', '遷都が行われた', '外国に占領された', '多くの寺社が焼失し焼け野原になった'],
          correctIndex: 3,
