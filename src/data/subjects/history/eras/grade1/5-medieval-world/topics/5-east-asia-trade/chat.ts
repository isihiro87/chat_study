  ...
  content: [
    ...
    },
    {
      ...
      points: [
        ...
        '<strong><ruby>朝鮮国<rp>(</rp><rt>ちょうせんこく</rt><rp>)</rp></ruby></strong>：<ruby>李成桂<rp>(</rp><rt>りせいけい</rt><rp>)</rp></ruby>が1392年に建国。<strong>ハングル</strong>（<ruby>訓民正音<rp>(</rp><rt>くんみんせいおん</rt><rp>)</rp></ruby>）を<ruby>制定<rp>(</rp><rt>せいてい</rt><rp>)</rp></ruby>し<ruby>民衆<rp>(</rp><rt>みんしゅう</rt><rp>)</rp></ruby>の<ruby>教育<rp>(</rp><rt>きょういく</rt><rp>)</rp></ruby>に利用',
