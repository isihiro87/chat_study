    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['防衛戦のため新領地がなく恩賞を出せなかったから', '領土が減ったから', '元に降伏したから', '天皇が力を持ったから'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['暴風雨に襲われた', '日本の騎兵に負けた', '食糧不足', '内部分裂'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['北条氏への権力集中に不満を持つ有力御家人が反旗を翻した', '外国の援助', '天皇自身の軍事力', '農民の蜂起'],
          correctIndex: 0,
        ...
        },
        {
          id: 'q24',
          question: '分割相続とは何？',
          options: ['長男が一括で相続する', '寺社に寄進する', '幕府に領地を返す', '親の領地を子供たちに分けて相続させる'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: ['すぐに室町幕府が開かれた', '朝廷が直接統治した', '50年間幕府がなかった', 'まず建武の新政が行われ崩壊後に室町幕府が開かれた'],
          correctIndex: 3,
