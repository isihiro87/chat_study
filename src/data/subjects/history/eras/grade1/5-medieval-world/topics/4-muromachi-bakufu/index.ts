    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['違いはない', '守護大名は幕府が任命しなかった', '守護大名は軍事・警察権に加え土地支配や年貢徴収も行った', '守護大名は朝廷に仕えた'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['足利尊氏が京都に別の天皇を立てたため', '吉野が経済の中心だったから', '仏教の聖地だったから', '朝廷の伝統だったから'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['金貸しの利益に幕府が税を課した', '幕府に軍事力を提供した', '幕府の土地を管理した', '朝廷との仲介をした'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['朝廷が任命した', '仏教の力で支持を集めた', '外国との貿易で富を得た', '南北朝の動乱で領地を拡大し武士を家来化した'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: ['武家の棟梁として当然のこと', '鎌倉に移った', '朝廷を廃止した', '武家と公家の両方の権威を手にした'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: ['戦がなくなったから', '土地を没収されたから', '税が増えたから', '武士が大きな功績を果たしたのに公家ばかりが優遇されたから'],
          correctIndex: 3,
