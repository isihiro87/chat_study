    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['分かりやすい文章と挿絵がついていたため', '高価だったから', '武士向けの軍記物だったから', '外国の物語だったから'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['外国から伝わった', '水がなかったから', '禅宗の影響で限られた空間で精神世界を表現しようとした', '経費を節約するため'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['全く無関係', '書院造は西洋建築の影響', '和室は中国から来た', '書院造は和室の原型で畳・障子・ふすまなどの基本要素は書院造に由来する'],
          correctIndex: 3,
