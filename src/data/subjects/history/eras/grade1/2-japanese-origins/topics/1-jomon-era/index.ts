...
export const jomonEra: Topic = {
  ...
  content: {
    ...
    flashcards: [
      {
        id: 'fc1',
        front: '{旧|きゅう}{石器|せっき}時代', explanation: '打製石器を使い移動生活をした最も古い時代。まだ土器は作られていなかった。', back: '打製石器を使い移動しながら生活した最も古い時代は？',
        difficulty: 'basic',
      },
      {
        id: 'fc2',
        front: '{氷期|ひょうき}（{氷河|ひょうが}時代）', explanation: '海面が低下して大陸と日本が陸続きになった寒冷な時期。大型動物が渡ってきた。', back: '日本が大陸と陸続きだった寒い時期を何という？',
        difficulty: 'basic',
      },
      {
        id: 'fc3',
      ...
      {
        id: 'fc5',
        front: '{打製|だせい}{石器|せっき}', explanation: '石を打ち欠いて作った最も原始的な石器。旧石器時代の代表的な道具。', back: '石を打ち欠いて作った旧石器時代の石器は？',
        difficulty: 'basic',
      },
      {
        id: 'fc6',
        front: '{岩宿|いわじゅく}{遺跡|いせき}', explanation: '相沢忠洋が打製石器を発見し、日本にも旧石器時代があったことを証明した重要な遺跡。', back: '群馬県で打製石器が発見され、日本の旧石器時代を証明した遺跡は？',
        difficulty: 'basic',
      },
      {
        id: 'fc7',
        front: '{相沢忠洋|あいざわただひろ}', explanation: '行商をしながら独学で考古学を学び、岩宿遺跡で打製石器を発見した人物。', back: '岩宿遺跡で打製石器を発見した人物は？',
        difficulty: 'basic',
      },
      {
        id: 'fc8',
        front: '{黒曜石|こくようせき}', explanation: '黒いガラス質の石で鋭い刃を作れた。遠方でも出土し、広域交易の証拠となる。', back: '石器の材料として重宝された黒いガラス質の石は？',
        difficulty: 'basic',
      },
      {
        id: 'fc9',
      ...
      {
        id: 'fc10',
        front: '{縄文|じょうもん}時代', explanation: '約1万数千年前に始まった時代。土器の使用や定住生活が特徴。', back: '約1万数千年前から日本で土器を使い始めた時代は？',
        difficulty: 'basic',
      },
      {
        id: 'fc11',
        front: '{縄文|じょうもん}{土器|どき}', explanation: '縄を転がしてつけた文様が特徴。厚手で装飾が豊かな土器。', back: '表面に縄目のような文様がある土器は？',
        difficulty: 'basic',
      },
      {
        id: 'fc12',
        front: 'たて{穴|あな}{住居|じゅうきょ}', explanation: '地面を掘り下げて柱を立て屋根をかけた住居。縄文時代の定住生活を象徴する。', back: '縄文人が地面を掘り柱を立てて造った家は？',
        difficulty: 'basic',
      },
      {
        id: 'fc13',
        front: '{貝塚|かいづか}', explanation: '食べた貝殻や骨を捨てた場所。当時の食生活を知る貴重な手がかり。', back: '食べ終わった貝殻や魚の骨を捨てた場所は？',
        difficulty: 'standard',
      },
      {
        id: 'fc14',
        front: '{土偶|どぐう}', explanation: '祈りや魔よけのために作られた土製の人形。縄文人の精神世界を示す。', back: '祈りや魔よけのために作られた土の人形は？',
        difficulty: 'standard',
      },
      {
        id: 'fc15',
        front: '{三内丸山|さんないまるやま}{遺跡|いせき}', explanation: '青森県にある縄文時代の大規模集落。大型建物やクリの栽培跡が発見された。', back: '青森県にある縄文時代の大規模な集落遺跡は？',
        difficulty: 'standard',
      },
      {
        id: 'fc16',
        front: '{屈葬|くっそう}', explanation: '死者の手足を折り曲げて埋葬する方法。霊が再び戻ってこないようにとの意味があったとされる。', back: '死者の手足を折り曲げて埋葬する方法は？',
        difficulty: 'standard',
      },
      {
        id: 'fc17',
        front: '{磨製|ません}{石器|せっき}', explanation: '表面を磨いて仕上げた石器。打製石器より精巧で、縄文時代に登場した。', back: '縄文時代に磨いて作られた石器は？',
        difficulty: 'standard',
      },
      {
        id: 'fc18',
        front: '{野尻湖|のじりこ}', explanation: '長野県にある湖。ナウマンゾウの化石が発見された旧石器時代の重要な遺跡。', back: 'ナウマンゾウの化石が発見された長野県の湖は？',
        difficulty: 'standard',
      },
      {
        id: 'fc19',
      ...
      {
        id: 'fc21',
        front: '{群馬県|ぐんまけん}', explanation: '岩宿遺跡がある県。日本の旧石器時代の存在を証明した重要な場所。', back: '岩宿遺跡がある県は？',
        difficulty: 'standard',
      },
      {
        id: 'fc22',
        front: '{青森県|あおもりけん}', explanation: '三内丸山遺跡がある県。縄文時代の大規模集落が発見された。', back: '三内丸山遺跡がある県は？',
        difficulty: 'standard',
      },
      {
        id: 'fc24',
