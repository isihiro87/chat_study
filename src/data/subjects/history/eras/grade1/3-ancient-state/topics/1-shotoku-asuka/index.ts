...
export const shotokuAsuka: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'fc10', front: '三宝（仏・法・僧）', back: '十七条の憲法の第2条「篤く〇〇を敬え」の〇〇に入る言葉は？', difficulty: 'basic' },
      ...
      { id: 'fc16', front: '摂政', back: '天皇が幼いときなどに代わって政治を行う役職は？', difficulty: 'standard' },
      { id: 'fc17', front: '和', back: '十七条の憲法の第一条「〇〇を以て貴しとなす」の〇〇に入る言葉は？', difficulty: 'standard' },
      ...
      { id: 'fc22', front: '607年', back: '小野妹子が遣隋使として派遣された年は？', difficulty: 'standard' },
      { id: 'fc23', front: '斑鳩（いかるが）', back: '法隆寺がある場所（奈良県）はどこ？', difficulty: 'advanced' },
      ...
      { id: 'fc27', front: '詔', back: '十七条の憲法の第三条「〇〇を承りては必ず謹め」の〇〇に入る言葉は？', difficulty: 'advanced' },
