    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['大化の改新', '遣唐使の中止', '壬申の乱', '大宝律令の制定'],
          correctIndex: 1,
