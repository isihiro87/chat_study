  ...
  content: [
    ...
    },
    {
      ...
      options: [
        ...
        { letter: 'B', text: '松尾芭蕉', correct: true },
        { letter: 'C', text: '近松門左衛門', correct: false },
        { letter: 'D', text: '菱川師宣', correct: false },
      ],
      explanation:
        '<strong>正解はB「松尾芭蕉」</strong>です。芭蕉は東北・北陸を旅し、その紀行文「奥の細道」は俳諧文学の傑作です。',
    },
    {
      type: 'message',
      side: 'right',
    ...
    },
    {
      ...
      options: [
        { letter: 'A', text: '松尾芭蕉', correct: false },
        { letter: 'B', text: '井原西鶴', correct: false },
        { letter: 'C', text: '近松門左衛門', correct: true },
        { letter: 'D', text: '菱川師宣', correct: false },
      ],
      explanation:
        '<strong>正解はC「近松門左衛門」</strong>です。「日本のシェイクスピア」とも呼ばれ、義理と人情の葛藤を描きました。',
    },
    {
      type: 'end',
      points: [
