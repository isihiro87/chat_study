    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: [],
          correctIndex: -1,
          explanation: '「I was happy when I heard the news.」が正解。when（〜のとき）+ I（私が）+ heard（聞いた）の順番だよ。',
        },
        {
          id: 'eng-cj-q7',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「I think that he is kind.」が正解。that（〜ということ）+ he（彼が）+ is（〜です）+ kind（やさしい）の順番だよ。',
        },
        {
          id: 'eng-cj-q8',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「I know that she is busy.」が正解。that（〜ということ）+ she（彼女が）+ is（〜です）+ busy（いそがしい）の順番だよ。',
        },
      ],
    },
    examples: {
