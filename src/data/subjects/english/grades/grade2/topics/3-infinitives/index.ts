    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['〜すること', '〜するための', '〜するために', 'どれでもない'],
          correctIndex: 2,
        ...
        },
        {
          ...
          options: ['〜すること', '〜するために', 'どれでもない', '〜するための'],
          correctIndex: 3,
        ...
        },
        {
          ...
          options: [],
          correctIndex: -1,
          explanation: '「I want to be a teacher.」が正解。I（私は）+ want（〜したい）+ to be（なること）+ a teacher（先生に）の順番だよ。',
        },
        {
          id: 'eng-inf-q7',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「I have something to eat.」が正解。something to eat =「食べるためのもの」で、不定詞が前のことばを説明しているよ。',
        },
        {
          id: 'eng-inf-q8',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「He came here to study.」が正解。to study =「勉強するために」で、不定詞の「〜するために」の使い方だよ。',
        },
      ],
    },
    examples: {
