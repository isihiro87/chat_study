    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: [],
          correctIndex: -1,
          explanation: '「She gave me a present.」が正解。She（彼女は）+ gave（くれた）+ me（私に）+ a present（プレゼントを）の順番で SVOO の形だよ。',
        },
        {
          id: 'eng-ss-q7',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「He looks happy.」が正解。He（彼は）+ looks（〜に見える）+ happy（うれしい）の順番で SVC の形だよ。',
        },
        {
          id: 'eng-ss-q8',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「We call him Ken.」が正解。We（私たちは）+ call（呼ぶ）+ him（彼を）+ Ken（ケンと）の順番で SVOC の形だよ。',
        },
      ],
    },
    examples: {
