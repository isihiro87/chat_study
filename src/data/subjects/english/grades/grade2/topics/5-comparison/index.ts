    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: [],
          correctIndex: -1,
          explanation: '「He is taller than Tom.」が正解。比較級 + than 〜 =「〜より…だ」の形だよ。',
        },
        {
          id: 'eng-comp-q7',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「This book is more interesting.」が正解。interesting は長いことばだから、前に more をつけて比較級にするよ。',
        },
        {
          id: 'eng-comp-q8',
          type: 'reorder',
          ...
          options: [],
          correctIndex: -1,
          explanation: '「He runs as fast as Tom.」が正解。as〜as =「同じくらい〜だ」の形で、あいだに形容詞や副詞を入れるよ。',
        },
      ],
    },
    examples: {
