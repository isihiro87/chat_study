...
export const disasters: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo2-ds-fc1', front: '海底で大きな地震が起こり、海底の地盤が急激に動いて海水が持ち上げられる', back: '津波はどのようにして発生するか？', difficulty: 'basic', explanation: '津波は台風の高潮とは原因が異なります。海底地震が原因で、沿岸部に甚大な被害をもたらします。' },
      { id: 'geo2-ds-fc2', front: '大量の土砂が水と混ざって山の斜面を一気に流れ下る災害。集中豪雨や長雨が原因', back: '土石流とはどんな災害か？何が原因で起こるか？', difficulty: 'basic', explanation: '山間部で特に危険です。集中豪雨で地盤がゆるむと発生しやすくなります。' },
      { id: 'geo2-ds-fc3', front: '地域ごとの災害リスクや避難場所を示した地図。自治体が作成', back: 'ハザードマップとは何か？', difficulty: 'basic', explanation: '自分の住む地域のハザードマップを確認し、避難場所や危険箇所を事前に把握しておくことが大切です。' },
      { id: 'geo2-ds-fc4', front: '公助は国・自治体の支援、自助は自分で守ること、共助は地域住民の助け合い', back: '防災における公助・自助・共助とは？', difficulty: 'basic', explanation: '3つを組み合わせることで防災力が高まります。まず自助で自分を守り、共助で地域を守ります。' },
      { id: 'geo2-ds-fc5', front: '冷害は夏に気温が上がらず農作物に被害。干害は長期間雨が降らず水不足になる', back: '冷害と干害はそれぞれどんな災害か？', difficulty: 'basic', explanation: '冷害は東北地方のやませ、干害は瀬戸内地方の少雨と結びつけて覚えましょう。' },
      { id: 'geo2-ds-fc6', front: '環太平洋造山帯に位置し、複数のプレートが押し合う場所にあるため', back: '日本で地震や火山の噴火が多い理由は何か？', difficulty: 'basic', explanation: '日本は4つのプレートが交わる世界的にも珍しい場所に位置しています。' },
      { id: 'geo2-ds-fc7', front: '太平洋プレート・フィリピン海プレート・ユーラシアプレート・北アメリカプレート', back: '日本付近にある4つのプレートの名前は？', difficulty: 'basic', explanation: '太平洋・フィリピン海の2つの海洋プレートが、ユーラシア・北アメリカの大陸プレートの下に沈み込んでいます。' },
      { id: 'geo2-ds-fc8', front: '地震の揺れによって、水を含んだ砂地盤が液体のようになる現象', back: '液状化現象とは何か？', difficulty: 'basic', explanation: '埋立地や河川沿いの低地で起こりやすく、建物が傾いたり沈んだりする被害が出ます。' },
      { id: 'geo2-ds-fc9', front: '約100以上', back: '日本にある活火山の数はおよそいくつか？', difficulty: 'basic', explanation: '世界の活火山の約7%が日本に集中しています。火山国である日本の特徴を示す数字です。' },
      { id: 'geo2-ds-fc10', front: '高温のガスや岩石の破片が高速で山を流れ下る現象。逃げることが極めて難しい', back: '火砕流とはどんな現象か？なぜ危険か？', difficulty: 'standard', explanation: '時速100km以上、温度数百度で流れ下るため、発生したら逃げることはほぼ不可能です。' },
      { id: 'geo2-ds-fc11', front: '台風が接近して海面が異常に上昇する現象', back: '高潮とは何か？', difficulty: 'standard', explanation: '台風の強風と低気圧による海面上昇が原因です。津波（海底地震が原因）とは発生メカニズムが異なります。' },
      { id: 'geo2-ds-fc12', front: '夏から秋にかけて', back: '台風が日本に接近・上陸しやすい季節はいつか？', difficulty: 'standard', explanation: '7月～10月ごろが台風シーズンです。暴風・大雨・高潮による被害に備えることが重要です。' },
      { id: 'geo2-ds-fc13', front: '温泉や肥沃な土地、地熱発電の利用、美しい景観', back: '火山がもたらす恩恵にはどんなものがあるか？', difficulty: 'standard', explanation: '火山は災害リスクだけでなく、温泉・観光・地熱発電など多くの恩恵ももたらしています。' },
      { id: 'geo2-ds-fc14', front: '防災は災害そのものを防ぐこと、減災は災害の被害を最小限に抑えること', back: '防災と減災の違いは何か？', difficulty: 'standard', explanation: '自然災害を完全に防ぐことは難しいため、被害を最小限にする「減災」の考え方が重要視されています。' },
      { id: 'geo2-ds-fc15', front: '非常持ち出し品の準備、避難経路の確認、家具の転倒防止', back: '自助の具体例を挙げよ', difficulty: 'standard', explanation: '自助は防災の基本です。日頃からの備えが、いざというときに自分と家族を守ります。' },
      { id: 'geo2-ds-fc16', front: '地域の避難訓練への参加、災害時に近所の高齢者を避難所まで誘導すること', back: '共助の具体例を挙げよ', difficulty: 'standard', explanation: '地域のつながりが災害時に大きな力を発揮します。日頃からの顔の見える関係づくりが大切です。' },
      { id: 'geo2-ds-fc17', front: '避難所の開設、救助活動、食料の配布', back: '公助の具体例を挙げよ', difficulty: 'standard', explanation: '公助は国や自治体による支援ですが、大規模災害時には公助だけでは対応しきれないこともあります。' },
      { id: 'geo2-ds-fc18', front: '強い揺れが届く前に住民に知らせ、身の安全を確保する時間を与えるため', back: '緊急地震速報が発表される目的は何か？', difficulty: 'standard', explanation: 'P波（初期微動）を検知してS波（主要動）が届く前に警報を出すシステムです。' },
      { id: 'geo2-ds-fc19', front: 'やませ（冷たく湿った北東の風）が吹くことで気温が上がらないため', back: '東北地方で冷害が起こりやすい原因は何か？', difficulty: 'advanced', explanation: 'やませは親潮（寒流）の上を通る冷たい風で、太平洋側の夏の気温を下げ、稲の生育に悪影響を与えます。' },
      { id: 'geo2-ds-fc20', front: '2011年3月11日、マグニチュード9.0。巨大な津波が東北地方太平洋沿岸を襲った', back: '東日本大震災の発生日・規模・最大の被害要因は？', difficulty: 'advanced', explanation: '日本の観測史上最大の地震であり、津波と原発事故による複合災害となりました。' },
      { id: 'geo2-ds-fc21', front: '災害時にパニックにならず、迅速かつ安全に避難できるよう行動を体で覚えておくため', back: '避難訓練を日頃から行うことの意義は何か？', difficulty: 'advanced', explanation: '実際の災害時は冷静な判断が難しくなるため、訓練で体に覚えさせておくことが命を守ります。' },
      { id: 'geo2-ds-fc22', front: '洪水・浸水・土砂崩れ（土石流・がけ崩れ）', back: '集中豪雨が原因で起こる災害を3つ挙げよ', difficulty: 'advanced', explanation: '近年、地球温暖化の影響で集中豪雨の頻度が増加しており、これらの災害リスクも高まっています。' },
    ],
    quiz: {
      questions: [
        {
