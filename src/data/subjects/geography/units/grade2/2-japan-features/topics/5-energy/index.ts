      ...
      questions: [
        {
          ...
          options: ['人口が多いから', '鉱産資源に乏しいから', '技術力が低いから', '面積が小さいから'],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ['阪神淡路大震災', '東日本大震災', '新潟県中越地震', '熊本地震'],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ['ゼロエミッション', 'カーボンニュートラル', 'エネルギーミックス', 'クリーンエネルギー'],
          correctIndex: 1,
