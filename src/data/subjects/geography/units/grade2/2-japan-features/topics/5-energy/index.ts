...
export const energy: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo2-en-fc1', front: '鉱産資源に乏しく、石油・石炭・天然ガスなどの多くを海外から輸入しているため', back: '日本のエネルギー自給率が低い理由は？', difficulty: 'basic' },
      { id: 'geo2-en-fc2', front: '太陽光発電・風力発電・水力発電・地熱発電・バイオマス発電', back: '再生可能エネルギーにはどんな種類があるか？', difficulty: 'basic' },
      { id: 'geo2-en-fc3', front: '石油・石炭・天然ガスを燃やして発電する方法', back: '火力発電とは何か？', difficulty: 'basic' },
      { id: 'geo2-en-fc4', front: 'ダムに貯めた水の力で発電する方法。1950年ごろまで日本の主力だった', back: '水力発電とは何か？', difficulty: 'basic' },
      { id: 'geo2-en-fc5', front: 'ウランを燃料として発電。温室効果ガスは少ないが安全性に課題', back: '原子力発電の特徴は？', difficulty: 'basic' },
      { id: 'geo2-en-fc6', front: '原料を輸入し、工業製品に加工して輸出する貿易の形態', back: '加工貿易とは何か？', difficulty: 'basic' },
      { id: 'geo2-en-fc7', front: '石油・石炭・天然ガスなど、大昔の生物が変化してできた燃料', back: '化石燃料とは何か？', difficulty: 'basic' },
      { id: 'geo2-en-fc8', front: 'リデュース（減らす）・リユース（再使用）・リサイクル（再資源化）', back: '3Rとは何か？それぞれの意味を答えよ', difficulty: 'standard' },
      { id: 'geo2-en-fc9', front: '使用済みの電子機器から金・銀・レアメタルを回収して再利用する考え方', back: '都市鉱山とは何か？', difficulty: 'standard' },
      { id: 'geo2-en-fc10', front: '中東地域（サウジアラビア、アラブ首長国連邦など）', back: '日本の石油の主な輸入先はどこか？', difficulty: 'standard' },
      { id: 'geo2-en-fc11', front: 'オーストラリア', back: '日本の石炭の最大の輸入相手国はどこか？', difficulty: 'standard' },
      { id: 'geo2-en-fc12', front: 'オーストラリアとブラジル', back: '日本の鉄鉱石の主な輸入相手国を2つ答えよ', difficulty: 'standard' },
      { id: 'geo2-en-fc13', front: '温室効果ガス（二酸化炭素）を大量に排出し、地球温暖化の原因となる', back: '火力発電の最大の問題点は何か？', difficulty: 'standard' },
      { id: 'geo2-en-fc14', front: '2011年の東日本大震災で福島第一原子力発電所の事故が起きたこと', back: '原子力発電の安全性が問題になった出来事は？', difficulty: 'standard' },
      { id: 'geo2-en-fc15', front: '天然ガスを冷却して液体にしたもの', back: 'LNG（液化天然ガス）とは何か？', difficulty: 'standard' },
      { id: 'geo2-en-fc16', front: '1960年代にエネルギーの中心が石炭から石油に変わったこと', back: 'エネルギー革命とは何か？', difficulty: 'standard' },
      { id: 'geo2-en-fc17', front: '温室効果ガスの排出量を実質ゼロにすること', back: 'カーボンニュートラルとは何か？', difficulty: 'standard' },
      { id: 'geo2-en-fc18', front: '地熱発電。日本は100以上の活火山がある火山国で地熱資源が豊富なため', back: '日本が火山国であることから有望な発電方法は？', difficulty: 'advanced' },
      { id: 'geo2-en-fc19', front: 'さまざまな発電方法を組み合わせて電力を供給する考え方', back: 'エネルギーミックスとは何か？', difficulty: 'advanced' },
      { id: 'geo2-en-fc20', front: '天候に左右されやすく発電量が不安定。蓄電設備や送電網の整備が必要', back: '再生可能エネルギーの課題は何か？', difficulty: 'advanced' },
      { id: 'geo2-en-fc21', front: '中東で紛争や政治不安が起きると石油の供給途絶や価格急騰のリスクがある', back: '石油の輸入が中東に集中していることのリスクは？', difficulty: 'advanced' },
      { id: 'geo2-en-fc22', front: '再生可能エネルギー', back: '自然の力を利用し、繰り返し使えるエネルギーを何というか？', difficulty: 'basic' },
      { id: 'geo2-en-fc23', front: '太陽光発電', back: '太陽の光エネルギーを電気に変える発電方法を何というか？', difficulty: 'basic' },
      { id: 'geo2-en-fc24', front: '風力発電', back: '風の力でタービンを回して発電する方法を何というか？', difficulty: 'basic' },
      { id: 'geo2-en-fc25', front: '地熱発電', back: '火山の地下の熱を利用して発電する方法を何というか？', difficulty: 'basic' },
      { id: 'geo2-en-fc26', front: 'バイオマス発電', back: '生物由来の資源（木材・家畜のふんなど）を利用した発電を何というか？', difficulty: 'standard' },
      { id: 'geo2-en-fc27', front: '輸入先の多様化', back: '輸入先をひとつの地域に頼りすぎないようにすることを何というか？', difficulty: 'standard' },
      { id: 'geo2-en-fc28', front: '火力発電', back: '現在の日本で最も発電量の割合が大きい発電方法は何か？', difficulty: 'basic' },
      { id: 'geo2-en-fc29', front: '持続可能な社会', back: '限りある資源を大切にし、将来の世代も利用できる社会を何というか？', difficulty: 'basic' },
      { id: 'geo2-en-fc30', front: '二酸化炭素（CO2）', back: '化石燃料を燃やすと排出される、地球温暖化の主な原因となる気体は何か？', difficulty: 'basic' },
      { id: 'geo2-en-fc31', front: '地球温暖化', back: '二酸化炭素の排出増加による地球規模の環境問題を何というか？', difficulty: 'basic' },
      { id: 'geo2-en-fc32', front: '太陽光パネル（ソーラーパネル）', back: '日本で家庭の屋根などに設置が進んでいる発電装置は何か？', difficulty: 'standard' },
      { id: 'geo2-en-fc33', front: '燃料電池', back: '水素を燃料として電気を作る装置を何というか？', difficulty: 'advanced' },
      { id: 'geo2-en-fc34', front: '先進国の中でも特に低い水準', back: '日本のエネルギー自給率はどのような水準か？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
