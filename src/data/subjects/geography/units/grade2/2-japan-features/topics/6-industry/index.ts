...
export const industry: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo2-in-fc1', front: 'カロリーベースで約40%前後（先進国の中でも低い水準）', back: '日本の食料自給率はカロリーベースでおよそ何%か？', difficulty: 'basic', explanation: '食料の約6割を海外に頼っている計算です。安い外国産農産物の輸入増加が主な原因です。' },
      { id: 'geo2-in-fc2', front: '関東地方から九州北部にかけての太平洋沿いの工業集中地域', back: '太平洋ベルトとはどこか？', difficulty: 'basic', explanation: '港に近く原料の輸入・製品の輸出に便利で、大消費地にも近いため工業が発達しました。' },
      { id: 'geo2-in-fc3', front: '京浜工業地帯・中京工業地帯・阪神工業地帯・北九州工業地帯', back: '日本の四大工業地帯をすべて答えよ。', difficulty: 'basic', explanation: '「京・中・阪・北」の4つです。現在は中京工業地帯が出荷額トップで、自動車工業が中心です。' },
      { id: 'geo2-in-fc4', front: 'サービス業・商業・運輸業・情報通信業など。日本では全就業者の約7割', back: '第三次産業とは何か？日本では就業者の何割を占めるか？', difficulty: 'standard', explanation: '経済が発展するほど第三次産業の割合が高くなる傾向があり、産業構造の変化を示しています。' },
      { id: 'geo2-in-fc5', front: '品質の高さを武器に付加価値をつけて販売する取り組み（コシヒカリ・夕張メロン・松阪牛など）', back: '農産物のブランド化とは何か？具体例を挙げよ。', difficulty: 'standard', explanation: '安い外国産に価格で対抗するのではなく、品質やブランド力で差別化する戦略です。' },
      { id: 'geo2-in-fc6', front: '東京から名古屋を経由して大阪（新大阪）を結ぶ、三大都市圏をつなぐ大動脈', back: '東海道新幹線はどの都市を結んでいるか？', difficulty: 'standard', explanation: '1964年に開業した日本初の新幹線で、日本の経済を支える重要な交通インフラです。' },
      { id: 'geo2-in-fc7', front: '農業・林業・水産業など、自然から直接資源を得る産業', back: '第一次産業とはどのような産業か？', difficulty: 'basic', explanation: '日本では第一次産業の就業者割合は約3%と低く、高齢化や後継者不足が課題です。' },
      { id: 'geo2-in-fc8', front: '製造業・建設業・鉱業など、原料を加工して製品をつくる産業', back: '第二次産業とはどのような産業か？', difficulty: 'basic', explanation: '自動車・電子機器・鉄鋼など、日本の工業力を支える産業です。太平洋ベルトに集中しています。' },
      { id: 'geo2-in-fc9', front: '海外から安い農産物が大量に輸入されるようになったため', back: '日本の食料自給率が低下した理由は何か？', difficulty: 'basic', explanation: '貿易自由化の進展で外国産の安い農産物が入るようになり、国内農業が価格競争で苦しくなりました。' },
      { id: 'geo2-in-fc10', front: '温暖な地域でビニールハウスなどを利用し、出荷時期を早める栽培方法', back: '促成栽培とはどのような栽培方法か？', difficulty: 'basic', explanation: '高知県のナスやピーマン、宮崎県のきゅうりなどが代表例です。端境期に高値で販売できます。' },
      { id: 'geo2-in-fc11', front: '涼しい高原などの気候を利用して、出荷時期を遅らせる栽培方法', back: '抑制栽培とはどのような栽培方法か？', difficulty: 'basic', explanation: '長野県のレタスが代表例です。夏でも涼しい高原の気候を活かして、他の産地と時期をずらして出荷します。' },
      { id: 'geo2-in-fc12', front: '地元で生産されたものを地元で消費すること', back: '地産地消とは何か？', difficulty: 'basic', explanation: '輸送コストの削減や新鮮な食材の提供、地域経済の活性化につながる取り組みです。' },
      { id: 'geo2-in-fc13', front: '原料を輸入し、加工して高品質な工業製品を輸出する貿易形態', back: '加工貿易とはどのような貿易か？', difficulty: 'standard', explanation: '資源の乏しい日本が技術力を活かして経済成長を遂げた基盤となる貿易形態です。' },
      { id: 'geo2-in-fc14', front: '工場が海外に移転し、国内の製造業が衰退して雇用が減少する現象', back: '産業の空洞化とは何か？', difficulty: 'standard', explanation: '人件費の安い海外に工場を移す企業が増え、国内の雇用や技術力の低下が懸念されています。' },
      { id: 'geo2-in-fc15', front: '中京工業地帯。自動車を中心とした機械工業がさかん', back: '現在、出荷額が最も大きい工業地帯はどこか？何がさかんか？', difficulty: 'standard', explanation: 'トヨタ自動車の本社がある愛知県を中心に、自動車関連工業が集積しています。' },
      { id: 'geo2-in-fc16', front: 'IC（集積回路）の製造など、最先端の科学技術を活用した産業', back: '先端技術産業とは何か？代表例を挙げよ。', difficulty: 'standard', explanation: 'ICやロボット、バイオテクノロジーなど高度な技術を基盤とした産業です。' },
      { id: 'geo2-in-fc17', front: 'ICは軽くて高価なため輸送コストが低く、広い土地ときれいな空気・水が必要なため', back: 'IC工場が内陸部の高速道路沿いに多い理由は？', difficulty: 'standard', explanation: '港に近い必要がなく、クリーンな環境が求められるため、内陸の高速道路インターチェンジ付近に立地します。' },
      { id: 'geo2-in-fc18', front: '千葉県の東京湾沿岸に広がる工業地域。石油化学工業がさかん', back: '京葉工業地域はどこにあり、何がさかんか？', difficulty: 'standard', explanation: '「京葉」は東京と千葉を合わせた名前です。埋立地に石油化学コンビナートが並んでいます。' },
      { id: 'geo2-in-fc19', front: '瀬戸内海沿岸に広がり、化学工業や鉄鋼業がさかんな工業地域', back: '瀬戸内工業地域の特徴を答えよ。', difficulty: 'standard', explanation: '瀬戸内海の穏やかな海を利用した海上輸送に便利な立地です。倉敷の水島コンビナートが有名です。' },
      { id: 'geo2-in-fc20', front: '情報通信技術（Information and Communication Technology）の略', back: 'ICTとは何の略か？', difficulty: 'basic', explanation: 'インターネットやスマートフォンなど、情報を伝達する技術全般を指します。' },
      { id: 'geo2-in-fc21', front: '東京・大阪・名古屋の3つの大都市', back: '日本の三大都市はどこか？', difficulty: 'basic', explanation: 'この3都市を中心とした三大都市圏に日本の人口の半数以上が集中しています。' },
      { id: 'geo2-in-fc22', front: '化学肥料や農薬をできるだけ使わず、自然の力を活かして行う農業', back: '有機農業とは何か？', difficulty: 'standard', explanation: '環境への負荷を減らし安全な食料を生産する農業で、消費者の健康志向の高まりから注目されています。' },
      { id: 'geo2-in-fc23', front: '港に近く原料の輸入・製品の輸出に便利で、大消費地にも近いため', back: '太平洋ベルトに工業地帯が集中した理由は？', difficulty: 'advanced', explanation: '臨海部に立地することで、重い原料の輸送コストを抑え、製品の輸出にも便利です。' },
      { id: 'geo2-in-fc24', front: '第一次産業の生産者が加工（第二次）や販売（第三次）まで手がけること。1×2×3＝6が名前の由来', back: '六次産業化とは何か？', difficulty: 'advanced', explanation: '農家が自ら加工品をつくり販売することで、付加価値を高めて収入を増やす取り組みです。' },
      { id: 'geo2-in-fc25', front: 'ロボット技術やICTを活用して省力化・高品質生産を実現する新しい農業', back: 'スマート農業とは何か？', difficulty: 'advanced', explanation: 'ドローンやGPS、センサーなどを活用し、少ない人手でも効率的に農業を行う仕組みです。' },
      { id: 'geo2-in-fc26', front: '食料の輸送量に輸送距離をかけた指標。日本は自給率が低く遠くから輸入するため値が大きい', back: 'フードマイレージとは何か？日本の特徴は？', difficulty: 'advanced', explanation: '遠くから大量に食料を運ぶほどCO2排出量が増えるため、環境負荷の指標として使われます。' },
      { id: 'geo2-in-fc27', front: '群馬県・栃木県・茨城県などに広がり、高速道路沿いに工場が進出した工業地域', back: '北関東工業地域の特徴を答えよ。', difficulty: 'advanced', explanation: '関越自動車道や東北自動車道の整備により、内陸部に工場が進出した比較的新しい工業地域です。' },
      { id: 'geo2-in-fc28', front: '静岡県を中心とした地域。製紙・パルプ工業やオートバイ製造がさかん', back: '東海工業地域はどこにあり、何がさかんか？', difficulty: 'advanced', explanation: '富士山の豊富な水を活かした製紙業と、浜松市のヤマハ・スズキなどのオートバイ工業が特徴です。' },
    ],
    quiz: {
      questions: [
        {
