...
export const regionalDivision: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo2-rd-fc1', front: 'さまざまな基準で日本をいくつかの地域に分けること。地域の特色や違いを理解するため', back: '地域区分とは何か？何のために行うか？', difficulty: 'basic' },
      { id: 'geo2-rd-fc2', front: '北海道・東北・関東・中部・近畿・中国四国・九州', back: '日本の7つの地方区分をすべて答えよ。', difficulty: 'basic' },
      { id: 'geo2-rd-fc3', front: '標高の違い（山地と平野）や気候の違い（日本海側と太平洋側）による区分', back: '自然的特徴を使った地域区分にはどんなものがあるか？', difficulty: 'standard' },
      { id: 'geo2-rd-fc4', front: '人口密度、産業別就業者数、大都市からの移動時間などによる区分', back: '人文的特徴を使った地域区分にはどんなものがあるか？', difficulty: 'standard' },
      { id: 'geo2-rd-fc5', front: '使う基準によって同じ地域でも異なる区分になるため、目的に応じた適切な視点を選ぶ', back: '地域区分を行うときに注意すべきことは？', difficulty: 'advanced' },
      { id: 'geo2-rd-fc6', front: '近距離は鉄道・バス・自動車、中距離（300〜500km）は新幹線、長距離は航空機', back: '距離に応じた主な交通手段をそれぞれ答えよ。', difficulty: 'basic' },
      { id: 'geo2-rd-fc7', front: '東京から名古屋を経由して新大阪を結ぶ、三大都市圏をつなぐ大動脈', back: '東海道新幹線はどの都市を結んでいるか？', difficulty: 'basic' },
      { id: 'geo2-rd-fc8', front: '2015年3月に金沢まで延伸開業した新幹線路線', back: '北陸新幹線はいつどこまで開業したか？', difficulty: 'basic' },
      { id: 'geo2-rd-fc9', front: '自動車（トラック）。戸口から戸口への個別配送ができる', back: '日本の貨物輸送で最も割合が高い輸送手段は何か？その特徴は？', difficulty: 'basic' },
      { id: 'geo2-rd-fc10', front: '重くてかさばるもの（原材料・石油・工業製品など）の輸送に適する', back: '船舶による輸送に適した貨物はどのようなものか？', difficulty: 'basic' },
      { id: 'geo2-rd-fc11', front: '軽くて高価な精密品（ICチップ・医薬品など）の輸送に適する', back: '航空機による輸送に適した貨物はどのようなものか？', difficulty: 'basic' },
      { id: 'geo2-rd-fc12', front: '千葉県にある日本の国際線の主要拠点空港', back: '成田国際空港はどこにあり、どのような役割を果たしているか？', difficulty: 'basic' },
      { id: 'geo2-rd-fc13', front: '大阪府にある海上空港。騒音回避と24時間運用のため海上に建設', back: '関西国際空港はどこにあり、なぜ海上に建設されたか？', difficulty: 'standard' },
      { id: 'geo2-rd-fc14', front: '大容量のデータを高速で通信できる通信回線', back: '光ファイバーの特徴を答えよ。', difficulty: 'standard' },
      { id: 'geo2-rd-fc15', front: '無線でインターネットに接続できる通信技術', back: 'Wi-Fiとは何か？', difficulty: 'basic' },
      { id: 'geo2-rd-fc16', front: '情報技術を使える人と使えない人の間に生じる格差', back: '情報格差（デジタルデバイド）とは何か？', difficulty: 'standard' },
      { id: 'geo2-rd-fc17', front: '東京都・神奈川県・埼玉県・千葉県・茨城県・栃木県・群馬県', back: '関東地方に含まれる都県をすべて答えよ。', difficulty: 'standard' },
      { id: 'geo2-rd-fc18', front: '青森県・岩手県・宮城県・秋田県・山形県・福島県', back: '東北地方に含まれる県をすべて答えよ。', difficulty: 'standard' },
      { id: 'geo2-rd-fc19', front: '中部地方の日本海側は冬に大雪、太平洋側は冬に晴天が多いように気候が大きく異なる', back: '同じ中部地方でも日本海側と太平洋側で異なる特徴は？', difficulty: 'standard' },
      { id: 'geo2-rd-fc20', front: '農業や漁業がさかんな地域と、都市化が進んだ地域の違いがわかる', back: '第一次産業の割合による地域区分で何がわかるか？', difficulty: 'standard' },
      { id: 'geo2-rd-fc21', front: '交通網の整備により、地方の人や企業が大都市に吸い寄せられる現象', back: 'ストロー効果（ストロー現象）とは何か？', difficulty: 'advanced' },
      { id: 'geo2-rd-fc22', front: '移動時間の短縮、観光客の増加、企業進出による経済活性化', back: '新幹線の開業が沿線地域にもたらすプラスの効果は？', difficulty: 'advanced' },
      { id: 'geo2-rd-fc23', front: 'テレワークが可能になり、地方に住みながら都市部の仕事ができるようになる', back: '情報通信網の整備が地方にもたらす効果は？', difficulty: 'advanced' },
      { id: 'geo2-rd-fc24', front: '東名高速道路・名神高速道路（東京〜名古屋〜大阪を結ぶ）', back: '日本の高速道路網の中心的な路線は何か？', difficulty: 'standard' },
      { id: 'geo2-rd-fc25', front: '大阪府・京都府・兵庫県・奈良県・滋賀県・和歌山県・三重県', back: '近畿地方に含まれる府県をすべて答えよ。', difficulty: 'standard' },
      { id: 'geo2-rd-fc26', front: '鳥取県・島根県・岡山県・広島県・山口県', back: '中国地方に含まれる県をすべて答えよ。', difficulty: 'advanced' },
      { id: 'geo2-rd-fc27', front: '徳島県・香川県・愛媛県・高知県', back: '四国地方に含まれる県をすべて答えよ。', difficulty: 'advanced' },
      { id: 'geo2-rd-fc28', front: 'トラック輸送を鉄道や船舶に切り替えること。環境負荷を軽減する目的がある', back: 'モーダルシフトとは何か？その目的は？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
        ...
        { id: 'geo2-rd-q6', question: '中距離の移動に最も適した交通手段は？', options: ['バス', '自動車', '新幹線', '航空機'], correctIndex: 2, explanation: '新幹線が最も適しています。', difficulty: 'basic' },
        ...
        { id: 'geo2-rd-q9', question: '船舶輸送に適した貨物は？', options: ['精密品', '重い原材料', '書類', '生鮮品'], correctIndex: 1, explanation: '重くてかさばるものです。', difficulty: 'basic' },
        { id: 'geo2-rd-q10', question: '航空機輸送に適した貨物は？', options: ['重い原料', '液体', '軽くて高価な品', '建設資材'], correctIndex: 2, explanation: '軽くて高価な精密品です。', difficulty: 'basic' },
        ...
        { id: 'geo2-rd-q14', question: 'デジタルデバイドとは？', options: ['経済格差', 'IT利用格差', '所得差', '放送差'], correctIndex: 1, explanation: 'IT利用の格差です。', difficulty: 'standard' },
        ...
        { id: 'geo2-rd-q17', question: '第一次産業割合で何がわかる？', options: ['気温差', '交通の便', '農漁業vs都市化', '年齢構成'], correctIndex: 2, explanation: '農漁業と都市化の違いです。', difficulty: 'standard' },
        ...
        { id: 'geo2-rd-q22', question: '新幹線のマイナス効果は？', options: ['観光客増加', '時間短縮', 'ストロー効果', '企業進出'], correctIndex: 2, explanation: '人口流出の可能性です。', difficulty: 'advanced' },
        ...
        { id: 'geo2-rd-q27', question: '自然的特徴の地域区分例は？', options: ['人口密度', '就業者数', '気候差', '移動時間'], correctIndex: 2, explanation: '気候差は自然的特徴です。', difficulty: 'standard' },
      ],
    },
    examples: {
      examples: [
