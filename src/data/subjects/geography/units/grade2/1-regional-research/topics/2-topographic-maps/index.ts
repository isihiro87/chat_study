...
export const topographicMaps: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo2-tm-fc1', front: '250m（1cm × 25,000 = 25,000cm = 250m）', back: '2万5千分の1地形図で、地図上の1cmは実際の何mにあたる？', difficulty: 'basic' },
      { id: 'geo2-tm-fc2', front: '500m（1cm × 50,000 = 50,000cm = 500m）', back: '5万分の1地形図で、地図上の1cmは実際の何mにあたる？', difficulty: 'basic' },
      { id: 'geo2-tm-fc3', front: '同じ高さの地点を結んだ線。間隔がせまいと急傾斜、広いとゆるやか', back: '等高線とは何か？間隔から何がわかる？', difficulty: 'basic' },
      { id: 'geo2-tm-fc4', front: '50mごと（通常の主曲線は10mごと）', back: '2万5千分の1地形図で、計曲線（太い等高線）は何mごとに引かれる？', difficulty: 'standard' },
      { id: 'geo2-tm-fc5', front: '尾根は等高線が低い方に突き出す部分、谷は等高線が高い方に入り込む部分', back: '等高線で尾根と谷をどう見分ける？', difficulty: 'standard' },
      { id: 'geo2-tm-fc6', front: '現在と過去の地形図や空中写真を閲覧でき、土地利用の変化を比較できる', back: '国土地理院の「地理院地図」で何ができる？', difficulty: 'standard' },
      { id: 'geo2-tm-fc7', front: '1,000m（4cm × 25,000 = 100,000cm = 1,000m）', back: '2万5千分の1地形図で地図上の4cmは実際何mか？', difficulty: 'advanced' },
      { id: 'geo2-tm-fc8', front: '国土地理院', back: '地形図を発行している国の機関はどこか？', difficulty: 'basic' },
      { id: 'geo2-tm-fc9', front: '2万5千分の1と5万分の1', back: 'よく使われる地形図の縮尺を2つ答えよ。', difficulty: 'basic' },
      { id: 'geo2-tm-fc10', front: '実際の距離を地図上でどれだけ縮めて表しているかを示すもの', back: '縮尺とは何か？', difficulty: 'basic' },
      { id: 'geo2-tm-fc11', front: '10mごと', back: '2万5千分の1地形図で主曲線（細い等高線）は何mごとに引かれるか？', difficulty: 'basic' },
      { id: 'geo2-tm-fc12', front: '20mごとに主曲線、100mごとに計曲線', back: '5万分の1地形図での等高線の間隔はどうなっているか？', difficulty: 'standard' },
      { id: 'geo2-tm-fc13', front: '傾斜がきつい（急斜面）', back: '等高線の間隔がせまい場所はどのような地形か？', difficulty: 'basic' },
      { id: 'geo2-tm-fc14', front: '傾斜がゆるやか（なだらか）', back: '等高線の間隔が広い場所はどのような地形か？', difficulty: 'basic' },
      { id: 'geo2-tm-fc15', front: 'ある2地点間の地形の高低を横から見た図で、等高線を読み取って作成する', back: '断面図とは何か？', difficulty: 'standard' },
      { id: 'geo2-tm-fc16', front: '鳥居の形', back: '地形図で「神社」を表す地図記号はどのような形か？', difficulty: 'basic' },
      { id: 'geo2-tm-fc17', front: '卍（まんじ）の形', back: '地形図で「寺院」を表す地図記号はどのような形か？', difficulty: 'basic' },
      { id: 'geo2-tm-fc18', front: '〒の形', back: '地形図で「郵便局」を表す地図記号はどのような形か？', difficulty: 'basic' },
      { id: 'geo2-tm-fc19', front: '×の形', back: '地形図で「交番」を表す地図記号はどのような形か？', difficulty: 'standard' },
      { id: 'geo2-tm-fc20', front: '十字の形（＋）', back: '地形図で「病院」を表す地図記号はどのような形か？', difficulty: 'standard' },
      { id: 'geo2-tm-fc21', front: '田は横線と縦線が交差した形、畑はVの字を組み合わせた形', back: '地形図で「田」と「畑」の地図記号の違いは？', difficulty: 'standard' },
      { id: 'geo2-tm-fc22', front: '広葉樹林は丸い形の樹木、針葉樹林はとがった三角形の樹木', back: '広葉樹林と針葉樹林の地図記号の違いは？', difficulty: 'standard' },
      { id: 'geo2-tm-fc23', front: 'Geographic Information System（地理情報システム）', back: 'GISとは何の略か？日本語名も答えよ。', difficulty: 'standard' },
      { id: 'geo2-tm-fc24', front: '複数の地理情報を重ね合わせて分析したり、目的に応じた地図を作成したりできる', back: 'GISを活用するとどのようなことができるか？', difficulty: 'advanced' },
      { id: 'geo2-tm-fc25', front: '点（ドット）を打つことで、分布の密度や偏りを表す地図', back: 'ドットマップとはどのような地図か？', difficulty: 'advanced' },
      { id: 'geo2-tm-fc26', front: '4cm（実際1km = 100,000cm、100,000 ÷ 25,000 = 4cm）', back: '実際の距離が1kmの場合、2万5千分の1地形図では地図上何cmになるか？', difficulty: 'advanced' },
      { id: 'geo2-tm-fc27', front: '拡大・縮小が自由にでき、複数のデータを重ね合わせて表示できる', back: 'デジタル地図の利点を2つ答えよ。', difficulty: 'advanced' },
      { id: 'geo2-tm-fc28', front: '2万5千分の1地形図の方が詳しい。縮尺が大きいため、より細かな地形や建物を表現できる', back: '2万5千分の1と5万分の1の地形図では、どちらがより詳しいか？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
        ...
        },
        {
          ...
          options: ['地図の色の濃さ', '実際の距離をどれだけ縮めたか', '地図の面積', '等高線の数'],
          correctIndex: 1,
