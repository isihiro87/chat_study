...
export const chugokuShikokuIndustryChat: HistoryChat = {
  ...
  content: [
    ...
    },
    {
      ...
      characterId: 'teacher',
      expression: 'explaining',
      text: '<ruby>高知<rp>(</rp><rt>こうち</rt><rp>)</rp></ruby>県では温暖な気候とビニールハウスを使った<strong><span class="keyword"><ruby>促成栽培<rp>(</rp><rt>そくせいさいばい</rt><rp>)</rp></ruby></span></strong>が盛んだよ。なすやピーマンを他の地域より早く出荷できるんだ',
    },
    {
      type: 'message',
      side: 'right',
