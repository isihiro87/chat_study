...
export const kantoNature: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'geo2-ktn-fc3', front: '関東平野', back: '日本最大の平野で、関東地方に広がる平野を何というか。', explanation: '面積約1万7千km2で日本最大。首都東京を含む大都市圏が広がる', difficulty: 'basic' },
      { id: 'geo2-ktn-fc4', front: '利根川', back: '流域面積が日本最大の、関東地方を流れる川を何というか。', explanation: '「坂東太郎」の別名を持ち、関東地方の水道水の重要な水源', difficulty: 'basic' },
      { id: 'geo2-ktn-fc5', front: 'からっ風', back: '冬に関東地方に吹く冷たい北西の季節風を何というか。', explanation: '山を越えて乾燥した冷たい風が関東平野に吹き下ろす', difficulty: 'basic' },
      { id: 'geo2-ktn-fc6', front: '世界都市', back: '政治・経済・文化の国際的な中心機能をもつ都市を何というか。', explanation: '東京が代表例', difficulty: 'basic' },
      { id: 'geo2-ktn-fc7', front: '国会・中央省庁・最高裁判所', back: '東京に置かれている国の三権の機関をそれぞれ答えよ。', explanation: '立法（国会）・行政（中央省庁）・司法（最高裁判所）がすべて東京に集中', difficulty: 'basic' },
      // standard (6)
      { id: 'geo2-ktn-fc8', front: '一極集中', back: '政治・経済・情報の機能が東京に偏って集まることを何というか。', explanation: '地方の過疎化や災害リスクの集中が問題視されている', difficulty: 'standard' },
      { id: 'geo2-ktn-fc9', front: '約3700万人（日本の人口の約3分の1）', back: '東京大都市圏の人口はおよそ何万人で、日本全体の約何分の1か。', explanation: '世界最大の都市圏の一つで、日本の人口の約3分の1が集中', difficulty: 'standard' },
      { id: 'geo2-ktn-fc10', front: '郊外の神奈川・埼玉・千葉から都心に通勤・通学する人が多いため', back: '東京都心で昼間人口が夜間人口を大幅に上回る理由は何か。', explanation: '千代田区は昼間人口が夜間人口の約17倍にもなる', difficulty: 'standard' },
      { id: 'geo2-ktn-fc11', front: '羽田空港と成田空港', back: '東京にある2つの国際空港の名前を答えよ。', explanation: '羽田は主に国内線と近距離国際線、成田は主に長距離国際線を担う', difficulty: 'standard' },
      { id: 'geo2-ktn-fc12', front: '地方の過疎化と首都直下型地震のリスク集中', back: '東京への一極集中がもたらす問題点を2つ答えよ。', explanation: '東京に機能が集中すると、大災害時の被害が甚大になるリスクがある', difficulty: 'standard' },
      { id: 'geo2-ktn-fc13', front: '約8割', back: '東京大都市圏で第三次産業が占める割合はおよそ何割か。', explanation: 'サービス業・金融・情報通信など第三次産業が中心の産業構造', difficulty: 'standard' },
      { id: 'geo2-ktn-fc14', front: '畑作', back: '関東ローム層は水はけがよいため、どのような農業に利用されているか。', explanation: '水を張れないため稲作には不向きだが、野菜などの畑作に適している', difficulty: 'basic' },
      { id: 'geo2-ktn-fc15', front: 'アスファルトやコンクリートの蓄熱と、エアコンの排熱', back: 'ヒートアイランド現象が起こる原因を2つ答えよ。', explanation: '緑地の減少で蒸発による冷却効果が失われることも一因', difficulty: 'standard' },
      { id: 'geo2-ktn-fc16', front: '黒潮（日本海流）', back: '関東地方の南部を流れる暖流を何というか。', explanation: '房総半島沖を流れ、関東南部の温暖な気候に影響を与えている', difficulty: 'basic' },
      { id: 'geo2-ktn-fc17', front: '神奈川県・埼玉県・千葉県', back: '東京を中心とする大都市圏に含まれる周辺3県を答えよ。', explanation: 'これら3県から東京への通勤・通学者が非常に多い', difficulty: 'basic' },
      { id: 'geo2-ktn-fc18', front: 'ニュータウン', back: '高度経済成長期に建設された郊外の大規模住宅地を何というか。', explanation: '多摩ニュータウンが代表例', difficulty: 'basic' },
      { id: 'geo2-ktn-fc19', front: '住民の高齢化と建物の老朽化', back: 'ニュータウンが現在抱えている課題を2つ答えよ。', explanation: '建設から50年以上が経ち、建物と住民の両方が同時に老いている', difficulty: 'standard' },
      { id: 'geo2-ktn-fc20', front: '国会（国会議事堂）', back: '東京にある日本の立法機関を何というか。', explanation: '衆議院と参議院の二院制で、法律の制定を行う', difficulty: 'basic' },
      { id: 'geo2-ktn-fc21', front: '中央省庁', back: '東京に集中している行政機関を何というか。', explanation: '霞が関に集まる政府の行政機関（財務省・外務省など）', difficulty: 'standard' },
      { id: 'geo2-ktn-fc22', front: '最高裁判所', back: '日本の最高の司法機関で、東京に置かれているものは何か。', explanation: '裁判の最終判断を下す司法の最高機関', difficulty: 'standard' },
      { id: 'geo2-ktn-fc23', front: '政治・経済の中心機能が集中する世界都市だから', back: '東京に外国の大使館や外国企業の本社が集まる理由を簡潔に述べよ。', explanation: 'ニューヨーク・ロンドンと並ぶ世界三大都市圏の一つ', difficulty: 'advanced' },
      { id: 'geo2-ktn-fc24', front: '火山灰が風化してできた赤土（粘土質の土壌）', back: '関東ローム層の「ローム」とは何を意味するか。', explanation: '富士山や箱根山などの火山灰が長い年月をかけて堆積したもの', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
        ...
        {
          id: 'geo2-ktn-q9',
          question: '高度経済成長期に建設された郊外の大規模住宅地を何というか。',
          options: ['ベッドタウン', 'ニュータウン', 'テクノポリス', 'コンパクトシティ'],
          correctIndex: 1,
          explanation: 'ニュータウンは高度経済成長期に大量の住宅需要に対応するため郊外に建設された大規模住宅地です。多摩ニュータウンが代表例です。',
          difficulty: 'standard',
        },
        {
          id: 'geo2-ktn-q10',
          question: '関東ローム層の「ローム」が意味するものはどれか。',
          options: ['石灰岩', '火山灰が風化した赤土', '河川の堆積物', '砂丘の砂'],
          correctIndex: 1,
          explanation: '関東ローム層の「ローム」は<ruby>火山灰<rp>(</rp><rt>かざんばい</rt><rp>)</rp></ruby>が風化してできた赤土（<ruby>粘土質<rp>(</rp><rt>ねんどしつ</rt><rp>)</rp></ruby>の土壌）を意味します。',
          difficulty: 'advanced',
        },
      ],
    },
