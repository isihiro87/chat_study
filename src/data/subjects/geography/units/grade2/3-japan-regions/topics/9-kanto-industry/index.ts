...
export const kantoIndustry: Topic = {
  ...
  content: {
    ...
    flashcards: [
      // basic (5)
      { id: 'geo2-kti-fc1', front: '近郊農業', back: '大都市の近くで新鮮な野菜や花などを供給する農業を何というか。', explanation: '千葉県や茨城県で盛んで、東京の大消費地に新鮮な野菜を届ける', difficulty: 'basic' },
      { id: 'geo2-kti-fc2', front: '京浜工業地帯', back: '東京から横浜にかけて広がる、出版・印刷業や情報産業が特徴の工業地帯を何というか。', explanation: '「京」は東京、「浜」は横浜を指す。日本を代表する工業地帯の一つ', difficulty: 'basic' },
      { id: 'geo2-kti-fc3', front: '京葉工業地域', back: '千葉県の臨海部に石油化学コンビナートが集まる工業地域を何というか。', explanation: '「京」は東京、「葉」は千葉を指す。埋め立て地に大型工場が立地', difficulty: 'basic' },
      { id: 'geo2-kti-fc4', front: '北関東工業地域', back: '群馬・栃木・茨城に広がり、高速道路沿いに自動車や電気機械の工場が立地する工業地域を何というか。', explanation: '内陸部は地価が安く広い用地を確保でき、高速道路で輸送も便利', difficulty: 'basic' },
      { id: 'geo2-kti-fc5', front: '筑波研究学園都市', back: '茨城県にある、研究機関が集約された学術都市を何というか。', explanation: '東京への一極集中を緩和するため、国の研究機関が移転された', difficulty: 'basic' },
      // standard (4)
      { id: 'geo2-kti-fc6', front: '東京という大消費地に近く、新鮮な野菜を素早く届けられるため', back: '千葉県や茨城県で近郊農業が発達した理由を述べよ。', explanation: '鮮度が重要な野菜は輸送時間が短いほど有利', difficulty: 'standard' },
      { id: 'geo2-kti-fc7', front: '出版社やマスメディアが集中し、大量の印刷需要があるため', back: '東京に印刷業が集中している理由を述べよ。', explanation: '京浜工業地帯の特徴的な産業で、東京の情報発信力と結びついている', difficulty: 'standard' },
      { id: 'geo2-kti-fc8', front: 'こんにゃく', back: '群馬県の特産品で、全国生産量の大部分を占める食品は何か。', explanation: '群馬県が全国生産量の約9割を占める', difficulty: 'standard' },
      { id: 'geo2-kti-fc9', front: 'キャベツ', back: '群馬県嬬恋村の高冷地で栽培が盛んな野菜は何か。', explanation: '夏でも涼しい気候を生かした栽培', difficulty: 'standard' },
      // advanced (3)
      { id: 'geo2-kti-fc10', front: '落花生', back: '千葉県や茨城県で生産が盛んな豆類は何か。', explanation: '千葉県は落花生の全国生産量の約8割を占める', difficulty: 'advanced' },
      { id: 'geo2-kti-fc11', front: '益子焼', back: '栃木県で生産される伝統的な焼き物を何というか。', explanation: '素朴で温かみのある作風が特徴の栃木県を代表する伝統工芸品', difficulty: 'advanced' },
      { id: 'geo2-kti-fc12', front: '群馬県太田市', back: '北関東工業地域で自動車工場が集まる都市はどこか。', explanation: 'SUBARU（旧富士重工業）の主力工場がある企業城下町', difficulty: 'advanced' },
      { id: 'geo2-kti-fc13', front: '出版・印刷業と情報産業', back: '京浜工業地帯に特に集中している産業を2つ答えよ。', explanation: '出版社・テレビ局・IT企業など情報関連産業が東京に集中', difficulty: 'basic' },
      { id: 'geo2-kti-fc14', front: '自動車と電気機械', back: '北関東工業地域で盛んな製造業を2つ答えよ。', explanation: '高速道路の整備により、臨海部から内陸部への工場移転が進んだ', difficulty: 'standard' },
      { id: 'geo2-kti-fc15', front: '東京ディズニーリゾート', back: '千葉県浦安市にある大型テーマパークは何か。', explanation: '名前に「東京」とあるが、実際は千葉県浦安市に所在する', difficulty: 'basic' },
      { id: 'geo2-kti-fc16', front: '幕張メッセ', back: '千葉市にある大型の国際展示場は何か。', explanation: '幕張新都心の中核施設で、大規模な見本市やイベントが開催される', difficulty: 'standard' },
      { id: 'geo2-kti-fc17', front: '高速道路で製品や部品を効率的に輸送でき、内陸部は地価が安く広い工場用地を確保できるため', back: '北関東工業地域が高速道路沿いに発展した理由を述べよ。', explanation: '「輸送の利便性」と「安い地価・広い用地」の2点が重要', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
