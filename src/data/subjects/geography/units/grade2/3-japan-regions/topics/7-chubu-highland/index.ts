...
export const chubuHighland: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'geo2-cbh-fc3', front: 'レタス（高原野菜）', back: '長野県の<ruby>八ヶ岳<rp>(</rp><rt>やつがたけ</rt><rp>)</rp></ruby>山麓で<ruby>抑制栽培<rp>(</rp><rt>よくせいさいばい</rt><rp>)</rp></ruby>されている代表的な野菜は何か。', explanation: '涼しい高原で夏に栽培し、平地の産地が出荷できない時期に出荷する', difficulty: 'basic' },
      ...
      { id: 'geo2-cbh-fc5', front: '東洋のスイス', back: '<ruby>精密機械<rp>(</rp><rt>せいみつきかい</rt><rp>)</rp></ruby>工業が盛んだった長野県の<ruby>諏訪<rp>(</rp><rt>すわ</rt><rp>)</rp></ruby>地方のよび名は何か。', explanation: 'スイスが時計産業で有名なように、諏訪も精密機械で発展した', difficulty: 'basic' },
      // standard (6)
      ...
      { id: 'geo2-cbh-fc8', front: '<ruby>輪島塗<rp>(</rp><rt>わじまぬり</rt><rp>)</rp></ruby>', back: '石川県で作られる伝統的な<ruby>漆器<rp>(</rp><rt>しっき</rt><rp>)</rp></ruby>を何というか。', explanation: '冬の豪雪時の副業から発展した北陸の代表的な伝統工芸品', difficulty: 'standard' },
      { id: 'geo2-cbh-fc9', front: '<ruby>九谷焼<rp>(</rp><rt>くたにやき</rt><rp>)</rp></ruby>', back: '石川県で作られる色彩<ruby>鮮<rp>(</rp><rt>あざ</rt><rp>)</rp></ruby>やかな<ruby>陶磁器<rp>(</rp><rt>とうじき</rt><rp>)</rp></ruby>を何というか。', explanation: '赤・黄・緑などの鮮やかな色絵が特徴の石川県の伝統工芸品', difficulty: 'standard' },
      { id: 'geo2-cbh-fc10', front: '<ruby>扇状地<rp>(</rp><rt>せんじょうち</rt><rp>)</rp></ruby>', back: '川が山地から平地に出るところにできる扇形の地形で、水はけがよく果樹栽培に適するのは何か。', explanation: '甲府盆地の扇状地ではぶどうや桃の栽培が盛ん', difficulty: 'standard' },
      { id: 'geo2-cbh-fc11', front: 'コンパクトシティ', back: '富山市がLRT（次世代型路面電車）を導入して都市機能を中心部に集約し目指している都市の形態は何か。', explanation: '車に頼らず公共交通と歩いて暮らせるまちづくりを目指す取り組み', difficulty: 'standard' },
      // advanced (4)
      { id: 'geo2-cbh-fc12', front: '冬の<ruby>豪雪<rp>(</rp><rt>ごうせつ</rt><rp>)</rp></ruby>で農作業ができず、副業として手工業が発達し伝統工芸品につながった', back: '北陸地方で伝統的工芸品が発達した背景は何か。', explanation: '農閑期の副業が職人技として磨かれ、全国的に有名な工芸品に成長した', difficulty: 'advanced' },
      { id: 'geo2-cbh-fc13', front: '<ruby>扇状地<rp>(</rp><rt>せんじょうち</rt><rp>)</rp></ruby>は水はけがよく果樹の根腐れが起きにくい。盆地で日照時間が長く<ruby>寒暖差<rp>(</rp><rt>かんだんさ</rt><rp>)</rp></ruby>が大きいため糖度が高まる', back: '甲府盆地で果樹栽培が盛んな理由を地形と気候から説明せよ。', explanation: '「地形（扇状地の水はけ）」と「気候（日照・寒暖差）」の2つの視点で答える', difficulty: 'advanced' },
      ...
      { id: 'geo2-cbh-fc15', front: '冬の<ruby>農閑期<rp>(</rp><rt>のうかんき</rt><rp>)</rp></ruby>の副業として始まり、石川県の<ruby>輪島塗<rp>(</rp><rt>わじまぬり</rt><rp>)</rp></ruby>・<ruby>九谷焼<rp>(</rp><rt>くたにやき</rt><rp>)</rp></ruby>、福井県<ruby>鯖江<rp>(</rp><rt>さばえ</rt><rp>)</rp></ruby>のメガネなどに発展', back: '北陸の伝統的工芸品の発展の経緯を具体例を挙げて述べよ。', explanation: '「なぜ発達したか（豪雪の農閑期）」と「具体例」を両方答えるのがポイント', difficulty: 'advanced' },
      { id: 'geo2-cbh-fc16', front: '加賀友禅', back: '石川県の伝統的な染色技術による織物を何というか。', explanation: '繊細な色彩と写実的な模様が特徴の石川県を代表する染め物', difficulty: 'standard' },
      { id: 'geo2-cbh-fc17', front: '越前漆器', back: '福井県で作られる伝統的な漆器を何というか。', explanation: '約1,500年の歴史を持つ福井県の伝統工芸品', difficulty: 'standard' },
      { id: 'geo2-cbh-fc18', front: '小千谷ちぢみ', back: '新潟県で作られる伝統的な織物を何というか。', explanation: '雪の上でさらす「雪ざらし」の工程が特徴の麻織物', difficulty: 'advanced' },
      { id: 'geo2-cbh-fc19', front: '金属洋食器', back: '新潟県燕市・三条市で盛んな伝統産業は何か。', explanation: '国内シェアの約9割を占め、世界的にも高品質で知られる', difficulty: 'standard' },
      { id: 'geo2-cbh-fc20', front: 'LRT（ライトレールトランジット）', back: '富山市が導入した次世代型路面電車を何というか。', explanation: '低床で乗り降りしやすく、高齢者にも優しい公共交通機関', difficulty: 'standard' },
      { id: 'geo2-cbh-fc21', front: 'コンピューター関連（電子機器）産業', back: '諏訪地方の工業は現在どのような産業に変化しているか。', explanation: '精密機械で培った高い技術力を電子機器産業に応用している', difficulty: 'standard' },
      { id: 'geo2-cbh-fc22', front: '精密機械工業（時計・カメラなど）', back: '長野県の諏訪地方でかつて盛んだった工業は何か。', explanation: '諏訪湖周辺のきれいな水と空気が精密機械の製造に適していた', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
