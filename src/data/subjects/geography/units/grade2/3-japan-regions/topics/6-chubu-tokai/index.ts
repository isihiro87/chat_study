...
export const chubuTokai: Topic = {
  ...
  content: {
    ...
    flashcards: [
      // basic (7)
      { id: 'geo2-cbt-fc1', front: '中京工業地帯', back: '愛知県を中心に広がる、自動車産業が盛んで<ruby>製造品出荷額<rp>(</rp><rt>せいぞうひんしゅっかがく</rt><rp>)</rp></ruby>が日本最大の工業地帯を何というか。', explanation: 'トヨタ自動車を中心に、製造品出荷額で日本一の工業地帯', difficulty: 'basic' },
      { id: 'geo2-cbt-fc2', front: '日本アルプス', back: '中部地方を東海・中央高地・北陸の3つの地域に分ける<ruby>飛驒<rp>(</rp><rt>ひだ</rt><rp>)</rp></ruby>山脈・<ruby>木曽<rp>(</rp><rt>きそ</rt><rp>)</rp></ruby>山脈・<ruby>赤石<rp>(</rp><rt>あかいし</rt><rp>)</rp></ruby>山脈の総称は何か。', explanation: '標高3,000m級の山々が連なり「日本の屋根」とも呼ばれる', difficulty: 'basic' },
      ...
      { id: 'geo2-cbt-fc4', front: '東海・中央高地・北陸', back: '日本アルプスを境にして中部地方が分かれる3つの地域は何か。', explanation: '太平洋側が東海、内陸が中央高地、日本海側が北陸', difficulty: 'basic' },
      { id: 'geo2-cbt-fc5', front: '<ruby>濃尾<rp>(</rp><rt>のうび</rt><rp>)</rp></ruby>平野', back: '<ruby>木曽三川<rp>(</rp><rt>きそさんせん</rt><rp>)</rp></ruby>（木曽川・<ruby>長良川<rp>(</rp><rt>ながらがわ</rt><rp>)</rp></ruby>・<ruby>揖斐川<rp>(</rp><rt>いびがわ</rt><rp>)</rp></ruby>）の下流域に広がる平野は何か。', explanation: '美濃（岐阜）と尾張（愛知）にまたがることから濃尾平野と呼ばれる', difficulty: 'basic' },
      { id: 'geo2-cbt-fc6', front: '<ruby>信濃川<rp>(</rp><rt>しなのがわ</rt><rp>)</rp></ruby>', back: '中部地方を流れ日本海にそそぐ、日本で最も長い川は何か。', explanation: '全長367kmで日本最長。長野県では千曲川と呼ばれる', difficulty: 'basic' },
      { id: 'geo2-cbt-fc7', front: '日本の屋根', back: '日本アルプスは標高が高いことから何とよばれるか。', explanation: '3,000m級の山が連なり、気候を分ける壁の役割を果たしている', difficulty: 'basic' },
      // standard (6)
      { id: 'geo2-cbt-fc8', front: '<ruby>輪中<rp>(</rp><rt>わじゅう</rt><rp>)</rp></ruby>', back: '木曽三川の<ruby>洪水<rp>(</rp><rt>こうずい</rt><rp>)</rp></ruby>に備え、周囲を<ruby>堤防<rp>(</rp><rt>ていぼう</rt><rp>)</rp></ruby>で囲んだ集落を何というか。', explanation: '低地が多い濃尾平野の下流域で洪水から暮らしを守る知恵', difficulty: 'standard' },
      { id: 'geo2-cbt-fc9', front: '<ruby>石油化学<rp>(</rp><rt>せきゆかがく</rt><rp>)</rp></ruby>コンビナート', back: '三重県<ruby>四日市<rp>(</rp><rt>よっかいち</rt><rp>)</rp></ruby>市に発達している、石油精製と化学工業を結合した工場群を何というか。', explanation: 'かつて四日市ぜんそく（四大公害病の一つ）が発生した地域', difficulty: 'standard' },
      { id: 'geo2-cbt-fc10', front: '<ruby>渥美<rp>(</rp><rt>あつみ</rt><rp>)</rp></ruby>半島の温室メロン', back: '愛知県の半島で温室栽培されている代表的な農産物は何か。', explanation: '温暖な気候と豊川用水を利用した施設園芸が盛ん', difficulty: 'standard' },
      { id: 'geo2-cbt-fc11', front: '静岡県の茶', back: '<ruby>牧之原<rp>(</rp><rt>まきのはら</rt><rp>)</rp></ruby>台地で栽培が盛んな農産物は何か。', explanation: '静岡県は茶の生産量日本一で、牧之原台地が主な産地', difficulty: 'standard' },
      { id: 'geo2-cbt-fc12', front: '木曽三川', back: '木曽川・<ruby>長良川<rp>(</rp><rt>ながらがわ</rt><rp>)</rp></ruby>・<ruby>揖斐川<rp>(</rp><rt>いびがわ</rt><rp>)</rp></ruby>を合わせた呼び名は何か。', explanation: '3つの大きな川が近接して流れるため、洪水被害が多かった', difficulty: 'standard' },
      { id: 'geo2-cbt-fc13', front: '中京工業地帯で最も出荷額が大きい工業', back: '自動車（<ruby>輸送用機械<rp>(</rp><rt>ゆそうようきかい</rt><rp>)</rp></ruby>）', explanation: '中京工業地帯の出荷額の半分以上を輸送用機械が占める', difficulty: 'standard' },
      // advanced (2)
      { id: 'geo2-cbt-fc14', front: '<ruby>愛知用水<rp>(</rp><rt>あいちようすい</rt><rp>)</rp></ruby>', back: '木曽川の水を<ruby>知多<rp>(</rp><rt>ちた</rt><rp>)</rp></ruby>半島などに引き、農業・工業・生活用水を供給するために建設された用水は何か。', explanation: '水不足だった知多半島の農業や工業の発展を支えた大規模用水路', difficulty: 'advanced' },
      { id: 'geo2-cbt-fc15', front: '冬の北西<ruby>季節風<rp>(</rp><rt>きせつふう</rt><rp>)</rp></ruby>が日本海の水分を含んで北陸に大量の雪を降らせ、山脈を越えると乾燥した風となり東海側は晴天が多い', back: '日本アルプスが中部地方の気候を3地域に分ける仕組みを説明せよ。', explanation: '山脈が壁となり、日本海側と太平洋側で気候が大きく異なる', difficulty: 'advanced' },
      { id: 'geo2-cbt-fc16', front: '太平洋側の気候で、冬は乾燥し夏は高温多雨', back: '東海地方の気候の特徴を答えよ。', explanation: '冬は季節風が山脈で遮られるため乾燥した晴天が続く', difficulty: 'basic' },
      { id: 'geo2-cbt-fc17', front: '内陸性の気候で、夏と冬の寒暖差が大きい', back: '中央高地の気候の特徴を答えよ。', explanation: '海から離れた高地のため降水量が少なく、昼夜の気温差も大きい', difficulty: 'standard' },
      { id: 'geo2-cbt-fc18', front: '北西の季節風', back: '北陸地方が冬に多雪になる原因となる風を何というか。', explanation: '日本海の水分をたっぷり含んだ季節風が山脈にぶつかり大量の雪を降らせる', difficulty: 'basic' },
      { id: 'geo2-cbt-fc19', front: 'オートバイと楽器', back: '静岡県浜松市で盛んな工業製品を2つ答えよ。', explanation: 'ヤマハ・スズキ（オートバイ）、ヤマハ・カワイ（楽器）', difficulty: 'standard' },
      { id: 'geo2-cbt-fc20', front: '太平洋', back: '木曽川や矢作川がそそぐのは太平洋と日本海のどちらか。', explanation: '中部地方の太平洋側を流れる河川は伊勢湾を通じて太平洋にそそぐ', difficulty: 'basic' },
      { id: 'geo2-cbt-fc21', front: '飛驒山脈・木曽山脈・赤石山脈', back: '日本アルプスを構成する3つの山脈をすべて答えよ。', explanation: '北から飛驒（北アルプス）、木曽（中央アルプス）、赤石（南アルプス）', difficulty: 'standard' },
      { id: 'geo2-cbt-fc22', front: '瀬戸焼と常滑焼', back: '愛知県の伝統的な焼き物として知られる2つの焼き物を答えよ。', explanation: '「瀬戸物」は焼き物の代名詞になるほど古くから生産が盛ん', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
