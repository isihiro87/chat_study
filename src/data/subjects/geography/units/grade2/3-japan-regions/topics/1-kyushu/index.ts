...
export const kyushu: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'geo2-ky-fc5', front: '桜島', back: '鹿児島湾に面し、現在も噴火を続けている九州の活火山は何か。', difficulty: 'basic' },
      { id: 'geo2-ky-fc6', front: '地熱発電', back: '火山の地下の高温の熱水や蒸気を利用して電気をつくる発電方法を何というか。', explanation: '大分県の八丁原発電所は日本最大級', difficulty: 'basic' },
      { id: 'geo2-ky-fc7', front: '南西諸島', back: '九州南西に連なる島々の総称で、さんご礁が発達している地域を何というか。', difficulty: 'basic' },
      { id: 'geo2-ky-fc8', front: '畜産', back: '鹿児島県や宮崎県で盛んな、肉牛・豚・鶏を飼育する産業を何というか。', explanation: '南九州はシラス台地の広い土地を牧場に利用', difficulty: 'basic' },
      { id: 'geo2-ky-fc9', front: '砂防ダム', back: '土石流を防ぐために河川の上流に造られるダムを何というか。', difficulty: 'basic' },
      // standard (40%)
      { id: 'geo2-ky-fc10', front: 'エコタウン事業', back: '北九州市が公害の教訓からリサイクル産業を集積させた環境事業を何というか。', difficulty: 'standard' },
      ...
      { id: 'geo2-ky-fc12', front: '八幡製鉄所', back: '1901年に操業を開始した、北九州市にある日本の近代工業の出発点となった施設は何か。', difficulty: 'standard' },
      { id: 'geo2-ky-fc13', front: '八丁原発電所', back: '大分県にある、日本最大級の地熱発電所の名前は何か。', difficulty: 'standard' },
      { id: 'geo2-ky-fc14', front: '筑後川', back: '筑紫平野を流れ有明海にそそぐ、九州最大級の河川は何か。', difficulty: 'standard' },
      { id: 'geo2-ky-fc15', front: 'さとうきび', back: '南西諸島で栽培が盛んな、砂糖の原料となる作物は何か。', difficulty: 'standard' },
      { id: 'geo2-ky-fc16', front: '環境モデル都市', back: '水俣市が公害の教訓から再生し目指している、環境保全の模範となる都市の姿を何というか。', difficulty: 'standard' },
      { id: 'geo2-ky-fc17', front: '別府温泉', back: '大分県にある日本有数の温泉地で、多くの観光客が訪れる温泉はどこか。', difficulty: 'standard' },
      { id: 'geo2-ky-fc18', front: '再生可能エネルギー', back: '地熱発電や太陽光発電のように繰り返し利用できるエネルギーの総称は何か。', difficulty: 'standard' },
      // advanced (20%)
      { id: 'geo2-ky-fc19', front: '克灰袋（こくはいぶくろ）', back: '鹿児島市で火山灰を集めて捨てるために市民に配布されている専用袋を何というか。', difficulty: 'advanced' },
    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['新日鉄製鉄所', '八幡製鉄所', '君津製鉄所', '釜石製鉄所'],
          correctIndex: 1,
        ...
        },
        {
          ...
          options: ['レタスとキャベツ', 'きゅうりとピーマン', 'なすとトマト', 'だいこんとにんじん'],
          correctIndex: 1,
