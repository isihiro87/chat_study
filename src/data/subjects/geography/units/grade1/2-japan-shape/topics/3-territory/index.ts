...
export const territory: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo1-tr-fc1', front: '領土・領海・領空', back: '日本の「領域」を構成する三つの要素は何か。', explanation: 'この三つの範囲に日本の主権がおよぶ。', difficulty: 'basic' },
      { id: 'geo1-tr-fc2', front: '沿岸から12海里（約22km）', back: '日本の領海は沿岸からどこまでの範囲か。', explanation: '領海内では日本の主権がおよび、他国は無害通航のみ可能。', difficulty: 'basic' },
      { id: 'geo1-tr-fc3', front: '沿岸から200海里（約370km）。水産資源や鉱産資源を管理する権利をもつ', back: '排他的経済水域（EEZ）は沿岸からどこまでの範囲で、どのような権利があるか。', explanation: '領海と異なり、他国の船の航行は自由に認められている。', difficulty: 'basic' },
      { id: 'geo1-tr-fc4', front: '沖ノ鳥島は最南端（EEZ確保）、南鳥島は最東端（レアアース等の海底資源）', back: '沖ノ鳥島と南鳥島はそれぞれ日本のどの端にあり、なぜ重要か。', explanation: 'ともに東京都に属する無人島。', difficulty: 'basic' },
      { id: 'geo1-tr-fc5', front: '択捉島・国後島・色丹島・歯舞群島', back: '北方領土を構成する四つの島を答えよ。', explanation: '日本固有の領土だが、1945年以降ロシアに占拠されている。', difficulty: 'basic' },
      { id: 'geo1-tr-fc6', front: '島根県に属する日本固有の領土。現在韓国が占拠している', back: '竹島はどの都道府県に属し、現在どのような状況にあるか。', explanation: '日本は国際法に基づく平和的な解決を主張している。', difficulty: 'basic' },
      { id: 'geo1-tr-fc7', front: '沖縄県に属する日本固有の領土。周辺に石油や天然ガスの可能性', back: '尖閣諸島はどの都道府県に属し、周辺海域にはどのような資源があるか。', explanation: '日本が有効に支配しており、領土問題は存在しないのが日本の立場。', difficulty: 'basic' },
      { id: 'geo1-tr-fc8', front: '水没すると約40万km²のEEZが失われるため、コンクリートで護岸工事が行われた', back: '沖ノ鳥島で護岸工事が行われた理由を答えよ。', explanation: '島が水没すると「岩」扱いになりEEZを設定できなくなる。', difficulty: 'standard' },
      { id: 'geo1-tr-fc9', front: '噴火で面積が大幅に拡大し、排他的経済水域も拡大した', back: '小笠原諸島の西之島の噴火は日本にとってどのような意味があるか。', explanation: '2013年以降の噴火で島が拡大し続けた。', difficulty: 'standard' },
      { id: 'geo1-tr-fc10', front: '約6,800の島が広範囲に散らばり、各島を基点に200海里のEEZが設定されるため', back: '日本の排他的経済水域が国土面積の約10倍もある理由を答えよ。', explanation: '離島が広く散らばっていることが広大なEEZにつながっている。', difficulty: 'standard' },
      { id: 'geo1-tr-fc11', front: '領海は12海里で主権がおよぶ。EEZは200海里で資源管理権があるが他国の船は航行自由', back: '領海と排他的経済水域の範囲と権利の違いを答えよ。', explanation: '範囲と権利の違いを区別して覚えることが大切。', difficulty: 'standard' },
      ...
      { id: 'geo1-tr-fc13', front: '約3000km', back: '日本列島の南北の長さはおよそ何kmか。', explanation: '南北に長いため気候の差が大きい。', difficulty: 'standard' },
      { id: 'geo1-tr-fc14', front: '択捉島', back: '北方領土を構成する4つの島のうち、最も大きい島はどれか。', explanation: '日本最北端の島でもある。', difficulty: 'standard' },
      { id: 'geo1-tr-fc15', front: '約38万km²', back: '日本の国土面積はおよそ何万km²か。', explanation: '世界で約60番目の広さ。', difficulty: 'basic' },
      { id: 'geo1-tr-fc16', front: '12海里', back: '日本の領海は沿岸から何海里の範囲か。', explanation: '約22kmに相当する。', difficulty: 'basic' },
      { id: 'geo1-tr-fc17', front: '200海里', back: '排他的経済水域は沿岸から何海里の範囲か。', explanation: '約370kmに相当する。', difficulty: 'basic' },
      { id: 'geo1-tr-fc18', front: 'EEZ（Exclusive Economic Zone）', back: '排他的経済水域の英語の略称を答えよ。', explanation: '「排他的」は独占的という意味。', difficulty: 'standard' },
      { id: 'geo1-tr-fc19', front: '約40万km²', back: '沖ノ鳥島があることで確保される排他的経済水域はおよそ何万km²か。', explanation: '日本の国土面積（約38万km²）よりも広い。', difficulty: 'standard' },
      { id: 'geo1-tr-fc20', front: '島根県', back: '竹島は何県に属するか。', explanation: '日本海に位置する。', difficulty: 'basic' },
      { id: 'geo1-tr-fc21', front: '沖縄県', back: '尖閣諸島は何県に属するか。', explanation: '東シナ海に位置する。', difficulty: 'basic' },
      { id: 'geo1-tr-fc22', front: '無害通航（沿岸国の安全を害さない通航のみ認められる）', back: '領海では他国の船はどのような条件で通航できるか。', explanation: '国連海洋法条約で定められた権利。', difficulty: 'advanced' },
      { id: 'geo1-tr-fc23', front: 'コンクリートやテトラポッドで島を補強する護岸工事', back: '沖ノ鳥島では波による浸食を防ぐためにどのような工事が行われたか。', explanation: '数百億円をかけて島の保全が行われている。', difficulty: 'advanced' },
      { id: 'geo1-tr-fc24', front: 'いずれも日本固有の領土であること', back: '日本の3つの領土問題の共通点は何か。', explanation: '日本は平和的な手段による解決を目指している。', difficulty: 'advanced' },
      { id: 'geo1-tr-fc25', front: '領土と領海の上空', back: '領空とはどの範囲の上空か。', explanation: '他国の航空機は許可なく通過できない。', difficulty: 'standard' },
      { id: 'geo1-tr-fc26', front: 'ロシア（旧ソ連が1945年以降占拠）', back: '北方領土を現在占拠している国はどこか。', explanation: '第二次世界大戦終結直後にソ連が占拠した。', difficulty: 'standard' },
      { id: 'geo1-tr-fc27', front: '石油や天然ガス', back: '尖閣諸島の周辺海域で存在が指摘されている資源は何か。', explanation: '1970年代以降に中国が領有権を主張し始めた背景の一つ。', difficulty: 'advanced' },
      { id: 'geo1-tr-fc28', front: 'レアアース（希少金属）', back: '南鳥島周辺の海底で確認されている資源は何か。', explanation: 'スマートフォンや電気自動車に不可欠な資源。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
