...
export const japanPosition: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'geo1-jp-fc2', front: '東経約123度〜約154度', back: '日本は経度でいうとおよそ何度から何度の間に位置しているか？', explanation: '与那国島（西端）から南鳥島（東端）までの範囲。', difficulty: 'basic' },
      { id: 'geo1-jp-fc3', front: 'ユーラシア大陸の東側', back: '日本はどの大陸のどちら側に位置しているか？', explanation: '大陸との間には日本海や東シナ海がある。', difficulty: 'basic' },
      { id: 'geo1-jp-fc4', front: '太平洋の北西部', back: '日本は太平洋のどのあたりに位置しているか？', explanation: 'アジア州の東アジアに属する島国。', difficulty: 'basic' },
      { id: 'geo1-jp-fc5', front: '東経135度（兵庫県明石市を通る）', back: '日本の標準時子午線は何度で、どこを通っているか？', explanation: 'イギリスとの時差は135÷15＝9時間。', difficulty: 'basic' },
      { id: 'geo1-jp-fc6', front: '沖ノ鳥島（東京都）', back: '日本最南端の島の名前を答えよ。', explanation: '排他的経済水域の確保に重要な役割を果たしている。', difficulty: 'basic' },
      { id: 'geo1-jp-fc7', front: '南鳥島（東京都小笠原村）', back: '日本最東端の島の名前を答えよ。', explanation: '周辺海域にはレアアースなどの海底資源が確認されている。', difficulty: 'basic' },
      { id: 'geo1-jp-fc8', front: '与那国島（沖縄県）', back: '日本最西端の島の名前を答えよ。', explanation: '台湾まで約110kmと非常に近い。', difficulty: 'basic' },
      { id: 'geo1-jp-fc9', front: '北海道・本州・四国・九州', back: '日本列島を構成する4つの大きな島を北から順に答えよ。', explanation: '本州が最も大きく、日本の人口の約8割が集中している。', difficulty: 'basic' },
      { id: 'geo1-jp-fc10', front: '約3000km', back: '日本列島の南北の長さはおよそ何kmか？', explanation: '南北に長いため、地域によって気候が大きく異なる。', difficulty: 'basic' },
      ...
      { id: 'geo1-jp-fc12', front: '関東地方（北緯約35度付近）', back: 'アフリカ大陸北端の地中海沿岸と同じ緯度にある日本の地方はどこか？', explanation: '同じ緯度でも海洋の影響で気候が異なる。', difficulty: 'standard' },
      { id: 'geo1-jp-fc13', front: '約38万km²（世界で約60番目）', back: '日本の国土面積はおよそ何万km²か？', explanation: 'ドイツやイギリスと同じくらいの広さ。', difficulty: 'standard' },
      { id: 'geo1-jp-fc14', front: '日本は海に囲まれた島国で湿潤、カイロは大陸内部で乾燥しているため', back: '同じ緯度にある日本とカイロで気候が大きく異なる理由を答えよ。', explanation: '緯度だけでなく海陸分布も気候に大きく影響する。', difficulty: 'standard' },
      { id: 'geo1-jp-fc15', front: '東：太平洋、西：日本海・東シナ海、北：オホーツク海、南：フィリピン海', back: '日本の東西南北にある海をそれぞれ答えよ。', explanation: '4つの海に囲まれていることが日本の気候や漁業に影響する。', difficulty: 'standard' },
      { id: 'geo1-jp-fc16', front: '日本海と東シナ海', back: '日本列島の西側にある海を2つ答えよ。', explanation: 'ユーラシア大陸との間にある海。', difficulty: 'standard' },
      { id: 'geo1-jp-fc17', front: 'オホーツク海', back: '日本列島の北側にある海を答えよ。', explanation: '冬には流氷が北海道沿岸に接近する。', difficulty: 'basic' },
      { id: 'geo1-jp-fc18', front: '中緯度は太陽の高さが季節で変化しやすく、四季が生まれる', back: '日本が中緯度に位置していることと四季の変化にはどのような関係があるか。', explanation: '地軸の傾きと中緯度の位置が四季のはっきりした気候をつくる。', difficulty: 'advanced' },
      { id: 'geo1-jp-fc19', front: '約6,800の島', back: '日本はおよそ何個の島からなるか。', explanation: '4つの大きな島と多数の離島で構成されている。', difficulty: 'standard' },
      { id: 'geo1-jp-fc20', front: 'え＝択捉島（北）、お＝沖ノ鳥島（南）、み＝南鳥島（東）、よ＝与那国島（西）', back: '日本の端の島を覚える語呂合わせ「えおみよ」のそれぞれの頭文字は何か。', explanation: 'テスト頻出。北から時計回りに覚えると整理しやすい。', difficulty: 'standard' },
      { id: 'geo1-jp-fc21', front: '北緯約46度', back: '日本の北端付近の緯度はおよそ何度か。', explanation: '択捉島付近の緯度。', difficulty: 'standard' },
      { id: 'geo1-jp-fc22', front: '東経約154度', back: '日本の東端付近の経度はおよそ何度か。', explanation: '南鳥島付近の経度。', difficulty: 'standard' },
      { id: 'geo1-jp-fc23', front: '東京都（小笠原村）', back: '南鳥島は何都道府県に属しているか。', explanation: '沖ノ鳥島も同じく東京都に属する。', difficulty: 'standard' },
      { id: 'geo1-jp-fc24', front: 'ワシントンD.C.（北緯約39度）', back: '日本と同緯度にあるアメリカの都市を1つ答えよ。', explanation: '同じ緯度でも大陸の東岸と西岸で気候が異なる。', difficulty: 'advanced' },
      { id: 'geo1-jp-fc25', front: '日本は海に囲まれた島国で湿潤、カイロは大陸内部で乾燥しているため', back: '同じ緯度でもカイロと東京では気候が大きく違う理由は。', explanation: '海洋からの湿った風が日本に多くの降水をもたらす。', difficulty: 'advanced' },
      { id: 'geo1-jp-fc26', front: '広大な排他的経済水域（漁業資源や海底資源）を確保できる', back: '日本が海洋国（島国）であることの利点を1つ答えよ。', explanation: '日本のEEZは国土面積の約12倍で世界第6位。', difficulty: 'advanced' },
      { id: 'geo1-jp-fc27', front: '上海（北緯約31度）', back: '日本と同緯度にある中国の代表的な都市を答えよ。', explanation: '九州南部とほぼ同じ緯度にある中国最大の都市。', difficulty: 'advanced' },
      { id: 'geo1-jp-fc28', front: '中緯度の島国で、周囲の海洋から暖かく湿った空気が流れ込むため', back: '日本の気候が温暖で降水量が多い理由を位置の特徴と関連づけて答えよ。', explanation: '梅雨や台風も海洋の影響を受けた現象。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
