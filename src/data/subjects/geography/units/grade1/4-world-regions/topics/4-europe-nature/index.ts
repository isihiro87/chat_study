...
export const europeNature: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo1-eu1-fc1', front: '北大西洋海流（暖流）と偏西風', back: 'ヨーロッパ州が高緯度の割に温暖な気候である理由を二つ答えよ。', explanation: '暖流が沿岸に温かい空気を運び、偏西風がその暖かさを内陸まで届ける。', difficulty: 'basic' },
      ...
      { id: 'geo1-eu1-fc4', front: '夏は高温乾燥、冬は温暖多雨。オリーブやぶどうの栽培がさかん', back: '地中海性気候の特徴と、栽培がさかんな農作物を答えよ。', explanation: '南ヨーロッパに見られる気候で、乾燥に強いオリーブやぶどうが地中海式農業の代表作物。', difficulty: 'basic' },
      { id: 'geo1-eu1-fc5', front: 'アルプス山脈', back: 'フランス・スイス・イタリア・オーストリアなどにまたがるヨーロッパ南部の大山脈を何というか。', explanation: 'モンブラン（標高4810m）が最高峰で、ヨーロッパの気候や水系に大きな影響を与える。', difficulty: 'basic' },
      { id: 'geo1-eu1-fc6', front: 'ゲルマン系（英語・ドイツ語）、ラテン系（フランス語・スペイン語）、スラブ系（ロシア語）', back: 'ヨーロッパの言語を三つの系統に分け、それぞれの代表例を答えよ。', explanation: '地理的に北西はゲルマン系、南はラテン系、東はスラブ系が多い傾向がある。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc7', front: '北大西洋海流', back: 'ヨーロッパの大西洋側を流れ、温暖な気候をもたらす暖流を何というか。', explanation: 'メキシコ湾流の延長にあたる暖流で、ヨーロッパ西岸の気温を引き上げる。', difficulty: 'basic' },
      { id: 'geo1-eu1-fc8', front: '偏西風', back: '年間を通じて西から東に向かって吹き、北大西洋海流の暖かさを内陸まで運ぶ風を何というか。', explanation: '中緯度で常に西から東へ吹く風で、ヨーロッパの西岸海洋性気候を作り出す原因の一つ。', difficulty: 'basic' },
      { id: 'geo1-eu1-fc9', front: 'ユーロ', back: 'EU加盟国の多くが導入している共通通貨は何か。', explanation: '2002年から流通が始まり、通貨の両替なしで国境を越えた経済活動が可能になった。', difficulty: 'basic' },
      { id: 'geo1-eu1-fc10', front: 'シェンゲン協定', back: 'EU加盟国間の移動でパスポートの検査を不要にする協定を何というか。', explanation: '人の自由な移動を実現する協定で、加盟国間の国境検査が原則廃止された。', difficulty: 'basic' },
      { id: 'geo1-eu1-fc11', front: 'エアバス', back: 'ヨーロッパの複数の国が開発費用を分担して共同生産している航空機を何というか。', explanation: 'フランス・ドイツ・スペイン・イギリスなどが協力し、アメリカのボーイングと並ぶ航空機メーカー。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc12', front: '酸性雨', back: '工場や自動車の排気ガスが原因で、森林の枯死や湖の生態系破壊を引き起こしたヨーロッパの環境問題は何か。', explanation: '国境を越えて被害が広がるため、国際的な協力による対策が必要とされた。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc13', front: 'パークアンドライド', back: '郊外の駐車場に車を停めて公共交通機関で都市中心部に移動する仕組みを何というか。', explanation: '都市中心部の渋滞や大気汚染を減らすためにヨーロッパ各地で導入されている。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc14', front: 'カトリック・プロテスタント・正教会', back: 'ヨーロッパで信仰されているキリスト教の3つの主な宗派を答えよ。', explanation: '南欧はカトリック、北欧はプロテスタント、東欧は正教会が多い傾向がある。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc15', front: 'EC（ヨーロッパ共同体）、1993年', back: 'EUの前身となった組織の略称と、EUに発展した年を答えよ。', explanation: 'ECは1967年に発足し、統合を深めて1993年にマーストリヒト条約によりEUに発展した。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc16', front: 'イギリス（ブレグジット）', back: '2020年にEUを離脱した国はどこか。また、その離脱は何とよばれるか。', explanation: '2016年の国民投票で離脱が決定し、移民問題や主権回復が主な理由だった。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc17', front: 'ルーラル・ツーリズム', back: '農村に滞在し、農業体験や自然とのふれあいを楽しむ観光の形態を何というか。', explanation: 'フランスやイタリアなどで盛んで、農村地域の活性化にも貢献している。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc18', front: '石油と天然ガス', back: 'ロシアで豊富に産出され、パイプラインでヨーロッパへ輸出される鉱産資源を2つ答えよ。', explanation: 'ヨーロッパのエネルギー供給はロシアに依存する部分が大きく、外交問題にもなる。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc19', front: 'タイガ', back: 'ロシアのシベリア地方などに広がる広大な針葉樹林を何というか。', explanation: '世界最大の森林帯で、木材資源の供給源として重要な役割を果たしている。', difficulty: 'standard' },
      { id: 'geo1-eu1-fc20', front: '国民総所得（Gross National Income）', back: 'GNIとは何の略か。日本語で答えよ。', explanation: 'その国の国民が国内外で1年間に得た所得の合計で、経済力の指標として使われる。', difficulty: 'advanced' },
      { id: 'geo1-eu1-fc21', front: '風力発電と太陽光発電', back: 'ヨーロッパで積極的に導入されている再生可能エネルギーを2つ答えよ。', explanation: '地球温暖化対策として化石燃料からの転換が進んでおり、特にデンマークやドイツで盛ん。', difficulty: 'advanced' },
      { id: 'geo1-eu1-fc22', front: 'スカンディナビア半島（ノルウェー）', back: 'フィヨルドが多く見られるのはヨーロッパのどの地域か。', explanation: 'ノルウェー西海岸に特に多く、氷河が削ったU字谷に海水が入り込んだ地形。', difficulty: 'advanced' },
      { id: 'geo1-eu1-fc23', front: 'フランクフルト', back: 'ヨーロッパ中央銀行（ECB）の本部がある都市はどこか。', explanation: 'ドイツの金融の中心地で、ユーロの金融政策を決定するECBの本部が置かれている。', difficulty: 'advanced' },
      { id: 'geo1-eu1-fc24', front: 'ライン川', back: 'スイスからオランダまで複数の国を流れ、国際協力で水質改善に成功した国際河川を何というか。', explanation: 'ヨーロッパの重要な水上交通路で、かつての水質汚染を国際協力で改善した成功例。', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
