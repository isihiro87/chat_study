...
export const southAmericaNature: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'geo1-sa1-fc1', front: '世界最大の流域面積を持ち、流域に広大な熱帯雨林が広がる川', back: 'アマゾン川はどのような特徴を持つ川か？', explanation: '全長約6400kmで、流域面積は約700万km²と日本の約18倍の広さ。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc2', front: '南北約7500kmの世界最長の山脈。インカ帝国が栄えた', back: 'アンデス山脈の特徴と、かつて高地に栄えた帝国の名前を答えよ。', explanation: '南アメリカ大陸の西岸を走る褶曲山脈で、6000m級の山々が連なる。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc3', front: 'スペイン・ポルトガルの植民地支配で先住民と混血し、言語・宗教が広まった', back: '南アメリカ州に混血文化が生まれた理由を説明せよ。', explanation: 'カトリックやスペイン語・ポルトガル語が広まり、ラテンアメリカと呼ばれる文化圏を形成。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc4', front: '森林を保全しながらカカオやコーヒーを育てる持続的農業', back: 'アグロフォレストリー（森林農業）とはどのような農業か？', explanation: '森林を伐採せず木々の間で作物を育てるため、環境への負荷が少ない。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc5', front: 'ラプラタ川流域（主にアルゼンチン）の大草原で、牧畜がさかん', back: 'パンパとはどのような地形で、どこに広がっているか？', explanation: '肥沃な土壌を持つ温帯草原で、牛肉や小麦の生産が盛んな地域。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc6', front: 'メスティーソ', back: '南アメリカの先住民とヨーロッパ系の人々の混血の人々を何というか？', explanation: '南アメリカの多くの国で人口の大きな割合を占めている。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc7', front: 'セルバ', back: 'アマゾン川流域に広がる世界最大の熱帯雨林を何というか？', explanation: '「地球の肺」と呼ばれ、二酸化炭素を吸収し酸素を放出する役割がある。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc8', front: '20世紀初頭、コーヒー農園での労働力として渡った', back: '日系移民はいつ頃、なぜブラジルに渡ったか？', explanation: '現在もブラジルには約190万人の日系人が暮らし、日本文化が根付いている。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc9', front: 'ブラジル高原', back: 'ブラジルの国土の大部分を占め、鉄鉱石が豊富に埋蔵される広大な高原を何というか。', explanation: 'カラジャス鉄山など世界最大級の鉄鉱石鉱山がある。', difficulty: 'basic' },
      { id: 'geo1-sa1-fc10', front: '焼畑農業', back: '森林を伐採して焼き、灰を肥料として農作物を育てる伝統的農業を何というか。', explanation: '熱帯地域の伝統的農法だが、大規模化すると森林破壊の原因となる。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc11', front: 'コーヒー豆', back: 'ブラジルが世界最大の生産量を誇る飲料用の農産物は何か。', explanation: '世界のコーヒー生産量の約3分の1をブラジルが占めている。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc12', front: '大豆', back: 'ブラジルが近年、世界最大級の輸出国となっている穀物は何か。', explanation: '中国向けの輸出が急増し、セラード（サバナ地帯）の開発が進んだ。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc13', front: '鉄鉱石', back: 'ブラジルで大量に産出され、中国や日本に輸出される鉱石は何か。', explanation: 'オーストラリアと並ぶ世界最大級の鉄鉱石輸出国。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc14', front: '銅鉱石', back: 'チリやペルーで多く産出される、電線などに使われる金属の鉱石は何か。', explanation: 'チリは世界最大の銅産出国で、国の経済を支える主要な輸出品。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc15', front: 'バイオエタノール', back: 'サトウキビを原料として作られ、ブラジルで自動車燃料に使われる再生可能な燃料を何というか。', explanation: 'ブラジルではガソリンとバイオエタノールの両方を使えるフレックス車が普及している。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc16', front: '大豆畑の開発と牧場の拡大', back: '南アメリカ州で熱帯雨林が大規模に減少している主な原因を2つ答えよ。', explanation: '経済発展のための開発と、世界的な食料需要の増加が森林破壊を加速させている。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc17', front: 'エコツーリズム', back: '自然環境を守りながら観光収入を得る取り組みを何というか。', explanation: 'アマゾンの熱帯雨林やガラパゴス諸島が代表的な目的地。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc18', front: 'マチュピチュ', back: 'アンデス山脈の高地にあるインカ帝国の有名な遺跡の名前を答えよ。', explanation: '標高約2400mにある「空中都市」で、ペルーの世界遺産として知られる。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc19', front: 'ブラジルはポルトガル語、他の多くの国はスペイン語', back: 'ブラジルの公用語は何か。他の南アメリカの多くの国の公用語は何か。', explanation: 'ブラジルがポルトガルの植民地、他の国がスペインの植民地だったことが背景。', difficulty: 'advanced' },
      { id: 'geo1-sa1-fc20', front: '生物多様性', back: '熱帯雨林が減少すると失われる、植物や動物の種類の豊かさを何というか。', explanation: 'アマゾンの熱帯雨林には地球上の生物種の約10%が生息するとされる。', difficulty: 'advanced' },
      { id: 'geo1-sa1-fc21', front: '約7500km', back: 'アンデス山脈は南北約何kmにわたって連なるか。', explanation: 'ベネズエラからチリ南端まで延び、世界最長の山脈として知られる。', difficulty: 'advanced' },
      { id: 'geo1-sa1-fc22', front: '持続可能な開発', back: '経済の発展と環境の保全を両立させる開発のあり方を何というか。', explanation: '将来の世代のニーズを損なわずに現在の世代のニーズを満たす開発。', difficulty: 'standard' },
      { id: 'geo1-sa1-fc23', front: 'テーブル状の台地が連なり、エンジェルフォール（世界最大落差の滝）がある', back: 'ギアナ高地の地形的特徴を答えよ。', explanation: 'ベネズエラにあるエンジェルフォールは落差約979mで世界最大。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
      ...
      },
        {
          ...
          options: ['アステカ帝国', 'マヤ文明', 'オスマン帝国', 'インカ帝国'],
          correctIndex: 3,
          explanation:
      ...
      },
        {
          ...
          options: ['約2000km', '約7500km', '約5000km', '約10000km'],
          correctIndex: 1,
      ...
      },
        {
          ...
          options: ['ブラジル高原', 'アンデス台地', 'パタゴニア台地', 'ギアナ高地'],
          correctIndex: 3,
      ...
      },
        {
          ...
          options: ['モノカルチャー経済', '計画経済', '持続可能な開発', '自由貿易'],
          correctIndex: 2,
      ...
      },
        {
          ...
          options: ['カトリック', 'プロテスタント', '正教会', '英国国教会'],
          correctIndex: 0,
      ...
      },
        {
          ...
          options: ['混合農業', 'プランテーション', '二期作', '焼畑農業'],
          correctIndex: 3,
      ...
      },
        {
          ...
          options: ['マスツーリズム', 'エコツーリズム', 'ルーラル・ツーリズム', 'グリーンツーリズム'],
          correctIndex: 1,
      ...
      },
        {
          ...
          options: ['アンコールワット', 'ピラミッド', 'マチュピチュ', 'コロッセオ'],
          correctIndex: 2,
      ...
      },
        {
          ...
          options: ['ブラジル高原', 'ギアナ高地', 'チベット高原', 'デカン高原'],
          correctIndex: 0,
      ...
      },
        {
          ...
          options: ['米と小麦', '大豆ととうもろこし', 'カカオとコーヒー', 'バナナとパイナップル'],
          correctIndex: 2,
