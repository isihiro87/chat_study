...
export const staticElectricity: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-static-fc15', front: '電子を受け取ったので−に帯電した。ティッシュペーパーから電子が移動した', back: 'ストローをティッシュでこすると−に帯電した。電子はどちら→どちらに移動？', difficulty: 'basic' },
      { id: 'sci2-static-fc16', front: '反発し合う。同じ種類の電気（−と−）は反発する', back: '−に帯電したストローAと−に帯電したストローBを近づけるとどうなる？', difficulty: 'basic' },
      { id: 'sci2-static-fc17', front: '引き合う。異なる種類の電気（−と＋）は引き合う', back: '−に帯電したストローに＋に帯電した布を近づけるとどうなる？', difficulty: 'basic' },
      { id: 'sci2-static-fc18', front: '下じきと髪の毛が異なる種類の電気を帯びて引き合うため', back: '帯電した下じきで髪の毛が逆立つのはなぜ？', difficulty: 'basic' },
      { id: 'sci2-static-fc19', front: '2種類。＋の電気と−の電気', back: '電気の種類は何種類ある？', difficulty: 'basic' },
      { id: 'sci2-static-fc20', front: '通さない。非常に大きな電気がたまると放電が起きる', back: 'ふだん空気は電気を通すか？', difficulty: 'standard' },
      { id: 'sci2-static-fc21', front: '雲の中で氷の粒がぶつかり合い、摩擦で帯電するため', back: '雲の中で静電気がたまるのはなぜ？', difficulty: 'standard' },
      { id: 'sci2-static-fc22', front: '蛍光灯とネオンサイン', back: '真空放電が利用されている身近な製品を2つ答えよ', difficulty: 'standard' },
      { id: 'sci2-static-fc23', front: '気圧を低くすると放電が起こりやすくなる', back: '真空放電では管の中の気圧をどうすると放電が起こりやすい？', difficulty: 'standard' },
      { id: 'sci2-static-fc24', front: '蛍光板が光る。電子が蛍光物質にぶつかって発光する', back: 'クルックス管で蛍光板に陰極線が当たるとどうなる？', difficulty: 'standard' },
      { id: 'sci2-static-fc25', front: '十字形の影ができる。陰極線が直進する性質があるため', back: 'クルックス管に十字形の金属板を置くとどうなる？何がわかる？', difficulty: 'standard' },
      { id: 'sci2-static-fc26', front: '−極から＋極へ移動する', back: '導線の中で電子はどちらの極からどちらの極に移動する？', difficulty: 'standard' },
      { id: 'sci2-static-fc27', front: '＋極から−極へ流れると定められている', back: '電流の向きはどう定められている？', difficulty: 'standard' },
      { id: 'sci2-static-fc28', front: 'アンペア（A）', back: '電流の単位は何？', difficulty: 'basic' },
      { id: 'sci2-static-fc29', front: '放射性物質。ウランやラジウムなどがある', back: '放射線を出す物質を何という？', difficulty: 'advanced' },
      { id: 'sci2-static-fc30', front: 'β線はアルミニウムなどの金属板で遮れる', back: 'β線を遮るには何が必要？', difficulty: 'advanced' },
      { id: 'sci2-static-fc31', front: '透過性。目に見えず物質を透過する性質をもつ', back: '放射線が物質を通り抜ける性質を何という？', difficulty: 'advanced' },
      { id: 'sci2-static-fc32', front: '存在する（自然放射線）。宇宙や大地、食物からも微量出ている', back: '自然界にも放射線は存在する？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
