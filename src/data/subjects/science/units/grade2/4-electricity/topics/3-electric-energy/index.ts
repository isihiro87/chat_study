...
export const electricEnergy: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-ee-fc13', front: '光エネルギー・熱エネルギー・音エネルギー・運動エネルギー', back: '電気エネルギーはどのようなエネルギーに変換される？4つ答えよ', difficulty: 'basic' },
      { id: 'sci2-ee-fc14', front: '熱エネルギー', back: '電熱線は電気エネルギーをおもに何エネルギーに変換？', difficulty: 'basic' },
      { id: 'sci2-ee-fc15', front: '運動エネルギー', back: 'モーターは電気エネルギーをおもに何エネルギーに変換？', difficulty: 'basic' },
      { id: 'sci2-ee-fc16', front: '音エネルギー', back: 'スピーカーは電気エネルギーをおもに何エネルギーに変換？', difficulty: 'basic' },
      { id: 'sci2-ee-fc17', front: '消費電力。その電圧で使ったときの電力', back: '電気器具に表示されている電力のことを何という？', difficulty: 'standard' },
      { id: 'sci2-ee-fc18', front: '12.5Ω（100V÷8A＝12.5Ω）', back: '「100V-800W」と表示された電子レンジの抵抗は何Ω？', difficulty: 'standard' },
      { id: 'sci2-ee-fc19', front: '小さくなる（抵抗は断面積に反比例）', back: '電熱線が太いほど抵抗はどうなる？', difficulty: 'standard' },
      { id: 'sci2-ee-fc20', front: '大きくなる（抵抗が小さいため電流が大きくなる）', back: '同じ電圧で電熱線が太いほど流れる電流は？', difficulty: 'standard' },
      { id: 'sci2-ee-fc21', front: '1cal。水1gの温度を1℃上げるのに必要な熱量', back: '水1gを1℃上げるのに必要な熱量は何cal？', difficulty: 'standard' },
      { id: 'sci2-ee-fc22', front: '600Wの電熱線×300s＝180000J', back: '600Wの電熱線を5分間使った熱量は？', difficulty: 'standard' },
      { id: 'sci2-ee-fc23', front: '1000Wh（500W×2h）', back: '500Wの電気器具を2時間使った電力量は何Wh？', difficulty: 'standard' },
      { id: 'sci2-ee-fc24', front: '3600000J（3.6×10⁶J）', back: '1kWhは何J？', difficulty: 'advanced' },
      { id: 'sci2-ee-fc25', front: '0.6kWh（1200W×0.5h＝600Wh＝0.6kWh）', back: '1200Wのドライヤーを30分間使った電力量は何kWh？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
