...
export const circuitOhm: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-circuit-fc16', front: '回路図。電池・豆電球・スイッチなどを記号で表す', back: '回路を電気用図記号で表した図を何という？', difficulty: 'basic' },
      { id: 'sci2-circuit-fc17', front: '回路全体に電流が流れなくなり、すべての豆電球が消える', back: '直列回路で豆電球が1つ切れるとどうなる？', difficulty: 'basic' },
      { id: 'sci2-circuit-fc18', front: '他の枝の豆電球は点灯し続ける', back: '並列回路で豆電球が1つ切れるとどうなる？', difficulty: 'basic' },
      { id: 'sci2-circuit-fc19', front: 'V（ボルト）。電流を流そうとする力', back: '電圧の単位は？電圧とは何？', difficulty: 'basic' },
      { id: 'sci2-circuit-fc20', front: '＋極から−極に向かう向き', back: '電流の向きはどう定められている？', difficulty: 'basic' },
      { id: 'sci2-circuit-fc21', front: '500mA÷1000＝0.5A', back: '500mAは何A？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc22', front: '0.25A×1000＝250mA', back: '0.25Aは何mA？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc23', front: '＋極側（電流が流れ込む側）につなぐ', back: '電流計の＋端子はどこにつなぐ？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc24', front: '最大の端子（300V端子）からつなぐ。計器を壊さないため', back: '電圧計を使うとき最初にどの端子につなぐ？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc25', front: 'V＝R×I（電圧＝抵抗×電流）', back: 'オームの法則を式で表せ', difficulty: 'standard' },
      { id: 'sci2-circuit-fc26', front: 'I＝V÷R', back: 'オームの法則を電流について変形した式は？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc27', front: 'R＝V÷I', back: 'オームの法則を抵抗について変形した式は？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc28', front: 'オーム（記号：Ω）', back: '抵抗の単位は何？', difficulty: 'basic' },
      { id: 'sci2-circuit-fc29', front: 'V-Iグラフが原点を通る直線になる', back: 'オームの法則をグラフで表すとどうなる？', difficulty: 'standard' },
      { id: 'sci2-circuit-fc30', front: '抵抗の値が大きい。同じ電流を流すのに大きい電圧が必要', back: 'V-Iグラフの傾きが大きい抵抗器の抵抗値は？', difficulty: 'advanced' },
      { id: 'sci2-circuit-fc31', front: 'ニクロム線。物質の種類によって抵抗が異なる', back: '同じ長さ・太さの銅線とニクロム線でどちらの抵抗が大きい？', difficulty: 'advanced' },
      { id: 'sci2-circuit-fc32', front: '電流の通り道が一本道で抵抗が次々と加わるため', back: '直列回路で合成抵抗が各抵抗より大きくなる理由は？', difficulty: 'advanced' },
      { id: 'sci2-circuit-fc33', front: '電流の通り道が増えて全体として電流が流れやすくなるため', back: '並列回路の合成抵抗が各抵抗の値より小さくなる理由は？', difficulty: 'advanced' },
      { id: 'sci2-circuit-fc34', front: '発光ダイオード（LED）。逆向きにつなぐと光らない', back: '一方向にしか電流を流さない電子部品を何という？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
