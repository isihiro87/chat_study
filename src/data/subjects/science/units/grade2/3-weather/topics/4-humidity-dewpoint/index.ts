...
export const humidityDewpoint: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci2-hdew-fc1', front: '空気1m³中に含むことができる水蒸気の最大量（g/m³）', back: '飽和水蒸気量とは何？', explanation: '気温が高いほど空気は多くの水蒸気を含むことができます。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc2', front: '空気中の水蒸気が冷やされて水滴に変わり始める温度', back: '露点とは何？', explanation: '露点は空気中の水蒸気量と飽和水蒸気量が等しくなる温度です。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc3', front: '湿度（%）＝実際の水蒸気量÷飽和水蒸気量×100', back: '湿度を求める公式は？', explanation: '湿度は飽和水蒸気量に対する実際の水蒸気量の割合を百分率で表したものです。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc4', front: '水蒸気が冷やされて水滴に変わる現象', back: '凝結とは何？', explanation: '空気が露点以下に冷やされると含みきれなくなった水蒸気が水滴になります。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc5', front: '空気中の目に見えない気体状態の水', back: '水蒸気とは何？', explanation: '水蒸気は気体なので目に見えません。白く見える湯気は水滴です。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc6', front: '気温が高いほど飽和水蒸気量は大きくなる', back: '気温と飽和水蒸気量の関係は？', explanation: '温度が高いほど水分子の運動が活発になり、より多くの水蒸気を含めます。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc7', front: '金属製コップに水を入れ、氷水を少しずつ加えて冷やし、表面がくもり始めた温度を記録する', back: '露点の測定実験の手順は？', explanation: 'コップの表面がくもり始めた瞬間の温度が、その空気の露点です。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc8', front: '金属は熱伝導がよく、コップの水温と表面温度がほぼ同じになるため', back: '露点測定で金属製コップを使う理由は？', explanation: '熱伝導がよいとコップ内外の温度差が小さくなり、正確な露点が測れます。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc9', front: '露点での飽和水蒸気量＝実際の空気中の水蒸気量', back: '露点から実際の水蒸気量を求めるには？', explanation: '露点では湿度が100%なので、そのときの飽和水蒸気量が実際の水蒸気量と一致します。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc10', front: '100%（飽和水蒸気量＝水蒸気量の状態）', back: '露点での湿度は何%？', explanation: '露点では空気中の水蒸気量がちょうど飽和状態に達しています。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc11', front: '飽和水蒸気量が大きくなり、相対的に湿度が下がる', back: '気温が上昇して水蒸気量が変わらないと、湿度はなぜ下がる？', explanation: '湿度は飽和水蒸気量に対する割合なので、分母が大きくなれば値は小さくなります。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc12', front: '気温↑→湿度↓、気温↓→湿度↑（反対の動き）', back: '晴れた日の気温と湿度の関係は？', explanation: '晴れた日は水蒸気量があまり変わらず、気温の変化で飽和水蒸気量だけが変わるためです。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc13', front: '気温・湿度ともに変化が小さく、湿度は一日中高い', back: '雨の日の気温と湿度の変化の特徴は？', explanation: '雲に覆われて日射が弱く気温変化が小さいため、湿度も安定して高くなります。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc14', front: '冷たいコップの表面温度が露点以下になり、空気中の水蒸気が凝結するため', back: '冷水のコップの外側に水滴がつく理由は？', explanation: 'コップ表面付近の空気が冷やされて露点を下回り、水蒸気が水滴になります。', difficulty: 'advanced' },
      { id: 'sci2-hdew-fc15', front: '20℃：約17.3g/m³、10℃：約9.4g/m³', back: '20℃と10℃の飽和水蒸気量はそれぞれ約何g/m³？', explanation: '気温が10℃下がると飽和水蒸気量はほぼ半分近くまで減少します。', difficulty: 'advanced' },
      { id: 'sci2-hdew-fc16', front: '14時ごろ。気温が最高になり飽和水蒸気量が最大になるため', back: '晴れた日に湿度が最も低くなるのは何時ごろ？その理由は？', explanation: '気温が最も高くなる14時ごろに飽和水蒸気量が最大となり、相対湿度が最低になります。', difficulty: 'advanced' },
      { id: 'sci2-hdew-fc17', front: '大きくなる。気温が低い空気は少ない水蒸気しか含めない', back: '気温が低くなると飽和水蒸気量はどうなる？', explanation: '気温が下がると空気が含める水蒸気の上限が減り、飽和しやすくなります。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc18', front: '約17.3g/m³', back: '気温20℃のときの飽和水蒸気量はおよそ何g/m³？', explanation: '湿度計算でよく使う代表的な値なので覚えておくと便利です。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc19', front: '約9.4g/m³', back: '気温10℃のときの飽和水蒸気量はおよそ何g/m³？', explanation: '20℃の約17.3g/m³と比較すると、10℃下がるだけで大幅に減少します。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc20', front: 'くみ置きの水（室温程度の水）', back: '露点の測定実験でコップにまず何を入れる？', explanation: '室温程度の水を入れることで、初めはコップ表面がくもらない状態から実験を開始します。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc21', front: '氷水（または砕いた氷）を少しずつ加える', back: '露点の測定実験で水温を下げるために何をする？', explanation: '少しずつ加えることで温度をゆっくり下げ、くもり始める瞬間を正確にとらえます。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc22', front: 'そのときの水温を記録する。これが露点にあたる', back: '露点の測定実験でコップの表面がくもり始めたとき何を記録？', explanation: 'くもりは空気中の水蒸気が凝結した証拠で、そのときの温度が露点です。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc23', front: '湿度は上がる。分母の飽和水蒸気量が小さくなるため', back: '気温が下がり水蒸気量が変わらないと湿度は？', explanation: '水蒸気量が同じでも飽和水蒸気量が小さくなると割合が大きくなります。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc24', front: '飽和状態（水蒸気量＝飽和水蒸気量の状態）', back: '湿度が100%のとき空気はどのような状態？', explanation: '空気がそれ以上水蒸気を含むことができない飽和の状態です。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc25', front: '温度の差（示度の差）を利用する', back: '乾湿計は乾球と湿球の何の差で湿度を求める？', explanation: '蒸発のしやすさが湿度によって変わるため、温度差から湿度が求められます。', difficulty: 'standard' },
      { id: 'sci2-hdew-fc26', front: '湿度が高い。蒸発が少なく湿球の温度があまり下がらない', back: '乾湿計で温度差が小さいほど湿度は？', explanation: '空気中の水蒸気が多いと蒸発しにくくなり、湿球の温度低下が小さくなります。', difficulty: 'advanced' },
      { id: 'sci2-hdew-fc27', front: '午後2時ごろ（14時ごろ）', back: '晴れた日の気温は1日のうちいつごろ最も高くなる？', explanation: '太陽の南中（正午ごろ）から地面が温まり続け、約2時間後に気温が最高になります。', difficulty: 'basic' },
      { id: 'sci2-hdew-fc28', front: '約30.4g/m³', back: '気温30℃のときの飽和水蒸気量はおよそ何g/m³？', explanation: '30℃では20℃の約2倍の水蒸気を含むことができ、蒸し暑さの原因になります。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
