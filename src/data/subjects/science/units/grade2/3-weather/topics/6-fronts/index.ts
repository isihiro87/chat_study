...
export const fronts: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci2-frnt-fc1', front: '気温や湿度がほぼ一様な、大きな空気の塊', back: '気団とは何？', explanation: '気団は同じ場所に長時間とどまった空気が均一な性質をもつようになったものです。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc2', front: '異なる気団の境界面', back: '前線面とは何？', explanation: '性質の異なる気団はすぐには混じり合わず、明確な境界面ができます。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc3', front: '前線面と地表面が交わる線', back: '前線とは何？', explanation: '天気図上では前線として線で描かれ、天気が大きく変わるポイントになります。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc4', front: '寒気が暖気の下にもぐり込む。積乱雲が発達し、短時間の激しい雨', back: '寒冷前線の特徴は？（気団の動き・雲・雨の降り方）', explanation: '寒気が暖気を急激に押し上げるため、背の高い積乱雲ができ激しい雨になります。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc5', front: '暖気が寒気の上をゆるやかに這い上がる。乱層雲で広い範囲の弱い長雨', back: '温暖前線の特徴は？（気団の動き・雲・雨の降り方）', explanation: '暖気がゆるやかに上昇するため広範囲に雲ができ、弱い雨が長時間続きます。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc6', front: '暖気と寒気がほぼ同じ勢力でぶつかり、ほとんど動かない前線', back: '停滞前線とは何？', explanation: '梅雨前線や秋雨前線が停滞前線の代表例で、長期間天気がぐずつきます。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc7', front: '北寄りの風に変わり、気温が急激に低下する', back: '寒冷前線が通過した後の天気の変化は？', explanation: '寒冷前線通過後は寒気に覆われるため、急激に気温が下がります。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc8', front: '南寄りの風に変わり、気温が上昇する', back: '温暖前線が通過した後の天気の変化は？', explanation: '温暖前線通過後は暖気に覆われるため、気温が上昇します。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc9', front: '南東側に温暖前線、南西側に寒冷前線を伴う中緯度の低気圧', back: '温帯低気圧とは何？前線の位置は？', explanation: '温帯低気圧は異なる気団の境界で発生し、2種類の前線を伴います。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc10', front: '寒冷前線が温暖前線に追いつくとできる前線', back: '閉そく前線はどのようにできる？', explanation: '寒冷前線は移動速度が速く、やがて温暖前線に追いつきます。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc11', front: '暖気が上空に押し上げられ、温帯低気圧が衰退する', back: '閉そく前線ができると温帯低気圧はどうなる？', explanation: '暖気が地表から切り離されてエネルギーの供給が減り、低気圧が弱まります。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc12', front: '西から東へ移動する', back: '温帯低気圧の移動方向は？', explanation: '偏西風の影響で温帯低気圧は西から東へ移動します。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc13', front: '暖気は密度が小さいため寒気の上に乗り上げ、上昇して雲ができやすい', back: '前線付近で天気が変わりやすい理由は？', explanation: '暖気が上昇することで冷却され、水蒸気が凝結して雲や雨が生じます。', difficulty: 'advanced' },
      { id: 'sci2-frnt-fc14', front: '三角形が進行方向についた線', back: '寒冷前線の天気図記号は？', explanation: '三角形（くさび形）は寒気が暖気に突っ込むイメージを表しています。', difficulty: 'advanced' },
      { id: 'sci2-frnt-fc15', front: '半円が進行方向についた線', back: '温暖前線の天気図記号は？', explanation: '半円は暖気がゆるやかに上昇する様子を表しています。', difficulty: 'advanced' },
      { id: 'sci2-frnt-fc16', front: '三角形と半円が交互に並んだ線', back: '停滞前線の天気図記号は？', explanation: '寒気と暖気が互いに押し合って動かないため、両方の記号が交互に並びます。', difficulty: 'advanced' },
      { id: 'sci2-frnt-fc17', front: '密度が小さいため寒気の上に乗り上げる', back: '異なる気団がぶつかったとき暖気はどうなる？', explanation: '暖かい空気は密度が小さく軽いため、冷たい空気の上に押し上げられます。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc18', front: '寒気が暖気の下にもぐり込む前線', back: '寒冷前線とはどんな前線？', explanation: '冷たい空気が暖かい空気の下に潜り込み、暖気を急激に押し上げる前線です。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc19', front: '暖気が寒気の上をゆるやかに這い上がる前線', back: '温暖前線とはどんな前線？', explanation: '暖かい空気が冷たい空気の上をゆっくり這い上がるため、広範囲に雲が広がります。', difficulty: 'basic' },
      { id: 'sci2-frnt-fc20', front: '短時間に激しい雨（にわか雨）', back: '寒冷前線付近の雨の降り方は？', explanation: '暖気が急激に押し上げられ積乱雲が発達するため、激しい雨が短時間降ります。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc21', front: '広い範囲で弱い長雨', back: '温暖前線付近の雨の降り方は？', explanation: '暖気がゆるやかに上昇するため雲が広範囲に広がり、弱い雨が長く続きます。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc22', front: '暖気が上昇して雲ができやすいから', back: '前線付近で天気が変わりやすい理由は？', explanation: '前線では暖気が寒気の上に押し上げられ、上昇気流により雲が発生しやすくなります。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc23', front: '中緯度帯で発生し前線を伴う低気圧', back: '温帯低気圧とはどんな低気圧？', explanation: '熱帯で発生する台風と異なり、前線を伴うのが温帯低気圧の特徴です。', difficulty: 'standard' },
      { id: 'sci2-frnt-fc24', front: '寒冷前線のほうが速い。そのため温暖前線に追いつく', back: '寒冷前線と温暖前線の移動速度はどちらが速い？', explanation: '寒気は密度が大きく勢いよく進むため、寒冷前線のほうが移動速度が速くなります。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
