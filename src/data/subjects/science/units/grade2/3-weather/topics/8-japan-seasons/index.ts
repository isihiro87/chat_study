...
export const japanSeasons: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci2-jsea-fc1', front: '西高東低。西にシベリア高気圧、東に低気圧', back: '冬の日本の典型的な気圧配置は？', explanation: 'シベリア高気圧から冷たい北西の季節風が吹き、等圧線が縦じま状に並びます。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc2', front: '日本海側は大雪、太平洋側は乾燥した晴天', back: '冬の日本海側と太平洋側の天気の違いは？', explanation: '季節風が日本海で水蒸気を吸収して雪雲をつくり、山脈を越えると乾燥した風になります。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc3', front: '熱帯低気圧が発達し、最大風速が17m/s以上になったもの', back: '台風の定義は？', explanation: '台風は前線を伴わず、暖かい海の水蒸気をエネルギー源とする点で温帯低気圧と異なります。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc4', front: '初夏に停滞前線が日本付近に停滞し、長雨が続く時期', back: '梅雨とは何？', explanation: '小笠原気団とオホーツク海気団がぶつかって停滞前線ができ、長雨をもたらします。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc5', front: '移動性高気圧と低気圧が交互に通過し、天気が周期的に変化する', back: '春と秋の天気の特徴は？', explanation: '偏西風に乗って高気圧と低気圧が交互に通過するため、数日ごとに天気が変わります。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc6', front: '災害が予想される危険な地域を地図上に示したもの', back: 'ハザードマップとは何？', explanation: '洪水・土砂災害などの危険区域や避難経路を事前に確認するための地図です。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc7', front: '北西季節風→日本海で水蒸気吸収→山脈で上昇→雪雲が発達', back: '冬の日本海側に大雪が降るしくみは？', explanation: '暖流の対馬海流から蒸発した水蒸気を含んだ風が山脈にぶつかり雪雲になります。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc8', front: '太平洋高気圧に覆われ、南東の季節風で高温多湿', back: '夏の日本の天気の特徴は？', explanation: '太平洋の暖かく湿った空気が流れ込むため、蒸し暑い天気が続きます。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc9', front: '小笠原気団とオホーツク海気団がぶつかってできる停滞前線', back: '梅雨前線はどのようにできる？', explanation: '温暖湿潤な小笠原気団と寒冷湿潤なオホーツク海気団の勢力が拮抗して停滞します。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc10', front: '暖かい海の水蒸気', back: '台風のエネルギー源は何？', explanation: '暖かい海面から蒸発した水蒸気が凝結するときに放出する熱がエネルギー源です。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc11', front: '貿易風で西へ→北上→偏西風で東へカーブ', back: '台風の進路の特徴は？', explanation: '低緯度では貿易風に流されて西進し、中緯度に達すると偏西風に乗って東へ転向します。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc12', front: 'コンピュータで大気の状態をシミュレーションして天気を予報する方法', back: '数値予報とは何？', explanation: '膨大な観測データをもとに物理法則で大気の変化を計算し、将来の天気を予測します。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc13', front: '太平洋高気圧の勢力が弱まり、台風が北上しやすくなる。偏西風で東へ向きを変える', back: '秋に台風が日本に接近しやすくなる理由は？', explanation: '夏は太平洋高気圧が強く台風を西へ押しやりますが、秋は弱まり北上しやすくなります。', difficulty: 'advanced' },
      { id: 'sci2-jsea-fc14', front: '重大な災害が予想されるときに気象庁が発表する最も深刻な警報', back: '特別警報とは何？', explanation: '数十年に一度の重大な災害が予想される場合に発表され、直ちに命を守る行動が求められます。', difficulty: 'advanced' },
      { id: 'sci2-jsea-fc15', front: '夏の終わりから秋にかけて日本付近に停滞する前線。梅雨前線と同じしくみ', back: '秋雨前線とは何？', explanation: '小笠原気団の勢力が弱まり始め、再び北の気団との境目に停滞前線ができます。', difficulty: 'advanced' },
      { id: 'sci2-jsea-fc16', front: 'シベリア高気圧', back: '冬に西に位置する高気圧の名前は？', explanation: 'シベリアの大陸上で冷えた空気が集まり、非常に強い高気圧を形成します。', difficulty: 'basic' },
      { id: 'sci2-jsea-fc17', front: '太平洋上を通過するとき海から水蒸気を吸収するから', back: '夏に吹く南東の季節風が湿っている理由は？', explanation: '暖かい太平洋上を渡る間に大量の水蒸気を含むため、湿った風になります。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc18', front: '晴れ（高気圧→下降気流→晴れ）', back: '移動性高気圧が通過するとき天気は？', explanation: '高気圧の中心では下降気流が生じて雲ができにくく、晴れやすくなります。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc19', front: '台風の進路は高気圧の縁に沿い、春〜夏は西寄り、秋は北上して日本方面へ', back: '台風の進路は春から夏と秋でどう異なる？', explanation: '太平洋高気圧の勢力の変化により、台風が通過する経路が季節で異なります。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc20', front: '大雨による河川の氾濫、台風による暴風被害、土砂崩れ', back: '気象災害の例を3つ答えよ', explanation: '気象現象は大きな災害をもたらすことがあり、事前の備えが重要です。', difficulty: 'standard' },
      { id: 'sci2-jsea-fc21', front: '豊富な降水量による農業用水・生活用水の確保、水力発電', back: '気象現象がもたらすめぐみを2つ答えよ', explanation: '日本は降水量が多く、農業用水や生活用水、水力発電など多くの恩恵を受けています。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
