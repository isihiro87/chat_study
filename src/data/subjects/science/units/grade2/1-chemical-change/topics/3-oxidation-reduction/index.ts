...
export const oxidationReduction: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-or-fc29', front: '酸化鉄', back: '鉄が酸化してできる物質の名称は？', difficulty: 'basic' },
      { id: 'sci2-or-fc30', front: '酸化銅', back: '銅が酸化してできる物質の名称は？', difficulty: 'basic' },
      { id: 'sci2-or-fc31', front: '酸化マグネシウム', back: 'マグネシウムが酸化してできる物質の名称は？', difficulty: 'basic' },
      { id: 'sci2-or-fc32', front: '化合', back: '酸化は化学変化のうち、化合・分解のどちらに分類されるか？', difficulty: 'standard' },
      { id: 'sci2-or-fc33', front: '増加する', back: 'スチールウールを燃焼させた後、質量はどうなるか？', difficulty: 'basic' },
      { id: 'sci2-or-fc34', front: '流れない（流れにくい）', back: '鉄を燃焼させた後の物質に電気は流れるか？', difficulty: 'standard' },
      { id: 'sci2-or-fc35', front: '鉄は固体のまま酸素と反応し、気体にならないため', back: 'スチールウールが炎を出さず赤く光りながら燃える理由は？', difficulty: 'advanced' },
      { id: 'sci2-or-fc36', front: 'ガスバーナー', back: 'マグネシウムリボンに点火する際、何を使うか？', difficulty: 'basic' },
      { id: 'sci2-or-fc37', front: '強い光で目を傷める危険があるため', back: 'マグネシウムの燃焼実験で、直接光を見てはいけない理由は？', difficulty: 'standard' },
      { id: 'sci2-or-fc38', front: '黒色', back: '銅粉を空気中で加熱すると何色に変化するか？', difficulty: 'basic' },
      { id: 'sci2-or-fc39', front: '穏やかである', back: '銅の酸化は、マグネシウムの燃焼に比べて穏やかか激しいか？', difficulty: 'standard' },
      { id: 'sci2-or-fc40', front: '二酸化炭素', back: '炭素が酸素と結びつくとできる気体は？', difficulty: 'basic' },
      { id: 'sci2-or-fc41', front: '水', back: '水素が酸素と結びつくと何ができるか？', difficulty: 'basic' },
      { id: 'sci2-or-fc42', front: '石灰水に通して白くにごるか調べる', back: '有機物が燃焼した後に二酸化炭素が発生することを確認する方法は？', difficulty: 'standard' },
      { id: 'sci2-or-fc43', front: '炭素の粉末（炭素粉末）', back: '酸化銅の還元実験で、酸化銅と混ぜる物質は？', difficulty: 'basic' },
      { id: 'sci2-or-fc44', front: '酸化銅から酸素がうばわれる化学変化', back: '酸化銅の還元実験で酸化銅に起きた変化を説明せよ', difficulty: 'standard' },
      { id: 'sci2-or-fc45', front: '石灰水が逆流して試験管が割れるのを防ぐため', back: '還元実験後に加熱をやめるとき、ガラス管を石灰水から先に取り出す理由は？', difficulty: 'standard' },
      { id: 'sci2-or-fc46', front: '○（正しい）', back: '酸化銅から酸素を奪えるのは、炭素が銅よりも酸素と結びつきやすいからである。○か×か？', difficulty: 'advanced' },
      { id: 'sci2-or-fc47', front: '還元', back: '鉄鉱石から鉄を取り出す化学変化は、酸化と還元のどちらか？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
