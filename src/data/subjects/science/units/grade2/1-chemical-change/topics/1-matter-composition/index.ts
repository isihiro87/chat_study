...
export const matterComposition: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-mc-fc29', front: '電気分解', back: '電流を流して物質を分解することを何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc30', front: 'もたない（別の物質になる）', back: '分解によって生じた物質は、もとの物質と同じ性質をもつか？', difficulty: 'basic' },
      { id: 'sci2-mc-fc31', front: '白くにごる', back: '炭酸水素ナトリウムの熱分解で発生した気体を石灰水に通すとどうなる？', difficulty: 'basic' },
      { id: 'sci2-mc-fc32', front: '石灰水が白くにごる', back: '二酸化炭素が存在することを確認する方法は？', difficulty: 'basic' },
      { id: 'sci2-mc-fc33', front: '水', back: '塩化コバルト紙の色が青色から赤色に変化するのは何が存在するため？', difficulty: 'basic' },
      { id: 'sci2-mc-fc34', front: '濃い赤色（赤紫色）', back: '炭酸ナトリウムの水溶液にフェノールフタレイン溶液を加えると何色になる？', difficulty: 'standard' },
      { id: 'sci2-mc-fc35', front: 'うすい赤色（ほとんど変化しない）', back: '炭酸水素ナトリウムの水溶液にフェノールフタレイン溶液を加えると何色になる？', difficulty: 'standard' },
      { id: 'sci2-mc-fc36', front: '炭酸ナトリウム', back: '炭酸ナトリウムと炭酸水素ナトリウムでは、どちらがアルカリ性が強い？', difficulty: 'standard' },
      { id: 'sci2-mc-fc37', front: 'ガラス管を水中から取り出す（水の逆流を防ぐ）', back: '炭酸水素ナトリウムの加熱実験で、火を消す前にしなければならないことは？', difficulty: 'standard' },
      { id: 'sci2-mc-fc38', front: '黒色', back: '酸化銀は何色の粉末か？', difficulty: 'basic' },
      { id: 'sci2-mc-fc39', front: 'みがくと光る（金属光沢がある）、電流が流れる、たたくとのびる', back: '酸化銀の分解で残った白い物質が金属であることを確認する方法は？', difficulty: 'standard' },
      { id: 'sci2-mc-fc40', front: '激しく燃える（炎を出して燃える）', back: '酸素中に火のついた線香を入れるとどうなる？', difficulty: 'basic' },
      { id: 'sci2-mc-fc41', front: '陰極側（−極側）', back: '水の電気分解で、水素のほうが多く発生するのは陰極側と陽極側のどちら？', difficulty: 'basic' },
      { id: 'sci2-mc-fc42', front: '水酸化ナトリウム（少量）', back: '純粋な水は電気を通しにくい。電気分解するために何を水に溶かす？', difficulty: 'standard' },
      { id: 'sci2-mc-fc43', front: '2H₂O → 2H₂ + O₂', back: '水の電気分解を化学反応式で表すと？', difficulty: 'advanced' },
      { id: 'sci2-mc-fc44', front: 'できない', back: '原子は化学変化によってそれ以上分割できるか？', difficulty: 'basic' },
      { id: 'sci2-mc-fc45', front: '変わらない', back: '化学変化の前後で、原子の種類は変わるか？', difficulty: 'basic' },
      { id: 'sci2-mc-fc46', front: 'しない', back: '化学変化によって、原子が新しくできたりなくなったりするか？', difficulty: 'basic' },
      { id: 'sci2-mc-fc47', front: '元素', back: '原子の種類のことを何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc48', front: '約118種類', back: '現在確認されている元素はおよそ何種類か？', difficulty: 'standard' },
      { id: 'sci2-mc-fc49', front: '元素記号', back: '元素を記号で表したものを何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc50', front: '大文字', back: '元素記号のアルファベット1文字目は大文字か小文字か？', difficulty: 'basic' },
      { id: 'sci2-mc-fc51', front: '分子', back: 'いくつかの原子が結びついてできた粒子を何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc52', front: '2個', back: '水素分子は水素原子何個からできているか？', difficulty: 'basic' },
      { id: 'sci2-mc-fc53', front: '水素原子2個と酸素原子1個', back: '水分子は何原子何個と何原子何個からできているか？', difficulty: 'basic' },
      { id: 'sci2-mc-fc54', front: '化学式', back: '物質を元素記号で表した式を何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc55', front: '単体', back: '1種類の元素だけからできている物質を何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc56', front: '化合物', back: '2種類以上の元素からできている物質を何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc57', front: '単体', back: '水素（H₂）は単体か化合物か？', difficulty: 'basic' },
      { id: 'sci2-mc-fc58', front: '化合物', back: '水（H₂O）は単体か化合物か？', difficulty: 'basic' },
      { id: 'sci2-mc-fc59', front: '純粋な物質（純物質）', back: '1種類の物質だけからできているものを何という？', difficulty: 'basic' },
      { id: 'sci2-mc-fc60', front: '混合物', back: '2種類以上の物質が混じり合ったものを何という？', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
