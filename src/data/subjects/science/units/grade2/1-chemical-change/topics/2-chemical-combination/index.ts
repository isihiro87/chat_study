...
export const chemicalCombination: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-cc-fc29', front: '化合物', back: '化合によってできた物質を何という？', difficulty: 'basic' },
      { id: 'sci2-cc-fc30', front: '単体', back: '1種類の元素だけからなる物質を何という？', difficulty: 'basic' },
      { id: 'sci2-cc-fc31', front: '単体', back: '水素や酸素は単体か化合物か？', difficulty: 'basic' },
      { id: 'sci2-cc-fc32', front: '化合物', back: '水は単体か化合物か？', difficulty: 'basic' },
      { id: 'sci2-cc-fc33', front: '上部（上の方）', back: '鉄と硫黄の混合物を加熱するとき、試験管のどの部分を加熱するか？', difficulty: 'standard' },
      { id: 'sci2-cc-fc34', front: 'やめる（加熱を止める）', back: '混合物の上部が赤くなり始めたら、加熱をどうするか？', difficulty: 'basic' },
      { id: 'sci2-cc-fc35', front: '鉄粉は黒色（灰色がかった黒色）', back: '鉄粉は何色か？', difficulty: 'basic' },
      { id: 'sci2-cc-fc36', front: 'できる（鉄が磁石に引きつけられるため）', back: '鉄と硫黄の混合物は磁石で分けることができるか？', difficulty: 'standard' },
      { id: 'sci2-cc-fc37', front: 'Fe', back: '鉄の元素記号は？', difficulty: 'basic' },
      { id: 'sci2-cc-fc38', front: 'S', back: '硫黄の元素記号は？', difficulty: 'basic' },
      { id: 'sci2-cc-fc39', front: '水', back: '水素と酸素が化合するとできる物質は？', difficulty: 'basic' },
      { id: 'sci2-cc-fc40', front: '白くにごる', back: '二酸化炭素は石灰水に通すとどうなる？', difficulty: 'basic' },
      { id: 'sci2-cc-fc41', front: '左側', back: '化学反応式で、反応する前の物質はどちら側に書くか？', difficulty: 'basic' },
      { id: 'sci2-cc-fc42', front: '右側', back: '化学反応式で、反応してできた物質はどちら側に書くか？', difficulty: 'basic' },
      { id: 'sci2-cc-fc43', front: '2個', back: '化学反応式 2H₂ + O₂ → 2H₂O で、左辺の酸素原子は全部で何個か？', difficulty: 'standard' },
      { id: 'sci2-cc-fc44', front: 'Cu + S → CuS', back: '銅と硫黄の化合を化学式で表せ', difficulty: 'standard' },
      { id: 'sci2-cc-fc45', front: '二酸化炭素', back: '炭素が酸素中で燃えるとできる物質は？', difficulty: 'basic' },
      { id: 'sci2-cc-fc46', front: 'CuO', back: '銅を空気中で加熱すると何ができるか？その化学式は？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
