...
export const chemicalCombination: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-cc-fc3', front: '各原子の数', back: '化学反応式では、左辺と右辺で何が等しくなるようにする？', explanation: '化学変化で原子の種類と数は変わらないため', difficulty: 'basic' },
      { id: 'sci2-cc-fc4', front: '2H₂ + O₂ → 2H₂O', back: '水素の燃焼の化学反応式を書きなさい', explanation: '左辺H=4,O=2、右辺H=4,O=2で一致', difficulty: 'standard' },
      { id: 'sci2-cc-fc5', front: '異なる性質をもつ', back: '化合物はもとの物質と性質が同じか違うか？', explanation: '混合物はそれぞれの物質の性質を保っている', difficulty: 'basic' },
      { id: 'sci2-cc-fc6', front: '下部を加熱すると気体の逃げ場がなく試験管が破裂する危険があるため', back: '鉄と硫黄の混合物を加熱するとき、なぜ上部を加熱するのか？', explanation: '安全のため上部から反応を進める', difficulty: 'standard' },
      { id: 'sci2-cc-fc7', front: '発熱反応であり、反応自体が熱を出すため', back: '鉄と硫黄の化合で加熱をやめても反応が続くのはなぜ？', explanation: '反応熱が周囲の未反応部分に伝わり連鎖的に進む', difficulty: 'basic' },
      ...
      { id: 'sci2-cc-fc11', front: '硫化銅（CuS）。Cu + S → CuS', back: '銅と硫黄が化合するとできる物質と化学反応式は？', explanation: '銅と硫黄の化合でできる黒色の化合物', difficulty: 'standard' },
      { id: 'sci2-cc-fc12', front: '爆発的に反応して水（H₂O）ができる', back: '水素と酸素の混合気体に点火するとどうなる？', explanation: '水素は酸素と結びついて化合し水になる', difficulty: 'basic' },
      { id: 'sci2-cc-fc13', front: '分子の個数比', back: '化学反応式の係数は何を表している？', explanation: '2H₂ + O₂ → 2H₂O は水素分子2個：酸素分子1個：水分子2個', difficulty: 'standard' },
      { id: 'sci2-cc-fc14', front: '2H＝水素原子2個、2H₂＝水素分子2個（原子は合計4個）', back: '2Hと2H₂はそれぞれ何を表す？', explanation: '化学式の前の数字は分子の個数、右下の数字は原子の個数を表す', difficulty: 'standard' },
      { id: 'sci2-cc-fc15', front: 'Fe + S → FeS', back: '鉄と硫黄の化合の化学反応式を書きなさい', explanation: '左辺も右辺もFe=1,S=1で一致', difficulty: 'standard' },
      { id: 'sci2-cc-fc16', front: 'C + O₂ → CO₂', back: '炭素の燃焼の化学反応式を書きなさい', explanation: '炭素が酸素と化合して二酸化炭素が生じる', difficulty: 'standard' },
      { id: 'sci2-cc-fc17', front: '2Ag₂O → 4Ag + O₂', back: '酸化銀の分解の化学反応式を書きなさい', explanation: '加熱により酸化銀が銀と酸素に分解される', difficulty: 'advanced' },
      { id: 'sci2-cc-fc18', front: '2NaHCO₃ → Na₂CO₃ + CO₂ + H₂O', back: '炭酸水素ナトリウムの熱分解の化学反応式を書きなさい', explanation: '3種類の物質に分解される', difficulty: 'advanced' },
      { id: 'sci2-cc-fc19', front: '係数', back: '化学反応式で原子の数を合わせるために化学式の前につける数字を何という？', explanation: '係数が1のときは省略する', difficulty: 'basic' },
      { id: 'sci2-cc-fc20', front: '卵の腐った臭い', back: '硫化水素はどんなにおいがする？', explanation: '有毒な気体で少量でも刺激臭がある', difficulty: 'basic' },
      { id: 'sci2-cc-fc21', front: '淡い青色の炎', back: '水素は空気中で点火すると何色の炎を出して燃える？', explanation: '燃えると水（H₂O）ができる', difficulty: 'standard' },
      { id: 'sci2-cc-fc22', front: 'CuS', back: '硫化銅の化学式は？', explanation: '銅と硫黄が1:1で結びついた化合物', difficulty: 'standard' },
      { id: 'sci2-cc-fc23', front: '2Cu + O₂ → 2CuO', back: '銅の酸化の化学反応式を書きなさい', explanation: '銅が酸素と結びつき黒色の酸化銅になる', difficulty: 'standard' },
      { id: 'sci2-cc-fc24', front: '黒色', back: '銅を空気中で加熱してできる酸化銅は何色？', explanation: '赤色の銅が酸化されると黒色に変化する', difficulty: 'basic' },
      { id: 'sci2-cc-fc25', front: '黄色', back: '硫黄の粉末は何色？', explanation: '非金属元素で独特のにおいがある', difficulty: 'basic' },
      { id: 'sci2-cc-fc26', front: '化合前は鉄が磁石で分離できるが、化合後の硫化鉄は分離できない', back: '鉄と硫黄の混合物と化合後の硫化鉄を磁石で見分ける方法は？', explanation: '化合すると性質が変わることを示す', difficulty: 'standard' },
      { id: 'sci2-cc-fc27', front: '水滴がつく', back: '水素が燃えた後、容器の内側はどうなる？なぜ？', explanation: '水素と酸素が化合して水ができるため', difficulty: 'advanced' },
      { id: 'sci2-cc-fc28', front: '係数1は省略する', back: '化学反応式で係数が1のとき、どうする？', explanation: '例：C + O₂ → CO₂ のCやCO₂の前には1を書かない', difficulty: 'basic' },
      { id: 'sci2-cc-fc29', front: '化合物', back: '化合によってできた物質を何という？', explanation: '2種類以上の元素が結びついた物質', difficulty: 'basic' },
      { id: 'sci2-cc-fc30', front: '単体', back: '1種類の元素だけからなる物質を何という？', explanation: '例：H₂、O₂、Fe、Cu', difficulty: 'basic' },
      { id: 'sci2-cc-fc31', front: '単体', back: '水素や酸素は単体か化合物か？', explanation: 'それぞれ1種類の元素のみからできている', difficulty: 'basic' },
      { id: 'sci2-cc-fc32', front: '化合物', back: '水は単体か化合物か？', explanation: '水素と酸素の2種類の元素からできている', difficulty: 'basic' },
      { id: 'sci2-cc-fc33', front: '上部（上の方）', back: '鉄と硫黄の混合物を加熱するとき、試験管のどの部分を加熱するか？', explanation: '下部を加熱すると気体の逃げ場がなく破裂の危険がある', difficulty: 'standard' },
      { id: 'sci2-cc-fc34', front: 'やめる（加熱を止める）', back: '混合物の上部が赤くなり始めたら、加熱をどうするか？', explanation: '発熱反応なので一度始まると反応自体の熱で進み続ける', difficulty: 'basic' },
      { id: 'sci2-cc-fc35', front: '鉄粉は黒色（灰色がかった黒色）', back: '鉄粉は何色か？', explanation: '硫黄（黄色）と混ぜると色で区別できる', difficulty: 'basic' },
      { id: 'sci2-cc-fc36', front: 'できる（鉄が磁石に引きつけられるため）', back: '鉄と硫黄の混合物は磁石で分けることができるか？', explanation: '混合物の状態では鉄の性質が残っている', difficulty: 'standard' },
      { id: 'sci2-cc-fc37', front: 'Fe', back: '鉄の元素記号は？', explanation: 'ラテン語のFerrumに由来', difficulty: 'basic' },
      { id: 'sci2-cc-fc38', front: 'S', back: '硫黄の元素記号は？', explanation: 'ラテン語のSulfurに由来', difficulty: 'basic' },
      { id: 'sci2-cc-fc39', front: '水', back: '水素と酸素が化合するとできる物質は？', explanation: '2H₂ + O₂ → 2H₂O', difficulty: 'basic' },
      { id: 'sci2-cc-fc40', front: '白くにごる', back: '二酸化炭素は石灰水に通すとどうなる？', explanation: '炭酸カルシウムの白い沈殿が生じる', difficulty: 'basic' },
      { id: 'sci2-cc-fc41', front: '左側', back: '化学反応式で、反応する前の物質はどちら側に書くか？', explanation: '→の左側が反応物、右側が生成物', difficulty: 'basic' },
      { id: 'sci2-cc-fc42', front: '右側', back: '化学反応式で、反応してできた物質はどちら側に書くか？', explanation: '→の右側に生成物を書く', difficulty: 'basic' },
      { id: 'sci2-cc-fc43', front: '2個', back: '化学反応式 2H₂ + O₂ → 2H₂O で、左辺の酸素原子は全部で何個か？', explanation: 'O₂は酸素原子2個からなる分子', difficulty: 'standard' },
      { id: 'sci2-cc-fc44', front: 'Cu + S → CuS', back: '銅と硫黄の化合を化学式で表せ', explanation: '銅と硫黄が1:1で結びつく', difficulty: 'standard' },
      { id: 'sci2-cc-fc45', front: '二酸化炭素', back: '炭素が酸素中で燃えるとできる物質は？', explanation: 'C + O₂ → CO₂', difficulty: 'basic' },
      { id: 'sci2-cc-fc46', front: 'CuO', back: '銅を空気中で加熱すると何ができるか？その化学式は？', explanation: '銅が酸素と化合（酸化）して黒色の酸化銅になる', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
        ...
        {
          id: 'sci2-cc-q29',
          question: '化合と分解の違いとして正しいものは？',
          options: [
            '化合は1種類が2種類以上に、分解は2種類以上が1種類に',
            '化合は2種類以上が結びつき、分解は1種類が2種類以上に分かれる',
            '化合も分解も同じ意味',
            '化合は物理変化、分解は化学変化',
          ],
          correctIndex: 1,
          explanation: '化合は2種類以上の物質が結びついて1種類の新しい物質ができる変化。分解は1種類の物質が2種類以上に分かれる変化です。',
          difficulty: 'standard',
        },
        {
          id: 'sci2-cc-q30',
          question: 'マグネシウムの燃焼の化学反応式は？',
          options: ['Mg + O₂ → MgO₂', '2Mg + O₂ → 2MgO', 'Mg + O → MgO', 'Mg₂ + O₂ → 2MgO'],
          correctIndex: 1,
          explanation: '2Mg + O₂ → 2MgO が正しい化学反応式です。',
          difficulty: 'advanced',
        },
        {
          id: 'sci2-cc-q31',
          question: '化学反応式で化学式の右下の数字を変えてはいけない理由は？',
          options: [
            '見にくくなるから',
            '数字が小さいから',
            '別の物質になってしまうから',
          ...
          correctIndex: 2,
          explanation: '化学式の右下の数字は物質そのものの構成を表すため、変えると別の物質になります。係数だけを変えて数を合わせます。',
          difficulty: 'advanced',
        },
        {
          id: 'sci2-cc-q32',
          question: '次のうち化合物をすべて含む選択肢は？',
          options: ['銅と硫黄', '水と硫化鉄', '酸素と炭素', '水素と鉄'],
          correctIndex: 1,
          explanation: '水（H₂O）と硫化鉄（FeS）は2種類以上の元素からなる化合物です。他は単体の組み合わせです。',
          difficulty: 'advanced',
        },
      ],
    },
