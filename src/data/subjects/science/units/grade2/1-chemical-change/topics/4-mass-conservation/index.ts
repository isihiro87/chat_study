...
export const massConservation: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-mcon-fc2', front: '銅:酸素 = 4:1', back: '銅と酸素が結びつくときの質量の比は？', explanation: '銅4gに対し酸素1gが結びつき酸化銅5gになる', difficulty: 'basic' },
      { id: 'sci2-mcon-fc3', front: 'マグネシウム:酸素 = 3:2', back: 'マグネシウムと酸素が結びつくときの質量の比は？', explanation: 'Mg3gに対し酸素2gが結びつきMgO5gになる', difficulty: 'basic' },
      { id: 'sci2-mcon-fc4', front: '密閉容器で実験する', back: '気体が発生する化学変化で質量保存を確認するにはどうする？', explanation: '気体が逃げると見かけの質量が変わってしまうため', difficulty: 'basic' },
      { id: 'sci2-mcon-fc5', front: '原子の質量は種類ごとに決まっており、一定の比で結びつくから', back: '化学変化する物質が一定の質量比で結びつくのはなぜ？', explanation: 'これを定比例の法則（プルースト）という', difficulty: 'standard' },
      { id: 'sci2-mcon-fc6', front: 'ラボアジエ', back: '質量保存の法則を発見したフランスの科学者は？', explanation: '18世紀に精密な実験で法則を確立した', difficulty: 'basic' },
      { id: 'sci2-mcon-fc7', front: '変わらない', back: '硫酸と塩化バリウム水溶液を混ぜて沈殿ができたとき、全体の質量は？', explanation: '沈殿（硫酸バリウム）ができても質量は保存される', difficulty: 'basic' },
      { id: 'sci2-mcon-fc8', front: '変わらない', back: '炭酸水素ナトリウムと塩酸を密閉容器で反応させると質量はどうなる？', explanation: '開放容器だとCO₂が逃げて減る', difficulty: 'basic' },
      { id: 'sci2-mcon-fc9', front: '空気中の酸素が銅と結びつくため', back: '銅の粉末を空気中で加熱すると質量が増えるのはなぜ？', explanation: '質量保存の法則が成り立ち、結合した酸素分が加わる', difficulty: 'basic' },
      { id: 'sci2-mcon-fc10', front: 'すべての銅が酸化銅になり、これ以上酸素と反応できないから', back: '銅の粉末を何度も加熱するとやがて質量が一定になるのはなぜ？', explanation: '未反応の銅がなくなるとそれ以上反応しない', difficulty: 'standard' },
      ...
      { id: 'sci2-mcon-fc13', front: '鉄:硫黄 = 7:4', back: '鉄と硫黄が結びつくときの質量の比は？', explanation: '鉄7gと硫黄4gで硫化鉄11gができる', difficulty: 'standard' },
      ...
      { id: 'sci2-mcon-fc16', front: 'すべての銅が酸化されたこと', back: '銅の加熱回数と質量のグラフで、質量が一定になった部分は何を意味する？', explanation: '反応しきれる銅がなくなるとそれ以上反応しない', difficulty: 'standard' },
      { id: 'sci2-mcon-fc17', front: '発生した二酸化炭素が空気中に逃げるため', back: '炭酸水素ナトリウムと塩酸を開放容器で反応させると質量が減って見えるのはなぜ？', explanation: '密閉容器で行えば質量は保存される', difficulty: 'standard' },
      { id: 'sci2-mcon-fc18', front: '変わらない', back: '砂糖を水に溶かしたとき全体の質量は変わるか？', explanation: '物理変化（溶解）でも質量保存は成り立つ', difficulty: 'basic' },
      { id: 'sci2-mcon-fc19', front: '質量保存の法則', back: '化学変化の前後で物質全体の質量が変わらない法則は？', explanation: 'ラボアジエが発見。原子が増減しないため成り立つ', difficulty: 'basic' },
      { id: 'sci2-mcon-fc20', front: '定比例の法則', back: '反応する物質の質量比が一定である法則は？', explanation: '原子の種類ごとに質量が決まっているため一定比になる', difficulty: 'standard' },
      { id: 'sci2-mcon-fc21', front: 'プルースト', back: '定比例の法則を提唱した科学者は？', explanation: 'フランスの化学者が18世紀末に提唱', difficulty: 'advanced' },
      ...
      { id: 'sci2-mcon-fc24', front: '発生した気体が空気中に逃げるため', back: '気体発生反応をふたなし容器で行うと質量が減って見える理由は？', explanation: '気体を含めた全体の質量は保存されている', difficulty: 'standard' },
      { id: 'sci2-mcon-fc25', front: '空気中の酸素と結びついた分だけ増加', back: 'スチールウール燃焼後に質量が増加する理由は？', explanation: '鉄＋酸素→酸化鉄。酸素の分だけ重くなる', difficulty: 'basic' },
      { id: 'sci2-mcon-fc26', front: '赤色から黒色に変わる', back: '銅粉を加熱すると色はどう変わる？', explanation: '銅が酸化されて酸化銅（CuO）になるため', difficulty: 'basic' },
      { id: 'sci2-mcon-fc27', front: '金属全体を空気中の酸素とまんべんなく反応させるため', back: '金属粉末を何回も加熱を繰り返す理由は？', explanation: '1回の加熱では内部まで反応しきれない', difficulty: 'standard' },
      ...
      { id: 'sci2-mcon-fc29', front: '状態変化（すべての変化に成り立つ）', back: '質量保存の法則は、化学変化だけでなく何にも成り立つか？', explanation: '溶解や状態変化などすべての変化に成り立つ', difficulty: 'standard' },
      { id: 'sci2-mcon-fc30', front: '硫酸バリウム', back: 'うすい硫酸と塩化バリウム水溶液を混ぜるとできる白い沈殿は？', explanation: '水に溶けにくい物質が生じる反応', difficulty: 'standard' },
      { id: 'sci2-mcon-fc31', front: '二酸化炭素', back: '炭酸水素ナトリウムとうすい塩酸を混ぜたとき発生する気体は？', explanation: '開放容器ではこの気体が逃げて質量が減って見える', difficulty: 'basic' },
      { id: 'sci2-mcon-fc32', front: '発生した気体が逃げないようにして質量保存の法則を確認するため', back: '気体が発生する反応を密閉容器で行う理由は？', explanation: '気体を含めた全体の質量を正確に測るため', difficulty: 'standard' },
      { id: 'sci2-mcon-fc33', front: '減少する', back: 'ふたのない容器で気体が発生する反応を行うと、反応後の質量はどうなるか？', explanation: '発生した気体が空気中に逃げるため見かけ上減少する', difficulty: 'basic' },
      { id: 'sci2-mcon-fc34', front: '成り立っている（逃げた気体の質量を含めれば全体の質量は変わらない）', back: '開放系で質量が減少したように見えても、質量保存の法則は成り立っているか？', explanation: '逃げた気体も含めれば全体の質量は変わらない', difficulty: 'standard' },
      { id: 'sci2-mcon-fc35', front: '酸化銅', back: '銅の粉末を加熱すると何という物質になるか？', explanation: '化学式CuO。黒色の粉末になる', difficulty: 'basic' },
      { id: 'sci2-mcon-fc36', front: '酸化マグネシウム', back: 'マグネシウムを加熱すると何という物質になるか？', explanation: '化学式MgO。白色の粉末になる', difficulty: 'basic' },
      { id: 'sci2-mcon-fc37', front: '銀白色から白色になる', back: 'マグネシウムを加熱すると色はどのように変化するか？', explanation: '酸化マグネシウム（MgO）は白色の粉末', difficulty: 'standard' },
      { id: 'sci2-mcon-fc38', front: 'すべての金属を酸素と反応させるため（反応しきれていない金属を残さないため）', back: '金属の粉末を加熱する実験で、何回も加熱をくり返す理由は？', explanation: '1回では内部の金属が反応しきれない', difficulty: 'standard' },
      { id: 'sci2-mcon-fc39', front: '空気と触れる面を増やし、すべての金属を酸素と反応させるため', back: '金属の粉末を加熱するとき、かき混ぜながら加熱するのはなぜ？', explanation: '空気に触れていない粉末も酸素と反応させる', difficulty: 'standard' },
      { id: 'sci2-mcon-fc40', front: '空気中に逃げた二酸化炭素の質量', back: '炭酸水素ナトリウムと塩酸の反応で質量が減少した分は何の質量に相当するか？', explanation: '密閉容器なら質量は保存されている', difficulty: 'standard' },
      { id: 'sci2-mcon-fc41', front: '3.0g', back: '酸化マグネシウム5.0gに含まれるマグネシウムの質量は？（Mg:MgO=3:5）', explanation: '5.0×3/5=3.0g。酸素は2.0g', difficulty: 'advanced' },
      { id: 'sci2-mcon-fc42', front: '2.5g', back: '銅2.0gを完全に酸化させると酸化銅は何gできるか？（銅:酸素=4:1）', explanation: '酸素=0.5g、CuO=2.0+0.5=2.5g', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
