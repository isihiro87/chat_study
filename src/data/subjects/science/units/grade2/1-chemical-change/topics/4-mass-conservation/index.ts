...
export const massConservation: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-mcon-fc29', front: '状態変化（すべての変化に成り立つ）', back: '質量保存の法則は、化学変化だけでなく何にも成り立つか？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc30', front: '硫酸バリウム', back: 'うすい硫酸と塩化バリウム水溶液を混ぜるとできる白い沈殿は？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc31', front: '二酸化炭素', back: '炭酸水素ナトリウムとうすい塩酸を混ぜたとき発生する気体は？', difficulty: 'basic' },
      { id: 'sci2-mcon-fc32', front: '発生した気体が逃げないようにして質量保存の法則を確認するため', back: '気体が発生する反応を密閉容器で行う理由は？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc33', front: '減少する', back: 'ふたのない容器で気体が発生する反応を行うと、反応後の質量はどうなるか？', difficulty: 'basic' },
      { id: 'sci2-mcon-fc34', front: '成り立っている（逃げた気体の質量を含めれば全体の質量は変わらない）', back: '開放系で質量が減少したように見えても、質量保存の法則は成り立っているか？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc35', front: '酸化銅', back: '銅の粉末を加熱すると何という物質になるか？', difficulty: 'basic' },
      { id: 'sci2-mcon-fc36', front: '酸化マグネシウム', back: 'マグネシウムを加熱すると何という物質になるか？', difficulty: 'basic' },
      { id: 'sci2-mcon-fc37', front: '銀白色から白色になる', back: 'マグネシウムを加熱すると色はどのように変化するか？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc38', front: 'すべての金属を酸素と反応させるため（反応しきれていない金属を残さないため）', back: '金属の粉末を加熱する実験で、何回も加熱をくり返す理由は？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc39', front: '空気と触れる面を増やし、すべての金属を酸素と反応させるため', back: '金属の粉末を加熱するとき、かき混ぜながら加熱するのはなぜ？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc40', front: '空気中に逃げた二酸化炭素の質量', back: '炭酸水素ナトリウムと塩酸の反応で質量が減少した分は何の質量に相当するか？', difficulty: 'standard' },
      { id: 'sci2-mcon-fc41', front: '3.0g', back: '酸化マグネシウム5.0gに含まれるマグネシウムの質量は？（Mg:MgO=3:5）', difficulty: 'advanced' },
      { id: 'sci2-mcon-fc42', front: '2.5g', back: '銅2.0gを完全に酸化させると酸化銅は何gできるか？（銅:酸素=4:1）', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
