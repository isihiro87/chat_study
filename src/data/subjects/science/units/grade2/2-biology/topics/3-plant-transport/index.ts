...
export const plantTransport: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-pt-fc29', front: '酸性（二酸化炭素が多い）', back: 'BTB溶液が黄色のとき、液性は何か？', difficulty: 'basic' },
      { id: 'sci2-pt-fc30', front: '中性', back: 'BTB溶液が緑色のとき、液性は何か？', difficulty: 'basic' },
      { id: 'sci2-pt-fc31', front: 'アルカリ性（二酸化炭素が少ない）', back: 'BTB溶液が青色のとき、液性は何か？', difficulty: 'basic' },
      ...
      { id: 'sci2-pt-fc34', front: '気泡（酸素の泡）', back: '水草（オオカナダモ）に光を当てると何が発生するか？', difficulty: 'basic' },
      { id: 'sci2-pt-fc35', front: '気孔をふさいで蒸散を防ぎ、蒸散量を比較するため', back: '蒸散の実験でワセリンを葉に塗る目的は？', difficulty: 'standard' },
      { id: 'sci2-pt-fc36', front: '水面からの蒸発を防ぎ、蒸散による水の減少量だけを正確に測るため', back: '蒸散の実験で水面に油を浮かべるのはなぜ？', difficulty: 'standard' },
      { id: 'sci2-pt-fc37', front: '輪の形（環状）に並んでいる', back: '双子葉類の茎の維管束はどのように並んでいるか？', difficulty: 'standard' },
      { id: 'sci2-pt-fc38', front: '散らばっている（ばらばらに分布）', back: '単子葉類の茎の維管束はどのように並んでいるか？', difficulty: 'standard' },
      { id: 'sci2-pt-fc39', front: '網目状（網状脈）', back: '双子葉類の葉脈はどのような形か？', difficulty: 'standard' },
      { id: 'sci2-pt-fc40', front: '平行（平行脈）', back: '単子葉類の葉脈はどのような形か？', difficulty: 'standard' },
      { id: 'sci2-pt-fc41', front: '根の表面積が大きくなり、水や水にとけた無機物を効率よく吸収できる', back: '根毛があることの利点は？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
