...
export const animalBody: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci2-animal-fc1', front: '口→食道→胃→小腸→大腸→肛門', back: '食物が通る消化管を口から順に答えよ', explanation: '食物は消化管を通りながら消化・吸収される', difficulty: 'basic' },
      { id: 'sci2-animal-fc2', front: 'アミラーゼ', back: 'だ液に含まれる消化酵素で、デンプンを麦芽糖に分解するものは？', explanation: '体温付近（約37℃）で最もよくはたらく', difficulty: 'basic' },
      { id: 'sci2-animal-fc3', front: '胆汁', back: '肝臓で作られ、消化酵素を含まないが脂肪の分解を助ける液は？', explanation: '胆のうにためられる', difficulty: 'basic' },
      { id: 'sci2-animal-fc4', front: '柔毛', back: '小腸の壁にある養分の吸収を効率よくするための突起を何という？', explanation: '表面積を大きくして効率よく養分を吸収する', difficulty: 'basic' },
      { id: 'sci2-animal-fc5', front: '肺胞', back: '肺の中にある小さなふくろで気体の交換を行う場所は？', explanation: '表面積が大きく効率よく気体交換', difficulty: 'basic' },
      { id: 'sci2-animal-fc6', front: '体循環＝心臓→全身→心臓、肺循環＝心臓→肺→心臓', back: '心臓からの2つの血液循環の経路を答えよ', explanation: '体循環は左心室から、肺循環は右心室から出発', difficulty: 'basic' },
      { id: 'sci2-animal-fc7', front: '赤血球（ヘモグロビン）', back: '血液の成分で酸素を運ぶはたらきをするものは？', explanation: 'ヘモグロビンが酸素と結びつき全身に運ぶ', difficulty: 'basic' },
      { id: 'sci2-animal-fc8', front: '肝臓＝アンモニアを尿素に変える、腎臓＝尿を作る', back: 'アンモニアを尿素に変える器官と尿を作る器官をそれぞれ答えよ', explanation: '有害なアンモニアを無害な尿素に変えてから排出する', difficulty: 'basic' },
      { id: 'sci2-animal-fc9', front: 'ベネジクト液', back: '麦芽糖やブドウ糖の検出に使い、加熱すると赤褐色に変化する試薬は？', explanation: '糖の有無を調べる代表的な試薬', difficulty: 'basic' },
      { id: 'sci2-animal-fc10', front: '体温に近い温度で消化酵素がよくはたらくため', back: 'だ液の消化実験で約37℃に保温する理由は？', explanation: '酵素には最適温度があり体温付近で最も活発', difficulty: 'basic' },
      { id: 'sci2-animal-fc11', front: 'アミラーゼ、トリプシン、リパーゼ', back: 'すい液に含まれる消化酵素を3つ答えよ', explanation: '3大栄養素すべてを分解できる', difficulty: 'standard' },
      { id: 'sci2-animal-fc12', front: '①グリコーゲンの貯蔵・放出 ②アンモニア→尿素 ③胆汁の生成', back: '肝臓のはたらきを3つ答えよ', explanation: '肝臓は「体内の化学工場」と呼ばれ、多くの化学変化を担う重要な臓器。', difficulty: 'standard' },
      { id: 'sci2-animal-fc13', front: '横隔膜が下がり胸腔が広がって肺がふくらむ', back: '息を吸うとき横隔膜はどう動くか？', explanation: '吐くときは横隔膜が上がり肺がしぼむ', difficulty: 'standard' },
      { id: 'sci2-animal-fc14', front: '動脈血＝O₂多く鮮やかな赤、静脈血＝CO₂多く暗い赤', back: '動脈血と静脈血の違いは？', explanation: 'ヘモグロビンと酸素の結合状態で色が変わる', difficulty: 'standard' },
      { id: 'sci2-animal-fc15', front: '血液の逆流を防ぐ', back: '心臓の弁のはたらきは何か？', explanation: '血液が一方向にだけ流れるようにする', difficulty: 'standard' },
      { id: 'sci2-animal-fc16', front: '動脈＝壁厚く弾力、静脈＝壁薄く弁あり、毛細血管＝1層の薄い壁で物質交換', back: '血管を3種類答え、それぞれの特徴を述べよ', explanation: '毛細血管で酸素・養分と老廃物の交換が行われる', difficulty: 'standard' },
      { id: 'sci2-animal-fc17', front: '組織液', back: '血しょうの一部が毛細血管からしみ出てできた液を何という？', explanation: '細胞と血液の間で物質のやり取りをする', difficulty: 'standard' },
      { id: 'sci2-animal-fc18', front: '炭水化物、タンパク質、脂肪', back: '食物に含まれる有機物の3大栄養素は何か？', explanation: 'それぞれ消化酵素で最終的にブドウ糖・アミノ酸・脂肪酸等に分解される', difficulty: 'basic' },
      { id: 'sci2-animal-fc19', front: '消化されなかった食物から水分を吸収する', back: '大腸の主なはたらきは何か？', explanation: '残りかすは便として排出される', difficulty: 'standard' },
      { id: 'sci2-animal-fc20', front: '二酸化炭素', back: '吸う息と比べて吐く息に多く含まれる気体は？', explanation: '肺胞で血液中のCO₂が放出されるため', difficulty: 'basic' },
      { id: 'sci2-animal-fc21', front: '腎臓', back: '血液から不要物をこし取り尿をつくる器官は？', explanation: '背中側に左右1つずつあるそら豆形の器官', difficulty: 'basic' },
      { id: 'sci2-animal-fc22', front: '輸尿管', back: '腎臓からぼうこうへ尿を運ぶ管は？', explanation: '腎臓でつくられた尿をぼうこうまで送る', difficulty: 'standard' },
      { id: 'sci2-animal-fc23', front: '胆のう', back: '胆汁が蓄えられる器官は？', explanation: '肝臓で作られた胆汁をためておく', difficulty: 'standard' },
      { id: 'sci2-animal-fc24', front: 'ヘモグロビン', back: '赤血球に含まれO₂と結びつく赤い色素は？', explanation: '酸素の多いところで結合し少ないところで放す', difficulty: 'standard' },
      { id: 'sci2-animal-fc25', front: '吸気時は下がり、呼気時は上がる', back: '横隔膜は吸うとき・吐くときそれぞれどう動く？', explanation: '横隔膜が下がると胸腔が広がり肺がふくらむ', difficulty: 'standard' },
      { id: 'sci2-animal-fc26', front: '血小板', back: '出血時に血液を固めるはたらきをする血液の成分は？', explanation: '傷口で血液を固めて止血する', difficulty: 'standard' },
      { id: 'sci2-animal-fc27', front: 'グリコーゲン', back: 'ブドウ糖は肝臓で何として蓄えられる？', explanation: '必要に応じてブドウ糖に分解され血液中に放出される', difficulty: 'advanced' },
      { id: 'sci2-animal-fc28', front: '毛細血管→肝臓（ブドウ糖・アミノ酸）、リンパ管（脂肪）', back: '柔毛で吸収された養分の2つの吸収経路を答えよ', explanation: '水溶性と脂溶性で吸収経路が異なる', difficulty: 'advanced' },
      { id: 'sci2-animal-fc29', front: '消化', back: '食物を細かく分解して体内に吸収しやすい形にするはたらきを何という？', explanation: '消化管と消化液のはたらきによって行われる', difficulty: 'basic' },
      { id: 'sci2-animal-fc30', front: '消化酵素', back: '消化液に含まれ、食物を化学的に分解するはたらきをもつものを何という？', explanation: '体温付近で最もよくはたらくタンパク質の一種', difficulty: 'basic' },
      { id: 'sci2-animal-fc31', front: 'ペプシン', back: '胃液に含まれる消化酵素で、タンパク質を分解するものは？', explanation: '胃液の塩酸（強酸性）の環境でよくはたらく', difficulty: 'standard' },
      { id: 'sci2-animal-fc32', front: 'ヨウ素液', back: 'だ液の実験で、デンプンが分解されたかどうかを調べるために使う薬品は？', explanation: 'デンプンがあれば青紫色に変化する', difficulty: 'basic' },
      { id: 'sci2-animal-fc33', front: '糖（麦芽糖やブドウ糖など）', back: 'ベネジクト液は何に反応するか？', explanation: '加熱すると赤褐色の沈殿ができる', difficulty: 'basic' },
      { id: 'sci2-animal-fc34', front: '水', back: 'だ液の実験で対照実験として、だ液の代わりに何を加えたものを用意するか？', explanation: 'だ液の有無だけを変える対照実験にするため', difficulty: 'standard' },
      { id: 'sci2-animal-fc35', front: 'ブドウ糖', back: 'デンプンが消化されると、最終的に何になるか？', explanation: 'アミラーゼ等で段階的に分解される', difficulty: 'basic' },
      { id: 'sci2-animal-fc36', front: 'アミノ酸', back: 'タンパク質が消化されると、最終的に何になるか？', explanation: 'ペプシンやトリプシンで段階的に分解される', difficulty: 'basic' },
      { id: 'sci2-animal-fc37', front: '脂肪酸とモノグリセリド', back: '脂肪が消化されると、最終的に何と何になるか？', explanation: '胆汁で細かくされた後リパーゼで分解される', difficulty: 'basic' },
      { id: 'sci2-animal-fc38', front: '小腸', back: '養分の吸収がおもに行われるのはどこか？', explanation: '柔毛があり表面積が大きく効率よく吸収できる', difficulty: 'basic' },
      { id: 'sci2-animal-fc39', front: '毛細血管', back: 'ブドウ糖とアミノ酸は柔毛の中の何に吸収されるか？', explanation: '肝臓へ運ばれてから全身に送られる', difficulty: 'standard' },
      { id: 'sci2-animal-fc40', front: 'リンパ管', back: '再び脂肪になった養分は、柔毛の中の何に吸収されるか？', explanation: 'リンパ管を通り最終的に血液に合流する', difficulty: 'standard' },
      { id: 'sci2-animal-fc41', front: 'アンモニア', back: 'タンパク質が分解されるときに生じる有害な物質は？', explanation: '肝臓で無害な尿素に変えられる', difficulty: 'standard' },
      { id: 'sci2-animal-fc42', front: '酸素', back: '肺胞で、血液中に取り入れられる気体は？', explanation: '同時にCO₂が血液から肺胞に放出される', difficulty: 'basic' },
      { id: 'sci2-animal-fc43', front: '4つ（右心房、右心室、左心房、左心室）', back: '心臓は何個の部屋に分かれているか？すべて答えよ', explanation: '弁によって血液の逆流が防がれている', difficulty: 'standard' },
      { id: 'sci2-animal-fc44', front: '動脈', back: '心臓から送り出される血液が流れる血管を何という？', explanation: '壁が厚く弾力性がある', difficulty: 'basic' },
      { id: 'sci2-animal-fc45', front: '静脈', back: '心臓にもどる血液が流れる血管を何という？', explanation: '壁が薄く逆流防止の弁がある', difficulty: 'basic' },
      { id: 'sci2-animal-fc46', front: '白血球', back: '体内に侵入した細菌などを分解するはたらきがある血液の成分は？', explanation: '体を守る免疫のはたらきをする', difficulty: 'standard' },
      { id: 'sci2-animal-fc47', front: '血しょう', back: '血液の液体成分を何という？', explanation: '養分や不要物を溶かして運ぶ', difficulty: 'standard' },
      { id: 'sci2-animal-fc48', front: '尿素', back: 'タンパク質の分解で生じたアンモニアは、肝臓で何に変えられるか？', explanation: '尿素は腎臓で血液からこし出されて尿になる', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
