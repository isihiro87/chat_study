...
export const animalBody: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-animal-fc29', front: '消化', back: '食物を細かく分解して体内に吸収しやすい形にするはたらきを何という？', difficulty: 'basic' },
      { id: 'sci2-animal-fc30', front: '消化酵素', back: '消化液に含まれ、食物を化学的に分解するはたらきをもつものを何という？', difficulty: 'basic' },
      { id: 'sci2-animal-fc31', front: 'ペプシン', back: '胃液に含まれる消化酵素で、タンパク質を分解するものは？', difficulty: 'standard' },
      { id: 'sci2-animal-fc32', front: 'ヨウ素液', back: 'だ液の実験で、デンプンが分解されたかどうかを調べるために使う薬品は？', difficulty: 'basic' },
      { id: 'sci2-animal-fc33', front: '糖（麦芽糖やブドウ糖など）', back: 'ベネジクト液は何に反応するか？', difficulty: 'basic' },
      { id: 'sci2-animal-fc34', front: '水', back: 'だ液の実験で対照実験として、だ液の代わりに何を加えたものを用意するか？', difficulty: 'standard' },
      { id: 'sci2-animal-fc35', front: 'ブドウ糖', back: 'デンプンが消化されると、最終的に何になるか？', difficulty: 'basic' },
      { id: 'sci2-animal-fc36', front: 'アミノ酸', back: 'タンパク質が消化されると、最終的に何になるか？', difficulty: 'basic' },
      { id: 'sci2-animal-fc37', front: '脂肪酸とモノグリセリド', back: '脂肪が消化されると、最終的に何と何になるか？', difficulty: 'basic' },
      { id: 'sci2-animal-fc38', front: '小腸', back: '養分の吸収がおもに行われるのはどこか？', difficulty: 'basic' },
      { id: 'sci2-animal-fc39', front: '毛細血管', back: 'ブドウ糖とアミノ酸は柔毛の中の何に吸収されるか？', difficulty: 'standard' },
      { id: 'sci2-animal-fc40', front: 'リンパ管', back: '再び脂肪になった養分は、柔毛の中の何に吸収されるか？', difficulty: 'standard' },
      { id: 'sci2-animal-fc41', front: 'アンモニア', back: 'タンパク質が分解されるときに生じる有害な物質は？', difficulty: 'standard' },
      { id: 'sci2-animal-fc42', front: '酸素', back: '肺胞で、血液中に取り入れられる気体は？', difficulty: 'basic' },
      { id: 'sci2-animal-fc43', front: '4つ（右心房、右心室、左心房、左心室）', back: '心臓は何個の部屋に分かれているか？すべて答えよ', difficulty: 'standard' },
      { id: 'sci2-animal-fc44', front: '動脈', back: '心臓から送り出される血液が流れる血管を何という？', difficulty: 'basic' },
      { id: 'sci2-animal-fc45', front: '静脈', back: '心臓にもどる血液が流れる血管を何という？', difficulty: 'basic' },
      { id: 'sci2-animal-fc46', front: '白血球', back: '体内に侵入した細菌などを分解するはたらきがある血液の成分は？', difficulty: 'standard' },
      { id: 'sci2-animal-fc47', front: '血しょう', back: '血液の液体成分を何という？', difficulty: 'standard' },
      { id: 'sci2-animal-fc48', front: '尿素', back: 'タンパク質の分解で生じたアンモニアは、肝臓で何に変えられるか？', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
