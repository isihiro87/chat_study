  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        {id:'sci2-animal-q6', question:'だ液のはたらきを調べる実験で、約37℃に保温する理由は？', options:['実験を早く終わらせるため','消化酵素が体温付近でよくはたらくため','デンプンを溶かすため','ベネジクト液を反応させるため'], correctIndex:1, explanation:'消化酵素は体温に近い約37℃で最もよくはたらきます。'},
        {id:'sci2-animal-q7', question:'すい液について正しいものはどれ？', options:['消化酵素を含まない','デンプンだけを分解する','3種類の消化酵素を含む','肝臓で作られる'], correctIndex:2, explanation:'すい液にはアミラーゼ（デンプン）、トリプシン（タンパク質）、リパーゼ（脂肪）の3種類が含まれます。'},
        {id:'sci2-animal-q8', question:'息を吸うとき横隔膜はどう動く？', options:['上がる','下がる','変わらない','左右に動く'], correctIndex:1, explanation:'横隔膜が下がると胸腔が広がり、肺がふくらんで空気が入ります。'},
        {id:'sci2-animal-q9', question:'動脈血について正しいものはどれ？', options:['二酸化炭素を多く含む','暗い赤色をしている','酸素を多く含み鮮やかな赤色','静脈だけを流れる'], correctIndex:2, explanation:'動脈血は酸素を多く含み鮮やかな赤色です。肺静脈にも動脈血が流れています。'},
        {id:'sci2-animal-q10', question:'ベネジクト液を使ってだ液のはたらきを確認する実験で、赤褐色に変化するのはどちらの試験管？', options:['だ液＋デンプン溶液','水＋デンプン溶液','だ液＋水','どちらも変化しない'], correctIndex:0, explanation:'だ液のアミラーゼがデンプンを麦芽糖に分解するため、ベネジクト液で加熱すると赤褐色に変化します。'},
        ...
        {id:'sci2-animal-q12', question:'肝臓のはたらきでないものはどれ？', options:['グリコーゲンを蓄える','胆汁を作る','尿を作る','アンモニアを尿素に変える'], correctIndex:2, explanation:'尿を作るのは腎臓のはたらきです。肝臓はグリコーゲンの貯蔵、胆汁の生成、アンモニアの無害化を行います。'},
      ],
    },
    examples: {
      examples: [
