...
export const cells: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-cells-fc2', front: '細胞壁、葉緑体、液胞', back: '植物の細胞にだけあるつくりを3つ答えよ', explanation: '動物細胞にはこの3つがない', difficulty: 'basic' },
      { id: 'sci2-cells-fc3', front: '単細胞生物', back: 'からだが1つの細胞からできている生物を何という？', explanation: '例：ゾウリムシ、ミカヅキモ', difficulty: 'basic' },
      { id: 'sci2-cells-fc4', front: '細胞→組織→器官→個体', back: '多細胞生物の体は、細胞から始まってどのような順で構成される？', explanation: '同じ形やはたらきの細胞が集まって組織、組織が集まって器官になる', difficulty: 'basic' },
      ...
      { id: 'sci2-cells-fc7', front: 'レボルバーとステージ', back: '対物レンズを切りかえる回転装置と、プレパラートをのせる台をそれぞれ何という？', explanation: '顕微鏡の基本的な部品名', difficulty: 'basic' },
      { id: 'sci2-cells-fc8', front: '一方の端を水に触れさせ静かに下ろす（気泡が入らないように）', back: 'カバーガラスをかけるとき気をつけることは？', explanation: '気泡が入ると観察の妨げになる', difficulty: 'basic' },
      { id: 'sci2-cells-fc9', front: '接眼レンズの倍率×対物レンズの倍率', back: '顕微鏡の倍率はどのように計算する？', explanation: '例：接眼10倍×対物40倍=400倍', difficulty: 'basic' },
      { id: 'sci2-cells-fc10', front: '酢酸オルセイン（赤）、酢酸カーミン（赤）、メチレンブルー（青）', back: '核を染める染色液を3つとその色を答えよ', explanation: '核は無色透明なので染色しないと見えにくい', difficulty: 'basic' },
      ...
      { id: 'sci2-cells-fc13', front: '動物：上皮組織・筋組織、植物：表皮組織・葉肉組織', back: '動物の組織を2つ、植物の組織を2つ答えよ', explanation: '同じ形やはたらきの細胞の集まりを組織という', difficulty: 'standard' },
      ...
      { id: 'sci2-cells-fc17', front: 'レボルバー', back: '顕微鏡で対物レンズを切り替える回転部品は？', explanation: '回転させて倍率の異なるレンズに切り替える', difficulty: 'basic' },
      { id: 'sci2-cells-fc18', front: 'プレパラート', back: 'スライドガラスに試料をのせカバーガラスをかけたものは？', explanation: '顕微鏡で観察するための標本', difficulty: 'basic' },
      { id: 'sci2-cells-fc19', front: '酢酸オルセイン・酢酸カーミン', back: '核を赤く染める染色液を2つ答えよ', explanation: 'どちらも核を赤色に染める', difficulty: 'basic' },
      { id: 'sci2-cells-fc20', front: '組織', back: '形やはたらきが同じ細胞の集まりを何という？', explanation: '例：筋組織、上皮組織、表皮組織', difficulty: 'basic' },
      { id: 'sci2-cells-fc21', front: '器官', back: '複数の組織が集まって特定のはたらきをするものは？', explanation: '例：心臓、肺、胃、葉', difficulty: 'basic' },
      { id: 'sci2-cells-fc22', front: 'ゾウリムシ、アメーバ、ミカヅキモ', back: '単細胞生物の例を3つ答えよ', explanation: '1つの細胞ですべての生命活動を行う', difficulty: 'standard' },
      { id: 'sci2-cells-fc23', front: 'プレパラートにぶつけて壊すのを防ぐため', back: '対物レンズをプレパラートに近づけてから遠ざけてピントを合わせる理由は？', explanation: '横から見ながら近づけ、のぞきながら遠ざける', difficulty: 'standard' },
      { id: 'sci2-cells-fc24', front: 'CO₂（二酸化炭素）', back: '細胞呼吸で放出される気体は？', explanation: '酸素を使って養分を分解する際にCO₂が生じる', difficulty: 'basic' },
      { id: 'sci2-cells-fc25', front: '目を傷める危険があるため', back: '顕微鏡で直射日光を避ける理由は？', explanation: '反射鏡やレンズで集められた光が目に入ると危険', difficulty: 'standard' },
      { id: 'sci2-cells-fc26', front: '視野が広く明るく、試料を見つけやすいため', back: '顕微鏡で低倍率から観察を始める理由は？', explanation: '高倍率は視野が暗くせまい', difficulty: 'standard' },
      { id: 'sci2-cells-fc27', front: '運動・成長・物質合成など細胞の活動', back: '細胞呼吸で取り出したエネルギーは何に使われる？', explanation: 'すべての生物の細胞で常に行われている', difficulty: 'standard' },
      { id: 'sci2-cells-fc28', front: '常に行う（昼も夜も）', back: '植物は細胞呼吸を行うか？いつ？', explanation: '光合成は光がないとできないが、呼吸は常に行う', difficulty: 'advanced' },
      { id: 'sci2-cells-fc29', front: '細胞膜', back: '細胞のいちばん外側にあるうすい膜を何という？', explanation: 'すべての細胞に共通するつくり', difficulty: 'basic' },
      { id: 'sci2-cells-fc30', front: '細胞壁', back: '細胞膜の外側にある、植物の細胞に特有の丈夫なつくりを何という？', explanation: '細胞の形を保つ役割がある', difficulty: 'basic' },
      { id: 'sci2-cells-fc31', front: '葉緑体', back: '植物の細胞にある、光合成を行う緑色の粒を何という？', explanation: '光エネルギーを使ってデンプンと酸素をつくる', difficulty: 'basic' },
      { id: 'sci2-cells-fc32', front: '液胞', back: '植物の細胞にある、水や物質が入った袋のようなつくりを何という？', explanation: '成長した細胞ほど大きくなる', difficulty: 'basic' },
      { id: 'sci2-cells-fc33', front: '細胞壁', back: '細胞壁と細胞膜で、動物の細胞に見られないのはどちら？', explanation: '細胞膜はすべての細胞にある', difficulty: 'basic' },
      { id: 'sci2-cells-fc34', front: 'ミドリムシはべん毛をもつ単細胞生物で葉緑体ももつ', back: 'ゾウリムシのように自ら動く生物で、葉緑体をもつものはあるか？', explanation: '動物的な運動と植物的な光合成の両方を行う', difficulty: 'standard' },
      { id: 'sci2-cells-fc35', front: '多細胞生物', back: '多くの細胞が集まってからだができている生物を何という？', explanation: '例：ヒト、タンポポ、カエルなど', difficulty: 'basic' },
      { id: 'sci2-cells-fc36', front: '器官', back: 'いくつかの種類の組織が集まって、特定のはたらきをするようになったものを何という？', explanation: '例：心臓、肺、胃、目など', difficulty: 'basic' },
      { id: 'sci2-cells-fc37', front: '神経組織、結合組織など', back: '動物の組織の例として、上皮組織と筋組織のほかに何があるか？', explanation: '体のさまざまなはたらきに対応した組織がある', difficulty: 'advanced' },
      { id: 'sci2-cells-fc38', front: '器官', back: 'ヒトの目、耳、心臓、肺などは、体の構成のうち何に分類されるか？', explanation: '複数の組織が集まって特定のはたらきをする', difficulty: 'standard' },
      { id: 'sci2-cells-fc39', front: '酸素と養分（有機物）', back: '細胞の呼吸に必要なものは何か？', explanation: '酸素で養分を分解しエネルギーを取り出す', difficulty: 'standard' },
      { id: 'sci2-cells-fc40', front: '細胞の活動（運動、成長、物質の合成など）に使われる', back: '細胞の呼吸で取り出されたエネルギーは何に使われるか？', explanation: 'すべての生物の生命活動に不可欠', difficulty: 'standard' },
      { id: 'sci2-cells-fc41', front: '水', back: '細胞の呼吸で二酸化炭素のほかにできる不要物は？', explanation: '養分＋酸素→CO₂＋水＋エネルギー', difficulty: 'advanced' },
      { id: 'sci2-cells-fc42', front: 'ろ紙で吸い取る', back: 'カバーガラスをかけた後、はみ出した液はどうするか？', explanation: 'はみ出した液がレンズを汚すのを防ぐ', difficulty: 'basic' },
      { id: 'sci2-cells-fc43', front: '上下左右が逆になる', back: '顕微鏡の像はどのように見えるか？', explanation: 'プレパラートを動かすときは逆方向に動かす', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
