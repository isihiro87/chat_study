...
export const cells: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci2-cells-fc29', front: '細胞膜', back: '細胞のいちばん外側にあるうすい膜を何という？', difficulty: 'basic' },
      { id: 'sci2-cells-fc30', front: '細胞壁', back: '細胞膜の外側にある、植物の細胞に特有の丈夫なつくりを何という？', difficulty: 'basic' },
      { id: 'sci2-cells-fc31', front: '葉緑体', back: '植物の細胞にある、光合成を行う緑色の粒を何という？', difficulty: 'basic' },
      { id: 'sci2-cells-fc32', front: '液胞', back: '植物の細胞にある、水や物質が入った袋のようなつくりを何という？', difficulty: 'basic' },
      { id: 'sci2-cells-fc33', front: '細胞壁', back: '細胞壁と細胞膜で、動物の細胞に見られないのはどちら？', difficulty: 'basic' },
      { id: 'sci2-cells-fc34', front: 'ミドリムシはべん毛をもつ単細胞生物で葉緑体ももつ', back: 'ゾウリムシのように自ら動く生物で、葉緑体をもつものはあるか？', difficulty: 'standard' },
      { id: 'sci2-cells-fc35', front: '多細胞生物', back: '多くの細胞が集まってからだができている生物を何という？', difficulty: 'basic' },
      { id: 'sci2-cells-fc36', front: '器官', back: 'いくつかの種類の組織が集まって、特定のはたらきをするようになったものを何という？', difficulty: 'basic' },
      { id: 'sci2-cells-fc37', front: '神経組織、結合組織など', back: '動物の組織の例として、上皮組織と筋組織のほかに何があるか？', difficulty: 'advanced' },
      { id: 'sci2-cells-fc38', front: '器官', back: 'ヒトの目、耳、心臓、肺などは、体の構成のうち何に分類されるか？', difficulty: 'standard' },
      { id: 'sci2-cells-fc39', front: '酸素と養分（有機物）', back: '細胞の呼吸に必要なものは何か？', difficulty: 'standard' },
      { id: 'sci2-cells-fc40', front: '細胞の活動（運動、成長、物質の合成など）に使われる', back: '細胞の呼吸で取り出されたエネルギーは何に使われるか？', difficulty: 'standard' },
      { id: 'sci2-cells-fc41', front: '水', back: '細胞の呼吸で二酸化炭素のほかにできる不要物は？', difficulty: 'advanced' },
      { id: 'sci2-cells-fc42', front: 'ろ紙で吸い取る', back: 'カバーガラスをかけた後、はみ出した液はどうするか？', difficulty: 'basic' },
      { id: 'sci2-cells-fc43', front: '上下左右が逆になる', back: '顕微鏡の像はどのように見えるか？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
