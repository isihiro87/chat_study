...
export const observation: Topic = {
  ...
  content: {
    ...
    flashcards: [
      // --- 観察記録・スケッチの基本（basic） ---
      { id: 'sci1-obs-fc1', front: '日時・場所・天気・気温・生物名・スケッチ・気づいたこと', back: '生物の観察記録に書くべき項目を答えよ。', explanation: '観察の再現性を高め、環境と生物の関係を調べるために必要な情報をすべて記録する。', difficulty: 'basic' },
      { id: 'sci1-obs-fc2', front: '細い1本の線', back: '理科のスケッチで使う線はどのような線か。', explanation: '細い線で輪郭を正確に描くことで、生物の形を客観的に記録できる。', difficulty: 'basic' },
      { id: 'sci1-obs-fc3', front: '影、ぬりつぶし、背景、器具の視野の円', back: 'スケッチで描いてはいけないものを4つ答えよ。', explanation: '理科のスケッチは観察対象の形を正確に記録するため、余計な情報を描かない。', difficulty: 'basic' },
      { id: 'sci1-obs-fc4', front: '生物カード', back: '観察した生物の情報を1種類ずつまとめるカードを何というか。', explanation: '1種類ごとにカードを作ることで、分類や比較がしやすくなる。', difficulty: 'basic' },
      { id: 'sci1-obs-fc5', front: '日当たりと湿り気', back: '観察する場所で注目すべき環境の条件を2つ答えよ。', explanation: '日当たりや湿り気によって、そこに生息する生物の種類が異なるため。', difficulty: 'basic' },
      { id: 'sci1-obs-fc6', front: '目に近づけて固定して持つ', back: 'ルーペで観察するとき、ルーペはどのように持つか。', explanation: '目に近づけることで視野が広くなり、ピントも合わせやすくなる。', difficulty: 'basic' },
      { id: 'sci1-obs-fc7', front: '観察するものを前後に動かす', back: 'ルーペで観察するとき、ピントを合わせるにはどうするか。', explanation: 'ルーペは目に固定したまま、観察物の距離を変えてピントを調整する。', difficulty: 'basic' },
      { id: 'sci1-obs-fc8', front: '体のつくりなど変化しにくい特徴', back: '科学的な分類で基準にするのはどのような特徴か。', explanation: '色や大きさは環境で変わりやすいが、体のつくりは安定しており信頼できる基準になる。', difficulty: 'basic' },
      { id: 'sci1-obs-fc9', front: '共通点と相違点に注目して生物をグループ分けすること', back: '分類とは何か。', explanation: '共通点でまとめ、相違点で分けることで生物の多様性を体系的に整理できる。', difficulty: 'basic' },
      // --- 観察・器具の詳細（standard） ---
      { id: 'sci1-obs-fc10', front: '生物の生活と環境の関係を調べるため', back: '観察記録に天気や気温を書くのはなぜか。', explanation: '天気や気温が変わると見られる生物が変わることがあり、環境との関係を考察できる。', difficulty: 'standard' },
      { id: 'sci1-obs-fc11', front: 'ぬらない。色の情報は文字で記録する', back: 'スケッチで色をぬってよいか。', explanation: 'スケッチは形を正確に記録するためのもので、色は文字で「花弁は黄色」などと記録する。', difficulty: 'standard' },
      { id: 'sci1-obs-fc12', front: '理科は影なし・細い線で輪郭のみ。美術は陰影をつけて立体感を表現する', back: '美術のデッサンと理科のスケッチの違いを答えよ。', explanation: '理科では形の正確さが重要で、美術では見た目の美しさや立体感を重視する。', difficulty: 'standard' },
      { id: 'sci1-obs-fc13', front: '視野が狭くなり、ピントも合わせにくくなるため', back: 'ルーペを目から離して使ってはいけない理由を答えよ。', explanation: 'ルーペは目に近づけて使うことで広い視野が得られ、正しく観察できる。', difficulty: 'standard' },
      { id: 'sci1-obs-fc14', front: '光が集まって目を傷めるおそれがあるから', back: 'ルーペで太陽を見てはいけない理由を答えよ。', explanation: 'レンズが光を集めるため、目の網膜を損傷する危険がある。', difficulty: 'standard' },
      { id: 'sci1-obs-fc15', front: 'ルーペを目に近づけたまま、自分の体を前後に動かしてピントを合わせる', back: 'ルーペで動かせないもの（花壇の花など）を観察するにはどうするか。', explanation: '観察物を動かせないときは、自分が動いて距離を調整する。', difficulty: 'standard' },
      { id: 'sci1-obs-fc16', front: '立体的に観察でき、倍率は20〜40倍。プレパラートなしで観察できる', back: '双眼実体顕微鏡の特徴と倍率を答えよ。', explanation: '両目でのぞくため立体的に見え、プレパラート不要で手軽に観察できる。', difficulty: 'standard' },
      { id: 'sci1-obs-fc17', front: '接眼レンズを先に、次に対物レンズを取り付ける。鏡筒にほこりが入るのを防ぐため', back: '顕微鏡のレンズはどの順番で取り付けるか。その理由も答えよ。', explanation: '接眼レンズで鏡筒の穴をふさいでから対物レンズをつけ、内部へのほこりの侵入を防ぐ。', difficulty: 'standard' },
      { id: 'sci1-obs-fc18', front: '環境や個体によって変化しやすい特徴だから', back: '花の色や大きさは分類の基準に向かない。その理由を答えよ。', explanation: '同じ種でも環境や個体差で色や大きさが変わるため、安定した基準にならない。', difficulty: 'standard' },
      // --- 応用・発展（advanced） ---
      { id: 'sci1-obs-fc19', front: '影は観察者によって異なり、生物の形を正確に記録できなくなるから', back: 'スケッチで影をつけてはいけない理由を答えよ。', explanation: '光の当たり方で影の見え方が変わるため、客観的な記録にならない。', difficulty: 'advanced' },
      { id: 'sci1-obs-fc20', front: '生物名・発見日時・発見場所・スケッチ', back: '生物カードに記入する項目を4つ答えよ。', explanation: 'これらの項目を記録することで、あとから生物を特定し比較することができる。', difficulty: 'advanced' },
      { id: 'sci1-obs-fc21', front: '1つだけでなく、目的に応じてさまざまな基準で分類できる', back: '分類の基準は1つだけでよいか。', explanation: '調べたい内容によって適切な基準が異なるため、複数の視点で分類できる。', difficulty: 'advanced' },
      { id: 'sci1-obs-fc22', front: '移動する＝動物、移動しない＝植物', back: '「移動するか・しないか」で生物を分けるとどうなるか。', explanation: '自分で移動して食べ物をとるか、その場で光合成をするかの違いによる分類。', difficulty: 'advanced' },
      { id: 'sci1-obs-fc23', front: '低倍率から観察を始める。広い範囲で観察物を探してから倍率を上げる', back: '顕微鏡で観察を始めるとき、最初の倍率はどうするか。その理由も答えよ。', explanation: '低倍率は視野が広いため観察物を見つけやすく、見つけてから高倍率で詳しく観察する。', difficulty: 'advanced' },
      { id: 'sci1-obs-fc24', front: 'スライドガラスの上に観察物をのせ、カバーガラスをかぶせて作る', back: 'プレパラートとは何か。作り方を答えよ。', explanation: 'カバーガラスは気泡が入らないよう端からゆっくり下ろす。', difficulty: 'advanced' },
      // --- ichimondittou補完（個別Q&A） ---
      { id: 'sci1-obs-fc25', front: 'つけてはいけない', back: 'スケッチで影をつけてよいか。', explanation: '影は観察者や光の条件で変わるため、正確な記録にならない。', difficulty: 'basic' },
      { id: 'sci1-obs-fc26', front: 'ぬりつぶしてはいけない', back: 'スケッチでぬりつぶしてよいか。', explanation: 'ぬりつぶすと細かい形が見えなくなり、正確な記録ができなくなる。', difficulty: 'basic' },
      { id: 'sci1-obs-fc27', front: '描いてはいけない。観察対象だけを描く', back: 'スケッチで背景を描いてよいか。', explanation: '背景は観察対象の記録に不要で、対象の形が見づらくなる。', difficulty: 'basic' },
      { id: 'sci1-obs-fc28', front: '描いてはいけない', back: 'スケッチで器具や顕微鏡の視野の円を描いてよいか。', explanation: '視野の円は器具の一部であり、観察対象そのものではないため描かない。', difficulty: 'standard' },
      { id: 'sci1-obs-fc29', front: '色の濃淡や模様を表現するとき。線の代わりに細かい点で表す', back: 'スケッチで点々（点描）を使うのはどのようなときか。', explanation: '色をぬれないスケッチで濃淡を表す唯一の方法が点描である。', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
      ...
      },
        {
          ...
          options: [
            '視野が広くなり、ピントも合わせやすくなる',
            '視野が狭くなり、ピントも合わせにくくなる',
            '観察物がより大きく鮮明に見えるようになる',
            '見え方は変わらず、特に問題は生じない',
          ],
          correctIndex: 1,
          explanation:
      ...
      },
        {
          ...
          options: [
            'ルーペのレンズが高温になって割れるおそれがあるから',
            '太陽が強くまぶしすぎて正確に観察できないから',
            '光が集まって目を傷めるおそれがあるから',
            '望遠鏡と違い太陽の観察には適した器具ではないから',
          ],
          correctIndex: 2,
          explanation:
      ...
      },
        {
          ...
          options: [
            '基準が複数あると分類は意味をなさない',
            '科学では分類の基準を1つだけに統一すべきである',
            '目的に応じてさまざまな基準で分類できる',
            'どの基準を使っても結果は同じになるべきである',
          ],
          correctIndex: 2,
          explanation:
      ...
      },
        {
          ...
          options: [
            'ルーペを花に近づけ、遠ざけながらピントを合わせる',
            '花を引き抜いて手に持ち、観察物を動かしてピントを合わせる',
            'ルーペを目から離して遠くから広い範囲を見渡す',
      ...
      },
        {
          ...
          options: [
            '適切である。客観的に測定できる基準だから',
            '適切でない。成長段階や個体差で変わりやすいから',
            '適切である。生物の大きさは体のつくりと関係するから',
            '適切でない。10cmよりも5cmを基準にすべきだから',
          ],
          correctIndex: 1,
          explanation:
