...
export const plantGroups: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci1-pg-fc1', front: 'シダ植物', back: 'シダ植物とコケ植物で維管束があるのはどちらか。', explanation: 'シダ植物は維管束をもつため水を効率よく運べるが、コケ植物にはない。', difficulty: 'basic' },
      { id: 'sci1-pg-fc2', front: '地下茎', back: 'シダ植物の茎は地中にあることが多い。これを何というか。', explanation: 'シダ植物の茎は地面の下にあり、そこから葉と根が出ている。', difficulty: 'basic' },
      { id: 'sci1-pg-fc3', front: '胞子のう', back: 'シダ植物の葉の裏にある胞子が入った袋を何というか。', explanation: '胞子のうの中の胞子が飛散して新しい個体をつくる。', difficulty: 'basic' },
      { id: 'sci1-pg-fc4', front: 'イヌワラビ、スギナ（ツクシ）、ゼンマイ', back: 'シダ植物の例を3つ挙げよ。', explanation: 'いずれも維管束をもち、胞子でふえるシダ植物の代表例。', difficulty: 'basic' },
      {
        id: 'sci1-pg-fc5',
        front: '体を地面に固定するためにある。水は吸収しない（体の表面全体で水を吸収する）',
        back: 'コケ植物の仮根の役割は何か。水を吸収するか。',
        explanation: '仮根は体を固定する役割のみで、水の吸収は体の表面全体で行う。',
        difficulty: 'basic',
      },
      { id: 'sci1-pg-fc6', front: 'ゼニゴケ、コスギゴケ', back: 'コケ植物の例を2つ挙げよ。', explanation: 'いずれも維管束がなく胞子でふえるコケ植物の代表例。', difficulty: 'basic' },
      { id: 'sci1-pg-fc7', front: '種子をつくるかどうか', back: '植物を大きく分類するとき、最初の分岐点は何か。', explanation: '種子をつくるかどうかで種子植物とそれ以外に大きく分けられる。', difficulty: 'basic' },
      { id: 'fc8', front: '種子ではなく胞子でふえる', back: 'シダ植物は種子でふえるか。', explanation: 'シダ植物は種子をつくらず、葉の裏の胞子のうから胞子を飛ばしてふえる。', difficulty: 'basic' },
      { id: 'fc9', front: 'ある', back: 'シダ植物には根・茎・葉の区別があるか。', explanation: 'コケ植物とちがい、シダ植物は根・茎・葉がはっきり区別できる。', difficulty: 'basic' },
      { id: 'fc10', front: 'ある', back: 'シダ植物に維管束はあるか。', explanation: '維管束があるため、水や養分を効率よく運ぶことができる。', difficulty: 'basic' },
      { id: 'fc11', front: 'ない', back: 'コケ植物には根・茎・葉の区別があるか。', explanation: 'コケ植物は根・茎・葉の区別がなく、単純な体のつくりをしている。', difficulty: 'basic' },
      { id: 'fc12', front: 'ない', back: 'コケ植物に維管束はあるか。', explanation: '維管束がないため、水や養分を体内で効率よく運べない。', difficulty: 'basic' },
      { id: 'fc13', front: 'しない（体の表面全体で水を吸収する）', back: 'コケ植物の仮根は水を吸収するか。', explanation: '仮根は体を固定するだけで、水を吸い上げる機能はもたない。', difficulty: 'standard' },
      { id: 'fc14', front: 'ある', back: 'コケ植物には雌株と雄株の区別があるか。', explanation: 'コケ植物には雌株と雄株があり、有性生殖を行ったのち胞子をつくる。', difficulty: 'standard' },
      { id: 'fc15', front: '胞子をつくる植物', back: '植物を大きく2つに分けると、種子をつくる植物と何をつくる植物か。', explanation: '種子をつくらない植物はシダ植物やコケ植物で、胞子でふえる。', difficulty: 'standard' },
      { id: 'fc16', front: 'シダ植物', back: '種子をつくらない植物のうち、維管束があるのはどちらか。', explanation: 'シダ植物は維管束があるため、種子をつくらない植物の中で区別される。', difficulty: 'standard' },
      { id: 'fc17', front: 'コケ植物', back: '種子をつくらない植物のうち、維管束がないのはどちらか。', explanation: 'コケ植物は維管束がないため、体が小さく水辺に生えることが多い。', difficulty: 'standard' },
      { id: 'fc18', front: '日当たりの悪い湿った場所', back: 'シダ植物はどのような場所に生えることが多いか。', explanation: '胞子の発芽には水分が必要なため、湿った場所に多く生える。', difficulty: 'standard' },
      { id: 'fc19', front: '種子植物', back: '種子をつくる植物をまとめて何というか。', explanation: '種子をつくって子孫を残す植物を種子植物という。', difficulty: 'standard' },
      { id: 'fc20', front: '被子植物', back: '胚珠が子房に包まれている植物を何というか。', explanation: '胚珠が子房に包まれていることが被子植物の最大の特徴。', difficulty: 'standard' },
      { id: 'fc21', front: '裸子植物', back: '胚珠がむき出しの植物を何というか。', explanation: '胚珠がむき出しになっているため「裸子」と呼ばれる。', difficulty: 'standard' },
      { id: 'fc22', front: '維管束の有無（根・茎・葉の区別があるか）', back: '種子をつくらない植物をシダ植物とコケ植物に分ける基準は何か。', explanation: '維管束の有無で、根茎葉の区別ができるかどうかも決まる。', difficulty: 'standard' },
      { id: 'fc23', front: '胚珠が子房に包まれるかどうか', back: '種子植物を被子植物と裸子植物に分ける基準は何か。', explanation: '子房の有無が被子植物と裸子植物を分ける決定的な違い。', difficulty: 'standard' },
      { id: 'fc24', front: '子葉の枚数', back: '被子植物を双子葉類と単子葉類に分ける基準は何か。', explanation: '子葉の枚数のほか、葉脈や根の形もセットで異なる。', difficulty: 'standard' },
      {
        id: 'fc25',
        front: '双子葉類（子葉2枚・網状脈・主根と側根）',
        back: '被子植物の子葉が2枚のグループの名前と特徴を答えよ。',
        explanation: '双子葉類は子葉2枚・網状脈・主根と側根の3つの特徴をセットで覚える。',
        difficulty: 'advanced',
      },
      {
        id: 'fc26',
        ...
        explanation: '単子葉類は子葉1枚・平行脈・ひげ根の3つの特徴をセットで覚える。',
        difficulty: 'advanced',
      },
      { id: 'fc27', front: '維管束があり、根・茎・葉の区別がある', back: 'シダ植物がコケ植物と異なる大きな特徴は何か。', explanation: '維管束があることで水や養分を効率よく運び、より大きく成長できる。', difficulty: 'advanced' },
      { id: 'fc28', front: '体の表面全体で水を吸収する', back: 'コケ植物はどのようにして水を吸収するか。', explanation: '維管束がないため根から水を吸い上げられず、体表面で吸収する。', difficulty: 'advanced' },
      { id: 'fc29', front: 'スギナ', back: 'ツクシは何というシダ植物の一部か。', explanation: 'ツクシは胞子をつくる部分で、緑色のスギナが栄養をつくる部分。', difficulty: 'advanced' },
      { id: 'fc30', front: '胞子でふえる', back: 'シダ植物とコケ植物に共通するふえ方は何か。', explanation: '種子ではなく胞子によって新しい個体をつくるのが共通点。', difficulty: 'advanced' },
      {
        id: 'fc31',
        front: '種子をつくらない、子房がない、維管束がない',
        back: 'コケ植物は「種子をつくるか」「子房があるか」「維管束があるか」のそれぞれについてどうか。',
        explanation: 'コケ植物は最も単純な体のつくりをもち、種子・子房・維管束のいずれもない。',
        difficulty: 'advanced',
      },
      {
        id: 'fc32',
        ...
        explanation: '胞子が発芽するには水分が欠かせないため、湿った環境に適応している。',
        difficulty: 'advanced',
      },
      {
        id: 'fc33',
        ...
        explanation: '大きな特徴から順に分けていくことで、すべての植物を体系的に分類できる。',
        difficulty: 'advanced',
      },
      {
        id: 'fc34',
        ...
        explanation: '維管束がなければ水や養分を体内で効率よく運べないため、体を大きくできない。',
        difficulty: 'advanced',
      },
      // --- ichimondittou/advanced補完 ---
      { id: 'fc35', front: '仮根', back: 'コケ植物が体を地面に固定するための根のようなものを何というか。', explanation: '仮根はコケ植物が地面にへばりつくためのもの。', difficulty: 'basic' },
      { id: 'fc36', front: 'ない。シダ植物なので胞子でふえる', back: 'スギナ（ツクシ）に花や種子はあるか。ふえ方を答えよ。', explanation: 'スギナはシダ植物なので花は咲かず、胞子で繁殖する。', difficulty: 'standard' },
      { id: 'fc37', front: '種子植物', back: '種子植物を被子植物と裸子植物に分ける前のグループ名は何か。', explanation: '種子植物はさらに被子植物と裸子植物に分けられる。', difficulty: 'basic' },
      { id: 'fc38', front: '被子植物', back: '種子植物のうち、胚珠が子房に包まれているものを何というか。', explanation: '被子植物は子房をもち、果実をつくることができる。', difficulty: 'standard' },
      { id: 'fc39', front: '裸子植物', back: '種子植物のうち、胚珠がむき出しのものを何というか。', explanation: '裸子植物は子房がないため果実はつくれないが種子はできる。', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
      ...
      },
        {
          ...
          options: ['仮根から水を吸収する', '体の表面全体から吸収する', '根から水を吸収する', '維管束を通じて吸収する'],
          correctIndex: 1,
          explanation:
      ...
      },
        {
          ...
          options: [
            '体の表面で水を吸収し、大きくなれない',
            '維管束がなくても水を体内で素早く運び大きく成長できる',
            '仮根から根のように水を効率よく吸収できる',
            '維管束がなくても種子で確実にふえることができる',
          ],
          correctIndex: 0,
          explanation:
