...
export const stateChangeChat: HistoryChat = {
  ...
  content: [
    ...
    {
      type: 'narrator',
      text: 'ロウの<ruby>状態変化<rp>(</rp><rt>じょうたいへんか</rt><rp>)</rp></ruby><ruby>実験<rp>(</rp><rt>じっけん</rt><rp>)</rp></ruby>で、<ruby>体積<rp>(</rp><rt>たいせき</rt><rp>)</rp></ruby>と<ruby>質量<rp>(</rp><rt>しつりょう</rt><rp>)</rp></ruby>の<ruby>変化<rp>(</rp><rt>へんか</rt><rp>)</rp></ruby>を<ruby>粒子<rp>(</rp><rt>りゅうし</rt><rp>)</rp></ruby>モデルで<ruby>理解<rp>(</rp><rt>りかい</rt><rp>)</rp></ruby>しましょう。',
    },
    {
      type: 'message',
      side: 'left',
      characterId: 'teacher',
      expression: 'explaining',
      text: 'ロウを<ruby>液体<rp>(</rp><rt>えきたい</rt><rp>)</rp></ruby>にして<ruby>冷<rp>(</rp><rt>ひ</rt><rp>)</rp></ruby>やすと、<ruby>表面<rp>(</rp><rt>ひょうめん</rt><rp>)</rp></ruby>が<strong>へこむ</strong>んだ。これは<ruby>液体<rp>(</rp><rt>えきたい</rt><rp>)</rp></ruby>→<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>で<ruby>粒子<rp>(</rp><rt>りゅうし</rt><rp>)</rp></ruby>の<ruby>間隔<rp>(</rp><rt>かんかく</rt><rp>)</rp></ruby>が<ruby>縮<rp>(</rp><rt>ちぢ</rt><rp>)</rp></ruby>まって<strong><ruby>体積<rp>(</rp><rt>たいせき</rt><rp>)</rp></ruby>が<ruby>小<rp>(</rp><rt>ちい</rt><rp>)</rp></ruby>さくなる</strong>から。でも<ruby>粒子<rp>(</rp><rt>りゅうし</rt><rp>)</rp></ruby>の<ruby>数<rp>(</rp><rt>かず</rt><rp>)</rp></ruby>は<ruby>変<rp>(</rp><rt>か</rt><rp>)</rp></ruby>わらないから<strong><ruby>質量<rp>(</rp><rt>しつりょう</rt><rp>)</rp></ruby>は<ruby>同<rp>(</rp><rt>おな</rt><rp>)</rp></ruby>じ</strong>だよ',
    },
    {
      type: 'message',
      side: 'right',
      characterId: 'student',
      expression: 'curious',
      text: '水も同じように<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>になると<ruby>体積<rp>(</rp><rt>たいせき</rt><rp>)</rp></ruby>が<ruby>小<rp>(</rp><rt>ちい</rt><rp>)</rp></ruby>さくなりますか？',
    },
    {
      type: 'message',
      side: 'left',
      characterId: 'teacher',
      expression: 'excited',
      text: '水は<strong><ruby>例外<rp>(</rp><rt>れいがい</rt><rp>)</rp></ruby></strong>なんだ！<ruby>氷<rp>(</rp><rt>こおり</rt><rp>)</rp></ruby>の<ruby>結晶構造<rp>(</rp><rt>けっしょうこうぞう</rt><rp>)</rp></ruby>はすき<ruby>間<rp>(</rp><rt>ま</rt><rp>)</rp></ruby>が多いから、<ruby>凍<rp>(</rp><rt>こお</rt><rp>)</rp></ruby>ると<ruby>体積<rp>(</rp><rt>たいせき</rt><rp>)</rp></ruby>が<strong><ruby>大<rp>(</rp><rt>おお</rt><rp>)</rp></ruby>きくなる</strong>。だから<ruby>氷<rp>(</rp><rt>こおり</rt><rp>)</rp></ruby>の<ruby>密度<rp>(</rp><rt>みつど</rt><rp>)</rp></ruby>は水より<ruby>小<rp>(</rp><rt>ちい</rt><rp>)</rp></ruby>さくなって<ruby>浮<rp>(</rp><rt>う</rt><rp>)</rp></ruby>くんだよ',
    },
    {
      type: 'summary-point',
    ...
    {
      type: 'date',
      text: '<ruby>加熱曲線<rp>(</rp><rt>かねつきょくせん</rt><rp>)</rp></ruby>と<ruby>昇華<rp>(</rp><rt>しょうか</rt><rp>)</rp></ruby>',
    },
    {
      type: 'narrator',
      text: '<ruby>純粋<rp>(</rp><rt>じゅんすい</rt><rp>)</rp></ruby>な<ruby>物質<rp>(</rp><rt>ぶっしつ</rt><rp>)</rp></ruby>と<ruby>混合物<rp>(</rp><rt>こんごうぶつ</rt><rp>)</rp></ruby>の<ruby>加熱<rp>(</rp><rt>かねつ</rt><rp>)</rp></ruby>グラフの<ruby>違<rp>(</rp><rt>ちが</rt><rp>)</rp></ruby>い、そして<strong><span class="keyword"><ruby>昇華<rp>(</rp><rt>しょうか</rt><rp>)</rp></ruby></span></strong>を学びましょう。',
    },
    {
      type: 'message',
      side: 'left',
      characterId: 'teacher',
      expression: 'explaining',
      text: '<ruby>純粋<rp>(</rp><rt>じゅんすい</rt><rp>)</rp></ruby>な<ruby>物質<rp>(</rp><rt>ぶっしつ</rt><rp>)</rp></ruby>を<ruby>加熱<rp>(</rp><rt>かねつ</rt><rp>)</rp></ruby>すると、<ruby>融点<rp>(</rp><rt>ゆうてん</rt><rp>)</rp></ruby>と<ruby>沸点<rp>(</rp><rt>ふってん</rt><rp>)</rp></ruby>で<strong><ruby>温度<rp>(</rp><rt>おんど</rt><rp>)</rp></ruby>が<ruby>一定<rp>(</rp><rt>いってい</rt><rp>)</rp></ruby>になる<ruby>区間<rp>(</rp><rt>くかん</rt><rp>)</rp></ruby></strong>ができるよ。<ruby>加<rp>(</rp><rt>くわ</rt><rp>)</rp></ruby>えた<ruby>熱<rp>(</rp><rt>ねつ</rt><rp>)</rp></ruby>が<ruby>状態変化<rp>(</rp><rt>じょうたいへんか</rt><rp>)</rp></ruby>に使われるからなんだ。でも<ruby>混合物<rp>(</rp><rt>こんごうぶつ</rt><rp>)</rp></ruby>は<ruby>温度<rp>(</rp><rt>おんど</rt><rp>)</rp></ruby>が<ruby>一定<rp>(</rp><rt>いってい</rt><rp>)</rp></ruby>にならないのが<ruby>特徴<rp>(</rp><rt>とくちょう</rt><rp>)</rp></ruby>だよ',
    },
    {
      type: 'message',
      side: 'right',
      characterId: 'student',
      expression: 'thinking',
      text: '<strong><ruby>昇華<rp>(</rp><rt>しょうか</rt><rp>)</rp></ruby></strong>って何ですか？',
    },
    {
      type: 'message',
      side: 'left',
      characterId: 'teacher',
      expression: 'happy',
      text: '<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>から<ruby>液体<rp>(</rp><rt>えきたい</rt><rp>)</rp></ruby>を<ruby>経<rp>(</rp><rt>へ</rt><rp>)</rp></ruby>ずに<ruby>直接<rp>(</rp><rt>ちょくせつ</rt><rp>)</rp></ruby><ruby>気体<rp>(</rp><rt>きたい</rt><rp>)</rp></ruby>になることを<strong><span class="keyword"><ruby>昇華<rp>(</rp><rt>しょうか</rt><rp>)</rp></ruby></span></strong>というよ。<ruby>代表例<rp>(</rp><rt>だいひょうれい</rt><rp>)</rp></ruby>は<strong>ドライアイス</strong>（<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>の<ruby>二酸化炭素<rp>(</rp><rt>にさんかたんそ</rt><rp>)</rp></ruby>）やナフタレンだね',
    },
    {
      type: 'message',
      side: 'right',
      characterId: 'student',
      expression: 'surprised',
      text: 'ドライアイスの<ruby>白<rp>(</rp><rt>しろ</rt><rp>)</rp></ruby>い<ruby>煙<rp>(</rp><rt>けむり</rt><rp>)</rp></ruby>はそういうことだったんですね！',
    },
    {
      type: 'summary-point',
    ...
    },
    {
      type: 'end',
      points: [
        '<strong><ruby>状態変化<rp>(</rp><rt>じょうたいへんか</rt><rp>)</rp></ruby></strong>：<ruby>温度<rp>(</rp><rt>おんど</rt><rp>)</rp></ruby>で<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>・<ruby>液体<rp>(</rp><rt>えきたい</rt><rp>)</rp></ruby>・<ruby>気体<rp>(</rp><rt>きたい</rt><rp>)</rp></ruby>に<ruby>変化<rp>(</rp><rt>へんか</rt><rp>)</rp></ruby>。<ruby>融解<rp>(</rp><rt>ゆうかい</rt><rp>)</rp></ruby>・<ruby>凝固<rp>(</rp><rt>ぎょうこ</rt><rp>)</rp></ruby>・<ruby>蒸発<rp>(</rp><rt>じょうはつ</rt><rp>)</rp></ruby>・<ruby>凝縮<rp>(</rp><rt>ぎょうしゅく</rt><rp>)</rp></ruby>・<ruby>昇華<rp>(</rp><rt>しょうか</rt><rp>)</rp></ruby>',
        'ロウは<ruby>液体<rp>(</rp><rt>えきたい</rt><rp>)</rp></ruby>→<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>で<ruby>体積<rp>(</rp><rt>たいせき</rt><rp>)</rp></ruby>が<ruby>減<rp>(</rp><rt>へ</rt><rp>)</rp></ruby>る。<strong>水は<ruby>例外<rp>(</rp><rt>れいがい</rt><rp>)</rp></ruby></strong>：<ruby>凍<rp>(</rp><rt>こお</rt><rp>)</rp></ruby>ると<ruby>体積<rp>(</rp><rt>たいせき</rt><rp>)</rp></ruby>が<ruby>増<rp>(</rp><rt>ふ</rt><rp>)</rp></ruby>える',
        '<strong><ruby>加熱曲線<rp>(</rp><rt>かねつきょくせん</rt><rp>)</rp></ruby></strong>：<ruby>純粋<rp>(</rp><rt>じゅんすい</rt><rp>)</rp></ruby>な<ruby>物質<rp>(</rp><rt>ぶっしつ</rt><rp>)</rp></ruby>は<ruby>融点<rp>(</rp><rt>ゆうてん</rt><rp>)</rp></ruby>・<ruby>沸点<rp>(</rp><rt>ふってん</rt><rp>)</rp></ruby>で<ruby>温度<rp>(</rp><rt>おんど</rt><rp>)</rp></ruby><ruby>一定<rp>(</rp><rt>いってい</rt><rp>)</rp></ruby>。<ruby>混合物<rp>(</rp><rt>こんごうぶつ</rt><rp>)</rp></ruby>は<ruby>一定<rp>(</rp><rt>いってい</rt><rp>)</rp></ruby>にならない',
        '<strong><ruby>蒸留<rp>(</rp><rt>じょうりゅう</rt><rp>)</rp></ruby></strong>＝<ruby>沸点<rp>(</rp><rt>ふってん</rt><rp>)</rp></ruby>の<ruby>違<rp>(</rp><rt>ちが</rt><rp>)</rp></ruby>いで<ruby>混合物<rp>(</rp><rt>こんごうぶつ</rt><rp>)</rp></ruby>を<ruby>分離<rp>(</rp><rt>ぶんり</rt><rp>)</rp></ruby>。<strong><ruby>昇華<rp>(</rp><rt>しょうか</rt><rp>)</rp></ruby></strong>＝<ruby>固体<rp>(</rp><rt>こたい</rt><rp>)</rp></ruby>→<ruby>直接<rp>(</rp><rt>ちょくせつ</rt><rp>)</rp></ruby><ruby>気体<rp>(</rp><rt>きたい</rt><rp>)</rp></ruby>',
      ],
    },
  ],
};
