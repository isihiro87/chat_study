...
export const substanceProperties: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci1-sp-fc29', front: 'コップ（形・用途に注目した呼び方）', back: '「ガラスのコップ」で物体にあたるのはどちらか？', difficulty: 'basic' },
      { id: 'sci1-sp-fc30', front: 'ガラス（材料に注目した呼び方）', back: '「ガラスのコップ」で物質にあたるのはどちらか？', difficulty: 'basic' },
      { id: 'sci1-sp-fc31', front: 'できる。例：鉄からくぎ・フライパン・はさみなど、異なる物体をつくれる', back: '同じ物質から異なる物体をつくることはできるか？具体例をあげよ。', difficulty: 'basic' },
      { id: 'sci1-sp-fc32', front: '金属と非金属', back: '物質は大きく2つに分けられる。何と何か？', difficulty: 'basic' },
      { id: 'sci1-sp-fc33', front: '金属光沢', back: '金属をみがいたときに見られる特有の光り方を何というか？', difficulty: 'basic' },
      { id: 'sci1-sp-fc34', front: '延性（引っ張ると細く伸びる性質）', back: '銅線が細い線でつくられるのは、金属のどの性質を利用しているか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc35', front: '金属の中で最も密度が小さく、水に浮く', back: 'リチウムの特徴的な性質を1つ答えよ。', difficulty: 'standard' },
      { id: 'sci1-sp-fc36', front: '物質1cm³あたりの質量のこと。単位はg/cm³', back: '密度とは何か？', difficulty: 'basic' },
      { id: 'sci1-sp-fc37', front: '2.7g/cm³（27÷10＝2.7）', back: '質量27g、体積10cm³の物質の密度を求めよ。', difficulty: 'standard' },
      { id: 'sci1-sp-fc38', front: '約1.0g/cm³', back: '水の密度は約何g/cm³か？', difficulty: 'basic' },
      { id: 'sci1-sp-fc39', front: 'その物質の密度が水の密度（約1.0g/cm³）より小さいこと', back: '物質が水に浮く条件を答えよ。', difficulty: 'standard' },
      { id: 'sci1-sp-fc40', front: '水に浮く（水の密度1.0g/cm³より小さいから）', back: '密度0.9g/cm³の物質を水に入れるとどうなるか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc41', front: 'メスシリンダー', back: '液体の体積をはかる器具を何というか？', difficulty: 'basic' },
      { id: 'sci1-sp-fc42', front: '最小目盛りの10分の1まで', back: 'メスシリンダーの最小目盛りの何分の1まで目分量で読むか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc43', front: '燃えない（食塩は無機物だから）', back: '食塩を燃やすとどうなるか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc44', front: '黒くこげて炭ができ、二酸化炭素と水が発生する（有機物だから）', back: '砂糖を燃やすとどうなるか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc45', front: '粒のようすを観察する。グラニュー糖は透明で角ばった結晶、食塩は立方体の結晶', back: 'グラニュー糖と食塩を見た目で区別する方法を答えよ。', difficulty: 'advanced' },
      { id: 'sci1-sp-fc46', front: '炎が消えることがある', back: 'ガスバーナーで空気を入れすぎると炎はどうなるか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc47', front: 'マッチに先に火をつけてからガスを出す。ガスを先に出すと引火の危険がある', back: 'ガスバーナーに火をつけるとき、マッチとガスはどちらを先に用意するか？', difficulty: 'standard' },
      { id: 'sci1-sp-fc48', front: '有機物。炭素をふくんでおり、燃やすと二酸化炭素と水が発生するから', back: 'エタノールは有機物か無機物か。理由もあわせて答えよ。', difficulty: 'advanced' },
      { id: 'sci1-sp-fc49', front: '有機物にふくまれる炭素が残って炭になるから', back: '有機物を燃やしたとき黒くこげるのはなぜか？', difficulty: 'advanced' },
      { id: 'sci1-sp-fc50', front: 'ガス調節ねじと空気調節ねじ', back: 'ガスバーナーの2つのねじの名前を答えよ。', difficulty: 'basic' },
      { id: 'sci1-sp-fc51', front: '青色', back: 'ガスバーナーの適正な炎の色は何色か？', difficulty: 'basic' },
      { id: 'sci1-sp-fc52', front: '空気（酸素）が不足している', back: 'ガスバーナーの炎がオレンジ色のときは何が不足しているか？', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
