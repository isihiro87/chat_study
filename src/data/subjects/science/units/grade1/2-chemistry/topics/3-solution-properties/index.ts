...
export const solutionProperties: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci1-slp-fc4', front: '飽和水溶液', back: '溶解度いっぱいまで物質がとけた水溶液を何という？', explanation: 'これ以上溶質がとけない限界まで達した水溶液。', difficulty: 'basic' },
      ...
      { id: 'sci1-slp-fc7', front: '溶質の粒子はろ紙を通り抜け、とけていない固体はろ紙上に残る', back: 'ろ過でろ紙を通り抜けるのは？ ろ紙上に残るのは？', explanation: '溶質の粒子は非常に小さいためろ紙を通り抜ける。', difficulty: 'basic' },
      { id: 'sci1-slp-fc8', front: '立方体（さいころ形）', back: '食塩の結晶はどんな形？', explanation: '食塩の結晶は粒子が規則正しく立方体に並んでできている。', difficulty: 'basic' },
      { id: 'sci1-slp-fc9', front: '硝酸カリウム＝針状、ミョウバン＝正八面体', back: '硝酸カリウムとミョウバンの結晶はそれぞれどんな形？', explanation: '結晶の形は物質の粒子の並び方で決まり、物質ごとに固有の形をもつ。', difficulty: 'basic' },
      { id: 'sci1-slp-fc10', front: '①透明である②濃さがどこでも均一③放置しても溶質が沈まない', back: '水溶液に共通する3つの特徴は？', explanation: '溶質が均一に広がっているため、どこでも同じ濃さで透明。', difficulty: 'basic' },
      { id: 'sci1-slp-fc11', front: '1種類の物質だけでできているもの。例：食塩、砂糖、水、酸素', back: '純物質とは何か？ 例を2つ挙げよ', explanation: '1種類の物質だけでできているものを純物質という。', difficulty: 'basic' },
      { id: 'sci1-slp-fc12', front: '2種類以上の物質が混じり合ったもの。例：食塩水、空気', back: '混合物とは何か？ 例を2つ挙げよ', explanation: '2種類以上の物質が混じり合ったものを混合物という。', difficulty: 'basic' },
      ...
      { id: 'sci1-slp-fc17', front: '物質の粒子が規則正しく並んでできた固体。物質ごとに決まった形をしている', back: '結晶とはどのようなものか？', explanation: '結晶は粒子が規則正しく並んだ固体で、物質ごとに固有の形をもつ。', difficulty: 'standard' },
      { id: 'sci1-slp-fc18', front: '半分に折り、さらにもう半分に折ってから、1枚と3枚に開いて円すい形にする', back: 'ろ紙をろうとにセットするとき、どう折る？', explanation: '1枚と3枚に分けて円すい形にし、ろうとにぴったり密着させる。', difficulty: 'standard' },
      ...
      { id: 'sci1-slp-fc20', front: '変わらない。溶液の質量＝水の質量＋砂糖の質量', back: '物質が水にとけると質量は変わる？', explanation: '物質が水にとけても粒子の数は変わらないため質量は保存される。', difficulty: 'standard' },
      { id: 'sci1-slp-fc21', front: 'いえる。透明とは向こう側が透けて見えることで、無色とは異なる', back: '色がついた水溶液は透明といえるか？', explanation: '透明とは向こう側が透けて見えるという意味で、色の有無とは関係ない。', difficulty: 'standard' },
      { id: 'sci1-slp-fc22', front: 'ろ紙を通り抜ける（溶質の粒子が非常に小さいため）', back: '水溶液をろ過すると溶質はどうなるか？', explanation: '溶質の粒子は非常に小さいため、ろ紙の穴を通り抜けてしまう。', difficulty: 'standard' },
      { id: 'sci1-slp-fc23', front: '純物質（水という1種類の物質だけでできているため）', back: '蒸留水は純物質か混合物か？', explanation: '蒸留水は水だけの1種類の物質なので純物質。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc24', front: '混合物（窒素・酸素・アルゴンなど複数の気体が混じり合っているため）', back: '空気は純物質か混合物か？', explanation: '空気は窒素や酸素など複数の気体が混じり合った混合物。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc25', front: 'とけ残る（それ以上とけない）', back: '飽和水溶液にさらに溶質を加えるとどうなるか？', explanation: '飽和状態ではこれ以上溶質を溶かす余地がない。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc26', front: '温度が高くなると大きく増加する', back: '硝酸カリウムの溶解度は温度が変わるとどう変化するか？', explanation: '再結晶に適した物質の代表例', difficulty: 'advanced' },
      { id: 'sci1-slp-fc27', front: '混合物から純粋な物質（純物質）を分離する方法', back: '再結晶は何から何を分離する方法として使われるか？', explanation: '再結晶を利用して混合物から目的の物質だけを取り出せる。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc28', front: '粒子の並び方が物質ごとに決まっているため', back: '物質によって結晶の形が決まっているのはなぜか？', explanation: '粒子の種類によって結合のしかたが異なり、固有の形になる。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc29', front: '食塩', back: '食塩水における溶質は何か？', explanation: '食塩水では食塩が溶けている物質なので溶質にあたる。', difficulty: 'basic' },
      { id: 'sci1-slp-fc30', front: '水', back: '食塩水における溶媒は何か？', explanation: '食塩水では水が溶かしている液体なので溶媒にあたる。', difficulty: 'basic' },
      { id: 'sci1-slp-fc31', front: '砂糖水全体（砂糖＋水）', back: '砂糖水における溶液はどの部分か？', explanation: '溶液は溶質と溶媒が混ざった全体のことを指す。', difficulty: 'basic' },
      { id: 'sci1-slp-fc32', front: '25%（50÷200×100＝25）', back: '水150gに砂糖50gをとかした水溶液の質量パーセント濃度は何%か？', explanation: '溶液＝50＋150＝200g、50÷200×100＝25%。', difficulty: 'standard' },
      { id: 'sci1-slp-fc33', front: '20g（200×10÷100＝20）', back: '質量パーセント濃度10%の食塩水200gに含まれる食塩は何gか？', explanation: '200g×10÷100＝20gの食塩が含まれている。', difficulty: 'standard' },
      { id: 'sci1-slp-fc34', front: '濃度は溶液（溶質＋溶媒）に対する溶質の割合であるため、溶液全体の質量で割る必要がある', back: '質量パーセント濃度で溶質の質量を溶媒の質量で割ってはいけない理由は？', explanation: '濃度は溶液全体に対する溶質の割合なので、溶液で割る。', difficulty: 'standard' },
      { id: 'sci1-slp-fc35', front: '食塩水＝混合物、蒸留水＝純物質', back: '食塩水と蒸留水はそれぞれ純物質か混合物か？', explanation: '食塩水は食塩と水の混合物、蒸留水は水だけの純物質。', difficulty: 'standard' },
      { id: 'sci1-slp-fc36', front: '大きくなる（とける量が増える）', back: '多くの固体の物質は、温度が上がると溶解度はどうなるか？', explanation: '温度が上がると粒子の運動が激しくなり、より多くの溶質が溶ける。', difficulty: 'standard' },
      { id: 'sci1-slp-fc37', front: 'できる（温度が上がると溶解度が大きくなる物質の場合）', back: '飽和水溶液の温度を上げると、溶質をさらにとかすことができるか？', explanation: '温度上昇で溶解度が増えるため、さらに溶質を溶かすことができる。', difficulty: 'standard' },
      { id: 'sci1-slp-fc38', front: '温度による溶解度の差', back: '再結晶では、溶解度の何を利用しているか？', explanation: '高温で多くとけた溶質が、冷却により溶けきれなくなって結晶として出る。', difficulty: 'standard' },
      { id: 'sci1-slp-fc39', front: '純粋な物質（純物質）', back: '再結晶でとり出される結晶は純粋な物質か混合物か？', explanation: '再結晶では不純物が液中に残るため、純粋な結晶が得られる。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc40', front: '規則正しい形をした固体', back: '結晶とは何か？', explanation: '結晶は粒子が規則正しく並んだ固体で、物質を特定する手がかり。', difficulty: 'basic' },
      { id: 'sci1-slp-fc41', front: '正八面体', back: 'ミョウバンの結晶はどのような形か？', explanation: 'ミョウバンの結晶は正八面体の形をしており、美しい幾何学的な形。', difficulty: 'advanced' },
      { id: 'sci1-slp-fc42', front: 'ろ紙の8分目（ろ紙の端より低くする）', back: 'ろうとに注ぐ液の量はろ紙の高さに対してどのくらいまでにするか？', explanation: 'ろ紙よりも高く液を入れるとろ紙の外から流れ出てしまう。', difficulty: 'standard' },
      { id: 'sci1-slp-fc43', front: '2回（半分に折ってさらに半分に折り、円すい形に開く）', back: 'ろ紙をろうとに取りつけるとき、ろ紙を何回折りたたむか？', explanation: '半分に2回折ってから1枚と3枚に開いて使う。', difficulty: 'standard' },
      { id: 'sci1-slp-fc44', front: 'ビーカーの内壁につける（液が飛び散らないようにするため）', back: 'ろうとの先（足の長いほう）はビーカーの壁にどのようにつけるか？', explanation: 'ろうとの先をビーカーの壁につけることで液が飛び散るのを防ぐ。', difficulty: 'standard' },
      { id: 'sci1-slp-fc45', front: '3枚重ねの部分', back: 'ろ過で液体を注ぐとき、ガラス棒はろ紙の何枚重ねの部分にあてるか？', explanation: 'ろ紙が3枚重ねの部分にガラス棒をあて、ろ紙が破れるのを防ぐ。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
