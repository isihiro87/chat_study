...
export const light: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci1-light-fc2', front: '光の直進', back: '光が同じ物質の中をまっすぐ進む性質を何というか？', explanation: '光は同じ物質の中ではまっすぐ進み、影ができる原因にもなる。', difficulty: 'basic' },
      ...
      { id: 'sci1-light-fc7', front: '光が異なる物質の境界面で進む方向が変わる現象', back: '光の屈折とは何か？', explanation: '光の速さが異なる物質の境界で進む方向が変わる現象。', difficulty: 'basic' },
      { id: 'sci1-light-fc8', front: '光が境界面ですべて反射し、向こう側に出ない現象', back: '全反射とは何か？', explanation: '光ファイバーに利用されている。', difficulty: 'basic' },
      { id: 'sci1-light-fc9', front: '全反射を利用して光を遠くまで伝える繊維状の通信ケーブル', back: '光ファイバーとは何か？', explanation: '全反射で光を効率よく遠距離まで伝える通信技術に使われる。', difficulty: 'basic' },
      { id: 'sci1-light-fc10', front: '中央がふくらんだレンズで、光を集めるはたらきがある', back: '凸レンズとはどのようなレンズか？', explanation: '凸レンズは光を1点に集め、像をつくることができる。', difficulty: 'basic' },
      { id: 'sci1-light-fc11', front: '凸レンズの中心を通り、レンズの面に垂直な直線', back: '光軸とは何か？', explanation: '光軸は凸レンズの作図の基準となる直線で、焦点もこの線上にある。', difficulty: 'standard' },
      ...
      { id: 'sci1-light-fc15', front: '物体と同じ大きさの倒立の実像ができる', back: '物体を焦点距離の2倍の位置に置くと、どのような像ができるか？', explanation: '焦点距離の2倍の位置は像の大きさが等倍になる特別な位置。', difficulty: 'standard' },
      { id: 'sci1-light-fc16', front: '①光軸に平行→焦点を通る ②中心を通る→直進 ③焦点を通る→光軸に平行', back: '凸レンズの作図で使う3本の光の道筋を答えよ。', explanation: 'この3本の光の道筋を使って、像の位置と大きさを作図で求められる。', difficulty: 'standard' },
      { id: 'sci1-light-fc17', front: '屈折角＜入射角（法線に近づくように曲がる）', back: '空気中からガラスや水に光が入るとき、入射角と屈折角の関係はどうなるか？', explanation: '密度の大きい物質に入ると光が法線に近づくように曲がる。', difficulty: 'standard' },
      { id: 'sci1-light-fc18', front: '屈折角＞入射角（法線から遠ざかるように曲がる）', back: 'ガラスや水から空気中に光が出るとき、入射角と屈折角の関係はどうなるか？', explanation: '密度の小さい物質に出ると光が法線から遠ざかるように曲がる。', difficulty: 'standard' },
      { id: 'sci1-light-fc19', front: '光源ではない。太陽の光を反射しているだけで、自ら光を出していない。', back: '月は光源か？理由もあわせて答えよ。', explanation: '月は太陽の光を反射して光って見えるが、自ら光を出していない。', difficulty: 'standard' },
      { id: 'sci1-light-fc20', front: '赤以外の光を吸収し、赤色の光だけを反射するから', back: 'りんごが赤く見える理由を説明せよ。', explanation: '物体の色は反射する光の色で決まる。', difficulty: 'standard' },
      { id: 'sci1-light-fc21', front: 'すべての色の光を吸収し、ほとんど反射しないため', back: '黒い物体が黒く見える理由を説明せよ。', explanation: 'すべての光を吸収してしまうため、目に届く光がなく黒く見える。', difficulty: 'standard' },
      { id: 'sci1-light-fc22', front: 'すべての色の光をほぼ均等に反射するため', back: '白い物体が白く見える理由を説明せよ。', explanation: 'すべての色の光を反射するため、白く見える。', difficulty: 'standard' },
      ...
      { id: 'sci1-light-fc25', front: 'さまざまな色（赤・橙・黄・緑・青・藍・紫）に分かれる（分散）', back: '三角柱のガラス（プリズム）に白色光を通すと何が起こるか？', explanation: '色によって屈折の度合いが異なるため、光が色ごとに分かれる。', difficulty: 'advanced' },
      { id: 'sci1-light-fc26', front: '像はできない。光が平行に進むため、どこにも集まらない。', back: '凸レンズの焦点にちょうど物体を置くとどうなるか？', explanation: '焦点からの光は凸レンズを通ると平行になるため、像を結ばない。', difficulty: 'advanced' },
      { id: 'sci1-light-fc27', front: '変わらない。距離にかかわらず身長の半分の鏡で全身が映る。', back: '全身を映す鏡の大きさは、鏡と人の距離によって変わるか？', explanation: '鏡と人の距離に関係なく、身長の半分の大きさの鏡で全身が映る。', difficulty: 'advanced' },
      { id: 'sci1-light-fc28', front: '2回（レンズに入るときと出るときで1回ずつ）', back: '光が凸レンズを通るとき、屈折は何回起こるか？', explanation: 'レンズの入口と出口の2か所で、光が曲がる。', difficulty: 'advanced' },
      { id: 'sci1-light-fc29', front: '太陽・電球・蛍光灯・スマートフォンのディスプレイ', back: '光源の例を4つあげよ。', explanation: '自ら光を出す物体を光源と呼び、光源からの光で他の物体が見える。', difficulty: 'basic' },
      { id: 'sci1-light-fc30', front: '光源から出た光が物体の表面で反射し、その反射した光が目に届くから', back: '光源でない物体が見えるのはなぜか？', explanation: '光源の光が物体に当たり、反射した光が目に届くことで見える。', difficulty: 'standard' },
      { id: 'sci1-light-fc31', front: '光源がないため物体を反射する光がなく、目に光が届かないから', back: '真っ暗な部屋で物が見えない理由を光の性質から説明せよ。', explanation: '光源がなければ物体を照らす光がなく、反射光も生じない。', difficulty: 'standard' },
      { id: 'sci1-light-fc32', front: '白色光（白い光）。さまざまな色の光がまざっている', back: '太陽の光は何色の光と言われるか？またその特徴は？', explanation: '太陽の白色光にはさまざまな色の光が含まれている。', difficulty: 'standard' },
      { id: 'sci1-light-fc33', front: '虚像', back: '鏡にうつった像を何というか？', explanation: '光が実際に集まっているのではなく、光の延長線上に見える', difficulty: 'standard' },
      { id: 'sci1-light-fc34', front: '物体と同じ大きさ', back: '鏡にうつる像の大きさは物体と比べてどうなるか？', explanation: '鏡の像は物体と線対称の位置にできるため、大きさは同じ。', difficulty: 'basic' },
      { id: 'sci1-light-fc35', front: '80cm（身長の半分）', back: '身長160cmの人が全身を鏡にうつすのに必要な鏡の最小の高さはいくらか？', explanation: '身長の半分の鏡があれば、入射角＝反射角の原理で全身が映る。', difficulty: 'standard' },
      { id: 'sci1-light-fc36', front: '水中のストローから出た光が水面で屈折して目に届くため、実際とは異なる位置にあるように見える', back: 'コップの水にストローを入れると曲がって見える理由を答えよ。', explanation: '水面で光が屈折するため、ストローが途中で折れ曲がって見える。', difficulty: 'standard' },
      { id: 'sci1-light-fc37', front: '物体より大きい実像ができる', back: '物体を焦点距離の2倍と焦点の間に置いたとき、実像の大きさはどうなるか？', explanation: '焦点距離の2倍と焦点の間では、拡大された実像ができる。', difficulty: 'advanced' },
      { id: 'sci1-light-fc38', front: '物体より小さい実像ができる', back: '物体を焦点距離の2倍より遠くに置いたとき、実像の大きさはどうなるか？', explanation: '焦点距離の2倍より遠いと、縮小された実像ができる。', difficulty: 'advanced' },
      { id: 'sci1-light-fc39', front: '実像は大きくなり、レンズからの距離は遠くなる', back: '物体を凸レンズに近づけると、実像の大きさと位置はどう変化するか？', explanation: '物体を凸レンズに近づけるほど実像は大きくなり、遠くにできる。', difficulty: 'advanced' },
      { id: 'sci1-light-fc40', front: '実像は小さくなり、焦点に近づく', back: '物体を凸レンズから遠ざけると、実像の大きさと位置はどう変化するか？', explanation: '物体を遠ざけるほど実像は小さくなり、焦点に近づく。', difficulty: 'advanced' },
      { id: 'sci1-light-fc41', front: '虚像。物体と同じ向き（正立）で物体より大きく見える', back: '虫めがねで文字を大きく見ているとき見えている像は何か？その特徴は？', explanation: '焦点より内側に物体を置くと正立で拡大された虚像が見える。虫めがねの原理。', difficulty: 'standard' },
      { id: 'sci1-light-fc42', front: 'なめらかな面では反射光が一方向にそろうため像が見えるが、ざらざらした面では乱反射により光がさまざまな方向に散らばるため像が見えない', back: 'なめらかな鏡で像が見え、ざらざらした面では見えない理由を答えよ。', explanation: 'なめらかな面では正反射で像ができるが、ざらざらした面では乱反射で像ができない。', difficulty: 'advanced' },
      { id: 'sci1-light-fc43', front: '起こらない。全反射はガラスや水から空気など、密度の大きい物質から小さい物質に光が出ようとするときだけ起こる', back: '全反射は空気からガラスに入るときにも起こるか？', explanation: '全反射は密度の大きい物質から小さい物質へ出るときだけ起こる。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
