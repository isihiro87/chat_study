  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        id: 'sci1-sound-fc19',
        front: '太鼓の音源',
        back: '太鼓をたたいたとき、音を出しているのは太鼓の膜（皮）。',
      },
      {
        id: 'sci1-sound-fc20',
        front: 'おんさを水面に近づけると',
        back: '鳴っているおんさを水面に近づけると水面が波立つ（しぶきが上がる）。',
      },
      {
        id: 'sci1-sound-fc21',
        front: '鳴っているおんさに手でふれると',
        back: '音が止まる。振動が止まるため。',
      },
      {
        id: 'sci1-sound-fc22',
        front: '糸電話で音が伝わる仕組み',
        back: '糸が振動を伝えている。糸をたるませると振動が伝わらず聞こえなくなる。',
      },
      {
        id: 'sci1-sound-fc23',
        front: '弦を強くはじくと音の大きさと高さ',
        back: '大きさは大きくなるが、高さは変わらない。',
      },
      {
        id: 'sci1-sound-fc24',
        front: '雷の音が遅れて聞こえる理由',
        back: '光の速さに比べて音の速さが遅いから。',
      },
      {
        id: 'sci1-sound-fc25',
        front: '真空鈴の実験結果',
        back: '容器内の空気を抜いていくとブザーの音がだんだん小さくなり、やがて聞こえなくなる。',
      },
      {
        id: 'sci1-sound-fc26',
        front: 'オシロスコープで大きくて高い音の波形',
        back: '波の高さが大きく、波の間隔がせまい（波の数が多い）。',
      },
      {
        id: 'sci1-sound-fc27',
        front: 'ギターの弦を短くおさえると',
        back: '高い音が出る。弦が短くなると振動数が大きくなるため。',
      },
      {
        id: 'sci1-sound-fc28',
        front: '音が耳に届くしくみ',
        back: '音源の振動→空気の振動（波）→鼓膜の振動→音として認識。',
      },
    ],
    quiz: {
      questions: [
