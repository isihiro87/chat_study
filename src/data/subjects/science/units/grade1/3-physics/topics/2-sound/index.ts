...
export const sound: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci1-sound-fc1', front: '物体の振動が波として物質中を伝わる現象。真空中では伝わらない。', back: '音はどのようにして伝わるか？', explanation: '音は物質の振動が波として伝わるため、真空では伝わらない。', difficulty: 'basic' },
      { id: 'sci1-sound-fc2', front: '約340m/s', back: '空気中の音の速さは約何m/sか？', explanation: '空気中の音速は約340m/sで、温度によって少し変化する。', difficulty: 'basic' },
      { id: 'sci1-sound-fc3', front: '振幅が大きいほど大きい音になる', back: '音の大きさは何によって決まるか？', explanation: '振動の幅（振幅）が大きいほど空気を大きく振動させ、大きな音になる。', difficulty: 'basic' },
      { id: 'sci1-sound-fc4', front: '振動数（Hz）が多いほど高い音になる', back: '音の高さは何によって決まるか？', explanation: '1秒間の振動数（Hz）が多いほど音の波が細かくなり高い音になる。', difficulty: 'basic' },
      ...
      { id: 'sci1-sound-fc7', front: '決まった振動数の音を出す金属製のU字型の実験器具', back: 'おんさとはどのような器具か？', explanation: 'おんさは常に同じ高さの音を出すため、音の実験に適している。', difficulty: 'basic' },
      { id: 'sci1-sound-fc8', front: '空気（気体）、水（液体）、金属・糸（固体）など。真空では伝わらない。', back: '音を伝えることができる物質の例を挙げよ。', explanation: '音は気体・液体・固体いずれの物質中も伝わるが、真空では伝わらない。', difficulty: 'basic' },
      { id: 'sci1-sound-fc9', front: '音速＝距離÷時間（距離＝音速×時間）', back: '音の速さを求める公式を答えよ。', explanation: '反射音（こだま）の場合は往復距離なので2で割る。', difficulty: 'basic' },
      { id: 'sci1-sound-fc10', front: '約1500m/s（空気中の約4.4倍）', back: '水中の音の速さは約何m/sか？', explanation: '液体や固体は分子の密度が高いため、空気中より速く音が伝わる。', difficulty: 'standard' },
      ...
      { id: 'sci1-sound-fc13', front: 'オシロスコープ', back: '音の波形を画面に表示する装置を何というか？', explanation: 'オシロスコープで音の波形を視覚的に確認できる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc14', front: 'モノコード', back: '弦の振動と音の関係を調べる1本弦の実験器具を何というか？', explanation: '1本の弦で振動と音の関係を系統的に調べられる実験器具。', difficulty: 'standard' },
      { id: 'sci1-sound-fc15', front: '低い音になる（振動数が小さくなる）', back: '弦を太くすると音はどう変化するか？', explanation: '太い弦は重いため振動しにくく、振動数が小さくなる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc16', front: '強く張る→高い音、ゆるめる→低い音', back: '弦の張りの強さと音の高さの関係を答えよ。', explanation: '強く張ると弦の復元力が大きくなり、速く振動して高い音になる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc17', front: '太鼓の膜（皮）', back: '太鼓をたたいたとき、音を出している部分はどこか？', explanation: '太鼓をたたくと膜が振動し、その振動が空気に伝わって音になる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc18', front: '音が止まる。振動が止まるため。', back: '鳴っているおんさに手でふれると音はどうなるか？', explanation: '手でふれると振動が止まるため、音も止まる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc19', front: '糸が振動を伝えている。糸をたるませると振動が伝わらず聞こえなくなる。', back: '糸電話で音が伝わる仕組みを説明せよ。', explanation: '糸が声の振動を伝えることで、離れた場所に音が届く。', difficulty: 'standard' },
      { id: 'sci1-sound-fc20', front: '水面が波立つ（しぶきが上がる）', back: '鳴っているおんさを水面に近づけるとどうなるか？', explanation: 'おんさの振動が水面に伝わり、波立つことで振動を目で確認できる。', difficulty: 'standard' },
      ...
      { id: 'sci1-sound-fc22', front: '光の速さに比べて音の速さが遅いから', back: '雷が光ってから音が遅れて聞こえる理由を答えよ。', explanation: '光は一瞬で届くが音は約340m/sと遅いため、距離に応じた遅れが生じる。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc23', front: 'だんだん小さくなり、やがて聞こえなくなる', back: '真空鈴の実験で容器内の空気を抜いていくとブザーの音はどうなるか？', explanation: '空気を抜くと振動を伝える物質がなくなるため、音が伝わらなくなる。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc24', front: '波の高さが大きく、波の間隔がせまい（波の数が多い）', back: 'オシロスコープで大きくて高い音の波形はどのような特徴があるか？', explanation: '波が高いと音が大きく、波の間隔がせまいと音が高いことを示す。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc25', front: '高い音が出る。弦が短くなると振動数が大きくなるため。', back: 'ギターの弦を短くおさえると音はどう変わるか？', explanation: '弦が短いと振動数が大きくなり高い音が出る。ギターのフレット操作の原理。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc26', front: '音源の振動→空気の振動（波）→鼓膜の振動→音として認識', back: '音が耳に届くまでのしくみを順に説明せよ。', explanation: '音は振動として物質中を伝わり、最終的に鼓膜を振動させて聞こえる。', difficulty: 'advanced' },
      ...
      { id: 'sci1-sound-fc28', front: '聞こえる。水が振動を伝えるため。', back: 'プールの中で音は聞こえるか？理由もあわせて答えよ。', explanation: '水も物質なので振動を伝えることができ、音が聞こえる。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc29', front: '弦', back: 'ギターで音を出しているのはどの部分か？', explanation: 'ギターは弦の振動で音を出す弦楽器。', difficulty: 'basic' },
      { id: 'sci1-sound-fc30', front: '振動している', back: 'おんさを鳴らしたとき、おんさはどうなっているか？', explanation: '音は物体の振動で生じるため、鳴っているおんさは振動している。', difficulty: 'basic' },
      { id: 'sci1-sound-fc31', front: '水面が波立つ（しぶきが上がる）', back: 'おんさを鳴らして水面に近づけると水面はどうなるか？', explanation: '振動が水面に伝わって波をつくり、振動の存在を目で確認できる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc32', front: '振幅', back: '振幅とは何か？', explanation: '音源の振動の中心からの幅（振動の大きさ）。オシロスコープでは波の高さ。', difficulty: 'basic' },
      { id: 'sci1-sound-fc33', front: '1秒間に振動する回数。単位はHz（ヘルツ）', back: '振動数とは何か？', explanation: '1秒間に何回振動するかを表す値で、単位はHz（ヘルツ）。', difficulty: 'basic' },
      { id: 'sci1-sound-fc34', front: '大きい音になる（振幅が大きくなるため）', back: '弦を強くはじくと音はどうなるか？', explanation: '強くはじくと振幅が大きくなるが、振動数は変わらないため高さは同じ。', difficulty: 'standard' },
      { id: 'sci1-sound-fc35', front: '低くなる（振動数が小さくなる）', back: '弦を長くすると音はどうなるか？', explanation: '弦が長いと振動にかかる時間が長くなり、振動数が小さくなる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc36', front: '高くなる', back: '弦を細くすると音はどうなるか？', explanation: '細い弦は軽いため速く振動し、振動数が大きくなって高い音が出る。', difficulty: 'standard' },
      { id: 'sci1-sound-fc37', front: '低くなる', back: '弦をゆるめると音はどうなるか？', explanation: 'ゆるめると弦の復元力が小さくなり、ゆっくり振動して低い音になる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc38', front: '振幅（音の大きさ）', back: 'オシロスコープの波形で、波の高さ（縦方向の幅）が表しているのは何か？', explanation: 'オシロスコープの波形で縦方向の幅が振幅を表し、音の大きさに対応する。', difficulty: 'standard' },
      { id: 'sci1-sound-fc39', front: '振動数（音の高さ）', back: 'オシロスコープの波形で、波の間隔（横方向の密度）が表しているのは何か？', explanation: 'オシロスコープの波形で波の間隔がせまいほど振動数が大きく高い音。', difficulty: 'standard' },
      { id: 'sci1-sound-fc40', front: '約1020m（340×3）', back: '花火が見えてから3秒後に音が聞こえた。花火までのおよその距離は何mか？', explanation: '340m/s×3秒＝1020mで、花火までの距離を求められる。', difficulty: 'standard' },
      { id: 'sci1-sound-fc41', front: '680m（340×4÷2、往復なので2で割る）', back: '山に向かって叫んでから4秒後にこだまが返ってきた。山までの距離は何mか？', explanation: '音は往復するので全距離を2で割る。340×4÷2＝680m。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc42', front: '約4.4倍（1500÷340）', back: '水中の音速は空気中の音速の約何倍か？', explanation: '1500÷340で約4.4倍。水中は空気中より速く音が伝わる。', difficulty: 'advanced' },
      { id: 'sci1-sound-fc43', front: '鼓膜', back: '音の振動が耳に届いたとき、最初に振動する部分は何か？', explanation: '音の振動が最初に鼓膜を振動させ、その情報が脳に伝わる。', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
