...
export const celestialBasic: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci3-celb-fc2', front: '日周運動', back: '地球の自転によって天体が1日で東→南中→西と動いて見える運動を何という？', explanation: '地球が西から東へ自転するため、天体は東から西へ動いて見える。', difficulty: 'basic' },
      { id: 'sci3-celb-fc3', front: '年周運動', back: '地球の公転によって同じ時刻に見える星座が1か月で約30度西へ移動する運動を何という？', explanation: '地球が太陽のまわりを公転するため、季節ごとに見える星座が変わる。', difficulty: 'basic' },
      { id: 'sci3-celb-fc4', front: '黄道', back: '太陽が天球上を1年かけて移動する見かけの道すじを何という？', explanation: '地球の公転により太陽が天球上を移動して見え、黄道十二星座がこの線上に並ぶ。', difficulty: 'basic' },
      { id: 'sci3-celb-fc5', front: '23.4度', back: '地軸は公転面に対して何度傾いている？', explanation: 'この傾きが四季の変化や昼夜の長さの変化を生む根本原因。', difficulty: 'basic' },
      { id: 'sci3-celb-fc6', front: '公転', back: '地球が太陽のまわりを1年で1周する運動を何という？', explanation: '公転により年周運動や季節の変化が生じる。公転面に対し地軸が23.4度傾いている。', difficulty: 'basic' },
      { id: 'sci3-celb-fc7', front: 'まわり（約6000℃）より温度が低い（約4000℃）ため', back: '太陽表面の黒点がまわりより暗く見える理由は？', explanation: '黒点は温度が低いため発する光が弱く、まわりより暗く見える。', difficulty: 'basic' },
      { id: 'sci3-celb-fc8', front: 'コロナ（高温ガス層）とプロミネンス（炎状のガス）', back: '太陽のまわりに見られる高温ガスの層と、炎のように吹き出すガスをそれぞれ何という？', explanation: 'コロナは約100万℃。プロミネンスは太陽活動が活発なときに大きくなる。', difficulty: 'standard' },
      { id: 'sci3-celb-fc9', front: '白夜（夏）と極夜（冬）', back: '北極で夏に太陽がしずまない現象と、冬に太陽がのぼらない現象をそれぞれ何という？', explanation: '地軸が23.4度傾いているため、極地では季節により1日中太陽が出る/出ないことがある。', difficulty: 'standard' },
      { id: 'sci3-celb-fc10', front: '自転', back: '地球が地軸を中心に1日で1回転する運動を何という？', explanation: '自転により昼と夜が交互に訪れ、日周運動が生じる。', difficulty: 'basic' },
      { id: 'sci3-celb-fc11', front: '西から東', back: '地球の自転の向きは？', explanation: '西から東へ自転するため、太陽や星は東から西へ動いて見える。', difficulty: 'basic' },
      { id: 'sci3-celb-fc12', front: '天球', back: '観測者を中心とした仮想の球面を何という？', explanation: '天体の位置や動きを表すために使う仮想の球面。天頂が真上の点。', difficulty: 'basic' },
      { id: 'sci3-celb-fc13', front: '南中', back: '天体が天の子午線を通過し、最も高くなることを何という？', explanation: '南中したときの高度が南中高度。太陽は正午ごろに南中する。', difficulty: 'basic' },
      { id: 'sci3-celb-fc14', front: '経度の違い（地球の自転により南中時刻がずれる）', back: '時差が生じる原因は？', explanation: '経度15度で1時間の時差が生じる。地球は24時間で360度自転するため。', difficulty: 'standard' },
      { id: 'sci3-celb-fc15', front: '東の地点ほど先に南中する', back: '地球上で東の地点と西の地点、どちらが先に太陽が南中する？', explanation: '地球は西から東へ自転するため、東の地点が先に太陽に面する。', difficulty: 'standard' },
      { id: 'sci3-celb-fc16', front: '南中高度が最も高く昼が最も長い', back: '日本の夏至の日の特徴は？', explanation: '地軸の北極側が太陽の方を向くため、北半球では太陽が高く昼が長い。', difficulty: 'standard' },
      { id: 'sci3-celb-fc17', front: '南中高度が最も低く昼が最も短い', back: '日本の冬至の日の特徴は？', explanation: '地軸の北極側が太陽と反対を向くため、北半球では太陽が低く昼が短い。', difficulty: 'standard' },
      { id: 'sci3-celb-fc18', front: '約30度（360度÷12か月）', back: '年周運動で星座は1か月に約何度西へ移動する？', explanation: '地球が1年で360度公転するため、1か月で約30度分ずれて見える。', difficulty: 'standard' },
      { id: 'sci3-celb-fc19', front: '地軸が23.4度傾いたまま公転しているから', back: '四季が生まれる根本的な原因は？', explanation: '傾きにより季節ごとに南中高度と昼の長さが変わり、気温が変化する。', difficulty: 'standard' },
      { id: 'sci3-celb-fc20', front: '東→南中→西', back: '日周運動で太陽はどの方角からどの方角へ動く？', explanation: '地球の自転方向（西→東）の逆に、太陽は東から西へ動いて見える。', difficulty: 'basic' },
      { id: 'sci3-celb-fc21', front: '太陽が自転していること', back: '黒点の位置が日ごとに移動することから何がわかる？', explanation: '黒点は太陽表面の模様なので、位置の移動は太陽自体が回転している証拠。', difficulty: 'standard' },
      { id: 'sci3-celb-fc22', front: '夏至は北寄り、冬至は南寄り', back: '季節による太陽の出入りの位置の変化は？', explanation: '地軸の傾きにより、夏は太陽の通り道が北寄りになり、冬は南寄りになる。', difficulty: 'advanced' },
      { id: 'sci3-celb-fc23', front: '真東からのぼり真西にしずむ', back: '春分・秋分の日の太陽の出入りの方角は？', explanation: '春分・秋分は昼と夜の長さがほぼ等しく、太陽は真東と真西を通る。', difficulty: 'advanced' },
      { id: 'sci3-celb-fc24', front: '黄道十二星座', back: '黄道上に並ぶ12の星座を何という？', explanation: '太陽の見かけの通り道に位置する星座で、1か月ごとに太陽が通過する。', difficulty: 'advanced' },
      { id: 'sci3-celb-fc25', front: '自転は1日で1回転、公転は1年で太陽を1周', back: '自転と公転の周期はそれぞれどれくらい？', explanation: '自転が日周運動、公転が年周運動の原因になる。', difficulty: 'advanced' },
      { id: 'sci3-celb-fc26', front: '夏（地軸の北極側が太陽の方を向く）', back: '北半球で地軸の北極側が太陽の方を向いている季節は？', explanation: '北極側が太陽を向くと南中高度が高くなり昼が長くなるため夏になる。', difficulty: 'advanced' },
      { id: 'sci3-celb-fc27', front: '約6000℃（黒点は約4000℃）', back: '太陽の表面温度はおよそ何℃？黒点の温度は？', explanation: '約2000℃の温度差があるため、黒点はまわりより暗く見える。', difficulty: 'standard' },
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-celb-q7', question: '年周運動で星座が1か月に約30度西へ移動する理由は？', options: ['星座が動いているから','地球が自転しているから','月が動いているから','地球が公転しているから'], correctIndex: 3, explanation: '地球が1年（12か月）で360度公転するため、1か月で360÷12＝約30度分ずれて見えます。', difficulty: 'basic' },
        ...
        { id: 'sci3-celb-q10', question: '太陽が天球上を1年かけて移動する見かけの道すじを何という？', options: ['天の子午線','赤道','地平線','黄道'], correctIndex: 3, explanation: '黄道は地球の公転により太陽が天球上を移動して見える道すじです。', difficulty: 'basic' },
        ...
        { id: 'sci3-celb-q12', question: 'プロミネンスとは何か？', options: ['太陽表面の暗い部分','太陽系外の天体','太陽のまわりの高温ガス層','太陽表面から吹き出す炎状のガス'], correctIndex: 3, explanation: 'プロミネンスは太陽表面から炎のように吹き出すガスです。コロナは太陽のまわりの高温ガス層です。', difficulty: 'standard' },
        ...
        { id: 'sci3-celb-q14', question: '地球の自転により太陽が最も高くなる現象を何という？', options: ['公転','月食','日食','南中'], correctIndex: 3, explanation: '太陽が天の子午線を通過して最も高くなることを南中といいます。', difficulty: 'standard' },
        ...
        { id: 'sci3-celb-q17', question: '地球が太陽のまわりを1年で1周する運動を何という？', options: ['公転','自転','日周運動','年周運動'], correctIndex: 0, explanation: '公転は地球が太陽のまわりを1年で1周する運動です。自転は地球が1日で1回転する運動です。', difficulty: 'standard' },
        ...
        { id: 'sci3-celb-q19', question: '時差が生じる原因は？', options: ['地球の公転','月の公転','緯度の違い','経度の違い'], correctIndex: 3, explanation: '地球が自転しているため、経度が異なる地点では太陽の南中時刻がずれ、これが時差の原因です。', difficulty: 'standard' },
        ...
        { id: 'sci3-celb-q22', question: '夏至の日の太陽の出入りの方角は？', options: ['北寄りから北寄り','真東から真西','南寄りから南寄り','真南から真北'], correctIndex: 0, explanation: '夏至の日は太陽が北寄りの方角からのぼり、北寄りの方角にしずみます。', difficulty: 'standard' },
        { id: 'sci3-celb-q23', question: '北極で夏に太陽がしずまない現象を何という？', options: ['白夜','極夜','日食','南中'], correctIndex: 0, explanation: '白夜は北極で夏至のころ、太陽がしずまない現象です。地軸が23.4度傾いていることが原因です。', difficulty: 'advanced' },
        ...
        { id: 'sci3-celb-q25', question: '自転と公転の周期はそれぞれどれくらい？', options: ['自転1日、公転1年','自転1年、公転1日','両方1日','両方1年'], correctIndex: 0, explanation: '自転は1日で1回転、公転は1年で太陽のまわりを1周します。', difficulty: 'advanced' },
