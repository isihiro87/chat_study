  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        id: 'sci3-celb-fc6',
        front: '公転',
        back: '地球が太陽のまわりを1年で1周する運動を何という？',
        explanation: '公転により年周運動が起こり、季節の変化が生まれる。',
      },
      {
        id: 'sci3-celb-fc7',
        front: '黒点',
        back: '太陽表面の暗い部分を何という？なぜ暗い？',
        explanation:
          '黒点はまわり（約6000℃）より温度が低い（約4000℃）ため暗く見える。黒点の移動は太陽の自転の証拠。',
      },
      {
        id: 'sci3-celb-fc8',
        front: 'コロナとプロミネンス',
        back: '太陽のまわりに見られる高温ガスの層と、炎のように吹き出すガスをそれぞれ何という？',
        explanation:
          'コロナは約100万℃の高温ガス。プロミネンスは太陽表面から吹き出す炎状のガス。',
      },
      {
        id: 'sci3-celb-fc9',
        front: '白夜と極夜',
        back: '北極で夏に太陽がしずまない現象と、冬に太陽がのぼらない現象をそれぞれ何という？',
        explanation:
          '地軸が23.4度傾いているため、北極では夏至のころ白夜、冬至のころ極夜が起こる。',
      },
    ],
    quiz: {
      questions: [
