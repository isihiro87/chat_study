...
export const solarSystemPlanets: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-ssp-fc1', front: '地球型惑星（岩石・小型・高密度）', back: '水星・金星・地球・火星のように、岩石でできた小型で密度が高い惑星を何という？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc2', front: '木星型惑星（気体・大型・低密度）', back: '木星・土星・天王星・海王星のように、気体でできた大型で密度が低い惑星を何という？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc3', front: '二酸化炭素の厚い大気（温室効果で約460℃）', back: '金星は何の大気に覆われ、表面温度は約何℃？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc4', front: '赤い色（酸化鉄）、大気が非常に薄い', back: '火星の色と大気の特徴は？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc5', front: '木星（大赤斑という巨大な渦がある）', back: '太陽系で最も大きい惑星は？表面にある巨大な渦模様を何という？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc6', front: '0.69g/cm³（水より小さい）', back: '土星の密度は何g/cm³？水の密度と比べてどうか？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc7', front: '自転軸がほぼ横倒しになっている', back: '天王星の自転軸にはどのような特徴がある？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc8', front: '青い色をしている（太陽から最も遠い惑星）', back: '海王星の色と太陽系での位置は？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc9', front: 'クレーターが多い（太陽に最も近い惑星）', back: '水星の表面の特徴と太陽からの順番は？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc10', front: '環（リング）（主に氷の粒でできている）', back: '土星の特徴的な構造は何？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc11', front: 'すべて同じ方向に公転している', back: '太陽系の8つの惑星の公転方向の特徴は？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc12', front: '衛星（地球の衛星は月）', back: '惑星のまわりを公転する天体を何という？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc13', front: 'ガニメデ・カリスト・イオ・エウロパ（ガリレオ衛星）', back: '木星の代表的な4つの衛星を答えよ。', difficulty: 'standard' },
      { id: 'sci3-ssp-fc14', front: '火星と木星の間', back: '小惑星帯はどの惑星とどの惑星の間にある？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc15', front: '太陽の熱で氷が蒸発し、ガスや塵が放出されるから', back: 'すい星が太陽に近づくと尾を引くのはなぜ？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc16', front: '太陽系外縁天体', back: '海王星より外側にある冥王星やエリスなどの天体をまとめて何という？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc17', front: '水金地火木土天海', back: '太陽系の8つの惑星を太陽に近い順に覚える語呂合わせは？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc18', front: '8つ', back: '太陽系の惑星の数は？', difficulty: 'basic' },
      { id: 'sci3-ssp-fc19', front: '冥王星（太陽系外縁天体に再分類）', back: 'かつて惑星に分類されていたが、現在は惑星ではない天体は？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc20', front: '酸化鉄（さび）', back: '火星が赤く見える原因の物質は？', difficulty: 'standard' },
      { id: 'sci3-ssp-fc21', front: '温室効果（二酸化炭素の厚い大気による）', back: '金星の表面温度が約460℃と非常に高い原因は？', difficulty: 'advanced' },
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-ssp-q12', question: '天王星の自転軸の特徴は？', options: ['垂直', '横倒し', '逆回転', '傾きなし'], correctIndex: 1, explanation: '天王星は自転軸が公転面に対してほぼ横倒しになっています。', difficulty: 'standard' },
        ...
        { id: 'sci3-ssp-q14', question: '木星の代表的な4つの衛星の総称は？', options: ['月の仲間', 'ガリレオ衛星', '土星の環', '小惑星群'], correctIndex: 1, explanation: 'ガニメデ・カリスト・イオ・エウロパの4つをガリレオ衛星といいます。ガリレオが望遠鏡で発見しました。', difficulty: 'standard' },
        ...
        { id: 'sci3-ssp-q16', question: '冥王星が惑星から外された理由は？', options: ['発見が新しいから', '軌道が楕円だから', '太陽系外縁天体に再分類されたから', '温度が低すぎるから'], correctIndex: 2, explanation: '2006年に国際天文学連合が惑星の定義を改定し、冥王星は太陽系外縁天体に再分類されました。', difficulty: 'standard' },
        { id: 'sci3-ssp-q17', question: '地球型惑星4つを太陽に近い順に正しく並べたものは？', options: ['金星・水星・地球・火星', '水星・金星・地球・火星', '地球・火星・金星・水星', '水星・地球・金星・火星'], correctIndex: 1, explanation: '太陽に近い順に水星・金星・地球・火星の4つが地球型惑星です。', difficulty: 'standard' },
        { id: 'sci3-ssp-q18', question: '木星型惑星4つを太陽に近い順に正しく並べたものは？', options: ['土星・木星・天王星・海王星', '木星・土星・天王星・海王星', '天王星・海王星・木星・土星', '木星・天王星・土星・海王星'], correctIndex: 1, explanation: '太陽に近い順に木星・土星・天王星・海王星の4つが木星型惑星です。', difficulty: 'standard' },
        ...
        { id: 'sci3-ssp-q26', question: '太陽系で最も表面温度が高い惑星は？', options: ['水星', '金星', '木星', '火星'], correctIndex: 1, explanation: '金星は二酸化炭素の厚い大気による温室効果で表面温度が約460℃と太陽系で最も高くなります。太陽に最も近い水星よりも高温です。', difficulty: 'advanced' },
        ...
        { id: 'sci3-ssp-q28', question: '小惑星が帯状に多く分布しているのはどの惑星の間？', options: ['地球と火星', '火星と木星', '木星と土星', '土星と天王星'], correctIndex: 1, explanation: '小惑星帯は火星と木星の間に位置しています。不規則な形の小さな天体が多数あります。', difficulty: 'advanced' },
      ],
    },
    examples: {
      examples: [
