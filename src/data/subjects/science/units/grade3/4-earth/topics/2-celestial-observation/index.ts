  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-celo-q13', question: '夏至と冬至の南中高度の差は何度？', options: ['23.4度', '46.8度', '90度', '30度'], correctIndex: 1, explanation: '夏至と冬至の差は23.4×2＝46.8度です。地軸の傾きが両方に影響するためです。', difficulty: 'standard' },
        ...
        { id: 'sci3-celo-q16', question: '年周運動で3か月後の同時刻に星座は何度西へ移動する？', options: ['30度', '60度', '90度', '120度'], correctIndex: 2, explanation: '1か月で約30度なので、3か月で30×3＝約90度西へ移動します。', difficulty: 'standard' },
        ...
        { id: 'sci3-celo-q18', question: '北極星がほとんど動かない理由は？', options: ['非常に遠いから', '地軸の延長線上にあるから', '他の星より重いから', '明るすぎるから'], correctIndex: 1, explanation: '北極星は地球の自転軸（地軸）の延長線上にあるため、地球が自転してもほとんど位置が変わりません。', difficulty: 'standard' },
        ...
        { id: 'sci3-celo-q20', question: '1月に午後9時に真南に見えた星座を3月に真南に見るには何時ごろ観察する？', options: ['午後11時', '午後7時', '午後5時', '午前3時'], correctIndex: 2, explanation: '1か月で約2時間早く南中するので、2か月で4時間早くなり、午後9時−4時間＝午後5時ごろです。', difficulty: 'standard' },
        ...
        { id: 'sci3-celo-q22', question: '夏至の日に太陽がのぼる方角は？', options: ['真東', '北寄り', '南寄り', '真南'], correctIndex: 1, explanation: '夏至の日は太陽が北寄りの方角からのぼります。冬至は南寄りです。', difficulty: 'standard' },
        ...
        { id: 'sci3-celo-q27', question: '北極で冬に太陽がのぼらない現象を何という？', options: ['白夜', '日食', '極夜', '月食'], correctIndex: 2, explanation: '極夜は北極で冬至のころに太陽がのぼらない現象です。地軸が傾いていることが原因です。', difficulty: 'advanced' },
        { id: 'sci3-celo-q28', question: '北の空の星が北極星を中心に何回りに動いて見える？', options: ['時計回り', '反時計回り', '上下に往復', '動かない'], correctIndex: 1, explanation: '北の空の星は北極星を中心に反時計回りに動いて見えます。', difficulty: 'advanced' },
      ],
    },
    examples: {
      examples: [
