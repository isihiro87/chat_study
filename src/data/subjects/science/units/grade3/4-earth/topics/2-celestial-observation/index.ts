...
export const celestialObservation: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-celo-fc1', front: '天球', back: '観測者を中心とした仮想の球面を何という？', explanation: '天体の位置や動きを表すために使う仮想の球面。実際には存在しない。', difficulty: 'basic' },
      { id: 'sci3-celo-fc2', front: '天頂', back: '天球上で観測者の真上にあたる点を何という？', explanation: '天頂の反対側（真下）を天底という。', difficulty: 'basic' },
      { id: 'sci3-celo-fc3', front: '天の子午線', back: '天球上で天頂と北の点・南の点を結ぶ線を何という？', explanation: '天体がこの線を通過するときに最も高くなり、これを南中という。', difficulty: 'basic' },
      { id: 'sci3-celo-fc4', front: '南中（そのときの角度が南中高度）', back: '天体が天の子午線を通過し最も高くなることを何という？', explanation: '太陽は正午ごろに南中し、そのときの高度が季節によって変わる。', difficulty: 'basic' },
      { id: 'sci3-celo-fc5', front: '●印の間隔が等しい（太陽が等速で動いている証拠）', back: '透明半球で太陽の位置を記録したとき、●印の間隔にはどんな特徴がある？', explanation: '地球の自転速度が一定であるため、太陽の見かけの動きも一定速度になる。', difficulty: 'standard' },
      { id: 'sci3-celo-fc6', front: '約15度（360度÷24時間）', back: '日周運動で天体は1時間に約何度動いて見える？', explanation: '地球が24時間で360度自転するため、1時間あたり15度ずつ動いて見える。', difficulty: 'basic' },
      { id: 'sci3-celo-fc7', front: '北極星を中心に反時計回り', back: '北の空の星はどのように動いて見える？', explanation: '地球が西から東へ自転するため、北の空では反時計回りに見える。', difficulty: 'basic' },
      { id: 'sci3-celo-fc8', front: '地軸の延長線上にあるため、ほとんど動かない', back: '北極星はなぜほとんど動かない？', explanation: '北極星は地球の自転軸の延長線上にあるため、回転の中心に位置する。', difficulty: 'basic' },
      { id: 'sci3-celo-fc9', front: '東経135度（兵庫県明石市）', back: '日本の標準時子午線は東経何度？どの都市を通る？', explanation: '日本全国の標準時はこの子午線上の時刻を基準にしている。', difficulty: 'basic' },
      { id: 'sci3-celo-fc10', front: '90度−緯度（例：北緯35度なら55度）', back: '春分・秋分の日の南中高度を求める式は？', explanation: '春分・秋分では太陽が赤道上にあるため、この式で求められる。', difficulty: 'basic' },
      { id: 'sci3-celo-fc11', front: '90度−緯度＋23.4度（例：北緯35度なら78.4度）', back: '夏至の日の南中高度を求める式は？', explanation: '夏至では太陽が北回帰線上にあるため、23.4度分高くなる。', difficulty: 'standard' },
      { id: 'sci3-celo-fc12', front: '90度−緯度−23.4度（例：北緯35度なら31.6度）', back: '冬至の日の南中高度を求める式は？', explanation: '冬至では太陽が南回帰線上にあるため、23.4度分低くなる。', difficulty: 'standard' },
      { id: 'sci3-celo-fc13', front: '夏至は北寄り、冬至は南寄り、春分秋分は真東から真西', back: '季節ごとの太陽の出入り位置はどう違う？', explanation: '地軸の傾きにより太陽の通り道が季節で変わるため、出入りの方角も変化する。', difficulty: 'standard' },
      { id: 'sci3-celo-fc14', front: '右ななめ上', back: '東の空での星の動きは？', explanation: '東の空では星がのぼっていくため、右ななめ上に動いて見える。', difficulty: 'standard' },
      { id: 'sci3-celo-fc15', front: '右（西）へ弧を描く', back: '南の空での星の動きは？', explanation: '南の空では星が東から西へ弧を描いて移動して見える。', difficulty: 'standard' },
      { id: 'sci3-celo-fc16', front: '右ななめ下', back: '西の空での星の動きは？', explanation: '西の空では星がしずんでいくため、右ななめ下に動いて見える。', difficulty: 'standard' },
      { id: 'sci3-celo-fc17', front: '46.8度（23.4度×2）', back: '夏至と冬至の南中高度の差は何度？', explanation: '夏至は＋23.4度、冬至は−23.4度なので、差は23.4×2＝46.8度。', difficulty: 'standard' },
      { id: 'sci3-celo-fc18', front: '経度15度で1時間の時差', back: '経度と時差の関係は？', explanation: '360度÷24時間＝15度。経度が15度異なると1時間の時差が生じる。', difficulty: 'standard' },
      { id: 'sci3-celo-fc19', front: '1か月で約2時間早く南中する', back: '年周運動で、ある星座の南中時刻は1か月でどれだけ変化する？', explanation: '1か月で約30度＝約2時間分ずれるため、南中時刻が2時間早くなる。', difficulty: 'advanced' },
      { id: 'sci3-celo-fc20', front: 'GMT（グリニッジ標準時）', back: '世界時の基準となる時刻は何？', explanation: 'イギリスのグリニッジ天文台を通る経度0度を基準とした時刻。', difficulty: 'advanced' },
      { id: 'sci3-celo-fc21', front: '南西の方角（2か月×30度＝60度西へ移動）', back: '1月に午後9時に真南に見えた星座は、3月の午後9時にはどの方角に見える？', explanation: '年周運動で1か月約30度西へ移動するため、2か月で60度西＝南西の方角。', difficulty: 'advanced' },
      { id: 'sci3-celo-fc22', front: '午後5時ごろ（2か月×2時間＝4時間早くなる）', back: '1月に午後9時に真南に見えた星座を、3月に真南に見るには何時ごろ観察する？', explanation: '南中時刻が1か月で約2時間早くなるため、2か月で4時間早い午後5時ごろ。', difficulty: 'advanced' },
      { id: 'sci3-celo-fc23', front: 'ペン先の影が記録用紙の点に重なるように記録', back: '透明半球で太陽の位置を記録する方法は？', explanation: 'ペンの影を利用して太陽の方向を正確に記録する実験方法。', difficulty: 'advanced' },
      { id: 'sci3-celo-fc24', front: '極夜', back: '北極で冬に太陽がのぼらない現象を何という？', explanation: '地軸の傾きにより、冬至のころ北極では1日中太陽がのぼらない。', difficulty: 'advanced' },
      ...
      { id: 'sci3-celo-fc26', front: 'グリニッジ（イギリス）', back: '世界の時刻の基準になっている天文台がある都市はどこ？', explanation: 'グリニッジ天文台を通る経度0度が世界時の基準。', difficulty: 'standard' },
      { id: 'sci3-celo-fc27', front: '南中高度', back: '天体が南中したときの地平線からの角度を何という？', explanation: '季節によって変化し、夏至が最大、冬至が最小になる。', difficulty: 'basic' },
      { id: 'sci3-celo-fc28', front: '夏は南中高度が高く昼が長いため、冬は低く短いため', back: '夏が冬より暖かい理由を「南中高度」と「昼の長さ」から説明せよ。', explanation: '南中高度が高いと地面に注ぐ光のエネルギーが大きく、昼が長いと受ける熱量が多い。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
