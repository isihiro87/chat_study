...
export const universe: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-uni-fc1', front: '銀河', back: '恒星が数千億個集まった大集団を何という？', difficulty: 'basic' },
      { id: 'sci3-uni-fc2', front: '光年', back: '光が1年間に進む距離を表す単位を何という？', difficulty: 'basic' },
      { id: 'sci3-uni-fc3', front: '天文単位（約1.5億km）', back: '太陽と地球の平均距離を1とする単位を何という？', difficulty: 'basic' },
      { id: 'sci3-uni-fc4', front: '約10万光年', back: '銀河系（天の川銀河）の直径はおよそ何光年？', difficulty: 'basic' },
      { id: 'sci3-uni-fc5', front: '約2000億個', back: '銀河系にはおよそ何個の恒星がある？', difficulty: 'basic' },
      { id: 'sci3-uni-fc6', front: '約3万光年（中心と端の中間あたり）', back: '太陽系は銀河系の中心からおよそ何光年の位置にある？', difficulty: 'basic' },
      { id: 'sci3-uni-fc7', front: '銀河系（天の川銀河）', back: '太陽系が属する銀河の名前は？', difficulty: 'basic' },
      { id: 'sci3-uni-fc8', front: '渦巻き円盤状', back: '銀河系の形は？', difficulty: 'basic' },
      { id: 'sci3-uni-fc9', front: '約9.5兆km（約6.3万天文単位）', back: '1光年はおよそ何km？', difficulty: 'standard' },
      { id: 'sci3-uni-fc10', front: '約1.5億km', back: '1天文単位をkmで表すと？', difficulty: 'standard' },
      { id: 'sci3-uni-fc11', front: '約1.5万光年', back: '銀河系の厚さはおよそ何光年？', difficulty: 'standard' },
      { id: 'sci3-uni-fc12', front: '無数にある', back: '銀河系以外にも銀河は存在するか？', difficulty: 'standard' },
      { id: 'sci3-uni-fc13', front: '天の川', back: '銀河系を地球から見たとき、夜空に帯状に見える光の帯を何という？', difficulty: 'standard' },
      { id: 'sci3-uni-fc14', front: 'アンドロメダ銀河', back: '銀河系に最も近い大きな銀河は？', difficulty: 'standard' },
      { id: 'sci3-uni-fc15', front: '太陽系 ⊂ 銀河系 ⊂ 宇宙', back: '太陽系・銀河系・宇宙の包含関係は？', difficulty: 'standard' },
      { id: 'sci3-uni-fc16', front: '秒速約30万km', back: '光の速さはどれくらい？', difficulty: 'standard' },
      { id: 'sci3-uni-fc17', front: '約8分（約500秒）', back: '太陽の光が地球に届くのにかかる時間は？', difficulty: 'advanced' },
      { id: 'sci3-uni-fc18', front: '太陽系内の距離を表すとき', back: '天文単位はどのような場面で使われる？', difficulty: 'advanced' },
      { id: 'sci3-uni-fc19', front: '天体間（恒星間や銀河間）の距離を表すとき', back: '光年はどのような場面で使われる？', difficulty: 'advanced' },
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-uni-q5', question: '太陽系は銀河系の中心からおよそ何光年の位置にある？', options: ['約1000光年', '約1万光年', '約3万光年', '約10万光年'], correctIndex: 2, explanation: '太陽系は銀河系の中心から約3万光年の位置にあります。', difficulty: 'basic' },
        { id: 'sci3-uni-q6', question: '銀河とは何か？', options: ['1つの恒星', '恒星が数千億個集まった大集団', '惑星の集まり', '衛星の集まり'], correctIndex: 1, explanation: '銀河とは恒星が数千億個集まった大集団のことです。宇宙にはこのような銀河が無数にあります。', difficulty: 'basic' },
        { id: 'sci3-uni-q7', question: '銀河系の形はどのような形？', options: ['球状', '立方体', '渦巻き円盤状', '三角形'], correctIndex: 2, explanation: '銀河系は渦を巻いた円盤状の形をしています。直径約10万光年、厚さ約1.5万光年です。', difficulty: 'basic' },
        { id: 'sci3-uni-q8', question: '1天文単位はおよそ何km？', options: ['約1500万km', '約1.5億km', '約15億km', '約150億km'], correctIndex: 1, explanation: '1天文単位は太陽と地球の平均距離で約1.5億km（約1億5000万km）です。', difficulty: 'basic' },
        ...
        { id: 'sci3-uni-q11', question: '天の川とは何か？', options: ['地球の大気の光', '銀河系を地球から見たときの帯状の光', '太陽の光の反射', '月の光'], correctIndex: 1, explanation: '天の川は銀河系の円盤を横から見たもので、無数の恒星が帯状に見える光です。', difficulty: 'standard' },
        ...
        { id: 'sci3-uni-q18', question: '光の速さはおよそ秒速何km？', options: ['約3万km', '約30万km', '約300万km', '約3000万km'], correctIndex: 1, explanation: '光の速さは秒速約30万km（約3×10⁵km/s）です。1秒で地球を7周半できる速さです。', difficulty: 'standard' },
        { id: 'sci3-uni-q19', question: '太陽の光が地球に届くのにかかる時間は？', options: ['約1秒', '約1分', '約8分', '約1時間'], correctIndex: 2, explanation: '太陽と地球の距離は約1.5億kmで、光の速さは秒速約30万km。1.5億÷30万＝約500秒≒約8分19秒です。', difficulty: 'standard' },
        { id: 'sci3-uni-q20', question: '銀河系に最も近い大きな銀河は？', options: ['太陽系', 'マゼラン雲', 'アンドロメダ銀河', '天の川'], correctIndex: 2, explanation: 'アンドロメダ銀河は銀河系に最も近い大きな銀河で、約250万光年の距離にあります。', difficulty: 'standard' },
        ...
        { id: 'sci3-uni-q25', question: '恒星が数千億個集まった大集団を何という？', options: ['太陽系', '惑星系', '銀河', '星座'], correctIndex: 2, explanation: '銀河とは恒星が数千億個集まった大集団です。太陽系が属する銀河は銀河系（天の川銀河）です。', difficulty: 'advanced' },
        ...
        { id: 'sci3-uni-q27', question: '宇宙の広がりを大きい順に並べたものは？', options: ['太陽系→銀河系→宇宙', '宇宙→銀河系→太陽系', '銀河系→太陽系→宇宙', '宇宙→太陽系→銀河系'], correctIndex: 1, explanation: '宇宙が最も大きく、その中に銀河系があり、銀河系の中に太陽系があります。', difficulty: 'advanced' },
