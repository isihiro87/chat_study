...
export const moonVenusDetail: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-mvd-fc1', front: '反時計回り（西から東）', back: '月は地球のまわりをどの向きに公転している？（北極側から見て）', explanation: '地球の自転と同じ方向。毎日同時刻に月を見ると東へずれて見える原因。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc2', front: '約50分ずつ遅くなる', back: '月の南中時刻は毎日どれくらい変化する？', explanation: '月が公転で東へ移動するため。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc3', front: '約27.3日（常に同じ面を地球に向ける）', back: '月の自転周期と公転周期はともに約何日？', explanation: '自転と公転の周期が一致するため、地球からは常に同じ面しか見えない。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc4', front: '大きく見えるが、大きく欠けて見える', back: '金星が地球に近いとき、大きさと形はどう見える？', explanation: '近いほど見かけが大きいが、太陽光は横から当たるため大きく欠ける。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc5', front: '小さく見えるが、丸く（満ちて）見える', back: '金星が地球から遠いとき、大きさと形はどう見える？', explanation: '遠いため見かけは小さいが、太陽光がほぼ正面から当たるため丸く見える。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc6', front: '外惑星（真夜中にも見え、ほぼ丸い）', back: '地球より外側を公転する惑星を何という？', explanation: '火星・木星・土星・天王星・海王星が外惑星。太陽の反対側にも来れるため真夜中にも見える。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc7', front: '皆既日食', back: '太陽が月に完全にかくされる日食を何という？', explanation: '月が太陽を完全にかくし、コロナやプロミネンスが観察できる。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc8', front: '金環日食', back: '月が太陽より小さく見え、太陽のふちがリング状に見える日食を何という？', explanation: '月が地球から遠いとき見かけが小さくなり、太陽を完全にかくせない。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc9', front: '皆既月食（赤銅色に見えることがある）', back: '月が地球の影に完全に入る月食を何という？', explanation: '地球の大気で屈折した赤い光が月に届くため、完全に暗くはならず赤銅色に見える。', difficulty: 'basic' },
      { id: 'sci3-mvd-fc10', front: '太陽の直径は月の約400倍、距離も約400倍だから', back: '太陽と月の見かけの大きさがほぼ同じ理由は？', explanation: '大きさと距離の比率が偶然ほぼ等しいため、見かけの大きさがほぼ同じになる。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc11', front: '月の影が地球上のごく限られた範囲にしか落ちないため', back: '日食が限られた場所でしか見えないのはなぜ？', explanation: '月の影は直径200km程度と小さく、その範囲でしか日食を観察できない。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc12', front: '常に同じ面を地球に向けている', back: '月の自転周期と公転周期が同じことから何がわかる？', explanation: '潮汐力の影響で自転と公転が同期し、裏側は地球から見えない。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc13', front: '東へずれる（月の公転方向と同じ）', back: '毎日同時刻に月を見ると月の位置はどちらにずれる？', explanation: '月が西から東へ公転しているため、毎日約13度ずつ東へずれる。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc14', front: '火星・木星・土星・天王星・海王星', back: '外惑星を5つ答えよ', explanation: '地球より外側を公転する惑星。太陽の反対方向にも位置できるため真夜中にも見える。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc15', front: '部分日食', back: '太陽の一部だけが月に隠される日食を何という？', explanation: '月の影のふちの範囲で観察でき、皆既日食より広い範囲で見られる。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc16', front: '月の公転軌道が楕円で地球からの距離が変わるから', back: '皆既日食と金環日食の違いが生まれる原因は？', explanation: '月が近いと見かけが大きく太陽をかくしきれる（皆既）。遠いとかくしきれない（金環）。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc17', front: '太陽光がほぼ正面から当たる面が常に見えるから', back: '外惑星が大きく満ち欠けしない理由は？', explanation: '外惑星は地球の外側にあるため、太陽光がほぼ正面から当たった面が見える。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc18', front: '夕方に南中し、真夜中に西に沈む', back: '上弦の月の南中時刻と沈む時刻は？', explanation: '上弦の月は太陽の東90度の位置にあるため、太陽より約6時間遅れて南中する。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc19', front: '真夜中に南中し、昼ごろに西に沈む', back: '下弦の月の南中時刻と沈む時刻は？', explanation: '下弦の月は太陽の西90度の位置にあるため、太陽より約12時間遅れて南中する。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc20', front: '赤銅色に見える（地球の大気で屈折した赤い光が届くため）', back: '皆既月食のとき月はどのように見える？', explanation: '地球の大気がプリズムのように光を屈折させ、赤い光だけが月に届く。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc21', front: '正午ごろ（太陽と同じ方向にあるため）', back: '新月が南中する時刻は？', explanation: '新月は太陽とほぼ同じ方向にあるため、太陽と一緒に南中する。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc22', front: '地球も公転しているため同じ位置関係に戻るのにさらに約2日かかる', back: '月の満ち欠けの周期（約29.5日）と公転周期（約27.3日）が異なる理由は？', explanation: '月が1周する間に地球も公転で位置が変わるため、さらに追いつく必要がある。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc23', front: 'コロナやプロミネンスが見える', back: '皆既日食のときに観察できる太陽の構造は？', explanation: 'ふだんは太陽の強い光に隠れているコロナやプロミネンスが皆既日食時に観察できる。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc24', front: '太陽の西側にあるとき', back: '金星が明けの明星として見えるとき、金星は太陽のどちら側にある？', explanation: '太陽の西側にあるため、日の出前に東の空で太陽より先に見える。', difficulty: 'advanced' },
      { id: 'sci3-mvd-fc25', front: '太陽の東側（太陽の左側）', back: 'よいの明星として見えるとき、金星は太陽のどちら側にある？', explanation: '太陽の東側にあるため、日没後に西の空で太陽の後に残って見える。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc26', front: '地球と金星の距離が公転により変化するため', back: '金星の見かけの大きさが変化するのはなぜ？', explanation: '近いときは大きく、遠いときは小さく見える。同時に満ち欠けの形も変わる。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc27', front: '約400倍', back: '太陽の直径は月の直径の約何倍？', explanation: '太陽までの距離も月の約400倍のため見かけの大きさがほぼ等しくなる。', difficulty: 'standard' },
      { id: 'sci3-mvd-fc28', front: '部分月食', back: '月の一部だけが地球の影に入る月食を何という？', explanation: '月の一部だけが暗くなる。皆既月食のほうがまれに起こる。', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
