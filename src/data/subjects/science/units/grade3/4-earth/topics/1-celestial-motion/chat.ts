...
export const celestialMotionChat: HistoryChat = {
  ...
  content: [
    ...
    },
    {
      ...
      points: [
        ...
        '<strong><ruby>公転<rp>(</rp><rt>こうてん</rt><rp>)</rp></ruby></strong>により星座が1か月で約30度西へ移動（<strong><ruby>年周運動<rp>(</rp><rt>ねんしゅううんどう</rt><rp>)</rp></ruby></strong>）',
