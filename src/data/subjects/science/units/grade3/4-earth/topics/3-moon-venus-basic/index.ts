  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-mvb-q6', question: '上弦の月はどちら側が光る？', options: ['左半分', '上半分', '右半分', '下半分'], correctIndex: 2, explanation: '上弦の月は右半分が光って見えます。', difficulty: 'basic' },
        ...
        { id: 'sci3-mvb-q8', question: '内惑星に分類される惑星はどれ？', options: ['火星と木星', '地球と火星', '水星と金星', '土星と天王星'], correctIndex: 2, explanation: '内惑星は地球より内側を公転する水星と金星です。', difficulty: 'basic' },
        { id: 'sci3-mvb-q9', question: '月は自ら光を出すか？', options: ['出す', '出さない', '夜だけ出す', '満月のときだけ出す'], correctIndex: 1, explanation: '月は自ら光を出さず、太陽の光を反射して光っています。', difficulty: 'basic' },
        ...
        { id: 'sci3-mvb-q13', question: '月食で月が暗くなる原因は？', options: ['太陽が消えるから', '月が自転を止めるから', '地球の影に月が入るから', '月が太陽の裏側に行くから'], correctIndex: 2, explanation: '月食は地球の影に月が入ることで、月が暗くなる現象です。', difficulty: 'standard' },
        ...
        { id: 'sci3-mvb-q16', question: '金星の見かけの大きさと形が変わる原因は？', options: ['金星自体が変形するから', '金星と地球の距離が変化するから', '太陽の明るさが変わるから', '地球の自転速度が変わるから'], correctIndex: 1, explanation: '金星と地球の距離が変化するため、見かけの大きさと太陽光の当たり方（形）が変わります。', difficulty: 'standard' },
        ...
        { id: 'sci3-mvb-q20', question: '新月のとき月が見えない理由は？', options: ['月が地球の裏側にあるから', '月が太陽と同じ方向にあり光っている面が見えないから', '月がなくなるから', '雲で隠れるから'], correctIndex: 1, explanation: '新月のとき月は太陽と同じ方向にあり、太陽光が当たっている面が地球の反対側を向いているため見えません。', difficulty: 'standard' },
        { id: 'sci3-mvb-q21', question: '満月のとき月はどの方向にある？', options: ['太陽と同じ方向', '太陽の反対方向', '太陽の右90度', '太陽の上'], correctIndex: 1, explanation: '満月のとき月は太陽の反対方向にあるため、太陽光が当たっている面全体が地球から見えます。', difficulty: 'standard' },
        ...
        { id: 'sci3-mvb-q23', question: '金星が満ち欠けする理由は？', options: ['金星が変形するから', '金星と太陽の距離が変わるから', '金星と地球の位置関係が変わり太陽光の当たり方が変化するから', '地球が自転するから'], correctIndex: 2, explanation: '金星と地球の位置関係が変化するため、太陽光が当たっている面の見え方が変わり、満ち欠けして見えます。', difficulty: 'advanced' },
        ...
        { id: 'sci3-mvb-q25', question: '内惑星の定義は？', options: ['小さい惑星', '地球より内側を公転する惑星', '気体でできた惑星', '衛星をもたない惑星'], correctIndex: 1, explanation: '内惑星とは地球より内側（太陽に近い側）を公転する惑星のことです。水星と金星が該当します。', difficulty: 'advanced' },
        { id: 'sci3-mvb-q26', question: '日食と月食で、毎回必ず起こらない理由は？', options: ['太陽が動くから', '月の公転面がずれていて一直線になりにくいから', '地球が自転するから', '天気が悪いから'], correctIndex: 1, explanation: '月の公転面が地球の公転面に対してわずかに傾いているため、毎回一直線にはならず、日食・月食は時々しか起こりません。', difficulty: 'advanced' },
