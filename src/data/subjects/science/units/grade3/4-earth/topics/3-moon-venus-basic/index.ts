...
export const moonVenusBasic: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-mvb-fc1', front: '衛星', back: '惑星のまわりを回る天体を何という？', explanation: '月は地球の衛星。木星や土星にも多くの衛星がある。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc2', front: '約29.5日', back: '月の満ち欠けの周期は約何日？', explanation: '月の公転周期（約27.3日）と異なるのは地球も公転しているため。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc3', front: '内惑星（水星と金星）', back: '地球より内側を公転する惑星を何という？', explanation: '太陽から大きく離れないため、真夜中には見えない。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc4', front: '日食（新月のとき）', back: '太陽−月−地球の順に並び、月が太陽をかくす現象を何という？', explanation: '月が太陽を完全にかくすと皆既日食、一部だと部分日食になる。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc5', front: '月食（満月のとき）', back: '太陽−地球−月の順に並び、地球の影に月が入る現象を何という？', explanation: '地球の影に月が完全に入ると皆既月食になり、赤銅色に見えることがある。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc6', front: 'よいの明星', back: '夕方の西の空に見える金星の呼び名は？', explanation: '金星が太陽の東側にあるとき、日没後に西の空に見える。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc7', front: '明けの明星', back: '明け方の東の空に見える金星の呼び名は？', explanation: '金星が太陽の西側にあるとき、日の出前に東の空に見える。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc8', front: '太陽と同じ方向（光っている面が地球側を向かず見えない）', back: '新月のとき、月は太陽に対してどの方向にある？', explanation: '太陽光が当たっている面が地球の反対側を向くため、地球からは見えない。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc9', front: '恒星のまわりを公転し、自ら光を出さない天体', back: '惑星とはどのような天体か？', explanation: '太陽系の惑星は8つ。恒星の光を反射して光って見える。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc10', front: '東から西へ（太陽や星と同じ日周運動）', back: '月は1日のうちにどの方角からどの方角へ動いて見える？', explanation: '地球の自転により月も東から西へ動いて見える。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc11', front: '上弦の月', back: '新月から満月に向かう途中の、右半分が光る半月を何という？', explanation: '夕方に南中し、真夜中に西にしずむ。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc12', front: '下弦の月', back: '満月から新月に向かう途中の、左半分が光る半月を何という？', explanation: '真夜中に東からのぼり、昼ごろに南中する。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc13', front: '太陽の光を反射しているから', back: '月が光って見える理由は？', explanation: '月は自ら光を出さず、太陽光が当たった面だけが明るく見える。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc14', front: '太陽−月−地球', back: '日食のときの3つの天体の並び順は？', explanation: '月が太陽と地球の間に入ることで、太陽の光がさえぎられる。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc15', front: '太陽−地球−月', back: '月食のときの3つの天体の並び順は？', explanation: '地球が太陽と月の間に入り、地球の影に月が入る。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc16', front: '太陽から大きく離れないため（内側を公転するから）', back: '内惑星が真夜中に見えない理由は？', explanation: '地球の内側を公転するため、見かけ上太陽から大きく離れることがない。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc17', front: '満ち欠けと見かけの大きさの変化が同時に起こる', back: '金星の見え方の特徴は？', explanation: '近いときは大きく欠けて見え、遠いときは小さく丸く見える。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc18', front: '新月→三日月→上弦→満月→下弦→新月', back: '月の満ち欠けの順番は？', explanation: '約29.5日かけて一巡する。光る部分が右から増えて左から減っていく。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc19', front: '太陽・地球・月の位置関係が変わるから', back: '月の満ち欠けが起こる理由は？', explanation: '月が地球のまわりを公転することで太陽光の当たり方が変化する。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc20', front: '明け方の東の空か夕方の西の空', back: '金星が見える場所と時間帯は？', explanation: '内惑星なので太陽の近くにしか見えず、日の出前か日没後にだけ見える。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc21', front: '月の公転面がずれていて毎回一直線にならないから', back: '日食と月食が毎回起こらない理由は？', explanation: '月の公転面が地球の公転面に対してわずかに傾いているため。', difficulty: 'advanced' },
      { id: 'sci3-mvb-fc22', front: '金星と地球の位置関係が変わり太陽光の当たり方が変化するから', back: '金星が満ち欠けする理由は？', explanation: '金星は内惑星のため、公転位置により太陽光の当たる面の見え方が大きく変わる。', difficulty: 'advanced' },
      { id: 'sci3-mvb-fc23', front: '太陽・地球・月の位置関係の変化', back: '月の満ち欠けの周期（約29.5日）は何によって決まる？', explanation: '月の公転と地球の公転の両方が関係するため、月の公転周期27.3日とは異なる。', difficulty: 'advanced' },
      { id: 'sci3-mvb-fc24', front: '地球の衛星（自ら光を出さず太陽光を反射）', back: '月は地球に対してどのような天体？', explanation: '月は地球のまわりを公転する唯一の自然の衛星。', difficulty: 'advanced' },
      { id: 'sci3-mvb-fc25', front: '地球の自転', back: '月の日周運動（1日で東から西へ動く）が起こる原因は？', explanation: '地球が西から東へ自転するため、月は見かけ上東から西へ動いて見える。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc26', front: '水星と金星', back: '内惑星を2つ答えよ。', explanation: '地球より太陽に近い軌道を公転する惑星が内惑星。', difficulty: 'basic' },
      { id: 'sci3-mvb-fc27', front: '地球をはさんで太陽の反対側', back: '満月のとき、月は太陽から見てどの位置にある？', explanation: '太陽の反対側にあるため太陽光が月の表面全体を照らし、丸く見える。', difficulty: 'standard' },
      { id: 'sci3-mvb-fc28', front: '恒星（例：太陽）', back: '自ら光を出す天体を何という？', explanation: '恒星は核融合反応によって自ら光と熱を出す天体。', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
