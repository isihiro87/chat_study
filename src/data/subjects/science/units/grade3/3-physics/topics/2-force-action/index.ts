  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-force-q10', question: '逆向きにはたらく6Nと4Nの一直線上の2力の合力は？', options: ['10N', '2N', '4N', '6N'], correctIndex: 1, explanation: '逆向きの2力の合力は差です。6N−4N＝2N。向きは大きい方の力の向きです。', difficulty: 'basic' },
        ...
        { id: 'sci3-force-q12', question: '斜面の傾きを大きくすると、斜面に垂直な分力はどうなる？', options: ['大きくなる', '変わらない', '小さくなる', '0のまま'], correctIndex: 2, explanation: '斜面の傾きが大きいほど、重力の斜面に垂直な分力は小さくなります。', difficulty: 'basic' },
        { id: 'sci3-force-q13', question: '力の合成とは何か？', options: ['1つの力を2つに分けること', '2つの力を1つにまとめること', '力を打ち消すこと', '力の向きを変えること'], correctIndex: 1, explanation: '力の合成は2つの力を1つの力（合力）にまとめることです。逆に分けるのは力の分解です。', difficulty: 'standard' },
        ...
        { id: 'sci3-force-q16', question: '合力が0のとき、運動中の物体はどうなる？', options: ['止まる', 'だんだん速くなる', '等速直線運動を続ける', '向きが変わる'], correctIndex: 2, explanation: '慣性の法則により、合力が0のとき運動中の物体は等速直線運動を続けます。', difficulty: 'standard' },
        { id: 'sci3-force-q17', question: 'ロケットが飛ぶしくみを説明する法則はどれ？', options: ['慣性の法則', 'フックの法則', '作用・反作用の法則', 'てこの原理'], correctIndex: 2, explanation: 'ロケットはガスを噴射（作用）すると、ガスからロケットに逆向きの力（反作用）がはたらいて飛びます。', difficulty: 'standard' },
        ...
        { id: 'sci3-force-q21', question: '右向き3Nと左向き3Nの一直線上の2力の合力は？', options: ['6N', '3N', '0N', '9N'], correctIndex: 2, explanation: '同じ大きさで逆向きの2力の合力は0Nです。2力がつり合っている状態です。', difficulty: 'standard' },
        ...
        { id: 'sci3-force-q27', question: '作用・反作用の法則の別名は？', options: ['運動の第1法則', '運動の第2法則', '運動の第3法則', 'エネルギー保存則'], correctIndex: 2, explanation: '作用・反作用の法則はニュートンの運動の第3法則ともよばれます。', difficulty: 'advanced' },
