...
export const forceAction: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-force-fc1', front: '合力', back: '2つの力を1つにまとめた力を何という？', explanation: '複数の力の効果を1つの力で表したもの。力の合成で求められる。', difficulty: 'basic' },
      { id: 'sci3-force-fc2', front: '慣性の法則（運動の第1法則）', back: '合力が0のとき、物体が静止し続けるか等速直線運動を続ける法則を何という？', explanation: 'ニュートンの運動の第1法則。力が加わらなければ運動状態は変わらない。', difficulty: 'basic' },
      { id: 'sci3-force-fc3', front: '作用・反作用の法則（運動の第3法則）', back: '物体Aが物体Bに力を加えると、BからAに同じ大きさ・逆向きの力がはたらく法則は？', explanation: '2つの力は必ず別々の物体にはたらく。つり合いの2力とは異なる。', difficulty: 'basic' },
      { id: 'sci3-force-fc6', front: '分力', back: '1つの力を分解したときの2つの力を何という？', explanation: '力の分解で得られる成分。斜面上の重力を分解するときなどに用いる。', difficulty: 'basic' },
      { id: 'sci3-force-fc7', front: '力の合成', back: '2つの力を1つの力にまとめることを何という？', explanation: '一直線上の合成は和や差で、角度がある場合は平行四辺形の法則で求める。', difficulty: 'basic' },
      { id: 'sci3-force-fc8', front: '力の分解', back: '1つの力を2つの力に分けることを何という？', explanation: '力の合成の逆の操作。斜面上の重力を分解して運動を分析するときに使う。', difficulty: 'basic' },
      { id: 'sci3-force-fc9', front: '平行四辺形の法則', back: '角度をもつ2力の合力を求めるとき、2力を2辺とする平行四辺形の対角線で求める方法を何という？', explanation: '2力が同じ方向でない場合にこの方法を使い、対角線の長さと向きが合力を表す。', difficulty: 'basic' },
      { id: 'sci3-force-fc10', front: '2力の和（例：3N＋5N＝8N）', back: '同じ向きにはたらく一直線上の2力の合力はどう求める？', explanation: '同じ向きの力は足し合わせるだけで合力が求められる。', difficulty: 'basic' },
      { id: 'sci3-force-fc11', front: '2力の差で、大きい力の向き（例：6N−4N＝2N）', back: '逆向きにはたらく一直線上の2力の合力はどう求める？', explanation: '逆向きの力は差を取り、合力の向きは大きい力の向きになる。', difficulty: 'basic' },
      ...
      { id: 'sci3-force-fc13', front: '垂直抗力とつり合う', back: '斜面上の物体にはたらく重力の斜面に垂直な分力は、何とつり合う？', explanation: '斜面に垂直な分力と垂直抗力がつり合うため、物体は斜面にめり込まない。', difficulty: 'standard' },
      { id: 'sci3-force-fc14', front: '慣性', back: '物体がもとの運動状態を続けようとする性質を何という？', explanation: '電車の急ブレーキ、だるま落とし、テーブルクロス引きなどが例。', difficulty: 'basic' },
      { id: 'sci3-force-fc15', front: 'つり合いは同じ物体に、作用・反作用は別々の物体にはたらく', back: 'つり合いの2力と作用・反作用の2力の最大の違いは？', explanation: 'どちらも同じ大きさ・逆向きだが、力がはたらく対象が異なる点が重要。', difficulty: 'standard' },
      { id: 'sci3-force-fc16', front: '慣性で前に進み続けようとするから', back: '電車が急ブレーキをかけたとき乗客が前に倒れるのはなぜ？', explanation: '電車は減速するが、乗客の体は慣性によりもとの速度で動き続けようとする。', difficulty: 'standard' },
      { id: 'sci3-force-fc17', front: 'だるま落とし', back: '静止している物体の慣性を利用した遊びは？', explanation: '下の段を素早く叩くと、上の段は慣性で静止し続けようとするため落ちない。', difficulty: 'standard' },
      { id: 'sci3-force-fc18', front: 'ロケットのガス噴射（ガスの反作用で前進）', back: '作用・反作用の法則の身近な例は？', explanation: 'ロケットがガスを後ろに噴射（作用）すると、ガスからロケットに前向きの力（反作用）がはたらく。', difficulty: 'standard' },
      { id: 'sci3-force-fc19', front: '運動の第1法則', back: '慣性の法則は運動の第何法則？', explanation: 'ニュートンが発見した運動に関する3つの法則のうちの1番目。', difficulty: 'standard' },
      { id: 'sci3-force-fc20', front: '運動の第3法則', back: '作用・反作用の法則は運動の第何法則？', explanation: 'ニュートンが発見した運動に関する3つの法則のうちの3番目。', difficulty: 'standard' },
      { id: 'sci3-force-fc21', front: '垂直抗力', back: '斜面上の物体にはたらく重力の斜面に垂直な分力とつり合う力は？', explanation: '斜面が物体を支える力で、斜面に垂直な方向にはたらく。', difficulty: 'standard' },
      { id: 'sci3-force-fc22', front: '同じ大きさ・逆向き・一直線上', back: '同じ物体にはたらく2力がつり合うための3条件は？', explanation: 'この3条件がすべて満たされると合力が0になり、物体の運動状態は変わらない。', difficulty: 'standard' },
      { id: 'sci3-force-fc23', front: '角度が大きいほど平行な分力が大きくなる', back: '斜面の角度と斜面に平行な分力の関係は？', explanation: '斜面が急なほど重力の斜面方向成分が大きくなり、物体が滑り落ちやすくなる。', difficulty: 'advanced' },
      { id: 'sci3-force-fc24', front: '角度が大きいほど垂直な分力が小さくなる', back: '斜面の角度と斜面に垂直な分力の関係は？', explanation: '斜面が急になると垂直方向の成分が減り、垂直抗力も小さくなる。', difficulty: 'advanced' },
      { id: 'sci3-force-fc25', front: 'テーブルクロス引き', back: '慣性で静止し続けようとする性質を利用した手品は？', explanation: '食器は慣性で静止し続けようとするため、クロスを素早く引いても動かない。', difficulty: 'advanced' },
      { id: 'sci3-force-fc26', front: '弾性力（フックの法則）であり慣性ではない', back: 'ばねを引くと元に戻ろうとするのは慣性か？', explanation: 'ばねの復元力は弾性力によるもので、運動状態を保とうとする慣性とは異なる。', difficulty: 'advanced' },
      { id: 'sci3-force-fc27', front: '質量が大きいほど慣性が大きい', back: '物体の慣性の大きさは何に関係する？', explanation: '質量が大きい物体ほど運動状態を変えにくく、動き出しにくく止まりにくい。', difficulty: 'advanced' },
      { id: 'sci3-force-fc28', front: '0N（斜面に平行な分力が重力と同じになる）', back: '斜面の角度が0度（水平）のとき、斜面に平行な分力はいくら？', explanation: '水平面では重力はすべて垂直方向にはたらき、水平方向の分力は0になる。', difficulty: 'advanced' },
      { id: 'sci3-force-fc4', front: 'ばねばかり', back: '角度をもってはたらく2力の合力を実験で求めるとき、使う器具は何？', explanation: 'ばねばかりで各方向の力の大きさを測定し、作図で合力を求める。', difficulty: 'basic' },
      { id: 'sci3-force-fc5', front: '左向きに2N', back: '右向きに3Nと左向きに5Nの力がはたらくとき、合力の大きさと向きは？', explanation: '逆向きの2力なので差を求め、5N−3N＝2Nで大きい方の左向きが合力の向き。', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
