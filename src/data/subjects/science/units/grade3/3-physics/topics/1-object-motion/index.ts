...
export const objectMotion: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-mot-fc1', front: '50回/秒（1打点0.02秒間隔）', back: '東日本の記録タイマーは1秒間に何回打点する？', explanation: '東日本は電源周波数が50Hzなので、記録タイマーも50回/秒で打点する。', difficulty: 'basic' },
      { id: 'sci3-mot-fc2', front: '平均の速さ', back: 'ある区間全体の移動距離を、かかった時間で割った速さを何という？', explanation: '平均の速さ＝移動距離÷時間。速さが変化する運動でも全体の速さを求められる。', difficulty: 'basic' },
      { id: 'sci3-mot-fc3', front: '等速直線運動', back: '一直線上を一定の速さで進み続ける運動を何という？', explanation: '合力が0のとき、物体は等速直線運動を続ける（慣性の法則）。', difficulty: 'basic' },
      { id: 'sci3-mot-fc4', front: '自由落下', back: '重力だけがはたらいて落下する運動を何という？', explanation: '空気抵抗を無視すれば、物体の質量に関係なく同じ加速度で落下する。', difficulty: 'basic' },
      { id: 'sci3-mot-fc5', front: '瞬間の速さ', back: 'ごく短い時間に移動した距離から求めた速さを何という？', explanation: '自動車のスピードメーターが示す速さは瞬間の速さ。', difficulty: 'basic' },
      { id: 'sci3-mot-fc6', front: 'ストロボスコープ', back: '一定の時間間隔で発光し、運動のようすを記録する装置を何という？', explanation: '一定間隔で発光した瞬間だけ写真に写るため、物体の位置の変化を追える。', difficulty: 'basic' },
      { id: 'sci3-mot-fc7', front: '0.1秒（0.02秒×5）', back: '50Hzの記録タイマーで5打点分の時間は何秒？', explanation: '1打点が0.02秒なので、5打点で0.02×5＝0.1秒になる。', difficulty: 'basic' },
      { id: 'sci3-mot-fc8', front: 'm/s（メートル毎秒）', back: '1秒間に何メートル進むかを表す速さの単位は？', explanation: '理科では主にm/sを使う。日常で使うkm/hとの換算も重要。', difficulty: 'basic' },
      { id: 'sci3-mot-fc9', front: '÷ 3.6する（例：36km/h ÷ 3.6 = 10m/s）', back: 'km/hをm/sに変換するにはどうする？', explanation: '1km＝1000m、1h＝3600sなので、km/hを3.6で割るとm/sになる。', difficulty: 'standard' },
      { id: 'sci3-mot-fc10', front: '原点を通る直線（傾き＝速さ）', back: '等速直線運動の距離-時間グラフはどのような形になる？', explanation: '速さが一定なので移動距離は時間に比例し、グラフの傾きが速さを表す。', difficulty: 'basic' },
      { id: 'sci3-mot-fc11', front: '水平な直線（面積＝移動距離）', back: '等速直線運動の速さ-時間グラフはどのような形になる？', explanation: '速さが一定のため水平な直線になり、グラフと時間軸で囲まれた面積が移動距離。', difficulty: 'standard' },
      ...
      { id: 'sci3-mot-fc14', front: '摩擦力', back: '運動の向きと逆向きにはたらき、物体を減速させる力を何という？', explanation: '接触面のあらさや物体の重さによって摩擦力の大きさが変わる。', difficulty: 'basic' },
      { id: 'sci3-mot-fc15', front: '移動距離を表す', back: '速さ-時間グラフで、グラフと時間軸で囲まれた面積は何を表す？', explanation: '速さ×時間＝距離の関係から、グラフの面積が移動距離に対応する。', difficulty: 'standard' },
      { id: 'sci3-mot-fc16', front: '打点間隔がだんだん広くなる', back: 'だんだん速くなる運動の記録テープの打点間隔はどうなる？', explanation: '同じ時間間隔で打点されるが、速くなるほど移動距離が増えるため間隔が広くなる。', difficulty: 'basic' },
      { id: 'sci3-mot-fc17', front: '打点間隔がだんだんせまくなる', back: 'だんだんおそくなる運動の記録テープの打点間隔はどうなる？', explanation: '速度が落ちるほど同じ時間で移動する距離が減るため、打点間隔がせまくなる。', difficulty: 'basic' },
      { id: 'sci3-mot-fc18', front: '速度', back: '速さと向きの両方を表す量を何という？', explanation: '速さは大きさだけ、速度は向きも含む。', difficulty: 'standard' },
      { id: 'sci3-mot-fc19', front: '0.02秒', back: '50Hzの記録タイマーの1打点の時間間隔は？', explanation: '1秒÷50回＝0.02秒。この値は東日本の交流周波数50Hzに由来する。', difficulty: 'basic' },
      { id: 'sci3-mot-fc20', front: '60回/秒', back: '西日本の記録タイマーは1秒間に何回打点する？', explanation: '西日本は電源周波数が60Hzなので、記録タイマーも60回/秒で打点する。', difficulty: 'basic' },
      { id: 'sci3-mot-fc21', front: '曲線（放物線）', back: 'だんだん速くなる運動の距離-時間グラフはどのような形？', explanation: '速さが増すほど同じ時間で進む距離が大きくなるため、グラフは上に凸の曲線になる。', difficulty: 'standard' },
      { id: 'sci3-mot-fc22', front: '右上がりの直線', back: 'だんだん速くなる運動の速さ-時間グラフはどのような形？', explanation: '一定の割合で速さが増加するため、右上がりの直線になる。傾きが加速の大きさを表す。', difficulty: 'standard' },
      { id: 'sci3-mot-fc23', front: '× 3.6する（例：10m/s × 3.6 = 36km/h）', back: 'm/sをkm/hに変換するにはどうする？', explanation: '1m/s＝3.6km/hの関係がある。m/sに3.6をかけるとkm/hになる。', difficulty: 'standard' },
      { id: 'sci3-mot-fc24', front: '影響しない（空気抵抗を無視すれば同じ加速度で落下）', back: '自由落下で物体の重さは落下速度に影響するか？', explanation: '重力加速度は質量に依存しないため、真空中ではすべての物体が同じ速さで落下する。', difficulty: 'advanced' },
      { id: 'sci3-mot-fc25', front: 'グラフと時間軸で囲まれた台形の面積を求める', back: '加速する運動の速さ-時間グラフで移動距離はどう求める？', explanation: '速さが変化する場合もグラフの面積が移動距離を表すため、台形や三角形の面積を計算する。', difficulty: 'advanced' },
      { id: 'sci3-mot-fc26', front: '自由落下と同じ運動になる', back: '斜面の角度を90度（垂直）にすると、物体の運動はどうなる？', explanation: '斜面が垂直になると重力の斜面方向の成分が重力そのものになり、自由落下になる。', difficulty: 'advanced' },
