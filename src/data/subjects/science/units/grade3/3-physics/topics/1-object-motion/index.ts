  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        id: 'sci3-mot-fc6',
        front: 'ストロボスコープ',
        back: '一定の時間間隔で発光し、運動のようすを記録する装置を何という？',
        explanation: 'ストロボスコープで撮影すると、等時間間隔の物体の位置が1枚の写真に記録される。',
      },
      {
        id: 'sci3-mot-fc7',
        front: '5打点分の時間（50Hz）',
        back: '50Hzの記録タイマーで5打点分の時間は何秒？',
        explanation: '1打点の間隔は0.02秒なので、5打点分は 0.02 × 5 = 0.1秒。',
      },
      {
        id: 'sci3-mot-fc8',
        front: '速さの単位 m/s',
        back: '1秒間に何メートル進むかを表す速さの単位は？',
        explanation: 'm/s（メートル毎秒）。理科の計算では基本的にこの単位を使う。',
      },
      {
        id: 'sci3-mot-fc9',
        front: 'km/hからm/sへの変換',
        back: 'km/hをm/sに変換するにはどうする？',
        explanation: '÷ 3.6 する。例：36km/h ÷ 3.6 = 10m/s。逆に m/s → km/h は × 3.6。',
      },
      {
        id: 'sci3-mot-fc10',
        front: '距離-時間グラフ（等速直線運動）',
        back: '等速直線運動の距離-時間グラフはどのような形になる？',
        explanation: '原点を通る直線になる。傾きが速さを表す。',
      },
      {
        id: 'sci3-mot-fc11',
        front: '速さ-時間グラフ（等速直線運動）',
        back: '等速直線運動の速さ-時間グラフはどのような形になる？',
        explanation: '水平な直線になる。速さが一定であることを示す。グラフの面積が移動距離を表す。',
      },
      {
        id: 'sci3-mot-fc12',
        front: '斜面の角度と加速',
        back: '斜面の角度を大きくすると、物体の速さの増え方はどうなる？',
        explanation: '角度が大きいほど重力の斜面方向の成分が大きくなり、加速が大きくなる。',
      },
      {
        id: 'sci3-mot-fc13',
        front: '重力の斜面成分',
        back: '斜面を下る物体を加速させる力の正体は？',
        explanation: '重力の斜面方向の成分（分力）。斜面の角度が大きいほどこの成分は大きくなる。',
      },
      {
        id: 'sci3-mot-fc14',
        front: '摩擦力',
        back: '運動の向きと逆向きにはたらき、物体を減速させる力を何という？',
        explanation: '摩擦力。接触面の粗さや垂直抗力の大きさによって変わる。',
      },
      {
        id: 'sci3-mot-fc15',
        front: '速さ-時間グラフの面積',
        back: '速さ-時間グラフで、グラフと時間軸で囲まれた面積は何を表す？',
        explanation: '移動距離を表す。等速直線運動なら長方形、加速運動なら三角形や台形になる。',
      },
      {
        id: 'sci3-mot-fc16',
        front: 'だんだん速くなる運動のテープ',
        back: 'だんだん速くなる運動の記録テープの打点間隔はどうなる？',
        explanation: '打点間隔がだんだん広くなる。5打点ごとに切って並べると、しだいに長くなる。',
      },
      {
        id: 'sci3-mot-fc17',
        front: 'だんだんおそくなる運動のテープ',
        back: 'だんだんおそくなる運動の記録テープの打点間隔はどうなる？',
        explanation: '打点間隔がだんだんせまくなる。5打点ごとに切って並べると、しだいに短くなる。',
      },
      {
        id: 'sci3-mot-fc18',
        front: '速度',
        back: '速さと向きの両方を表す量を何という？',
        explanation: '速度。速さは大きさだけを表すが、速度は向きも含む。等速直線運動は速度が一定。',
      },
      { id: 'sci3-mot-fc19', front: '0.02秒', back: '50Hzの記録タイマーの1打点の時間間隔は？' },
      { id: 'sci3-mot-fc20', front: '60回/秒', back: '西日本の記録タイマーは1秒間に何回打点する？' },
      { id: 'sci3-mot-fc21', front: '曲線（放物線）', back: 'だんだん速くなる運動の距離-時間グラフはどのような形？' },
      { id: 'sci3-mot-fc22', front: '右上がりの直線', back: 'だんだん速くなる運動の速さ-時間グラフはどのような形？' },
      { id: 'sci3-mot-fc23', front: '水平な直線', back: '等速直線運動の速さ-時間グラフはどのような形？' },
      { id: 'sci3-mot-fc24', front: '× 3.6', back: 'm/sをkm/hに変換するにはどうする？' },
      { id: 'sci3-mot-fc25', front: '空気抵抗を無視すれば同じ加速度', back: '自由落下で物体の重さは落下速度に影響するか？' },
      { id: 'sci3-mot-fc26', front: '台形の面積', back: '加速する運動の速さ-時間グラフで移動距離はどう求める？' },
      { id: 'sci3-mot-fc27', front: '90度（垂直）', back: '斜面の角度を最大にしたとき、それは何の運動と同じになる？（自由落下）' },
      { id: 'sci3-mot-fc28', front: '打点の間隔で運動の種類がわかる', back: '記録テープから物体の運動をどう判断する？' },
    ],
    quiz: {
      questions: [
        {
        ...
        { id: 'sci3-mot-q13', question: '西日本の記録タイマーが1秒間に打つ打点の回数は？', options: ['30回', '40回', '50回', '60回'], correctIndex: 3, explanation: '西日本は電源の周波数が60Hzなので、記録タイマーは1秒間に60回打点します。' },
        { id: 'sci3-mot-q14', question: '10m/sは何km/h？', options: ['3.6km/h', '10km/h', '36km/h', '100km/h'], correctIndex: 2, explanation: 'm/sからkm/hへの変換は × 3.6 です。10 × 3.6 = 36km/h になります。' },
        { id: 'sci3-mot-q15', question: '等速直線運動の速さ-時間グラフはどのような形？', options: ['右上がりの直線', '右下がりの直線', '水平な直線', '曲線'], correctIndex: 2, explanation: '等速直線運動では速さが一定なので、速さ-時間グラフは水平な直線になります。' },
        { id: 'sci3-mot-q16', question: 'だんだん速くなる運動の距離-時間グラフはどのような形？', options: ['直線', '水平な直線', '曲線（放物線）', '右下がりの直線'], correctIndex: 2, explanation: '速さが増加すると、同じ時間でも後半ほど移動距離が大きくなるため、曲線になります。' },
        { id: 'sci3-mot-q17', question: '速さ-時間グラフで、グラフと時間軸で囲まれた面積は何を表す？', options: ['速さ', '加速度', '移動距離', '力'], correctIndex: 2, explanation: '速さ-時間グラフの面積は移動距離を表します。' },
        { id: 'sci3-mot-q18', question: '記録タイマー（50Hz）で10打点分のテープの長さが30cmだった。平均の速さは？', options: ['0.3m/s', '1.5m/s', '3.0m/s', '15m/s'], correctIndex: 1, explanation: '10打点分の時間＝0.02×10＝0.2秒、平均の速さ＝0.30m÷0.2s＝1.5m/s です。' },
        { id: 'sci3-mot-q19', question: '斜面の角度を90度にすると、物体の運動は何と同じになる？', options: ['等速直線運動', '自由落下', '円運動', '静止'], correctIndex: 1, explanation: '斜面の角度が90度（垂直）になると、重力の斜面方向の成分が重力そのものになり、自由落下と同じです。' },
        { id: 'sci3-mot-q20', question: '等速直線運動している物体に力がはたらいていないとき、物体はどうなる？', options: ['止まる', 'だんだん速くなる', 'だんだんおそくなる', '等速直線運動を続ける'], correctIndex: 3, explanation: '力がはたらいていなければ（合力0なら）、物体は等速直線運動を続けます。' },
        { id: 'sci3-mot-q21', question: '速さと速度の違いは？', options: ['同じもの', '速度は大きさのみ、速さは向きも含む', '速さは大きさのみ、速度は向きも含む', '単位が違う'], correctIndex: 2, explanation: '速さは大きさだけを表し、速度は大きさと向きの両方を表します。' },
        { id: 'sci3-mot-q22', question: 'ストロボ写真で像の間隔がだんだん広くなる運動は？', options: ['等速直線運動', 'だんだん速くなる運動', 'だんだんおそくなる運動', '静止'], correctIndex: 1, explanation: '像の間隔がだんだん広くなるのは、同じ時間に移動する距離が増えている＝だんだん速くなる運動です。' },
        { id: 'sci3-mot-q23', question: 'だんだん速くなる運動の速さ-時間グラフはどのような形？', options: ['水平な直線', '右下がりの直線', '右上がりの直線', '曲線'], correctIndex: 2, explanation: 'だんだん速くなる運動では速さが一定の割合で増加するため、速さ-時間グラフは右上がりの直線になります。' },
        { id: 'sci3-mot-q24', question: '自動車のスピードメーターが示す速さは何の速さ？', options: ['平均の速さ', '瞬間の速さ', '合計の速さ', '最大の速さ'], correctIndex: 1, explanation: 'スピードメーターはその瞬間の速さ（瞬間の速さ）を示しています。' },
        { id: 'sci3-mot-q25', question: '物体が0.5秒間に3m移動したとき、平均の速さは？', options: ['1.5m/s', '3m/s', '6m/s', '0.5m/s'], correctIndex: 2, explanation: '平均の速さ＝移動距離÷時間＝3m÷0.5s＝6m/sです。' },
        { id: 'sci3-mot-q26', question: '記録テープを5打点ごとに切って並べたら全部同じ長さだった。この運動は？', options: ['だんだん速くなる運動', 'だんだんおそくなる運動', '等速直線運動', '自由落下'], correctIndex: 2, explanation: 'テープの長さがすべて同じ＝同じ時間に同じ距離を移動＝等速直線運動です。' },
        { id: 'sci3-mot-q27', question: '摩擦力は物体の運動にどのような影響を与える？', options: ['加速させる', '減速させる', '向きを変える', '影響しない'], correctIndex: 1, explanation: '摩擦力は運動の向きと逆向きにはたらき、物体を減速させます。' },
        { id: 'sci3-mot-q28', question: '等速直線運動で速さ2m/sの物体が10秒間に移動する距離は？', options: ['5m', '12m', '20m', '8m'], correctIndex: 2, explanation: '移動距離＝速さ×時間＝2m/s×10s＝20mです。' },
      ],
    },
    examples: {
      examples: [
