  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-mot-q14', question: '10m/sは何km/h？', options: ['3.6km/h', '10km/h', '36km/h', '100km/h'], correctIndex: 2, explanation: 'm/sからkm/hへの変換は × 3.6 です。10 × 3.6 = 36km/h になります。', difficulty: 'standard' },
        ...
        { id: 'sci3-mot-q23', question: 'だんだん速くなる運動の速さ-時間グラフはどのような形？', options: ['水平な直線', '右下がりの直線', '右上がりの直線', '曲線'], correctIndex: 2, explanation: 'だんだん速くなる運動では速さが一定の割合で増加するため、速さ-時間グラフは右上がりの直線になります。', difficulty: 'advanced' },
        ...
        { id: 'sci3-mot-q26', question: '記録テープを5打点ごとに切って並べたら全部同じ長さだった。この運動は？', options: ['だんだん速くなる運動', 'だんだんおそくなる運動', '等速直線運動', '自由落下'], correctIndex: 2, explanation: 'テープの長さがすべて同じ＝同じ時間に同じ距離を移動＝等速直線運動です。', difficulty: 'advanced' },
        ...
        { id: 'sci3-mot-q28', question: '等速直線運動で速さ2m/sの物体が10秒間に移動する距離は？', options: ['5m', '12m', '20m', '8m'], correctIndex: 2, explanation: '移動距離＝速さ×時間＝2m/s×10s＝20mです。', difficulty: 'advanced' },
      ],
    },
    examples: {
      examples: [
