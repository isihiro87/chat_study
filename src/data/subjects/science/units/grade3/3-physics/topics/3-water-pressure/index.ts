...
export const waterPressure: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'sci3-wp-fc1', front: '水圧', back: '水中の物体にあらゆる方向からはたらく圧力を何という？', explanation: '水の重さによって生じる圧力で、深いほど大きくなる。', difficulty: 'basic' },
      { id: 'sci3-wp-fc2', front: '浮力', back: '水中の物体にはたらく上向きの力を何という？', explanation: '物体の上面と下面にはたらく水圧の差によって生じる上向きの力。', difficulty: 'basic' },
      { id: 'sci3-wp-fc3', front: 'パスカル（Pa）', back: '圧力（水圧）の単位は何？', explanation: '1Paは1m²あたり1Nの力がはたらく圧力。', difficulty: 'basic' },
      { id: 'sci3-wp-fc4', front: '深いほど大きくなる', back: '水圧は水の深さによってどう変わる？', explanation: '深いほど上にある水の量が多く、その重力によって水圧が大きくなる。', difficulty: 'basic' },
      { id: 'sci3-wp-fc5', front: 'どの方向も同じ大きさ', back: '同じ深さにおいて、水圧は方向によって異なるか？', explanation: '水圧はあらゆる方向から等しくはたらくため、同じ深さなら方向に関係なく同じ。', difficulty: 'basic' },
      { id: 'sci3-wp-fc6', front: '上面と下面にはたらく水圧の差', back: '浮力が生じる原因は何？', explanation: '下面は上面より深いため水圧が大きく、その差が上向きの力（浮力）になる。', difficulty: 'basic' },
      { id: 'sci3-wp-fc7', front: '浮力＝空気中の値−水中の値', back: 'ばねばかりを使った浮力の求め方は？', explanation: '水中では浮力の分だけばねばかりの値が軽くなるため、差が浮力になる。', difficulty: 'standard' },
      { id: 'sci3-wp-fc8', front: '水中にある物体の体積（質量や深さには無関係）', back: '浮力の大きさは何によって決まる？', explanation: '物体が押しのけた水の体積が大きいほど浮力が大きくなる。', difficulty: 'standard' },
      { id: 'sci3-wp-fc9', front: '関係しない（同じ体積なら同じ浮力）', back: '浮力の大きさは物体の質量（重さ）に関係するか？', explanation: '浮力は水中の体積のみで決まるため、同じ大きさなら鉄でも木でも浮力は同じ。', difficulty: 'standard' },
      { id: 'sci3-wp-fc10', front: '浮力＝重力（つり合っている）', back: '物体が水面に浮いて静止しているとき、浮力と重力の関係は？', explanation: '静止しているので力がつり合っており、上向きの浮力と下向きの重力が等しい。', difficulty: 'standard' },
      { id: 'sci3-wp-fc11', front: '変わらない（浮力は体積で決まり、深さには関係しない）', back: '完全に水中に沈んでいる物体をさらに深く沈めると、浮力はどうなる？', explanation: '上面・下面ともに水圧が同じだけ増えるため、その差（浮力）は変わらない。', difficulty: 'advanced' },
      { id: 'sci3-wp-fc12', front: '0.6N（2.0N−1.4N）', back: '空気中で2.0Nの物体を水中に沈めたらばねばかりが1.4Nを示した。浮力は？', explanation: '浮力＝空気中の重さ−水中のばねばかりの値で計算する。', difficulty: 'advanced' },
      { id: 'sci3-wp-fc13', front: '体積が大きい方', back: '同じ質量で体積が異なる2つの物体を水中に沈めたとき、浮力が大きいのはどちら？', explanation: '浮力は水中の体積に比例するため、体積が大きいほど浮力も大きくなる。', difficulty: 'standard' },
      { id: 'sci3-wp-fc14', front: '大きくなる（深いほど水圧が大きいため）', back: 'ゴム膜を張った容器を水中に沈めると、深いほどゴム膜のへこみはどうなる？', explanation: '深いほど水圧が大きいため、ゴム膜がより強く押されてへこみが大きくなる。', difficulty: 'standard' },
      { id: 'sci3-wp-fc15', front: '左右の水圧は同じ深さで等しく打ち消し合うため', back: '物体の左右にはたらく水圧が浮力に関係しない理由は？', explanation: '同じ深さの水圧は等しいので、左右からの力が打ち消し合い浮力には寄与しない。', difficulty: 'advanced' },
      { id: 'sci3-wp-fc16', front: '上にある水の重力が増えるため', back: '水圧が深いほど大きくなる理由は？', explanation: '深い場所ほど上にある水の量が多く、その重力が大きくなるから。', difficulty: 'standard' },
      { id: 'sci3-wp-fc17', front: '0.7N（2.5N−1.8N）', back: '空気中で2.5N、水中で1.8Nのとき浮力はいくら？', explanation: '空気中と水中のばねばかりの値の差が浮力の大きさになる。', difficulty: 'standard' },
      { id: 'sci3-wp-fc18', front: '関係しない（完全に水中にあれば深さによらず一定）', back: '浮力の大きさは物体を沈める深さに関係するか？', explanation: '完全に沈んでいれば上面と下面の水圧差は深さに関係なく一定になる。', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        {
