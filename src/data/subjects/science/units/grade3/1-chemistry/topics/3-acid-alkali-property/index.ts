...
export const acidAlkaliProperty: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci3-aap-fc21', front: 'pH', back: '水溶液の酸性・アルカリ性の強さを0〜14の数値で表すものを何という？', explanation: 'pHはpower of Hydrogenの略で、水素イオン濃度の指標。7が中性の基準となる。', difficulty: 'standard' },
      { id: 'sci3-aap-fc22', front: '酸', back: '水に溶けてH⁺（水素イオン）を生じる物質を何という？', explanation: '塩酸・硫酸・酢酸などが酸にあたる。H⁺を出すことが酸の共通した性質。', difficulty: 'standard' },
      { id: 'sci3-aap-fc23', front: 'アルカリ', back: '水に溶けてOH⁻（水酸化物イオン）を生じる物質を何という？', explanation: '水酸化ナトリウムや水酸化カルシウムなどがアルカリにあたる。OH⁻を出すのが共通の性質。', difficulty: 'advanced' },
      { id: 'sci3-aap-fc24', front: 'pHが小さいほどH⁺の濃度が高い', back: 'pHとH⁺の濃度の関係は？', explanation: 'pH 1はpH 3より100倍H⁺の濃度が高い。pHが1小さくなるとH⁺濃度は10倍になる。', difficulty: 'advanced' },
      { id: 'sci3-aap-fc25', front: 'HNO₃ → H⁺ + NO₃⁻', back: '硝酸の電離式を書け', explanation: '硝酸は水に溶けると水素イオンと硝酸イオンに電離する強酸。', difficulty: 'advanced' },
      { id: 'sci3-aap-fc26', front: '赤色リトマス紙が青色に変わる', back: 'アルカリ性の水溶液をリトマス紙で調べるとどうなる？', explanation: 'アルカリ性ではOH⁻が存在し、赤色リトマス紙を青色に変化させる。青色リトマス紙は変化しない。', difficulty: 'advanced' },
      { id: 'sci3-aap-fc27', front: '酢酸（食酢）は弱い酸性', back: '食酢（酢酸水溶液）は何性か？', explanation: '酢酸は弱酸であり、水中で一部しか電離しないためpHは比較的高い（酸性が弱い）。', difficulty: 'advanced' },
      { id: 'sci3-aap-fc28', front: 'Ba(OH)₂ → Ba²⁺ + 2OH⁻', back: '水酸化バリウムの電離式を書け', explanation: '水酸化バリウムは2価のアルカリで、水に溶けるとOH⁻を2個生じる。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
