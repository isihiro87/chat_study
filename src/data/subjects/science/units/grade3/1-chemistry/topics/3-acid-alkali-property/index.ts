...
export const acidAlkaliProperty: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      {
        id: 'sci3-aap-fc17',
        front: '電流が流れる（電解質が溶けている）',
        back: '酸性の水溶液に電流を流すとどうなる？',
        explanation: '酸性の水溶液にはH⁺とその対になる陰イオンが溶けているため電流が流れる。',
      },
      {
        id: 'sci3-aap-fc18',
        front: '変化しない（反応しない）',
      ...
      {
        id: 'sci3-aap-fc20',
        front: '硝酸カリウム水溶液（電解質で導電性がある中性の液）',
        back: '電気泳動実験でろ紙にしみこませる液体は何か？',
        explanation: 'ろ紙に導電性を持たせるため、中性の電解質である硝酸カリウム水溶液を使う。',
      },
      { id: 'sci3-aap-fc21', front: 'pH', back: '水溶液の酸性・アルカリ性の強さを0〜14の数値で表すものを何という？' },
      { id: 'sci3-aap-fc22', front: '酸', back: '水に溶けてH⁺（水素イオン）を生じる物質を何という？' },
      { id: 'sci3-aap-fc23', front: 'アルカリ', back: '水に溶けてOH⁻（水酸化物イオン）を生じる物質を何という？' },
      { id: 'sci3-aap-fc24', front: 'pHが小さいほどH⁺の濃度が高い', back: 'pHとH⁺の濃度の関係は？' },
      { id: 'sci3-aap-fc25', front: 'HNO₃ → H⁺ + NO₃⁻', back: '硝酸の電離式を書け' },
      { id: 'sci3-aap-fc26', front: '赤色リトマス紙が青色に変わる', back: 'アルカリ性の水溶液をリトマス紙で調べるとどうなる？' },
      { id: 'sci3-aap-fc27', front: '酢酸（食酢）は弱い酸性', back: '食酢（酢酸水溶液）は何性か？' },
      { id: 'sci3-aap-fc28', front: 'Ba(OH)₂ → Ba²⁺ + 2OH⁻', back: '水酸化バリウムの電離式を書け' },
    ],
    quiz: {
      questions: [
        {
        ...
        { id: 'sci3-aap-q13', question: '水に溶けてH⁺を生じる物質を何という？', options: ['アルカリ', '塩', '酸', '酸化物'], correctIndex: 2, explanation: '酸とは水に溶けてH⁺（水素イオン）を生じる物質のことです。' },
        { id: 'sci3-aap-q14', question: '水に溶けてOH⁻を生じる物質を何という？', options: ['酸', '塩', 'アルカリ', '酸化物'], correctIndex: 2, explanation: 'アルカリとは水に溶けてOH⁻（水酸化物イオン）を生じる物質のことです。' },
        { id: 'sci3-aap-q15', question: 'pH 11の水溶液の性質は？', options: ['強い酸性', '弱い酸性', '中性', 'アルカリ性'], correctIndex: 3, explanation: 'pH 7が中性で、7より大きいほどアルカリ性が強くなります。pH 11はアルカリ性です。' },
        { id: 'sci3-aap-q16', question: '硫酸（H₂SO₄）が電離したとき、H⁺は何個生じる？', options: ['1個', '2個', '3個', '4個'], correctIndex: 1, explanation: 'H₂SO₄ → 2H⁺ + SO₄²⁻ です。H₂なのでH⁺が2個生じます。' },
        { id: 'sci3-aap-q17', question: '次のうち、アルカリ性の水溶液はどれ？', options: ['塩酸', '食酢', '石灰水', '炭酸水'], correctIndex: 2, explanation: '石灰水（水酸化カルシウム水溶液）はアルカリ性です。塩酸・食酢・炭酸水は酸性です。' },
        { id: 'sci3-aap-q18', question: '酸性の水溶液にマグネシウムを入れると水素が発生する理由は？', options: ['マグネシウムが分解されるから', 'H⁺がマグネシウムから電子を受け取るから', 'OH⁻が分解されるから', '水が蒸発するから'], correctIndex: 1, explanation: '酸性の水溶液中のH⁺がマグネシウムから電子を受け取り、H₂として発生します。' },
        { id: 'sci3-aap-q19', question: '中性の水溶液にBTB溶液を加えると何色になる？', options: ['黄色', '緑色', '青色', '赤色'], correctIndex: 1, explanation: 'BTB溶液は中性で緑色、酸性で黄色、アルカリ性で青色になります。' },
        { id: 'sci3-aap-q20', question: 'pH 7の水溶液とpH 12の水溶液ではどちらがアルカリ性が強い？', options: ['pH 7', 'pH 12', '同じ', '判別できない'], correctIndex: 1, explanation: 'pHの値が大きいほどアルカリ性が強くなります。pH 12はpH 7（中性）よりアルカリ性が強いです。' },
        { id: 'sci3-aap-q21', question: '水酸化カリウム（KOH）の電離式として正しいものは？', options: ['KOH → K⁺ + OH⁻', 'KOH → K²⁺ + OH⁻', 'KOH → K⁺ + O²⁻ + H⁺', 'KOH → K + OH'], correctIndex: 0, explanation: '水酸化カリウムは水に溶けるとK⁺とOH⁻に電離します。NaOHと同様のパターンです。' },
        { id: 'sci3-aap-q22', question: '酸性の水溶液に共通する性質として正しくないものは？', options: ['電流が流れる', 'マグネシウムと反応して水素が発生する', 'フェノールフタレインが赤色になる', '青色リトマス紙が赤くなる'], correctIndex: 2, explanation: 'フェノールフタレインが赤色になるのはアルカリ性の水溶液の性質です。酸性では無色のままです。' },
        { id: 'sci3-aap-q23', question: '硝酸（HNO₃）の電離式として正しいものは？', options: ['HNO₃ → H⁺ + NO₃⁻', 'HNO₃ → H⁺ + N³⁻ + 3O²⁻', 'HNO₃ → H₂⁺ + NO₃²⁻', 'HNO₃ → H + NO₃'], correctIndex: 0, explanation: '硝酸は水に溶けるとH⁺とNO₃⁻（硝酸イオン）に電離します。' },
        { id: 'sci3-aap-q24', question: '次の水溶液のうち、中性のものはどれ？', options: ['塩酸', '食塩水', '石灰水', '酢酸'], correctIndex: 1, explanation: '食塩水は中性です。塩酸と酢酸は酸性、石灰水はアルカリ性です。' },
        { id: 'sci3-aap-q25', question: 'アルカリ性の水溶液にBTB溶液を加えると何色になる？', options: ['黄色', '緑色', '赤色', '青色'], correctIndex: 3, explanation: 'BTB溶液はアルカリ性で青色になります。酸性では黄色、中性では緑色です。' },
        { id: 'sci3-aap-q26', question: '水酸化バリウム（Ba(OH)₂）が電離したとき、OH⁻は何個生じる？', options: ['1個', '2個', '3個', '4個'], correctIndex: 1, explanation: 'Ba(OH)₂ → Ba²⁺ + 2OH⁻ です。(OH)₂なのでOH⁻が2個生じます。' },
        { id: 'sci3-aap-q27', question: 'pHの値が0に近いほどどうなる？', options: ['アルカリ性が強い', '中性に近い', '酸性が強い', '変化しない'], correctIndex: 2, explanation: 'pHの値が0に近いほど酸性が強くなります。H⁺の濃度が高い状態です。' },
        { id: 'sci3-aap-q28', question: '酸性とアルカリ性の水溶液に共通して電流が流れる理由は？', options: ['水分子が電気を通すから', '温度が高いから', 'どちらもイオンが溶けているから', '電極が反応するから'], correctIndex: 2, explanation: '酸性もアルカリ性もイオン（H⁺やOH⁻、その対イオン）が溶けている電解質の水溶液なので電流が流れます。' },
      ],
    },
    examples: {
      examples: [
