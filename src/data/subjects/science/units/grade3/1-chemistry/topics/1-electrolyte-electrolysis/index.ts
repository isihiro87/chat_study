  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '電解質がイオンとして水中に存在し、電荷を運ぶ役割を果たすため電流が流れる。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ee-fc10',
        ...
        explanation: 'クエン酸は電解質であり、水中でイオンに電離して電気を運ぶことができる。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ee-fc11',
      ...
      },
      {
        ...
        explanation: '純水にはイオンがほとんど存在しないため、電荷を運ぶ粒子がなく電流が流れない。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ee-fc20',
        ...
        back: '塩化水素は電解質？非電解質？',
        explanation: '塩化水素は水に溶けると水素イオンと塩化物イオンに電離するため電解質である。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ee-fc21',
        ...
        back: 'デンプンは電解質？非電解質？',
        explanation: 'デンプンは水に溶けてもイオンに分かれないため、電流を流すことができない。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ee-fc22',
        ...
        explanation: '塩化ナトリウムが水に溶けるとナトリウムイオンと塩化物イオンに分かれる。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ee-fc23',
        ...
        explanation: '銅イオンが陰極で電子を受け取り、赤色の銅として電極に付着する。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ee-fc24',
        ...
        explanation: '塩化物イオンが電子を失って塩素ガスになる。塩素は有毒で漂白作用をもつ。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ee-fc25',
        ...
        back: '水素の確認方法は？',
        explanation: '水素は可燃性の気体であり、火を近づけると空気中の酸素と反応して燃える。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ee-fc26',
      ...
      },
      {
        ...
        front: 'HCl → H⁺ + Cl⁻',
        back: '塩化水素の電離式を書くと？',
        explanation: '塩化水素が水に溶けると水素イオンと塩化物イオンに分かれる。これが塩酸である。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ee-fc28',
