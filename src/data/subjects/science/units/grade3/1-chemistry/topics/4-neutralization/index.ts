...
export const neutralization: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci3-neut-fc17', front: 'H⁺ + OH⁻ → H₂O', back: '中和反応の本質をイオンの式で表すと？', explanation: '中和の本質は水素イオンと水酸化物イオンが結びついて水ができること。', difficulty: 'standard' },
      { id: 'sci3-neut-fc18', front: 'HCl + NaOH → NaCl + H₂O', back: '塩酸と水酸化ナトリウムの中和の化学反応式を書け', explanation: '塩酸のH⁺とNaOHのOH⁻が水になり、Na⁺とCl⁻が塩化ナトリウムになる。', difficulty: 'standard' },
      { id: 'sci3-neut-fc19', front: '酸の陰イオンとアルカリの陽イオンが結びつく', back: '中和で塩（えん）ができるしくみは？', explanation: 'H⁺とOH⁻が水になった後、残ったイオンどうしが結びついて塩になる。', difficulty: 'standard' },
      { id: 'sci3-neut-fc20', front: '温度が上がる', back: '中和反応が起きたとき、水溶液の温度はどうなる？', explanation: '中和は発熱反応であり、H⁺とOH⁻が結びつくときに熱エネルギーが放出される。', difficulty: 'standard' },
      { id: 'sci3-neut-fc21', front: '硫酸ナトリウム（Na₂SO₄）', back: '硫酸と水酸化ナトリウムの中和でできる塩は？', explanation: 'H₂SO₄ + 2NaOH → Na₂SO₄ + 2H₂O。硫酸は2価の酸なのでNaOHが2倍必要。', difficulty: 'standard' },
      { id: 'sci3-neut-fc22', front: '塩化カルシウム（CaCl₂）', back: '塩酸と水酸化カルシウムの中和でできる塩は？', explanation: '2HCl + Ca(OH)₂ → CaCl₂ + 2H₂O。塩化カルシウムは水に溶ける塩。', difficulty: 'standard' },
      { id: 'sci3-neut-fc23', front: 'Na⁺が増え続ける', back: '塩酸にNaOHを加えていくとき、Na⁺の数はどう変化する？', explanation: 'Na⁺は中和反応に関与しないため、NaOHを加えた分だけ増え続ける。', difficulty: 'advanced' },
      { id: 'sci3-neut-fc24', front: 'ちょうど中性になった（H⁺とOH⁻が過不足なく反応した状態）', back: 'BTB溶液が緑色になったとき、中和の状態はどうか？', explanation: 'BTBが緑色のときはpH 7付近で、H⁺もOH⁻もほとんど残っていない状態。', difficulty: 'standard' },
      { id: 'sci3-neut-fc25', front: 'HNO₃ + KOH → KNO₃ + H₂O', back: '硝酸と水酸化カリウムの中和の化学反応式を書け', explanation: '硝酸のH⁺とKOHのOH⁻が水になり、K⁺とNO₃⁻が硝酸カリウムになる。', difficulty: 'advanced' },
      { id: 'sci3-neut-fc26', front: '水に溶ける塩と溶けない塩がある', back: '中和でできる塩はすべて水に溶けるか？', explanation: 'NaClは水に溶けるが、BaSO₄やCaCO₃は水に溶けず白い沈殿になる。', difficulty: 'advanced' },
      { id: 'sci3-neut-fc27', front: '2HCl + Ca(OH)₂ → CaCl₂ + 2H₂O', back: '塩酸と水酸化カルシウムの中和の化学反応式を書け', explanation: 'Ca(OH)₂はOH⁻を2個出すので、HClが2個必要。水も2分子できる。', difficulty: 'advanced' },
      { id: 'sci3-neut-fc28', front: 'H₂SO₄ + 2NaOH → Na₂SO₄ + 2H₂O', back: '硫酸と水酸化ナトリウムの中和の化学反応式を書け', explanation: '硫酸はH⁺を2個出すので、NaOHが2個必要。Na₂SO₄は水に溶ける塩。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
      ...
      },
        {
          ...
          options: ['黄色→緑色→青色','青色→緑色→黄色','赤色→緑色→青色','黄色→赤色→青色',
          ],
          correctIndex: 0,
          explanation:
        ...
        { id: 'sci3-neut-q11', question: '中和反応は発熱反応と吸熱反応のどちらか？', options: ['発熱反応','吸熱反応','どちらでもない','反応による'], correctIndex: 0, explanation: '中和反応は発熱反応で、混合すると水溶液の温度が上がります。', difficulty: 'standard' },
        { id: 'sci3-neut-q12', question: '塩酸と水酸化カルシウムの中和でできる塩の名称は？', options: ['塩化ナトリウム','炭酸カルシウム','硫酸カルシウム','塩化カルシウム'], correctIndex: 3, explanation: 'HClのCl⁻とCa(OH)₂のCa²⁺が結びついて塩化カルシウム（CaCl₂）ができます。', difficulty: 'standard' },
        { id: 'sci3-neut-q13', question: '中和反応の本質をイオンの式で表すと？', options: ['H⁺ + OH⁻ → H₂O','Na⁺ + Cl⁻ → NaCl','Cu²⁺ + 2e⁻ → Cu','H₂ → 2H⁺ + 2e⁻'], correctIndex: 0, explanation: '中和の本質はH⁺とOH⁻が結びついて水（H₂O）ができる反応です。', difficulty: 'standard' },
        ...
        { id: 'sci3-neut-q16', question: '中和でできたNaCl水溶液を加熱して水を蒸発させると残る固体は？', options: ['水酸化ナトリウム','何も残らない','塩酸','塩化ナトリウム（食塩）'], correctIndex: 3, explanation: '中和で生じたNa⁺とCl⁻が結びついて塩化ナトリウム（食塩）の白い固体が残ります。', difficulty: 'standard' },
        ...
        { id: 'sci3-neut-q23', question: 'NaOH水溶液を5cm³加えたとき酸性（まだH⁺が残っている）の水溶液にマグネシウムを入れるとどうなる？', options: ['変化しない','沈殿ができる','酸素が発生する','水素が発生する'], correctIndex: 3, explanation: 'まだ酸性（H⁺が残っている）なので、マグネシウムがH⁺と反応して水素が発生します。', difficulty: 'advanced' },
        { id: 'sci3-neut-q24', question: 'ちょうど中性になった水溶液のpHは？', options: ['0','3','14','7'], correctIndex: 3, explanation: '中性の水溶液のpHは7です。H⁺とOH⁻がちょうど過不足なく反応した状態です。', difficulty: 'advanced' },
        { id: 'sci3-neut-q25', question: '中和でできる塩（えん）と食塩の関係は？', options: ['食塩（NaCl）は塩（えん）の一種','塩（えん）と食塩は全く無関係','食塩が中和で塩（えん）をつくる','塩（えん）は食塩の別名'], correctIndex: 0, explanation: '塩（えん）は酸の陰イオンとアルカリの陽イオンが結びついた物質の総称で、食塩（NaCl）はその一例です。', difficulty: 'advanced' },
        { id: 'sci3-neut-q26', question: '塩酸とNaOHの中和で、NaOH水溶液を加え続けると電流の流れやすさはどう変化する？', options: ['最初減ってから増える','ずっと増え続ける','ずっと減り続ける','変わらない'], correctIndex: 0, explanation: '中和が進むとイオンが減って電流が流れにくくなり、中性を超えるとNa⁺とOH⁻が増えて再び流れやすくなります。', difficulty: 'advanced' },
