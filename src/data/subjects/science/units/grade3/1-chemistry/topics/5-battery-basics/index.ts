  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '果汁中のクエン酸が電解質として働き、2種類の金属との組み合わせで電池の条件を満たす。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-bb-fc11',
      ...
      { id: 'sci3-bb-fc16', front: '2つの金属のイオン化傾向の差が大きいほど大きい', back: '電池の電圧を大きくするにはどうすればよい？', explanation: 'イオン化傾向の差が大きいほど電子を放出する力の差が大きくなり、電圧が高くなる。', difficulty: 'standard' },
      { id: 'sci3-bb-fc17', front: 'MgとCuの電池のほうが電圧が大きい', back: 'ZnとCuの電池とMgとCuの電池では、どちらの電圧が大きい？', explanation: 'Mg > Zn > Cuなので、MgとCuのイオン化傾向の差のほうが大きく電圧が高い。', difficulty: 'standard' },
      { id: 'sci3-bb-fc18', front: 'ならない（イオン化傾向の差がないため）', back: '同じ金属2枚を電解質水溶液に入れると電池になるか？', explanation: '電池には異なる2種類の金属が必要。同じ金属ではイオン化傾向の差がなく電子が流れない。', difficulty: 'standard' },
      { id: 'sci3-bb-fc19', front: 'イオン化傾向が小さい金属が＋極', back: '電池で＋極（正極）になるのは、イオン化傾向がどちらの金属？', explanation: 'イオン化傾向が大きい金属が電子を放出して−極になり、小さい方が＋極になる。', difficulty: 'standard' },
      { id: 'sci3-bb-fc20', front: '＋極（銅板）から水素が発生する', back: 'うすい塩酸を使った電池で、＋極にはどのような変化が起こる？', explanation: '水溶液中のH⁺が＋極で電子を受け取り、水素ガスとして発生する。', difficulty: 'standard' },
      { id: 'sci3-bb-fc21', front: '置き換え反応', back: 'イオン化傾向の大きい金属がイオンになり、水溶液中のイオンが金属として析出する反応を何という？', explanation: 'イオン化傾向の大きい金属が電子を失い、小さい金属のイオンが電子を得て析出する。', difficulty: 'standard' },
      { id: 'sci3-bb-fc22', front: 'Cu + 2Ag⁺ → Cu²⁺ + 2Ag', back: '硝酸銀水溶液に銅線を入れたときの反応をイオン式で書くと？', explanation: 'Cu > Agなので銅が電子を失いCu²⁺に、Ag⁺が電子を受け取り銀として析出する。', difficulty: 'standard' },
      { id: 'sci3-bb-fc23', front: '鉄（Fe）', back: 'イオン化傾向の序列 Mg > Zn > Fe > Cu > Ag で、ZnとCuの間に位置する金属は？', explanation: '鉄は亜鉛よりイオンになりにくく、銅よりイオンになりやすい中間的な金属。', difficulty: 'advanced' },
      { id: 'sci3-bb-fc24', front: '電子を失いやすい（イオンになりやすい）', back: 'イオン化傾向が大きい金属の性質は？', explanation: 'イオン化傾向が大きい金属ほど酸化されやすく、水溶液中で陽イオンになりやすい。', difficulty: 'advanced' },
      { id: 'sci3-bb-fc25', front: '亜鉛板がボロボロに溶ける', back: 'うすい塩酸を使った電池で長時間電流を流すと、−極（亜鉛板）はどうなる？', explanation: '亜鉛が継続的にZn²⁺として水溶液中に溶け出すため、板がしだいに小さくなる。', difficulty: 'advanced' },
      { id: 'sci3-bb-fc26', front: 'Mg + Cu²⁺ → Mg²⁺ + Cu', back: '硫酸銅水溶液にMg片を入れたときの反応をイオン式で書くと？', explanation: 'Mg > Cuなのでマグネシウムがイオンになり、銅イオンが銅として析出する。', difficulty: 'advanced' },
      { id: 'sci3-bb-fc27', front: 'MgはZn²⁺もCu²⁺も置き換えた', back: 'マイクロプレート実験でMgのイオン化傾向が最大だとわかった根拠は？', explanation: 'イオン化傾向が最も大きい金属はどの金属イオンの水溶液でも置き換え反応を起こす。', difficulty: 'advanced' },
      { id: 'sci3-bb-fc28', front: '電流の向きと電子の流れは逆', back: '電池の回路で電流の向きと電子の流れの関係は？', explanation: '電流は＋極から−極へ流れると定義されるが、実際の電子は−極から＋極へ移動する。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
