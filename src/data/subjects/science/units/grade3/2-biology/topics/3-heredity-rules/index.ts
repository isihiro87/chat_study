  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: 'Aからは必ずA、aからは必ずaが伝わるので、子はすべてAaになる。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-hr-fc12',
        ...
        explanation: 'AとaがそれぞれA・aに分離し、組み合わせでAA・Aa・Aa・aaの4通りになる。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-hr-fc13',
      ...
      { id: 'sci3-hr-fc14', front: 'DNA', back: '遺伝子の本体である物質を何という？', explanation: 'DNAはデオキシリボ核酸の略で、二重らせん構造をもつ。染色体の中に含まれる。', difficulty: 'standard' },
      { id: 'sci3-hr-fc15', front: '検定交雑', back: '調べたい個体と潜性の純系（aa）を交配して遺伝子型を調べる方法を何という？', explanation: '潜性の純系と交配して子の形質を見ることで、調べたい個体がAAかAaか判定できる。', difficulty: 'standard' },
      { id: 'sci3-hr-fc16', front: 'Aa × aa → Aa：aa＝1：1', back: '遺伝子型Aaの個体と遺伝子型aaの個体を交配したとき、子の遺伝子型の比は？', explanation: 'Aaからはa又はAが、aaからは必ずaが伝わるので、AaとaaがI：1の比になる。', difficulty: 'standard' },
      { id: 'sci3-hr-fc17', front: '子はすべて赤色（Bb）', back: '赤色の純系（BB）と白色の純系（bb）を交配したとき、子の形質は？', explanation: '子はすべてBbになり、顕性形質の赤色が現れる。白色の遺伝子bは隠れている。', difficulty: 'standard' },
      { id: 'sci3-hr-fc18', front: '丸5474：しわ1850（約3：1）', back: 'メンデルの実験で孫の代の種子の形の実験結果は？', explanation: '大量のデータを調べることで分離の法則による約3：1の比が確認された。', difficulty: 'standard' },
      { id: 'sci3-hr-fc19', front: '優性・劣性は「優れている」「劣っている」を意味しない', back: '顕性形質（優性形質）の名称で注意すべき点は？', explanation: '現れやすいか隠れやすいかの違いであり、形質の優劣とは関係がない。', difficulty: 'standard' },
      { id: 'sci3-hr-fc20', front: 'AAまたはAa', back: '顕性形質が現れている個体の遺伝子型として考えられるものは？', explanation: 'Aが1つでもあれば顕性形質が現れるため、AAとAaのどちらの可能性もある。', difficulty: 'standard' },
      { id: 'sci3-hr-fc21', front: 'aaのみ', back: '潜性形質が現れている個体の遺伝子型は？', explanation: '顕性の遺伝子Aが1つでもあると潜性形質は隠れるため、aaの場合のみ現れる。', difficulty: 'standard' },
      { id: 'sci3-hr-fc22', front: '3：1', back: 'Aa × Aa の孫の代で、顕性形質：潜性形質の比は？', explanation: 'AA・Aa・Aaの3つが顕性形質、aaの1つが潜性形質として現れるため3：1になる。', difficulty: 'standard' },
      { id: 'sci3-hr-fc23', front: '1：2：1', back: 'Aa × Aa の孫の代で、AA：Aa：aaの遺伝子型の比は？', explanation: '両親からA又はaが等確率で伝わるため、4通りの組み合わせでこの比になる。', difficulty: 'advanced' },
      { id: 'sci3-hr-fc24', front: 'エンドウの種子の丸形としわ形', back: 'メンデルの実験で調べた対立形質の代表例は？', explanation: 'メンデルは種子の形のほか、さやの色・花の色など7つの対立形質を調べた。', difficulty: 'advanced' },
      { id: 'sci3-hr-fc25', front: '受精で再び対になる', back: '減数分裂で分かれた遺伝子はいつ再び対になる？', explanation: '卵と精子の核が合体する受精のとき、分かれていた遺伝子が再び対になる。', difficulty: 'advanced' },
      { id: 'sci3-hr-fc26', front: '1：1', back: 'Aa × aa の子の遺伝子型の比は？（Aa：aa）', explanation: 'AaからAまたはaが半々で伝わり、aaからは必ずaが伝わるためAa：aa＝1：1になる。', difficulty: 'advanced' },
      { id: 'sci3-hr-fc27', front: '子がすべて赤色→BB、赤と白が半々→Bb', back: '検定交雑で赤色の個体がBBかBbかを見分ける方法は？', explanation: 'BBならbb との子はすべてBb(赤色)、Bbならbb との子はBb：bb＝1：1で白色も現れる。', difficulty: 'advanced' },
      { id: 'sci3-hr-fc28', front: 'メンデル', back: 'エンドウを使って遺伝の法則を発見した科学者は誰？', explanation: 'オーストリアの修道士メンデルが1865年に発表。「遺伝学の父」と呼ばれる。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
