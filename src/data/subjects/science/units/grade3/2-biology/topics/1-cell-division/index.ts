  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '塩酸が細胞どうしを接着している物質を溶かし、細胞をばらばらにしやすくする。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-cd-fc8',
        ...
        explanation: 'これらの染色液は核や染色体を染め、顕微鏡で観察しやすくする。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-cd-fc9',
      ...
      },
      {
        ...
        explanation: '単細胞生物は体全体が1つの細胞なので、細胞分裂がそのまま個体の増殖になる。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-cd-fc13',
      ...
      },
      {
        ...
        explanation: '根や茎の先端付近に分裂が活発な成長点があり、ここで新しい細胞がつくられる。',
        difficulty: 'standard',
      },
      { id: 'sci3-cd-fc15', front: '染色体の数は変わらない', back: '体細胞分裂の前後で染色体の数はどうなる？', explanation: '分裂前に染色体が複製されるため、分裂後の各細胞はもとの細胞と同じ染色体数をもつ。', difficulty: 'standard' },
      { id: 'sci3-cd-fc16', front: '分裂前に染色体が複製される', back: '体細胞分裂で染色体数が変わらない理由は？', explanation: 'DNAが複製されて染色体が2倍になり、分裂で半分ずつに分かれてもとの数に戻る。', difficulty: 'standard' },
      { id: 'sci3-cd-fc17', front: 'おしつぶして細胞を広げる', back: '体細胞分裂の観察でカバーガラスの上からおしつぶす理由は？', explanation: '細胞が重なっていると観察しにくいため、押しつぶして1層に広げる必要がある。', difficulty: 'standard' },
      { id: 'sci3-cd-fc18', front: '接ぎ木', back: '農業で利用される栄養生殖の方法の一つで、異なる植物の枝を接合する方法は？', explanation: '丈夫な台木に品質のよい穂木を接ぎ、両方の長所を活かした個体をつくる技術。', difficulty: 'standard' },
      { id: 'sci3-cd-fc19', front: '骨髄', back: '動物（ヒト）で血液の細胞をつくるための細胞分裂が行われる場所は？', explanation: '骨の内部にある骨髄で赤血球・白血球・血小板などの血液細胞がつくられる。', difficulty: 'standard' },
      { id: 'sci3-cd-fc20', front: 'コダカラベンケイ', back: '葉のふちに子株（小さな芽）ができて落ちて増える植物の名前は？', explanation: '葉のふちに小さな子株ができ、地面に落ちると根を出して新しい個体になる栄養生殖の例。', difficulty: 'standard' },
      { id: 'sci3-cd-fc21', front: 'ヤマノイモのむかご', back: 'ヤマノイモが無性生殖で増えるときにできる小さな芽のような構造は？', explanation: 'むかごは葉のつけ根にできる小さな球状の構造で、地面に落ちると新しい個体になる。', difficulty: 'standard' },
      { id: 'sci3-cd-fc22', front: 'オランダイチゴ（ほふく茎）', back: 'ほふく茎（ランナー）を伸ばして増える植物は？', explanation: 'ほふく茎が地面をはって伸び、先端に新しい個体をつくる栄養生殖の例。', difficulty: 'standard' },
      { id: 'sci3-cd-fc23', front: '有性生殖は多様な形質の子ができる', back: '有性生殖の利点は何？', explanation: '両親から異なる遺伝子を受けつぐため、環境の変化に適応しやすい多様な子が生まれる。', difficulty: 'advanced' },
      { id: 'sci3-cd-fc24', front: '無性生殖は受精なしで速くふえられる', back: '無性生殖の利点は何？', explanation: '相手を見つける必要がなく、体細胞分裂だけで短時間に多くの子をつくることができる。', difficulty: 'advanced' },
      { id: 'sci3-cd-fc25', front: '減数分裂', back: '生殖細胞をつくるとき、染色体数が半分になる特別な細胞分裂を何という？', explanation: '受精で染色体数がもとに戻るため、あらかじめ半分にしておく必要がある。', difficulty: 'advanced' },
      { id: 'sci3-cd-fc26', front: '半分になる', back: '減数分裂後の生殖細胞の染色体数はもとの体細胞の何倍？', explanation: 'ヒトの場合、体細胞46本に対し、卵や精子の染色体数は23本になる。', difficulty: 'advanced' },
      { id: 'sci3-cd-fc27', front: 'イソギンチャク', back: '動物のうち、分裂によって無性生殖を行う例は？', explanation: 'イソギンチャクは体が分裂して2個体に分かれることで無性生殖を行う。', difficulty: 'advanced' },
      { id: 'sci3-cd-fc28', front: 'ミカヅキモ', back: '単細胞の藻類で、分裂によって増える生物は？', explanation: 'ミカヅキモは三日月形をした単細胞の藻類で、細胞分裂によって増殖する。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
