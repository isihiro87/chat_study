...
export const cellDivision: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'sci3-cd-fc15', front: '染色体の数は変わらない', back: '体細胞分裂の前後で染色体の数はどうなる？' },
      { id: 'sci3-cd-fc16', front: '分裂前に染色体が複製される', back: '体細胞分裂で染色体数が変わらない理由は？' },
      { id: 'sci3-cd-fc17', front: 'おしつぶして細胞を広げる', back: '体細胞分裂の観察でカバーガラスの上からおしつぶす理由は？' },
      { id: 'sci3-cd-fc18', front: '接ぎ木', back: '農業で利用される栄養生殖の方法の一つで、異なる植物の枝を接合する方法は？' },
      { id: 'sci3-cd-fc19', front: '骨髄', back: '動物（ヒト）で血液の細胞をつくるための細胞分裂が行われる場所は？' },
      { id: 'sci3-cd-fc20', front: 'コダカラベンケイ', back: '葉のふちに子株（小さな芽）ができて落ちて増える植物の名前は？' },
      { id: 'sci3-cd-fc21', front: 'ヤマノイモのむかご', back: 'ヤマノイモが無性生殖で増えるときにできる小さな芽のような構造は？' },
      { id: 'sci3-cd-fc22', front: 'オランダイチゴ（ほふく茎）', back: 'ほふく茎（ランナー）を伸ばして増える植物は？' },
      { id: 'sci3-cd-fc23', front: '有性生殖は多様な形質の子ができる', back: '有性生殖の利点は何？' },
      { id: 'sci3-cd-fc24', front: '無性生殖は受精なしで速くふえられる', back: '無性生殖の利点は何？' },
      { id: 'sci3-cd-fc25', front: '減数分裂', back: '生殖細胞をつくるとき、染色体数が半分になる特別な細胞分裂を何という？' },
      { id: 'sci3-cd-fc26', front: '半分になる', back: '減数分裂後の生殖細胞の染色体数はもとの体細胞の何倍？' },
      { id: 'sci3-cd-fc27', front: 'イソギンチャク', back: '動物のうち、分裂によって無性生殖を行う例は？' },
      { id: 'sci3-cd-fc28', front: 'ミカヅキモ', back: '単細胞の藻類で、分裂によって増える生物は？' },
    ],
    quiz: {
      questions: [
        {
        ...
        { id: 'sci3-cd-q8', question: '体細胞分裂の前後で染色体の数は？', options: ['半分になる', '2倍になる', '変わらない', '0になる'], correctIndex: 2, explanation: '体細胞分裂では分裂前に染色体が複製されるため、分裂後も同じ数の染色体をもちます。' },
        { id: 'sci3-cd-q9', question: '減数分裂後の生殖細胞の染色体数はもとの体細胞の何倍？', options: ['同じ', '2倍', '半分', '4分の1'], correctIndex: 2, explanation: '減数分裂では染色体数が半分になります。受精で元の数に戻ります。' },
        { id: 'sci3-cd-q10', question: 'ジャガイモが無性生殖でふえるとき、子の形質は？', options: ['親と全く異なる', '両親の中間', '親と全く同じ', 'ランダム'], correctIndex: 2, explanation: '無性生殖（栄養生殖）では体細胞分裂で子ができるため、親と全く同じ形質をもちます。' },
        { id: 'sci3-cd-q11', question: '次のうち、有性生殖はどれ？', options: ['アメーバの分裂', 'ジャガイモの栄養生殖', 'カエルの卵と精子の受精', 'イソギンチャクの分裂'], correctIndex: 2, explanation: 'カエルの卵と精子の受精は有性生殖です。他の3つは無性生殖です。' },
        { id: 'sci3-cd-q12', question: '体細胞分裂の観察でカバーガラスの上からおしつぶす理由は？', options: ['細胞を殺すため', '染色体を壊すため', '細胞を重ならないようにするため', '塩酸を除くため'], correctIndex: 2, explanation: 'おしつぶすことで細胞が重ならず、1つ1つの細胞が観察しやすくなります。' },
        { id: 'sci3-cd-q13', question: '接ぎ木は何という生殖の方法か？', options: ['有性生殖', '減数分裂', '栄養生殖（無性生殖）', '受精'], correctIndex: 2, explanation: '接ぎ木は植物の体の一部を使って増やす栄養生殖の一種で、無性生殖に分類されます。' },
        { id: 'sci3-cd-q14', question: '体細胞の染色体数が46本の生物の、減数分裂後の生殖細胞の染色体数は？', options: ['46本', '92本', '23本', '12本'], correctIndex: 2, explanation: '減数分裂で染色体数は半分になるので、46÷2＝23本です。' },
        { id: 'sci3-cd-q15', question: '生物の形質（形や性質）を決めるものは何？', options: ['染色体', '遺伝子', '細胞膜', '核膜'], correctIndex: 1, explanation: '遺伝子は染色体の中にあり、生物の形質を決めるはたらきをしています。' },
        { id: 'sci3-cd-q16', question: '細胞分裂のときにはっきりしたひも状になるものは？', options: ['細胞膜', '核', '染色体', '葉緑体'], correctIndex: 2, explanation: '染色体はふだんは核の中にあって見えにくいですが、分裂のときにはっきりしたひも状になります。' },
        { id: 'sci3-cd-q17', question: 'クローンとは何か？', options: ['有性生殖でできた子', '無性生殖でできた、親と同じ遺伝子をもつ子', '突然変異した子', '異なる種の子'], correctIndex: 1, explanation: 'クローンとは無性生殖でできた、親と全く同じ遺伝子をもつ個体のことです。' },
        { id: 'sci3-cd-q18', question: '動物（ヒト）で血液の細胞をつくる細胞分裂が行われる場所は？', options: ['肝臓', '心臓', '脳', '骨髄'], correctIndex: 3, explanation: '骨の内部にある骨髄で細胞分裂が行われ、血液の細胞がつくられます。' },
        { id: 'sci3-cd-q19', question: '無性生殖でできた子が親と同じ形質をもつ理由は？', options: ['環境が同じだから', '体細胞分裂で子ができるため染色体が親と同じだから', '食べ物が同じだから', '大きさが同じだから'], correctIndex: 1, explanation: '無性生殖では体細胞分裂で子ができるため、染色体（遺伝子）が親と全く同じになります。' },
        { id: 'sci3-cd-q20', question: '次のうち、分裂でふえる単細胞生物をすべて選んだものは？', options: ['ゾウリムシとアメーバ', 'ジャガイモとサツマイモ', 'カエルとウニ', 'ゾウリムシとジャガイモ'], correctIndex: 0, explanation: 'ゾウリムシとアメーバは単細胞生物で、体が分裂してふえます。ジャガイモは栄養生殖です。' },
        { id: 'sci3-cd-q21', question: '有性生殖の利点として正しいものは？', options: ['速くふえられる', '多様な形質の子が生まれる', '親と同じ形質が保証される', '受精が不要'], correctIndex: 1, explanation: '有性生殖では両親から半分ずつ染色体を受けつぐため、多様な形質の子が生まれ、環境変化に適応しやすくなります。' },
        { id: 'sci3-cd-q22', question: '酢酸ダーリアバイオレットで染色体を染めると何色になる？', options: ['赤色', '青色', '紫色', '緑色'], correctIndex: 2, explanation: '酢酸ダーリアバイオレットは染色体を紫色に染めます。酢酸カーミンは赤色に染めます。' },
        { id: 'sci3-cd-q23', question: 'タマネギの根の先端付近の細胞の特徴は？', options: ['細胞が大きい', '細胞が小さく、さかんに分裂している', '細胞が存在しない', '染色体がない'], correctIndex: 1, explanation: '根の先端付近では細胞分裂がさかんなので、小さい細胞が多く観察されます。' },
        { id: 'sci3-cd-q24', question: '受精によって染色体数がもとに戻るしくみは？', options: ['体細胞分裂が起こる', '減数分裂で半分になった染色体が受精で合わさる', '染色体が2倍に複製される', '遺伝子が変異する'], correctIndex: 1, explanation: '減数分裂で半分になった生殖細胞どうしが受精することで、もとの染色体数に戻ります。' },
        { id: 'sci3-cd-q25', question: '生殖とは何か？', options: ['成長すること', '栄養を取ること', '自分と同じ種類の新しい個体をつくること', '環境に適応すること'], correctIndex: 2, explanation: '生殖とは生物が自分と同じ種類の新しい個体（子）をつくることです。' },
        { id: 'sci3-cd-q26', question: 'サツマイモがふえる方法は？', options: ['分裂', '受精', '栄養生殖', '出芽'], correctIndex: 2, explanation: 'サツマイモはいも（からだの一部）から新しい個体ができる栄養生殖（無性生殖）でふえます。' },
        { id: 'sci3-cd-q27', question: '体細胞分裂で細胞の数が増えた後、成長するためにさらに必要なことは？', options: ['細胞がさらに分裂する', 'それぞれの細胞が大きくなる', '細胞が合体する', '細胞が消滅する'], correctIndex: 1, explanation: '成長では、まず体細胞分裂で細胞の数を増やし、その後それぞれの細胞が大きくなります。' },
        { id: 'sci3-cd-q28', question: '種子からふやした個体が親と異なる形質をもつことがある理由は？', options: ['栄養が違うから', '有性生殖で両親から半分ずつ染色体を受けつぐから', '温度が違うから', '無性生殖だから'], correctIndex: 1, explanation: '種子は受精（有性生殖）でできるため、両親から半分ずつ染色体を受けつぎ、親と異なる形質が現れることがあります。' },
      ],
    },
    examples: {
      examples: [
