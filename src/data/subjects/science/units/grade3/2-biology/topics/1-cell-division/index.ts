  ...
  content: {
    ...
    quiz: {
      questions: [
        ...
        { id: 'sci3-cd-q8', question: '体細胞分裂の前後で染色体の数は？', options: ['半分になる', '2倍になる', '変わらない', '0になる'], correctIndex: 2, explanation: '体細胞分裂では分裂前に染色体が複製されるため、分裂後も同じ数の染色体をもちます。', difficulty: 'basic' },
        ...
        { id: 'sci3-cd-q13', question: '接ぎ木は何という生殖の方法か？', options: ['有性生殖', '減数分裂', '栄養生殖（無性生殖）', '受精'], correctIndex: 2, explanation: '接ぎ木は植物の体の一部を使って増やす栄養生殖の一種で、無性生殖に分類されます。', difficulty: 'standard' },
        { id: 'sci3-cd-q14', question: '体細胞の染色体数が46本の生物の、減数分裂後の生殖細胞の染色体数は？', options: ['46本', '92本', '23本', '12本'], correctIndex: 2, explanation: '減数分裂で染色体数は半分になるので、46÷2＝23本です。', difficulty: 'standard' },
        ...
        { id: 'sci3-cd-q16', question: '細胞分裂のときにはっきりしたひも状になるものは？', options: ['細胞膜', '核', '染色体', '葉緑体'], correctIndex: 2, explanation: '染色体はふだんは核の中にあって見えにくいですが、分裂のときにはっきりしたひも状になります。', difficulty: 'standard' },
        ...
        { id: 'sci3-cd-q21', question: '有性生殖の利点として正しいものは？', options: ['速くふえられる', '多様な形質の子が生まれる', '親と同じ形質が保証される', '受精が不要'], correctIndex: 1, explanation: '有性生殖では両親から半分ずつ染色体を受けつぐため、多様な形質の子が生まれ、環境変化に適応しやすくなります。', difficulty: 'standard' },
        { id: 'sci3-cd-q22', question: '酢酸ダーリアバイオレットで染色体を染めると何色になる？', options: ['赤色', '青色', '紫色', '緑色'], correctIndex: 2, explanation: '酢酸ダーリアバイオレットは染色体を紫色に染めます。酢酸カーミンは赤色に染めます。', difficulty: 'standard' },
        { id: 'sci3-cd-q23', question: 'タマネギの根の先端付近の細胞の特徴は？', options: ['細胞が大きい', '細胞が小さく、さかんに分裂している', '細胞が存在しない', '染色体がない'], correctIndex: 1, explanation: '根の先端付近では細胞分裂がさかんなので、小さい細胞が多く観察されます。', difficulty: 'advanced' },
        ...
        { id: 'sci3-cd-q25', question: '生殖とは何か？', options: ['成長すること', '栄養を取ること', '自分と同じ種類の新しい個体をつくること', '環境に適応すること'], correctIndex: 2, explanation: '生殖とは生物が自分と同じ種類の新しい個体（子）をつくることです。', difficulty: 'advanced' },
