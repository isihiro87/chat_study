  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '脊椎動物はまず水中で魚類として誕生し、そこからさまざまなグループに進化した。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ve-fc3',
        ...
        explanation: '魚類は一生を水中で過ごし、水中の酸素をえらで取り入れて呼吸する。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ve-fc4',
        ...
        explanation: '両生類は水中と陸上の両方で生活し、成長に伴い呼吸法が変わる。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ve-fc5',
        ...
        explanation: 'ハチュウ類はかたいうろこと殻のある卵により、水辺から離れた陸上生活に適応した。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ve-fc6',
        ...
        explanation: '鳥類は恒温動物で体温を一定に保ち、羽毛が保温と飛翔の両方に役立つ。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ve-fc7',
        ...
        explanation: '哺乳類は恒温動物で、母乳で子を育てる胎生が最大の特徴。',
        difficulty: 'standard',
      },
      {
        id: 'sci3-ve-fc8',
        ...
        explanation: '恒温動物はエネルギーを使って体温を維持するため、寒い環境でも活動できる。',
        difficulty: 'basic',
      },
      {
        id: 'sci3-ve-fc9',
      ...
      },
      {
        ...
        explanation: '水中の魚類から両生類が陸に上がり、さらにハチュウ類・哺乳類・鳥類へと進化した。',
        difficulty: 'basic',
      },
      { id: 'sci3-ve-fc12', front: '約40億年前', back: '地球上に最初の生命が誕生したのは約何年前？', explanation: '最初の生命は海中で誕生し、長い進化の歴史を経て現在のさまざまな生物になった。', difficulty: 'basic' },
      { id: 'sci3-ve-fc13', front: '胎生', back: '母体内で子を育てて産む方法を何という？（哺乳類の特徴）', explanation: '母体の中で栄養を受け取って成長するため、外敵から守られた状態で発生できる。', difficulty: 'standard' },
      { id: 'sci3-ve-fc14', front: '始祖鳥', back: 'ハチュウ類と鳥類の中間的な特徴をもつ化石生物を何という？', explanation: '羽毛(鳥類の特徴)をもちながら、歯や爪(ハチュウ類の特徴)も併せもっていた。', difficulty: 'standard' },
      { id: 'sci3-ve-fc15', front: 'かたいうろこ・殻のある卵', back: 'ハチュウ類が水辺から離れて生活できるようになった体のつくりは？', explanation: 'かたいうろこが体の乾燥を防ぎ、殻のある卵が胚を乾燥から守る。', difficulty: 'standard' },
      { id: 'sci3-ve-fc16', front: '肺呼吸', back: 'ハチュウ類・鳥類・哺乳類に共通する呼吸法は？', explanation: '陸上生活に適応するため、空気中の酸素を肺で取り入れる呼吸法に進化した。', difficulty: 'standard' },
      { id: 'sci3-ve-fc17', front: '水中に卵を産む', back: '魚類と両生類に共通する産卵場所は？', explanation: '卵に殻がなく乾燥に弱いため、水中でないと発生できない。', difficulty: 'standard' },
      { id: 'sci3-ve-fc18', front: '恒温動物', back: '体温を一定に保つことができる動物を何という？', explanation: '鳥類と哺乳類が該当。代謝によって体温を維持し、寒い環境でも活動できる。', difficulty: 'standard' },
      { id: 'sci3-ve-fc19', front: '変温動物', back: '周囲の温度によって体温が変わる動物を何という？', explanation: '魚類・両生類・ハチュウ類が該当。気温が低いと活動が鈍くなる。', difficulty: 'standard' },
      { id: 'sci3-ve-fc20', front: '羽毛', back: '鳥類の体表を覆っているものは？', explanation: '羽毛は体温の保持と飛翔の両方に重要な役割を果たす。', difficulty: 'standard' },
      { id: 'sci3-ve-fc21', front: '体毛', back: '哺乳類の体表を覆っているものは？', explanation: '体毛は体温を保ち、外部の刺激から体を守る役割がある。', difficulty: 'standard' },
      { id: 'sci3-ve-fc22', front: '湿った皮膚', back: '両生類の体表の特徴は？', explanation: '湿った皮膚を通して皮膚呼吸も行うが、乾燥しやすいため水辺から離れにくい。', difficulty: 'standard' },
      { id: 'sci3-ve-fc23', front: 'えら呼吸', back: '魚類の呼吸法は？', explanation: 'えらで水中に溶けた酸素を取り入れ、二酸化炭素を水中に放出する。', difficulty: 'advanced' },
      { id: 'sci3-ve-fc24', front: '子はえら→成体は肺と皮膚', back: '両生類の呼吸法の特徴は？', explanation: 'オタマジャクシはえらで水中呼吸し、カエルに変態すると肺と皮膚で呼吸するようになる。', difficulty: 'advanced' },
      { id: 'sci3-ve-fc25', front: '殻のある卵を陸上に産む', back: 'ハチュウ類と鳥類に共通する産卵方法は？', explanation: '殻が卵の中の水分を保ち、胚の乾燥を防ぐため陸上での発生が可能になった。', difficulty: 'advanced' },
      { id: 'sci3-ve-fc26', front: 'ひれ', back: '魚類が水中で移動するために使う器官は？', explanation: 'ひれは水をかいて推進力を得る。進化の過程でひれが足に変化して陸上生活に適応した。', difficulty: 'advanced' },
      { id: 'sci3-ve-fc27', front: '約5億年前', back: '最古の脊椎動物（魚類）の化石は約何年前のもの？', explanation: '古生代初期のカンブリア紀ごろに最初の脊椎動物である魚類が出現した。', difficulty: 'advanced' },
      { id: 'sci3-ve-fc28', front: '相同器官', back: '形やはたらきは異なるが、起源が同じ器官（ヒトの手・クジラのひれなど）を何という？', explanation: '骨格の基本構造が共通しており、共通の祖先から進化したことの証拠になる。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
      ...
      },
        {
          ...
          options: ['イクチオステガ','始祖鳥','カモノハシ','ユーステノプテロン',
          ],
          correctIndex: 3,
          explanation:
        ...
        { id: 'sci3-ve-q11', question: '魚類の体表を覆っているものは？', options: ['体毛','羽毛','湿った皮膚','うろこ'], correctIndex: 3, explanation: '魚類の体表はうろこに覆われています。水中生活に適した特徴です。', difficulty: 'standard' },
        { id: 'sci3-ve-q12', question: '進化とは何か？', options: ['生物の体の特徴が長い年月をかけて変化すること','個体が成長すること','環境が変わること','個体数が増えること'], correctIndex: 0, explanation: '進化とは生物のからだの特徴が長い年月をかけて変化することです。', difficulty: 'standard' },
        { id: 'sci3-ve-q13', question: 'ハチュウ類の体温調節の特徴は？', options: ['変温動物','恒温動物','体温がない','常に一定'], correctIndex: 0, explanation: 'ハチュウ類は変温動物で、周囲の温度によって体温が変わります。', difficulty: 'standard' },
        { id: 'sci3-ve-q14', question: '哺乳類が陸上で一生を過ごせる理由として正しいものは？', options: ['えら呼吸ができるから','変温動物だから','水中に卵を産むから','恒温動物で体毛があり胎生だから'], correctIndex: 3, explanation: '哺乳類は恒温動物で体温を保て、体毛で乾燥を防ぎ、胎生で水辺を必要としないため陸上で生活できます。', difficulty: 'standard' },
        ...
        { id: 'sci3-ve-q17', question: 'ヒトの手・クジラのひれ・コウモリの翼の関係は？', options: ['相同器官','無関係','同じ機能','退化器官'], correctIndex: 0, explanation: 'これらは形やはたらきは異なりますが、骨格の基本構造が共通しており、相同器官です。共通の祖先から進化した証拠になります。', difficulty: 'standard' },
        { id: 'sci3-ve-q18', question: '地球に最初の生命が誕生したのは約何年前？', options: ['約40億年前','約10億年前','約5億年前','約100億年前'], correctIndex: 0, explanation: '約40億年前に地球上に最初の生命が誕生したと考えられています。', difficulty: 'standard' },
        ...
        { id: 'sci3-ve-q23', question: '魚類の産卵場所はどこ？', options: ['水中','空中','陸上','地中'], correctIndex: 0, explanation: '魚類は水中に卵を産みます。両生類も同様に水中に産卵します。', difficulty: 'advanced' },
        ...
        { id: 'sci3-ve-q25', question: '変温動物である3つの脊椎動物グループは？', options: ['魚類・両生類・鳥類','両生類・ハチュウ類・哺乳類','鳥類・哺乳類・ハチュウ類','魚類・両生類・ハチュウ類'], correctIndex: 3, explanation: '変温動物は魚類・両生類・ハチュウ類です。鳥類と哺乳類は恒温動物です。', difficulty: 'advanced' },
        { id: 'sci3-ve-q26', question: '脊椎動物の進化で、水中から陸上へ移行したとき、呼吸法はどう変わった？', options: ['えら呼吸→肺呼吸','肺呼吸→えら呼吸','皮膚呼吸→えら呼吸','変わらなかった'], correctIndex: 0, explanation: '水中ではえら呼吸、陸上では肺呼吸へと進化しました。両生類はその過渡期を示しています。', difficulty: 'advanced' },
