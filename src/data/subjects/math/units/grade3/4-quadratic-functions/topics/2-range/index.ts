  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '$x = -1$ で $y = -2$、$x = -3$ で $y = -18$。$0$ を含まないので端だけ比較',
        difficulty: 'standard',
      },
      {
