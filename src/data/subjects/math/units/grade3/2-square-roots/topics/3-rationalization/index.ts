  ...
  content: {
    ...
    flashcards: [
      // === 既存フラッシュカード（fc1〜fc18） ===
      {
        ...
        front: '分母にある $\\sqrt{}$（無理数）をなくして、分母を有理数にすること。分母分子に同じルートをかけて行う。', back: '有理化とは何か？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc2',
        front: '分母分子に分母と同じ $\\sqrt{a}$ をかける。$\\frac{b}{\\sqrt{a}} = \\frac{b \\times \\sqrt{a}}{\\sqrt{a} \\times \\sqrt{a}} = \\frac{b\\sqrt{a}}{a}$', back: '有理化の基本手順は？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc3',
        front: '$\\sqrt{a} \\times \\sqrt{a} = a$。同じルート同士をかけるとルートが消えて中の数になる。これが有理化の核心！', back: '$\\sqrt{a} \\times \\sqrt{a}$ はいくつ？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc4',
        front: '$\\frac{1}{\\sqrt{2}} = \\frac{1 \\times \\sqrt{2}}{\\sqrt{2} \\times \\sqrt{2}} = \\frac{\\sqrt{2}}{2}$', back: '$\\frac{1}{\\sqrt{2}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc5',
        front: '$\\frac{1}{\\sqrt{3}} = \\frac{\\sqrt{3}}{3}$。分母分子に $\\sqrt{3}$ をかけて、$\\sqrt{3} \\times \\sqrt{3} = 3$ を利用する。', back: '$\\frac{1}{\\sqrt{3}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc6',
        front: '$\\frac{1}{\\sqrt{5}} = \\frac{\\sqrt{5}}{5}$。分母分子に $\\sqrt{5}$ をかけて、$\\sqrt{5} \\times \\sqrt{5} = 5$ を利用する。', back: '$\\frac{1}{\\sqrt{5}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc7',
        front: '有理化後の分子の係数と分母の数に公約数があるとき。例: $\\frac{6}{\\sqrt{2}} = \\frac{6\\sqrt{2}}{2} = 3\\sqrt{2}$（6と2を2で約分）', back: '有理化したあと約分が必要なのはどんなとき？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc8',
        front: '先に分母を簡単にする。$\\sqrt{8} = 2\\sqrt{2}$ なので $\\frac{4}{2\\sqrt{2}} = \\frac{2}{\\sqrt{2}}$。その後 $\\frac{2\\sqrt{2}}{2} = \\sqrt{2}$。', back: '$\\frac{4}{\\sqrt{8}}$ を有理化するとき、まず何をする？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc9',
        front: '分母の係数が大きいと有理化後の数も大きくなり約分が面倒。先に簡単にすると数が小さくなり計算ミスが減る。例: $\\sqrt{12} = 2\\sqrt{3}$ に直してから有理化。', back: '分母を先に簡単にするのはなぜ有利？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc10',
        front: '① 分数にまとめる: $\\frac{a\\sqrt{b}}{\\sqrt{c}}$ ② 分子のルートと分母のルートを計算: $a\\sqrt{\\frac{b}{c}}$ または有理化して整理。', back: '$\\sqrt{}$ をふくむ式の除法 $a\\sqrt{b} \\div \\sqrt{c}$ の手順は？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc11',
        front: '$2\\sqrt{15} \\div \\sqrt{5} = \\frac{2\\sqrt{15}}{\\sqrt{5}} = 2\\sqrt{\\frac{15}{5}} = 2\\sqrt{3}$。ルートの中を割り算できる。', back: '$2\\sqrt{15} \\div \\sqrt{5}$ を計算すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc12',
        front: '$\\frac{10}{\\sqrt{5}} = \\frac{10\\sqrt{5}}{5} = 2\\sqrt{5}$。10 と 5 の最大公約数は 5 なので約分する。', back: '$\\frac{10}{\\sqrt{5}}$ を有理化・約分すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc13',
        front: '$\\frac{8}{\\sqrt{2}} = \\frac{8\\sqrt{2}}{2} = 4\\sqrt{2}$。有理化後に 8÷2=4 で約分。', back: '$\\frac{8}{\\sqrt{2}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc14',
        front: '$\\frac{\\sqrt{12}}{\\sqrt{18}} = \\sqrt{\\frac{12}{18}} = \\sqrt{\\frac{2}{3}} = \\frac{\\sqrt{2}}{\\sqrt{3}} = \\frac{\\sqrt{6}}{3}$。', back: '$\\frac{\\sqrt{12}}{\\sqrt{18}}$ を簡単にすると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc15',
        front: '$\\frac{3\\sqrt{2}}{\\sqrt{6}} = \\frac{3\\sqrt{2} \\times \\sqrt{6}}{\\sqrt{6} \\times \\sqrt{6}} = \\frac{3\\sqrt{12}}{6} = \\frac{3 \\times 2\\sqrt{3}}{6} = \\sqrt{3}$。', back: '$\\frac{3\\sqrt{2}}{\\sqrt{6}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc16',
        front: '分母にルートがあると数値代入後に割り算が複雑。有理化して分母を整数にすると代入・計算が簡単になる。例: $\\frac{1}{\\sqrt{3}} = \\frac{\\sqrt{3}}{3}$。', back: '式の値を求めるときに有理化が便利な理由は？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc17',
        front: '$\\frac{\\sqrt{3}}{3} = \\frac{1.732}{3} \\approx 0.577$。これは $\\frac{1}{\\sqrt{3}}$ と同じ値。', back: '$\\sqrt{3} = 1.732$ のとき $\\frac{\\sqrt{3}}{3}$ の値は？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc18',
        front: '「分母分子に同じルートをかける」。これだけ！かけ算なので分数の値は変わらず、分母のルートだけ消える。', back: '有理化で最も大切なルールをひとことで言うと？',
        difficulty: 'basic',
      },
      // === 新規フラッシュカード（fc19〜fc40） ===
      {
        id: 'math-g3-rationalization-fc19',
        front: '$\\frac{1}{\\sqrt{7}} = \\frac{\\sqrt{7}}{7}$。分母分子に $\\sqrt{7}$ をかける。', back: '$\\frac{1}{\\sqrt{7}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc20',
        front: '$\\frac{1}{\\sqrt{11}} = \\frac{\\sqrt{11}}{11}$。分母分子に $\\sqrt{11}$ をかける。', back: '$\\frac{1}{\\sqrt{11}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc21',
        front: '$\\frac{1}{\\sqrt{6}} = \\frac{\\sqrt{6}}{6}$。分母分子に $\\sqrt{6}$ をかける。', back: '$\\frac{1}{\\sqrt{6}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc22',
        front: '$\\frac{1}{\\sqrt{10}} = \\frac{\\sqrt{10}}{10}$。分母分子に $\\sqrt{10}$ をかける。', back: '$\\frac{1}{\\sqrt{10}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc23',
        front: '$\\frac{3}{\\sqrt{5}} = \\frac{3\\sqrt{5}}{5}$。分母分子に $\\sqrt{5}$ をかける。', back: '$\\frac{3}{\\sqrt{5}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc24',
        front: '$\\frac{2}{\\sqrt{3}} = \\frac{2\\sqrt{3}}{3}$。分母分子に $\\sqrt{3}$ をかける。', back: '$\\frac{2}{\\sqrt{3}}$ を有理化すると？',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-rationalization-fc25',
        front: '$\\frac{\\sqrt{5}}{\\sqrt{3}} = \\frac{\\sqrt{5} \\times \\sqrt{3}}{3} = \\frac{\\sqrt{15}}{3}$。分子にルートがあっても同じ手順。', back: '$\\frac{\\sqrt{5}}{\\sqrt{3}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc26',
        front: '$\\frac{\\sqrt{7}}{\\sqrt{5}} = \\frac{\\sqrt{7} \\times \\sqrt{5}}{5} = \\frac{\\sqrt{35}}{5}$。', back: '$\\frac{\\sqrt{7}}{\\sqrt{5}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc27',
        front: '$\\frac{6}{\\sqrt{3}} = \\frac{6\\sqrt{3}}{3} = 2\\sqrt{3}$。有理化後に $6 \\div 3 = 2$ で約分。', back: '$\\frac{6}{\\sqrt{3}}$ を有理化・約分すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc28',
        front: '$\\frac{4}{\\sqrt{2}} = \\frac{4\\sqrt{2}}{2} = 2\\sqrt{2}$。有理化後に $4 \\div 2 = 2$ で約分。', back: '$\\frac{4}{\\sqrt{2}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc29',
        front: '$\\frac{12}{\\sqrt{6}} = \\frac{12\\sqrt{6}}{6} = 2\\sqrt{6}$。有理化後に $12 \\div 6 = 2$ で約分。', back: '$\\frac{12}{\\sqrt{6}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc30',
        front: '$\\frac{15}{\\sqrt{3}} = \\frac{15\\sqrt{3}}{3} = 5\\sqrt{3}$。有理化後に $15 \\div 3 = 5$ で約分。', back: '$\\frac{15}{\\sqrt{3}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc31',
        front: '先に $\\sqrt{12} = 2\\sqrt{3}$ に変形。$\\frac{6}{2\\sqrt{3}} = \\frac{3}{\\sqrt{3}} = \\frac{3\\sqrt{3}}{3} = \\sqrt{3}$。', back: '$\\frac{6}{\\sqrt{12}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc32',
        front: '先に $\\sqrt{20} = 2\\sqrt{5}$ に変形。$\\frac{10}{2\\sqrt{5}} = \\frac{5}{\\sqrt{5}} = \\frac{5\\sqrt{5}}{5} = \\sqrt{5}$。', back: '$\\frac{10}{\\sqrt{20}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc33',
        front: '先に $\\sqrt{18} = 3\\sqrt{2}$ に変形。$\\frac{3}{3\\sqrt{2}} = \\frac{1}{\\sqrt{2}} = \\frac{\\sqrt{2}}{2}$。', back: '$\\frac{3}{\\sqrt{18}}$ を有理化すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc34',
        front: '$\\sqrt{30} \\div \\sqrt{6} = \\sqrt{\\frac{30}{6}} = \\sqrt{5}$。ルートの中を割り算。', back: '$\\sqrt{30} \\div \\sqrt{6}$ を計算すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc35',
        front: '$\\sqrt{3} \\div \\sqrt{6} = \\sqrt{\\frac{3}{6}} = \\sqrt{\\frac{1}{2}} = \\frac{1}{\\sqrt{2}} = \\frac{\\sqrt{2}}{2}$。', back: '$\\sqrt{3} \\div \\sqrt{6}$ を計算すると？',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-rationalization-fc36',
        front: '$\\sqrt{18} = 3\\sqrt{2}$、$\\sqrt{8} = 2\\sqrt{2}$ より、$\\frac{3\\sqrt{2} - 2\\sqrt{2}}{\\sqrt{2}} = \\frac{\\sqrt{2}}{\\sqrt{2}} = 1$。', back: '$\\frac{(\\sqrt{18} - \\sqrt{8})}{\\sqrt{2}}$ を計算すると？',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-rationalization-fc37',
        front: '$\\sqrt{50} = 5\\sqrt{2}$、$\\sqrt{32} = 4\\sqrt{2}$ より、$\\frac{9\\sqrt{2}}{\\sqrt{2}} = 9$。', back: '$\\frac{(\\sqrt{50} + \\sqrt{32})}{\\sqrt{2}}$ を計算すると？',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-rationalization-fc38',
        front: '$\\sqrt{\\frac{5}{12}} = \\frac{\\sqrt{5}}{2\\sqrt{3}} = \\frac{\\sqrt{5} \\times \\sqrt{3}}{2 \\times 3} = \\frac{\\sqrt{15}}{6}$。', back: '$\\sqrt{\\frac{5}{12}}$ を有理化すると？',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-rationalization-fc39',
        front: '$\\frac{(\\sqrt{2} + 1) \\times \\sqrt{2}}{2} = \\frac{2 + \\sqrt{2}}{2} = 1 + \\frac{\\sqrt{2}}{2}$。', back: '$\\frac{(\\sqrt{2} + 1)}{\\sqrt{2}}$ を有理化すると？',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-rationalization-fc40',
        front: '$\\sqrt{54} \\times \\frac{\\sqrt{6}}{12} = 3\\sqrt{6} \\times \\frac{\\sqrt{6}}{12} = \\frac{3 \\times 6}{12} = \\frac{18}{12} = \\frac{3}{2}$。', back: '$\\sqrt{54} \\div \\frac{12}{\\sqrt{6}}$ を計算すると？',
        difficulty: 'advanced',
      },
    ],
    quiz: {
