  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        front: '$\\sqrt{108}$ を簡単にすると？',
        back: '$\\sqrt{108} = \\sqrt{36 \\times 3} = 6\\sqrt{3}$\n$108 = 6^2 \\times 3$ なので $6^2 = 36$ を外に出す。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc22',
        front: '$\\sqrt{0.03}$ を簡単にすると？',
        back: '$\\sqrt{0.03} = \\sqrt{\\dfrac{3}{100}} = \\dfrac{\\sqrt{3}}{10}$\n小数はまず分数に直してからルートを簡単にしよう。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc23',
        front: '$\\sqrt{\\dfrac{45}{49}}$ を簡単にすると？',
        back: '$\\sqrt{\\dfrac{45}{49}} = \\dfrac{\\sqrt{45}}{\\sqrt{49}} = \\dfrac{3\\sqrt{5}}{7}$\n分数のルートは分子・分母を別々に計算！',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc24',
        front: '$\\sqrt{2} \\times (-\\sqrt{15})$ を計算すると？',
        back: '$\\sqrt{2} \\times (-\\sqrt{15}) = -\\sqrt{2 \\times 15} = -\\sqrt{30}$\n符号に注意！正×負＝負だよ。',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc25',
        front: '$\\sqrt{\\dfrac{2}{3}} \\times \\sqrt{\\dfrac{3}{5}}$ を計算すると？',
        back: '$\\sqrt{\\dfrac{2}{3}} \\times \\sqrt{\\dfrac{3}{5}} = \\sqrt{\\dfrac{2}{3} \\times \\dfrac{3}{5}} = \\sqrt{\\dfrac{2}{5}}$\n分数どうしも中身をかけるだけ！',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc26',
        front: '$(-\\sqrt{18}) \\div (-\\sqrt{2})$ を計算すると？',
        back: '$(-\\sqrt{18}) \\div (-\\sqrt{2}) = \\sqrt{\\dfrac{18}{2}} = \\sqrt{9} = 3$\n負÷負＝正。中身をわって $\\sqrt{9} = 3$！',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc27',
        front: '$6\\sqrt{2}$ を $\\sqrt{c}$ の形にすると？',
        back: '$6\\sqrt{2} = \\sqrt{6^2 \\times 2} = \\sqrt{72}$\n$6^2 = 36$ をルートの中に入れる。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc28',
        front: '$2\\sqrt{7}$ を $\\sqrt{c}$ の形にすると？',
        back: '$2\\sqrt{7} = \\sqrt{2^2 \\times 7} = \\sqrt{28}$\n$2^2 = 4$ をルートの中に入れる。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc29',
        front: '$7\\sqrt{3}$ を $\\sqrt{c}$ の形にすると？',
        back: '$7\\sqrt{3} = \\sqrt{7^2 \\times 3} = \\sqrt{147}$\n$7^2 = 49$ をルートの中に入れる。',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc30',
        front: '$\\sqrt{3} = 1.732$ のとき $\\sqrt{300}$ の値は？',
        back: '$\\sqrt{300} = \\sqrt{100 \\times 3} = 10\\sqrt{3} = 10 \\times 1.732 = 17.32$\n$\\sqrt{3}$ の形に変形してから代入！',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc31',
        front: '$\\sqrt{5} = 2.236$ のとき $\\sqrt{0.05}$ の値は？',
        back: '$\\sqrt{0.05} = \\sqrt{\\dfrac{5}{100}} = \\dfrac{\\sqrt{5}}{10} = \\dfrac{2.236}{10} = 0.2236$\n小数を分数に直して $\\sqrt{5}$ の形にする！',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc32',
        front: '$\\sqrt{2} = 1.414$ のとき $\\sqrt{\\dfrac{1}{2}}$ の値は？',
        back: '$\\sqrt{\\dfrac{1}{2}} = \\dfrac{\\sqrt{1}}{\\sqrt{2}} = \\dfrac{1}{\\sqrt{2}} = \\dfrac{\\sqrt{2}}{2} = \\dfrac{1.414}{2} = 0.707$\n有理化してから代入するのがポイント！',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc33',
        front: '$\\sqrt{28}$ を簡単にすると？',
        back: '$\\sqrt{28} = \\sqrt{4 \\times 7} = 2\\sqrt{7}$\n$28 = 2^2 \\times 7$ なので $2^2$ を外に出す。',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc34',
        front: '$\\sqrt{48}$ を簡単にすると？',
        back: '$\\sqrt{48} = \\sqrt{16 \\times 3} = 4\\sqrt{3}$\n$48 = 4^2 \\times 3$ なので $4^2 = 16$ を外に出す。',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc35',
        front: '$\\sqrt{0.05}$ を簡単にすると？',
        back: '$\\sqrt{0.05} = \\sqrt{\\dfrac{5}{100}} = \\dfrac{\\sqrt{5}}{10}$\n小数はまず分数に直す！$\\dfrac{5}{100}$ の分母 $100 = 10^2$ を外に出す。',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-sqrt-mul-div-fc36',
        front: '$\\sqrt{\\dfrac{48}{25}}$ を簡単にすると？',
        back: '$\\sqrt{\\dfrac{48}{25}} = \\dfrac{\\sqrt{48}}{\\sqrt{25}} = \\dfrac{4\\sqrt{3}}{5}$\n分子と分母を別々に簡単にしよう。',
        difficulty: 'advanced',
      },
    ],
    quiz: {
