...
export const sqrtMeaning: Topic = {
  ...
  content: {
    ...
    flashcards: [
      // --- 平方根の定義（basic） ---
      { id: 'math-g3-sqrt-meaning-fc1', front: '平方根とは？', back: '2乗すると a になる数のこと。a の平方根は $\\pm\\sqrt{a}$ の2つある', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc2', front: '$\\sqrt{\\phantom{0}}$（ルート）記号の意味', back: '正の平方根を表す記号。$\\sqrt{9} = 3$（正の方だけ）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc3', front: '$9$ の平方根は？', back: '$\\pm 3$（$3^2 = 9$、$(-3)^2 = 9$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc4', front: '$(\\sqrt{a})^2 = ?$', back: '$a$（ルートと2乗は打ち消し合う）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc5', front: '$(-\\sqrt{a})^2 = ?$', back: '$a$（負の数の2乗は正になる）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc6', front: '$0$ の平方根は？', back: '$0$ だけ（$0^2 = 0$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc7', front: '負の数の平方根は？', back: '存在しない（2乗は必ず0以上）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc8', front: '有理数とは？', back: '整数 $m$ と 0でない整数 $n$ で $\\frac{m}{n}$ と表せる数', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc9', front: '無理数とは？', back: '分数で表せない数（$\\sqrt{2}$、$\\sqrt{3}$、$\\pi$ など）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc10', front: '$\\sqrt{2}$ の近似値は？', back: '$1.41421356\\ldots$（ひとよひとよにひとみごろ）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc11', front: '$\\sqrt{3}$ の近似値は？', back: '$1.7320508\\ldots$（ひとなみにおごれや）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc12', front: '$\\sqrt{5}$ の近似値は？', back: '$2.2360679\\ldots$（ふじさんろくおうむなく）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc13', front: '平方根の大小比較のルール', back: '$a < b$ ならば $\\sqrt{a} < \\sqrt{b}$（中の数が大きいほど$\\sqrt{\\phantom{0}}$も大きい）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc14', front: '負の平方根の大小比較', back: '$a < b$ ならば $-\\sqrt{a} > -\\sqrt{b}$（負になると不等号が逆転）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc15', front: '有限小数とは？', back: '小数点以下が有限で終わる小数（例: $0.125$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc16', front: '循環小数とは？', back: '同じ数字の並びがくり返される小数（例: $0.333\\ldots$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc17', front: '近似値とは？', back: '真の値に近い値として得られた値', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc18', front: '誤差の求め方', back: '誤差 $=$ 近似値 $-$ 真の値', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc19', front: '有効数字とは？', back: '近似値を表すとき、信頼できる意味のある数字', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc20', front: '有効数字の表し方', back: '$a \\times 10^n$ の形（例: $4500$ を有効数字2けた → $4.5 \\times 10^3$）', difficulty: 'standard' },
      // --- 以下、ichimondittou.md から追加 ---
      { id: 'math-g3-sqrt-meaning-fc21', front: '$25$ の平方根は？', back: '$\\pm 5$（$5^2 = 25$、$(-5)^2 = 25$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc22', front: '$64$ の平方根は？', back: '$\\pm 8$（$8^2 = 64$、$(-8)^2 = 64$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc23', front: '$0.04$ の平方根は？', back: '$\\pm 0.2$（$0.2^2 = 0.04$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc24', front: '$\\frac{16}{25}$ の平方根は？', back: '$\\pm\\frac{4}{5}$（$\\left(\\frac{4}{5}\\right)^2 = \\frac{16}{25}$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc25', front: '$\\sqrt{16} = ?$', back: '$4$（$4^2 = 16$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc26', front: '$-\\sqrt{49} = ?$', back: '$-7$（$\\sqrt{49} = 7$ の負の方）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc27', front: '$\\sqrt{0.09} = ?$', back: '$0.3$（$0.3^2 = 0.09$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc28', front: '$-\\sqrt{\\frac{1}{4}} = ?$', back: '$-\\frac{1}{2}$（$\\sqrt{\\frac{1}{4}} = \\frac{1}{2}$）', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc29', front: '$\\sqrt{121} = ?$', back: '$11$（$11^2 = 121$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc30', front: '$\\sqrt{144} = ?$', back: '$12$（$12^2 = 144$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc31', front: '$\\sqrt{400} = ?$', back: '$20$（$20^2 = 400$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc32', front: '$(-\\sqrt{0.3})^2 = ?$', back: '$0.3$（$(-\\sqrt{a})^2 = a$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc33', front: '$\\left(\\sqrt{\\frac{2}{3}}\\right)^2 = ?$', back: '$\\frac{2}{3}$（$(\\sqrt{a})^2 = a$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc34', front: '$\\sqrt{64}$ を $\\sqrt{\\phantom{0}}$ を使わずに表すと？', back: '$8$（$8^2 = 64$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc35', front: '$-\\sqrt{81}$ を $\\sqrt{\\phantom{0}}$ を使わずに表すと？', back: '$-9$（$9^2 = 81$）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc36', front: '$\\sqrt{\\frac{9}{25}}$ を $\\sqrt{\\phantom{0}}$ を使わずに表すと？', back: '$\\frac{3}{5}$（$\\left(\\frac{3}{5}\\right)^2 = \\frac{9}{25}$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc37', front: '$\\sqrt{(-6)^2} = ?$', back: '$6$（$(-6)^2 = 36$、$\\sqrt{36} = 6$）', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc38', front: '$\\sqrt{11}$ と $\\sqrt{13}$ の大小は？', back: '$\\sqrt{11} < \\sqrt{13}$（$11 < 13$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc39', front: '$-\\sqrt{5}$ と $-\\sqrt{7}$ の大小は？', back: '$-\\sqrt{7} < -\\sqrt{5}$（負の数は絶対値が大きいほど小さい）', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc40', front: '$6$ と $\\sqrt{37}$ の大小は？', back: '$6 < \\sqrt{37}$（$6^2 = 36 < 37$）', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc41', front: '$\\sqrt{50}$ と $7$ の大小は？', back: '$7 < \\sqrt{50}$（$7^2 = 49 < 50$）', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc42', front: '$3 < \\sqrt{a} < 4$ となる自然数 $a$ はいくつ？', back: '$6$ 個（$a = 10, 11, 12, 13, 14, 15$）。$3^2 = 9$、$4^2 = 16$ より $9 < a < 16$', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc43', front: '$\\sqrt{5}$ は有理数？無理数？', back: '無理数（$5$ は完全平方数でないので分数で表せない）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc44', front: '$\\sqrt{9}$ は有理数？無理数？', back: '有理数（$\\sqrt{9} = 3$ で整数になる）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc45', front: '円周率 $\\pi$ は有理数？無理数？', back: '無理数（分数で表せない）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc46', front: '$\\frac{5}{8}$ は有限小数？循環小数？', back: '有限小数（$\\frac{5}{8} = 0.625$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc47', front: '$\\frac{1}{3}$ は有限小数？循環小数？', back: '循環小数（$\\frac{1}{3} = 0.333\\ldots$）', difficulty: 'standard' },
      { id: 'math-g3-sqrt-meaning-fc48', front: '有限小数・循環小数は有理数？無理数？', back: '有理数（どちらも分数で表せる）', difficulty: 'basic' },
      { id: 'math-g3-sqrt-meaning-fc49', front: '近似値 $4507$m を有効数字3けたで $a \\times 10^n$ の形にすると？', back: '$4.51 \\times 10^3$ m', difficulty: 'advanced' },
      { id: 'math-g3-sqrt-meaning-fc50', front: '近似値 $2.96$km の有効数字は何けた？', back: '$3$ けた（$2, 9, 6$）', difficulty: 'standard' },
    ],
    quiz: {
      questions: [
        // --- 既存問題（basic / standard） ---
