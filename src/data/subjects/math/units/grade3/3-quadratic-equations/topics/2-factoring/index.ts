...
export const quadEqFactoring: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      {
        id: 'math-g3-qef-fc6',
        front: '(x+3)(x−3)=0 → x=±3', back: 'x²−9=0 の解き方は？',
        explanation: '差の平方の公式 a²−b²=(a+b)(a−b) を使う',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc7',
        front: 'x = ±a', back: 'x²−a²=0 の解は？',
        explanation: '(x+a)(x−a)=0 → x = a または x = −a',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc8',
        front: '両辺に−1をかけて x²−5x+6=0 にする', back: '−x²+5x−6=0 を解くにはまず何をする？',
        explanation: 'x²の係数を正の1にそろえてから因数分解',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc9',
        front: '両辺を2で割って x²−5x+6=0 にする', back: '2x²−10x+12=0 を解くにはまず何をする？',
        explanation: '共通因数で割って係数をそろえてから因数分解',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc10',
        front: '解けない！右辺が0でないとA×B=0が使えない', back: '(x−3)(x−4)=2 はそのまま解ける？',
        explanation: '展開→整理→因数分解の手順で解く',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc11',
        front: '(x+a)²', back: '完全平方式 x²+2ax+a² の因数分解は？',
        explanation: '例: x²+6x+9 = (x+3)²',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc12',
        front: '(x−a)²', back: '完全平方式 x²−2ax+a² の因数分解は？',
        explanation: '例: x²−10x+25 = (x−5)²',
        difficulty: 'basic',
      },
      {
        id: 'math-g3-qef-fc13',
        front: '両辺を x で割って x=0 を見落とすこと\n正解: x=0 または x=a', back: 'x(x−a)=0 の解を求めるとき、よくあるミスは？',
        explanation: '因数分解の形のまま各因数=0とするのが鉄則。両辺を文字で割ると解を失う。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc14',
        front: '左辺が因数分解できる形であること\nできなければ解の公式を使う', back: '因数分解で解ける二次方程式の見分け方は？',
        explanation: 'かけてc・足してbになる整数の組を探し、見つからなければ解の公式へ。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc15',
      ...
      },
      {
        ...
        explanation: 'a²−b²=(a+b)(a−b) の公式を使う。x²−25=(x+5)(x−5)。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc18',
        front: 'x=4, x=−2\n(x−4)(x+2)=0', back: 'x²−2x−8=0 の解は？',
        explanation: 'かけて−8、足して−2になる組は−4と2。(x−4)(x+2)=0。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc19',
      ...
      },
      {
        ...
        explanation: '共通因数xでくくる。x=0を忘れないように注意。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc21',
        front: '3で割って x²−x−6=0\n(x−3)(x+2)=0 → x=3, −2', back: '3x²−3x−18=0 の解は？',
        explanation: '全体を3で割ってx²の係数を1にしてから因数分解する。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc22',
        front: 'x=1, x=7\n展開→x²−8x+12=5→x²−8x+7=0→(x−1)(x−7)=0', back: '(x−4)²=9−4x の解は？',
        explanation: 'まず左辺を展開して整理し、ax²+bx+c=0の形にしてから因数分解。',
        difficulty: 'standard',
      },
      {
        id: 'math-g3-qef-fc23',
      ...
      },
      {
        ...
        explanation: 'x²−a²=(x+a)(x−a) の公式。49=7² なので x=±7。',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-qef-fc26',
        front: 'x=2, x=−7\n(x−2)(x+7)=0', back: 'x²+5x−14=0 の解は？',
        explanation: 'かけて−14、足して5になる組は7と−2。(x+7)(x−2)=0。',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-qef-fc27',
        front: 'x=0, x=8\nx(x−8)=0', back: 'x²=8x の解は？（移項してから）',
        explanation: '右辺を左辺に移項してx²−8x=0とし、xでくくる。',
        difficulty: 'advanced',
      },
      {
        id: 'math-g3-qef-fc28',
        front: 'x=6, x=−1\n−1をかけて x²−5x−6=0→(x−6)(x+1)=0', back: '−x²+5x+6=0 の解は？',
        explanation: 'x²の係数が負のときは全体に−1をかけて正にしてから因数分解。',
        difficulty: 'advanced',
      },
