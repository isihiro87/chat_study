    ...
    flashcards: [
      {
        ...
        explanation: '未知数の数だけ式が必要。2つの未知数には2つの式で連立する。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc4',
        front: '$x + y = 10$', back: '「合わせて 10 個」を式にすると？（$x$ 個と $y$ 個）',
        explanation: '「合わせて」は足し算の合計を表すキーワード。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc5',
        front: '$ax + by = S$', back: '1 個 $a$ 円の品を $x$ 個、1 個 $b$ 円の品を $y$ 個買って合計 $S$ 円。金額の式は？',
        explanation: '単価 $\\times$ 個数の合計が代金になる。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc6',
        front: '$10x + y$', back: '2 けたの自然数を、十の位 $x$・一の位 $y$ で表すと？',
        explanation: '十の位は $10$ 倍して一の位を足す。例: $35 = 10 \\times 3 + 5$。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc7',
        front: '$10y + x$', back: '十の位と一の位を入れかえた数は？',
        explanation: '元の数が $10x + y$ なら、入れかえると $10y + x$ になる。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc8',
        front: '$A \\times \\dfrac{p}{100}$', back: '「$A$ の $p$%」を式で表すと？',
        explanation: '百分率は $100$ で割って割合に直す。例: $20$% $= 0.2$。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc9',
      ...
      },
      {
        ...
        explanation: '元の量 $1$ に増加分 $\\dfrac{p}{100}$ を足す。例: $5$%増 $= 1.05$ 倍。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc12',
        front: '$\\left(1 - \\dfrac{p}{100}\\right)$ 倍', back: '「$p$% 減少」は元の何倍？',
        explanation: '元の量 $1$ から減少分 $\\dfrac{p}{100}$ を引く。例: $20$%減 $= 0.8$ 倍。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-app-fc14',
        front: '足し算（$x + y = \\text{合計}$）の式になる', back: '文章題で「合計」という言葉が出たら、どんな式？',
        explanation: '「合計」「合わせて」「全部で」は足し算のキーワード。',
        difficulty: 'standard',
      },
      {
        id: 'math-g2-app-fc15',
        front: '引き算（$x - y = \\text{差}$）の式になる', back: '文章題で「差」という言葉が出たら、どんな式？',
        explanation: '「差」「～多い」「～少ない」は引き算のキーワード。',
        difficulty: 'standard',
      },
      { id: 'math-g2-app-fc21', front: '人数 × 単価 $=$ 金額。人数の合計と金額の合計で2式', back: '入場料の文章題のパターンは？', explanation: '人数の式と金額の式を立てて連立する。', difficulty: 'standard' },
      { id: 'math-g2-app-fc23', front: '$x + y = $ 全体の量、$(条件式1)x + (条件式2)y = $ 結果の量', back: '典型的な連立方程式の文章題の2式のパターンは？', explanation: '1式目は数量の合計、2式目は条件を使った関係式になることが多い。', difficulty: 'advanced' },
      { id: 'math-g2-app-fc25', front: '「合計」「差」「割合」「代金」のキーワードに注目する', back: '文章題で式を立てるとき、どんな言葉に注目する？', explanation: 'キーワードが演算のヒントになる。合計→足し算、差→引き算。', difficulty: 'advanced' },
      { id: 'math-g2-app-fc26', front: '単位をそろえてから式を立てる（分→時間、cm→m など）', back: '文章題で単位が異なるときは？', explanation: '単位が混在すると計算を間違えるので、先にそろえるのが鉄則。', difficulty: 'advanced' },
      { id: 'math-g2-app-fc27', front: '$11(x + y)$', back: '2けたの数と入れかえた数の和は $11$ の倍数。この式は？', explanation: '$(10x + y) + (10y + x) = 11(x + y)$。', difficulty: 'advanced' },
      { id: 'math-g2-app-fc28', front: '求めた値が整数かつ正の数であること（個数や人数は自然数）', back: '文章題の答えに必要な条件は？', explanation: '負の数や小数になったら問題の条件に合うか確認する。', difficulty: 'advanced' },
