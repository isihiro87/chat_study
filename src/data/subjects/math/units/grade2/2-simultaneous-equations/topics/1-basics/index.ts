...
export const simulEqBasics: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g2-sb-fc27', front: '三元一次方程式', back: '未知数が3つの場合は何という？', explanation: '3つの式が必要。' },
      { id: 'math-g2-sb-fc28', front: '$n$ 個の未知数には $n$ 本の式が必要', back: '未知数の数と式の数の関係は？', explanation: '式1つにつき未知数を1つ消去できる。' },
      { id: 'math-g2-sb-fc29', front: '「元」は未知数のこと', back: '「二元」の「元」は何を意味する？', explanation: '二元 $=$ 未知数が $2$ つ。', difficulty: 'basic' },
      ...
      { id: 'math-g2-sb-fc41', front: '表を使う方法は解が整数でない場合見つけにくい', back: '表を使って解を見つける方法の欠点は？', explanation: '加減法や代入法の方が確実。', difficulty: 'standard' },
      { id: 'math-g2-sb-fc42', front: '$(4, 2)$', back: '$\\begin{cases} x + y = 6 \\\\ x - y = 2 \\end{cases}$ の解は？', explanation: '表から共通の組を見つける。', difficulty: 'standard' },
      { id: 'math-g2-sb-fc43', front: '三元一次方程式', back: '未知数が $3$ つの一次方程式を何という？', explanation: '$3$ つの式が必要。', difficulty: 'advanced' },
