    ...
    flashcards: [
      {
        id: 'math-g2-sb-fc2',
        front: '$x = 4, y = 1$',
        back: '$x + y = 5$ と $x - y = 3$ を両方満たす $(x, y)$ は？',
        explanation: '$4 + 1 = 5$ ✓、$4 - 1 = 3$ ✓。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sb-fc3',
      ...
      {
        id: 'math-g2-sb-fc7',
        front: 'いいえ', back: '$2x + 3 = 7$ は二元一次方程式？',
        hint: '文字がいくつあるか数えよう',
        explanation: '一元一次方程式。文字が $x$ の1つだけなので「一元」一次方程式。二元には2つの文字が必要。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sb-fc8',
        front: 'いいえ', back: '$x^2 + y = 5$ は二元一次方程式？',
        hint: '各文字の次数をチェック',
        explanation: '$x^2$ があるので一次方程式ではない。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sb-fc9',
        front: 'いいえ', back: '$xy = 6$ は二元一次方程式？',
        hint: '$x$ と $y$ の積は何次？',
        explanation: '$xy$ は二次の項なので二元一次方程式ではない。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sb-fc12',
      ...
      },
      {
        ...
        hint: 'セットで考えるという意味',
        explanation: '大かっこは2つの方程式を同時に満たす解を求めることを示す記号。',
      },
      {
        id: 'math-g2-sb-fc14',
        front: '$x = 5, y = 2$',
      ...
      },
      {
        ...
        explanation: '未知数が2つあるのに条件が1つだけでは、解の組み合わせが無数にある。',
      },
      {
        id: 'math-g2-sb-fc16',
        front: '$(3, 2)$', back: '$x + y = 5$ と $x - y = 1$ を両方満たす $(x, y)$ は？',
        hint: '$3 + 2 = 5$ ✓、$3 - 2 = 1$ ✓',
        explanation: '2つの式を足すと $2x = 6$ → $x = 3$、$y = 2$ と求まる。',
      },
      {
        id: 'math-g2-sb-fc17',
        front: '$x$ と $y$ の値の組で表す（例: $x = 2, y = 3$）', back: '二元一次方程式の解はどのように表す？',
        hint: '1つの値ではなく、2つセットで',
        explanation: '未知数が2つあるので、解も2つの値の組で表す必要がある。',
      },
      { id: 'math-g2-sb-fc18', front: '$ax + by = c$ の形', back: '二元一次方程式の標準形は？', explanation: '$a$, $b$, $c$ は定数。' },
      { id: 'math-g2-sb-fc19', front: '2つの直線の交点', back: '連立方程式の解をグラフで表すと？', explanation: 'グラフでは交点が解を表す。' },
      { id: 'math-g2-sb-fc20', front: '解がない', back: '連立方程式に解がないことはある？', explanation: '2つの直線が平行で交わらない場合、解がない。' },
      { id: 'math-g2-sb-fc24', front: 'はい', back: '二元一次方程式の係数は $1$ 以外でもいい？', explanation: '$3x + 2y = 10$ のように、係数は整数や分数でもよい。' },
      { id: 'math-g2-sb-fc25', front: 'はい（一種）', back: '$y = 5$ は二元一次方程式？', explanation: '$y = k$（定数）の形も $0x + y = k$ と見なせるので二元一次方程式の一種。' },
      { id: 'math-g2-sb-fc26', front: '方程式は特定の値でのみ成り立つ等式、恒等式はすべての値で成り立つ等式', back: '方程式と恒等式の違いは？', explanation: '例: $x + 1 = 3$ は方程式（$x=2$ のみ）、$2(x+1) = 2x+2$ は恒等式（常に成立）。' },
      { id: 'math-g2-sb-fc27', front: '$x = 1, y = 2$', back: '$\\begin{cases} 3x + y = 5 \\\\ x + 2y = 5 \\end{cases}$ の解は？', explanation: '①$\\times 2 - $②で $5x = 5$。', difficulty: 'standard' },
      { id: 'math-g2-sb-fc28', front: '$n$ 個の未知数には $n$ 本の式が必要', back: '未知数の数と式の数の関係は？', explanation: '式1つにつき未知数を1つ消去できる。' },
      { id: 'math-g2-sb-fc29', front: '$x = 2, y = 4$', back: '$\\begin{cases} x + y = 6 \\\\ 2x + y = 8 \\end{cases}$ の解は？', explanation: '②$-$①で $x = 2$、$y = 4$。', difficulty: 'basic' },
      { id: 'math-g2-sb-fc30', front: 'いいえ（文字が1つだけ）', back: '$2x + 3 = 7$ は二元一次方程式？', explanation: '一元一次方程式。', difficulty: 'basic' },
      { id: 'math-g2-sb-fc31', front: 'いいえ（$x^2$ があるので一次ではない）', back: '$x^2 + y = 5$ は二元一次方程式？', explanation: '各文字が $1$ 次でなければならない。', difficulty: 'basic' },
      ...
      { id: 'math-g2-sb-fc34', front: '$x = 3, y = 1$', back: '$\\begin{cases} 2x + y = 7 \\\\ x - y = 2 \\end{cases}$ の解は？', explanation: '足すと $3x = 9$、$x = 3$、$y = 1$。', difficulty: 'basic' },
      ...
      { id: 'math-g2-sb-fc39', front: 'はい', back: '$\\begin{cases} x + y = 7 \\\\ x - y = 3 \\end{cases}$ で $x = 5, y = 2$ は解？', explanation: '$5+2=7$ ✓、$5-2=3$ ✓。', difficulty: 'standard' },
      { id: 'math-g2-sb-fc40', front: 'はい', back: '$\\begin{cases} 2x + 3y = 13 \\\\ x + y = 5 \\end{cases}$ で $x = 2, y = 3$ は解？', explanation: '$4+9=13$ ✓、$2+3=5$ ✓。', difficulty: 'standard' },
      { id: 'math-g2-sb-fc42', front: '$(4, 2)$', back: '$\\begin{cases} x + y = 6 \\\\ x - y = 2 \\end{cases}$ の解は？', explanation: '表から共通の組を見つける。', difficulty: 'standard' },
      { id: 'math-g2-sb-fc43', front: '$x = 5, y = -1$', back: '$\\begin{cases} 3x + 2y = 13 \\\\ x - 4y = 9 \\end{cases}$ の解は？', explanation: '①$\\times 2 + $②で $7x = 35$。', difficulty: 'advanced' },
      { id: 'math-g2-sb-fc44', front: '解が $1$ つに決まらない（不定）', back: '連立方程式で式の数が未知数の数より少ないとどうなる？', explanation: '式が足りないと解が無数にある。', difficulty: 'advanced' },
      { id: 'math-g2-sb-fc45', front: 'はい（$0x + y = k$ と見なせる）', back: '$y = 5$ は二元一次方程式の一種？', explanation: '$x$ の係数が $0$ の特殊な場合。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
