  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '例: $3$% と $8$% を混ぜると、必ず $3$%～$8$% の間になる。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-apadv-fc11',
        front: '$4x$ km', back: '時速 4km で $x$ 時間歩いたときの距離は？',
        explanation: '距離 $=$ 速さ $\\times$ 時間 $= 4 \\times x$。',
        difficulty: 'basic',
      },
      { id: 'math-g2-apadv-fc15', front: '行き: $\\dfrac{d}{v_1}$ 時間、帰り: $\\dfrac{d}{v_2}$ 時間', back: '片道 $d$ km を行き速さ $v_1$、帰り速さ $v_2$ で往復する時間は？', explanation: '時間 $=$ 距離 $\\div$ 速さ。行きと帰りで別々に求める。', difficulty: 'standard' },
      { id: 'math-g2-apadv-fc16', front: '濃度が下がる', back: '食塩水に水を加えるとどうなる？', explanation: '食塩水に水を加えると濃度は下がる。食塩を加えると濃度は上がる。', difficulty: 'standard' },
      { id: 'math-g2-apadv-fc18', front: '距離の式と時間の式の2つ', back: '速さの問題で立てる2つの式は？', explanation: '距離が等しい関係と、時間の合計の関係を使って連立する。', difficulty: 'standard' },
      { id: 'math-g2-apadv-fc22', front: '混合後の食塩の量 $=$ 各食塩水の食塩の量の合計', back: '食塩水を混ぜるときの食塩の量の関係は？', explanation: '食塩は化学変化しないので量が保存される。', difficulty: 'standard' },
      { id: 'math-g2-apadv-fc23', front: '濃度が上がる', back: '食塩水を加熱して蒸発させるとどうなる？', explanation: '蒸発させると水だけが減り食塩は残る → 濃度が上がる。', difficulty: 'advanced' },
      { id: 'math-g2-apadv-fc24', front: '向かい合う→速さの和、追いかける→速さの差', back: '2人の速さの問題の2パターンは？', explanation: '出会うときは速さを足し、追いつくときは速さの差で考える。', difficulty: 'advanced' },
      { id: 'math-g2-apadv-fc26', front: '$24$ g', back: '$8$% の食塩水 $300$ g に含まれる食塩は？', explanation: '$300 \\times 0.08 = 24$ g。', difficulty: 'advanced' },
      { id: 'math-g2-apadv-fc27', front: '必ず2つの濃度の間になる', back: '混合後の食塩水の濃度の範囲は？', explanation: '濃い方より高くも、薄い方より低くもならない。', difficulty: 'advanced' },
