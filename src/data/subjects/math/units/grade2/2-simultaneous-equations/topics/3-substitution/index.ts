  ...
  content: {
    ...
    flashcards: [
      ...
      },
      {
        ...
        explanation: '$x$ を右辺に移項するだけで $y = 5 - x$ が得られる。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sub-fc8',
        ...
        explanation: '$-y$ を移項すると $x = y + 2$ となる。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sub-fc9',
      ...
      },
      {
        ...
        explanation: '分配法則でかっこを外し、同類項をまとめて解く。',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-sub-fc11',
      ...
      },
      {
        ...
        explanation: '係数がそろっていれば引くだけで文字が消去できる。',
        difficulty: 'standard',
      },
      {
        id: 'math-g2-sub-fc14',
        ...
        hint: '変形 → 代入 → 逆代入',
        explanation: 'この3ステップで未知数を1つずつ順番に求める。',
        difficulty: 'standard',
      },
      {
        id: 'math-g2-sub-fc15',
      ...
      { id: 'math-g2-sub-fc19', front: '代入した式を展開するとき、必ずかっこをつけて計算ミスを防ぐ', back: '代入法で最もよくあるミスは？', explanation: 'かっこを忘れると符号ミスにつながる。例: $-2(x-3)$ を $-2x-3$ としがち。', difficulty: 'standard' },
      { id: 'math-g2-sub-fc20', front: '$x = 4, y = 1$', back: '$y = x - 3$, $x + 2y = 6$ を代入法で解くと？', explanation: '$x + 2(x-3) = 6$ → $3x - 6 = 6$ → $x = 4$。', difficulty: 'standard' },
      { id: 'math-g2-sub-fc21', front: '$x = 1, y = 4$', back: '$x = 5 - y$, $3x + y = 7$ を代入法で解くと？', explanation: '$3(5-y) + y = 7$ → $15 - 2y = 7$ → $y = 4$。', difficulty: 'standard' },
      { id: 'math-g2-sub-fc22', front: '一方の式がすでに $x = $ or $y = $ の形 → 代入法が最適', back: '代入法を選ぶべきサインは？', explanation: '変形の手間なくそのまま代入できるので計算が楽。', difficulty: 'standard' },
      { id: 'math-g2-sub-fc25', front: '$x = 2, y = 4$', back: '$y = 2x$, $3x + y = 10$ を代入法で解くと？', explanation: '$3x + 2x = 10$ → $5x = 10$ → $x = 2$。', difficulty: 'advanced' },
      { id: 'math-g2-sub-fc26', front: '$x = 4, y = 2$', back: '$x = 2y$, $x + 3y = 10$ を代入法で解くと？', explanation: '$2y + 3y = 10$ → $5y = 10$ → $y = 2$。', difficulty: 'advanced' },
      ...
      { id: 'math-g2-sub-fc33', front: '$x = 3, y = 4$', back: '$\\begin{cases} y = x + 1 \\\\ 3x + y = 13 \\end{cases}$ を代入法で解くと？', explanation: '$3x + (x+1) = 13$、$4x = 12$。', difficulty: 'basic' },
      { id: 'math-g2-sub-fc34', front: '$x = 5, y = 4$', back: '$\\begin{cases} y = x - 1 \\\\ 3x - 2y = 7 \\end{cases}$ を代入法で解くと？', explanation: '$3x - 2(x-1) = 7$、$x + 2 = 7$。', difficulty: 'standard' },
      { id: 'math-g2-sub-fc35', front: '$x = 3, y = 1$', back: '$\\begin{cases} y = -x + 4 \\\\ 2x + y = 7 \\end{cases}$ を代入法で解くと？', explanation: '$2x + (-x+4) = 7$、$x = 3$。', difficulty: 'standard' },
      { id: 'math-g2-sub-fc36', front: '$x = 3, y = 12$', back: '$\\begin{cases} y = 4x \\\\ x + y = 15 \\end{cases}$ を代入法で解くと？', explanation: '$x + 4x = 15$、$5x = 15$。', difficulty: 'basic' },
