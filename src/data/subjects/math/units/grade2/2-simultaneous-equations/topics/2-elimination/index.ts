...
export const elimination: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g2-elim-fc35', front: '$x = 2, y = 3$', back: '$\\begin{cases} 2x + y = 7 \\\\ 2x - 3y = -5 \\end{cases}$ を加減法で解くと？', explanation: '①-②で $4y = 12$。', difficulty: 'standard' },
      { id: 'math-g2-elim-fc36', front: '$x = 5, y = 2$', back: '$\\begin{cases} x + 2y = 9 \\\\ x - 2y = 1 \\end{cases}$ を加減法で解くと？', explanation: '足すと $2x = 10$。', difficulty: 'basic' },
      { id: 'math-g2-elim-fc37', front: '$x = 3, y = 2$', back: '$\\begin{cases} 3x + 2y = 13 \\\\ x + 2y = 7 \\end{cases}$ を加減法で解くと？', explanation: '①-②で $2x = 6$。', difficulty: 'standard' },
      { id: 'math-g2-elim-fc38', front: '$x = 4, y = 2$', back: '$\\begin{cases} 5x - 2y = 16 \\\\ 3x - 2y = 8 \\end{cases}$ を加減法で解くと？', explanation: '①-②で $2x = 8$。', difficulty: 'standard' },
      { id: 'math-g2-elim-fc39', front: '$x = 2, y = 3$', back: '$\\begin{cases} 2x + 5y = 19 \\\\ 2x + y = 7 \\end{cases}$ を加減法で解くと？', explanation: '①-②で $4y = 12$。', difficulty: 'standard' },
      { id: 'math-g2-elim-fc40', front: '$x = 4, y = 3$', back: '$\\begin{cases} 4x + 3y = 25 \\\\ 4x - y = 13 \\end{cases}$ を加減法で解くと？', explanation: '①-②で $4y = 12$。', difficulty: 'standard' },
