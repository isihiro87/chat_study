...
export const linearFuncMeaning: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g2-linear-func-meaning-fc29', front: '$6$', back: '$y = 3x + 1$ で $x$ が $2$ 増えたとき、$y$ の増加量は？', explanation: '変化の割合 $3 \\times 2 = 6$。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc30', front: '$-8$', back: '$y = -4x + 5$ で $x$ が $2$ 増えたとき、$y$ の増加量は？', explanation: '$-4 \\times 2 = -8$。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc31', front: '$11$', back: '$y = 2x + 3$ で $x = 4$ のとき $y$ は？', explanation: '$y = 2 \\times 4 + 3 = 11$。', difficulty: 'basic' },
      ...
      { id: 'math-g2-linear-func-meaning-fc37', front: '$-2$', back: '$y = -x + 5$ で $x = 7$ のとき $y$ は？', explanation: '$y = -7 + 5 = -2$。', difficulty: 'basic' },
