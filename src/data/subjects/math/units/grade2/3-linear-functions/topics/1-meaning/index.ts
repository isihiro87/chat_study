...
export const linearFuncMeaning: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g2-linear-func-meaning-fc29', front: '$y$ が $x$ の一次式で表される関数（$y = ax + b$, $a \\neq 0$）', back: '一次関数とは何？', explanation: '$a$ は傾き、$b$ は切片。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc30', front: '変化の割合（傾き）', back: '$y = ax + b$ の $a$ を何という？', explanation: '$x$ が $1$ 増えるときの $y$ の増加量。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc31', front: '切片', back: '$y = ax + b$ の $b$ を何という？', explanation: '$x = 0$ のときの $y$ の値。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc32', front: 'はい（$a = -5$, $b = 0$）', back: '$y = -5x$ は一次関数？', explanation: '比例でもある。$b = 0$ の一次関数。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc33', front: 'いいえ（$a = 0$ なので関数ではない）', back: '$y = 7$ は一次関数？', explanation: '$x$ が変わっても $y$ は変わらない。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc34', front: 'いいえ（$x^2$ の項があるので一次式ではない）', back: '$y = x^2 + 3$ は一次関数？', explanation: '一次関数は $x$ の $1$ 乗まで。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc35', front: 'いいえ（$y = \\dfrac{12}{x}$ で反比例）', back: '$xy = 12$ は一次関数？', explanation: '一次関数ではなく反比例。', difficulty: 'standard' },
      { id: 'math-g2-linear-func-meaning-fc36', front: '$\\dfrac{y の増加量}{x の増加量}$', back: '変化の割合の求め方は？', explanation: '一次関数では常に一定で $a$ に等しい。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc37', front: '比例（$b = 0$ の一次関数）', back: '一次関数 $y = ax + b$ で $b = 0$ のとき、何という？', explanation: '$y = ax$ は比例の式。', difficulty: 'basic' },
      { id: 'math-g2-linear-func-meaning-fc38', front: '$a$ は $1$ あたりの変化量、$b$ は初期値', back: '文章題で $a$ と $b$ を見つけるコツは？', explanation: '傾きと切片をそれぞれ見つける。', difficulty: 'standard' },
      { id: 'math-g2-linear-func-meaning-fc39', front: '$y$ の増え方が一定かチェック', back: '一次関数かどうかを表で確認するには？', explanation: '表で $y$ の差が一定なら一次関数。', difficulty: 'standard' },
      { id: 'math-g2-linear-func-meaning-fc40', front: '$|a|$ が大きいほどグラフは急', back: '傾きの大きさとグラフの関係は？', explanation: '$a$ の絶対値で急さが決まる。', difficulty: 'standard' },
      { id: 'math-g2-linear-func-meaning-fc41', front: '$a > 0$ なら右上がり、$a < 0$ なら右下がり', back: '一次関数のグラフの向きは何で決まる？', explanation: '傾き $a$ の正負。', difficulty: 'standard' },
      { id: 'math-g2-linear-func-meaning-fc42', front: '$y$ 軸との交点の $y$ 座標', back: '切片をグラフ上で見つけるには？', explanation: '$x = 0$ のときの $y$ の値。', difficulty: 'standard' },
      { id: 'math-g2-linear-func-meaning-fc43', front: '$a = 0$ だと $y = b$ で $x$ によって変化しないから', back: '一次関数で $a \\neq 0$ が必要な理由は？', explanation: '定数は関数とはいえない。', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
