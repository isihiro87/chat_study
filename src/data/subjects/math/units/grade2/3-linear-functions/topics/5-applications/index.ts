    ...
    flashcards: [
      {
        ...
        front: '速さを表す', explanation: '傾き＝距離の変化÷時間の変化＝速さ', back: '距離と時間のグラフで、傾きは何を表す？',
        difficulty: 'basic',
      },
      {
        id: 'math-g2-lfapps-fc2',
        front: '止まっている', explanation: '時間が経っても距離が変わらない＝移動していない', back: '距離と時間のグラフで、水平な部分は何を意味する？',
        difficulty: 'basic',
      },
      {
      ...
      },
      {
        ...
        front: '出会う時刻と場所', explanation: '同じ時刻に同じ場所にいることを表す', back: '2人の移動グラフで、交点は何を表す？',
        difficulty: 'basic',
      },
      {
      ...
      },
      {
        ...
        front: '変域ごとに式が変わるから', explanation: '点がどの辺にいるかで傾きが変わる', back: '動く点の問題で、グラフが折れ線になる理由は？',
        difficulty: 'standard',
      },
      {
    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          options: ['速さが速い', '速さが遅い', '距離が短い', '時間が長い'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['$y = 2x + 30$', '$y = 30x + 2$', '$y = 32x$', '$y = 2x - 30$'],
          correctIndex: 0,
        ...
        },
        {
          ...
          options: ['速さが上がった', '速さが一定', '引き返している', '止まっている'],
          correctIndex: 2,
