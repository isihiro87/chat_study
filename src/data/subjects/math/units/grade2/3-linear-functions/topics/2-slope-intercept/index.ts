...
export const slopeIntercept: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g2-slope-intercept-fc29', front: '$a$（$x$ の係数）', back: '一次関数 $y = ax + b$ で「傾き」はどの文字？', explanation: '$x$ が $1$ 増えたときの $y$ の変化量。', difficulty: 'basic' },
      { id: 'math-g2-slope-intercept-fc30', front: '$3$', back: '$y = 3x + 2$ の傾きは？', explanation: '$x$ が $1$ 増えると $y$ は $3$ 増える。', difficulty: 'basic' },
      { id: 'math-g2-slope-intercept-fc31', front: '$-5$', back: '$y = -5x + 1$ の傾きは？', explanation: '$x$ が $1$ 増えると $y$ は $5$ 減る。', difficulty: 'basic' },
      { id: 'math-g2-slope-intercept-fc32', front: '$1$', back: '$y = x - 4$ の傾きは？', explanation: '$x$ の係数が省略されているとき $1$。', difficulty: 'basic' },
      { id: 'math-g2-slope-intercept-fc33', front: '$-1$', back: '$y = -x + 7$ の傾きは？', explanation: '$-x = -1 \\times x$。', difficulty: 'basic' },
      { id: 'math-g2-slope-intercept-fc34', front: '$\\dfrac{2}{3}$', back: '$y = \\dfrac{2}{3}x + 1$ の傾きは？', explanation: '分数も傾きになれる。', difficulty: 'standard' },
      { id: 'math-g2-slope-intercept-fc35', front: '$3$ 増える', back: '傾きが $\\dfrac{3}{4}$ のとき、$x$ が $4$ 増えると $y$ は？', explanation: '$\\dfrac{3}{4} \\times 4 = 3$。', difficulty: 'standard' },
      { id: 'math-g2-slope-intercept-fc36', front: '$b$（$x = 0$ のときの $y$ の値）', back: '一次関数 $y = ax + b$ の切片は？', explanation: 'グラフが $y$ 軸と交わる点の $y$ 座標。', difficulty: 'basic' },
      { id: 'math-g2-slope-intercept-fc37', front: '$2$', back: '$y = 3x + 2$ の切片は？', explanation: '$x = 0$ のとき $y = 2$。', difficulty: 'basic' },
      ...
      { id: 'math-g2-slope-intercept-fc43', front: '切片を読む → もう1点との差から傾きを計算', back: 'グラフから一次関数の式を読み取る手順は？', explanation: '①$y$ 軸との交点 → ②傾き。', difficulty: 'standard' },
