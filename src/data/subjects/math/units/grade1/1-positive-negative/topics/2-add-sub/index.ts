...
export const addSub: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'math-g1-as-fc1', front: '加法（かほう）', back: 'たし算のことを数学では何という？' },
      { id: 'math-g1-as-fc2', front: '減法（げんぽう）', back: 'ひき算のことを数学では何という？' },
      { id: 'math-g1-as-fc3', front: '絶対値の和に共通の符号をつける', back: '同符号の加法のルールは？' },
      { id: 'math-g1-as-fc4', front: '絶対値の差に、絶対値が大きい方の符号をつける', back: '異符号の加法のルールは？' },
      { id: 'math-g1-as-fc5', front: '同符号（正＋正）→ 絶対値の和 $3+5=8$ に正の符号 → $+8$', back: '$(+3)+(+5)$ の計算方法は？' },
      { id: 'math-g1-as-fc6', front: '同符号（負＋負）→ 絶対値の和 $4+7=11$ に負の符号 → $-11$', back: '$(-4)+(-7)$ の計算方法は？' },
      { id: 'math-g1-as-fc7', front: '異符号 → 絶対値の差 $7-3=4$ に大きい方（正）の符号 → $+4$', back: '$(+7)+(-3)$ の計算方法は？' },
      { id: 'math-g1-as-fc8', front: 'ひく数の符号を変えて足す。例: $a-b = a+(-b)$', back: '減法を加法に変換する方法は？' },
      { id: 'math-g1-as-fc9', front: '$(+5)+(+3) = +8$', back: '$(+5)-(-3)$ を加法に直すと？' },
      { id: 'math-g1-as-fc10', front: '項（こう）', back: '加法だけの式に直したとき、各数を何と呼ぶ？' },
      { id: 'math-g1-as-fc11', front: '$+7$ と $+3$', back: '$7-12+3$ の正の項は？' },
      { id: 'math-g1-as-fc12', front: '$-12$', back: '$7-12+3$ の負の項は？' },
      { id: 'math-g1-as-fc13', front: '$a + b = b + a$（順番を入れかえても結果は同じ）', back: '加法の交換法則とは？' },
      { id: 'math-g1-as-fc14', front: '$(a+b)+c = a+(b+c)$（組み合わせを変えても結果は同じ）', back: '加法の結合法則とは？' },
      { id: 'math-g1-as-fc15', front: '正の項どうし、負の項どうしをそれぞれ足してから、最後に合わせる', back: '正の項と負の項をまとめて計算するコツは？' },
      { id: 'math-g1-as-fc16', front: '$(+a) + 0 = a$。$0$ を足しても値は変わらない。', back: '$0$ を足すとどうなる？' },
      { id: 'math-g1-as-fc17', front: '$(+5) + (-5) = 0$。絶対値が同じで符号が逆の2数の和は $0$', back: '反数どうしを足すと？' },
      { id: 'math-g1-as-fc18', front: '和（わ）。例: $3 + 5 = 8$ → $8$ が和', back: 'たし算の結果を何という？' },
      { id: 'math-g1-as-fc19', front: '差（さ）。例: $8 - 3 = 5$ → $5$ が差', back: 'ひき算の結果を何という？' },
      { id: 'math-g1-as-fc20', front: '通分してから加減する。$(-\frac{1}{3}) + (+\frac{1}{6}) = -\frac{2}{6} + \frac{1}{6} = -\frac{1}{6}$', back: '分数の正負の数の加減のポイントは？' },
      { id: 'math-g1-as-fc21', front: '小数も同じルール。$(-1.5) + (+2.3) = +(2.3 - 1.5) = +0.8$', back: '小数の正負の加法のやり方は？' },
      { id: 'math-g1-as-fc22', front: '反数のペアを探す。$(+50)+(-50)=0$ のようにまとめる', back: '計算を工夫する方法は？' },
      { id: 'math-g1-as-fc23', front: '引く数の符号を変えて足す。$(-7)-(-3)=(-7)+(+3)=-4$', back: '負の数を引くとは？' },
      { id: 'math-g1-as-fc24', front: '$-(+5) = -5$、$-(-5) = +5$。符号を反対にする操作。', back: '「符号を変える」とは？' },
      { id: 'math-g1-as-fc25', front: '$0 - (-7) = 0 + 7 = +7$', back: '$0$ から負の数を引くと？' },
      { id: 'math-g1-as-fc26', front: '正の項を先にまとめ、負の項を後にまとめると計算しやすい', back: '多くの項がある式を整理するコツは？' },
      { id: 'math-g1-as-fc27', front: '$y$ の増加量 $= a \times x$ の増加量で素早く求められる', back: '変化の割合を使った増加量の計算法は？' },
      { id: 'math-g1-as-fc28', front: '正の項の和と負の項の和をそれぞれ求め、最後に加える', back: '四つ以上の項がある式の計算手順は？' },
    ],
    quiz: {
      questions: [
        {
