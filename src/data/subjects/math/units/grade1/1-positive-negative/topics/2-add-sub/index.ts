...
export const addSub: Topic = {
  ...
  content: {
    ...
    videos: [],
    flashcards: [
      { id: 'math-g1-as-fc1', front: '加法（かほう）', back: 'たし算のことを数学では何という？', difficulty: 'basic' },
      { id: 'math-g1-as-fc2', front: '減法（げんぽう）', back: 'ひき算のことを数学では何という？', difficulty: 'basic' },
      { id: 'math-g1-as-fc3', front: '絶対値の和に共通の符号をつける', back: '同符号の加法のルールは？', difficulty: 'basic' },
      { id: 'math-g1-as-fc4', front: '絶対値の差に、絶対値が大きい方の符号をつける', back: '異符号の加法のルールは？', difficulty: 'basic' },
      { id: 'math-g1-as-fc5', front: '同符号（正＋正）→ 絶対値の和 $3+5=8$ に正の符号 → $+8$', back: '$(+3)+(+5)$ の計算方法は？', difficulty: 'basic' },
      { id: 'math-g1-as-fc6', front: '同符号（負＋負）→ 絶対値の和 $4+7=11$ に負の符号 → $-11$', back: '$(-4)+(-7)$ の計算方法は？', difficulty: 'basic' },
      { id: 'math-g1-as-fc7', front: '異符号 → 絶対値の差 $7-3=4$ に大きい方（正）の符号 → $+4$', back: '$(+7)+(-3)$ の計算方法は？', difficulty: 'basic' },
      { id: 'math-g1-as-fc8', front: 'ひく数の符号を変えて足す。例: $a-b = a+(-b)$', back: '減法を加法に変換する方法は？', difficulty: 'basic' },
      { id: 'math-g1-as-fc9', front: '$(+5)+(+3) = +8$', back: '$(+5)-(-3)$ を加法に直すと？', difficulty: 'basic' },
      { id: 'math-g1-as-fc10', front: '項（こう）', back: '加法だけの式に直したとき、各数を何と呼ぶ？', difficulty: 'basic' },
      { id: 'math-g1-as-fc11', front: '$+7$ と $+3$', back: '$7-12+3$ の正の項は？', difficulty: 'basic' },
      { id: 'math-g1-as-fc12', front: '$-12$', back: '$7-12+3$ の負の項は？', difficulty: 'basic' },
      { id: 'math-g1-as-fc13', front: '$a + b = b + a$（順番を入れかえても結果は同じ）', back: '加法の交換法則とは？', difficulty: 'standard' },
      { id: 'math-g1-as-fc14', front: '$(a+b)+c = a+(b+c)$（組み合わせを変えても結果は同じ）', back: '加法の結合法則とは？', difficulty: 'standard' },
      { id: 'math-g1-as-fc15', front: '正の項どうし、負の項どうしをそれぞれ足してから、最後に合わせる', back: '正の項と負の項をまとめて計算するコツは？', difficulty: 'standard' },
      { id: 'math-g1-as-fc16', front: '$(+a) + 0 = a$。$0$ を足しても値は変わらない。', back: '$0$ を足すとどうなる？', difficulty: 'standard' },
      { id: 'math-g1-as-fc17', front: '$(+5) + (-5) = 0$。絶対値が同じで符号が逆の2数の和は $0$', back: '反数どうしを足すと？', difficulty: 'standard' },
      { id: 'math-g1-as-fc18', front: '和（わ）。例: $3 + 5 = 8$ → $8$ が和', back: 'たし算の結果を何という？', difficulty: 'standard' },
      { id: 'math-g1-as-fc19', front: '差（さ）。例: $8 - 3 = 5$ → $5$ が差', back: 'ひき算の結果を何という？', difficulty: 'standard' },
      { id: 'math-g1-as-fc20', front: '通分してから加減する。$(-\frac{1}{3}) + (+\frac{1}{6}) = -\frac{2}{6} + \frac{1}{6} = -\frac{1}{6}$', back: '分数の正負の数の加減のポイントは？', difficulty: 'standard' },
      { id: 'math-g1-as-fc21', front: '小数も同じルール。$(-1.5) + (+2.3) = +(2.3 - 1.5) = +0.8$', back: '小数の正負の加法のやり方は？', difficulty: 'standard' },
      { id: 'math-g1-as-fc22', front: '反数のペアを探す。$(+50)+(-50)=0$ のようにまとめる', back: '計算を工夫する方法は？', difficulty: 'standard' },
      { id: 'math-g1-as-fc23', front: '引く数の符号を変えて足す。$(-7)-(-3)=(-7)+(+3)=-4$', back: '負の数を引くとは？', difficulty: 'advanced' },
      { id: 'math-g1-as-fc24', front: '$-(+5) = -5$、$-(-5) = +5$。符号を反対にする操作。', back: '「符号を変える」とは？', difficulty: 'advanced' },
      { id: 'math-g1-as-fc25', front: '$0 - (-7) = 0 + 7 = +7$', back: '$0$ から負の数を引くと？', difficulty: 'advanced' },
      { id: 'math-g1-as-fc26', front: '正の項を先にまとめ、負の項を後にまとめると計算しやすい', back: '多くの項がある式を整理するコツは？', difficulty: 'advanced' },
      { id: 'math-g1-as-fc27', front: '正の項の和 $+$ 負の項の和を計算。$3-8+5-2+7 = (3+5+7)+(-8-2) = 15-10 = 5$', back: '5つ以上の項がある加減の効率的な計算法は？', difficulty: 'advanced' },
      { id: 'math-g1-as-fc28', front: '正の項の和と負の項の和をそれぞれ求め、最後に加える', back: '四つ以上の項がある式の計算手順は？', difficulty: 'advanced' },
    ],
    quiz: {
      questions: [
        {
        ...
        },
        {
          ...
          options: ['$-1$', '$+1$', '$-3$', '$+17$'],
          correctIndex: 0,
          explanation: '正の項: $3 + 5 = 8$。負の項: $-8 - 1 = -9$。$8 + (-9) = -1$ だよ。',
          difficulty: 'standard',
        },
        {
        ...
        },
        {
          ...
          options: ['$-7$', '$0$', '$+7$', '$+14$'],
          correctIndex: 2,
          explanation: '$0 - (-7) = 0 + (+7) = +7$。$0$ から負の数を引くと正になるよ。',
          difficulty: 'standard',
        },
        {
          ...
          options: ['$-4$', '$+4$', '$-24$', '$+24$'],
          correctIndex: 0,
          explanation: '正: $9 + 1 = 10$。負: $-5 -3 -6 = -14$。$10 - 14 = -4$ だよ。',
          difficulty: 'standard',
        },
        {
          ...
          correctIndex: 0,
          explanation: '分母が同じ。分子: $-2 + 3 = 1$。答え $+\frac{1}{5}$ だよ。',
          difficulty: 'standard',
        },
        {
        ...
        },
        {
          ...
          options: ['$+7$', '$-7$', '$+3$', '$-3$'],
          correctIndex: 0,
          explanation: '加法に直すと $(-3)+(+8)+(-2)+(+4)$。正: $12$。負: $-5$。$12-5=7$ だよ。',
          difficulty: 'advanced',
        },
        {
          ...
          options: ['$+2$', '$-2$', '$+10$', '$0$'],
          correctIndex: 0,
          explanation: '正: $2 + 4 = 6$。負: $-1 + (-3) = -4$。$6 + (-4) = +2$ だよ。',
          difficulty: 'advanced',
        },
        {
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: '加法の結合法則は $(a+b)+c = a+(b+c)$。組み合わせを変えても和は同じだよ。',
          difficulty: 'advanced',
        },
      ],
    },
