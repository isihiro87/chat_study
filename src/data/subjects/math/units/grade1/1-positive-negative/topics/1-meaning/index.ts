...
export const posNegMeaning: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g1-pn-m-fc11', front: '絶対値が大きいほど小さい', explanation: '例: $|-5| = 5 > |-2| = 2$ だから $-5 < -2$。', back: '負の数どうしの大小比較のコツは？', difficulty: 'basic' },
      ...
      { id: 'math-g1-pn-m-fc19', front: '数直線上で右側にある数ほど大きい', explanation: '数直線を描いて位置を比べるとわかりやすい。', back: '数直線で大小を比べるコツは？', difficulty: 'standard' },
