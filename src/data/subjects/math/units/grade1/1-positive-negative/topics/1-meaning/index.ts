...
export const posNegMeaning: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g1-pn-m-fc49', front: '$7$', explanation: '絶対値は符号を取った値。$|-7| = 7$。', back: '$-7$ の絶対値は？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc50', front: '$+8$ と $-8$ の2つ', explanation: '原点から $8$ の距離にある点は正と負の2つ。', back: '絶対値が $8$ の整数は？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc51', front: '$\\frac{3}{4}$', explanation: '絶対値は符号を取った値。分数でも同じ。$|-\\frac{3}{4}| = \\frac{3}{4}$。', back: '$-\\frac{3}{4}$ の絶対値は？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc52', front: '$-7 < -4$', explanation: '負の数どうしでは絶対値が大きいほど小さい。$|-7|=7 > |-4|=4$。', back: '$-7$ と $-4$ の大小を不等号で表すと？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc53', front: '$-6 < -1 < 0 < +3 < +5$', explanation: '負の数は絶対値が大きいほど小さく、正の数はそのまま。', back: '$+3, -1, 0, +5, -6$ を小さい順に並べると？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc54', front: '$-0.3$', explanation: '$0$ より $0.3$ 小さい数は負の符号をつけて $-0.3$。', back: '$0$ より $0.3$ 小さい数を負の符号をつけて表すと？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc55', front: '$-\\frac{1}{2}$', explanation: '$0$ より小さい分数には負の符号をつける。', back: '$0$ より $\\frac{1}{2}$ 小さい数を負の符号をつけて表すと？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc56', front: '$+2$', explanation: '$-2$ と絶対値が同じで符号が反対の数は $+2$。', back: '$-2$ と絶対値が同じで符号が反対の数は？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc57', front: '$-0.3 < +0.1$', explanation: '負の数は正の数より必ず小さい。', back: '$-0.3$ と $+0.1$ の大小を不等号で表すと？', difficulty: 'basic' },
      { id: 'math-g1-pn-m-fc58', front: '$-\\frac{1}{2} < -\\frac{1}{3}$', explanation: '通分: $-\\frac{3}{6} < -\\frac{2}{6}$。絶対値が大きい方が小さい。', back: '$-\\frac{1}{2}$ と $-\\frac{1}{3}$ の大小を不等号で表すと？', difficulty: 'standard' },
      { id: 'math-g1-pn-m-fc59', front: '$7$ 個', explanation: '絶対値が $3$ 以下: $-3, -2, -1, 0, +1, +2, +3$ の $7$ 個。', back: '絶対値が $3$ 以下の整数は何個？', difficulty: 'standard' },
      { id: 'math-g1-pn-m-fc60', front: '$-8 < -5 < -\\frac{1}{2} < 0 < +3$', explanation: '負の数は絶対値が大きいほど小さい。$|-8|>|-5|>|-\\frac{1}{2}|$。', back: '$+3, -5, 0, -\\frac{1}{2}, -8$ を小さい順に並べると？', difficulty: 'standard' },
      { id: 'math-g1-pn-m-fc61', front: '$9$ m', explanation: '$+4$ m と $-5$ m の差。$|4-(-5)| = |4+5| = 9$。', back: '海抜 $+4$ m と海抜 $-5$ m の高さの差は？', difficulty: 'advanced' },
      { id: 'math-g1-pn-m-fc62', front: '$-3.5 < -2.1 < -0.8 < +1.4$', explanation: '負の数は絶対値が大きいほど小さい。正の数は大きい方が大きい。', back: '$+1.4, -2.1, -0.8, -3.5$ を小さい順に並べると？', difficulty: 'advanced' },
      { id: 'math-g1-pn-m-fc63', front: '$21$ 個', explanation: '$-10$ から $+10$ まで $21$ 個。$10 + 1 + 10 = 21$。', back: '絶対値が $10$ 以下の整数は何個？', difficulty: 'advanced' },
      { id: 'math-g1-pn-m-fc64', front: '$1.2$', explanation: '小数の絶対値も符号を取った値。$|-1.2| = 1.2$。', back: '$-1.2$ の絶対値は？', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
