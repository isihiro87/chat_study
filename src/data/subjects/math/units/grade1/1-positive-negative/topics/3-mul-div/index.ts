...
export const mulDiv: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g1-md-fc7', front: '$0$', explanation: '$0$ にどんな数をかけても $0$ になる。', back: '$0 \\times (-7)$ の計算結果は？', difficulty: 'basic' },
      ...
      { id: 'math-g1-md-fc49', front: '$+24$', explanation: '負が偶数個（$4$ 個）→正。$2 \\times 3 \\times 1 \\times 4 = 24$。', back: '$(-2) \\times (-3) \\times (-1) \\times (-4)$ の計算結果は？', difficulty: 'basic' },
      { id: 'math-g1-md-fc50', front: '$-6$', explanation: '負が奇数個（$3$ 個）→負。$2 \\times 3 \\times 1 = 6$。', back: '$(-2) \\times (-3) \\times (-1)$ の計算結果は？', difficulty: 'basic' },
      { id: 'math-g1-md-fc51', front: '$+8$', explanation: '同符号（負÷負）→正。$56 \\div 7 = 8$。', back: '$(-56) \\div (-7)$ の計算結果は？', difficulty: 'standard' },
      { id: 'math-g1-md-fc52', front: '$-\\frac{3}{2}$', explanation: '分子分母を入れかえて符号はそのまま。$-\\frac{2}{3} \\times (-\\frac{3}{2}) = 1$。', back: '$-\\frac{2}{3}$ の逆数は？', difficulty: 'standard' },
      { id: 'math-g1-md-fc53', front: '$+3$', explanation: '除法→乗法: $(-6) \\times (-\\frac{1}{2}) = +3$。', back: '$(-6) \\div (-2)$ の計算結果は？', difficulty: 'standard' },
      { id: 'math-g1-md-fc54', front: '$+\\frac{3}{8}$', explanation: '除法→乗法: $(-\\frac{3}{4}) \\times (-\\frac{1}{2})$。同符号→正。', back: '$(-\\frac{3}{4}) \\div (+2)$ の計算結果は？', difficulty: 'advanced' },
      { id: 'math-g1-md-fc55', front: '$-12$', explanation: '負が奇数個（$3$ 個）→負。$2 \\times 3 \\times 2 = 12$。', back: '$(-2) \\times 3 \\times (+2)$ の計算結果は？', difficulty: 'advanced' },
      { id: 'math-g1-md-fc56', front: '$-2$', explanation: '$(-8) \\times \\frac{1}{4} = -2$。除法は逆数のかけ算。', back: '$(-8) \\div 4$ の計算結果は？', difficulty: 'basic' },
    ],
    quiz: {
      questions: [
        {
