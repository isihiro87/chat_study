...
export const proportion: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g1-proportion-fc31', front: '関数', back: '$x$ の値を決めると $y$ の値がただ1つ決まるとき、$y$ は $x$ の何？', explanation: 'ともなって変わる2つの量の関係。', difficulty: 'basic' },
      { id: 'math-g1-proportion-fc32', front: 'ただ1つ', back: '関数の定義で大切な条件「$x$ の値を決めると $y$ の値が（　）決まる」の（　）は？', explanation: '1つの $x$ に対して $y$ が2つ以上あると関数ではない。', difficulty: 'basic' },
      { id: 'math-g1-proportion-fc33', front: '変数', back: '関数でいろいろな値をとる文字（$x$ や $y$）を何という？', explanation: '定数（変わらない数）の対義語。', difficulty: 'basic' },
      { id: 'math-g1-proportion-fc34', front: '$y = ax$（$a$ は $0$ でない定数）', back: '$y$ が $x$ に比例するとき、式で表すと？', explanation: '$a$ は比例定数。', difficulty: 'basic' },
      { id: 'math-g1-proportion-fc35', front: '比例定数', back: '$y = ax$ の $a$ を何という？', explanation: '$a = \\dfrac{y}{x}$ で求められる。', difficulty: 'basic' },
      ...
      { id: 'math-g1-proportion-fc38', front: '$-2 < x < 5$', back: '$x$ の変域が $-2$ より大きく $5$ 未満のとき、不等号で表すと？', explanation: '「より大きい」「未満」はその数を含まない。', difficulty: 'standard' },
