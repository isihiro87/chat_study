...
export const eqBasics: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g1-eq-b-fc39', front: '$x = 4$', back: '$3x + 2 = 14$ の解は？', explanation: '移項して $3x = 12$、両辺を $3$ で割る。', difficulty: 'standard' },
      { id: 'math-g1-eq-b-fc40', front: '$x = 3$', back: '$-2x + 9 = 3$ の解は？', explanation: '移項して $-2x = -6$、両辺を $-2$ で割る。', difficulty: 'standard' },
      { id: 'math-g1-eq-b-fc41', front: '$x = -3$', back: '$4x + 7 = -5$ の解は？', explanation: '移項して $4x = -12$、両辺を $4$ で割る。', difficulty: 'standard' },
      { id: 'math-g1-eq-b-fc42', front: '$x = 3$', back: '$7x - 5 = 3x + 7$ の解は？', explanation: '移項して $4x = 12$、$x = 3$。', difficulty: 'standard' },
      { id: 'math-g1-eq-b-fc43', front: '$x = 4$', back: '$2x + 10 = 5x - 2$ の解は？', explanation: '移項して $-3x = -12$、$x = 4$。', difficulty: 'standard' },
      { id: 'math-g1-eq-b-fc44', front: '$x = 4$', back: '$2(x + 3) = 14$ の解は？', explanation: '展開して $2x + 6 = 14$、$2x = 8$、$x = 4$。', difficulty: 'standard' },
      { id: 'math-g1-eq-b-fc45', front: '$x = 7$', back: '$3(x - 4) = 9$ の解は？', explanation: '展開して $3x - 12 = 9$、$3x = 21$、$x = 7$。', difficulty: 'advanced' },
      { id: 'math-g1-eq-b-fc46', front: '$x = 5$', back: '$4(x - 1) = 2(x + 3)$ の解は？', explanation: '展開して $4x - 4 = 2x + 6$、$2x = 10$、$x = 5$。', difficulty: 'advanced' }
    ],
    quiz: {
      questions: [
        // === 方程式の定義（basic） ===
