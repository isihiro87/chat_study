...
export const eqApplications: Topic = {
  ...
  content: {
    ...
    flashcards: [
      ...
      { id: 'math-g1-eq-a-fc30', front: '$x = 6$', back: '比例式 $2 : 3 = 4 : x$ の $x$ は？', explanation: '$2x = 3 \\times 4 = 12$、$x = 6$。', difficulty: 'basic' },
      { id: 'math-g1-eq-a-fc31', front: '$x = 10$', back: '比例式 $3 : 5 = 6 : x$ の $x$ は？', explanation: '$3x = 5 \\times 6 = 30$、$x = 10$。', difficulty: 'basic' },
      { id: 'math-g1-eq-a-fc32', front: '$x = 8$', back: '比例式 $x : 6 = 4 : 3$ の $x$ は？', explanation: '$3x = 6 \\times 4 = 24$、$x = 8$。', difficulty: 'basic' },
      ...
      { id: 'math-g1-eq-a-fc41', front: '$14$', back: 'ある量を $2 : 3$ に分けたとき大きい方が $21$。小さい方は？', explanation: '$2 : 3 = x : 21$、$3x = 42$、$x = 14$。', difficulty: 'advanced' },
    ...
    quiz: {
      questions: [
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: '内項の積 = 外項の積より $12x = 36$。\n$x = 3$。',
          difficulty: 'basic',
        },
        {
        ...
        },
        {
          ...
          options: ['$x = 4$', '$x = 5$', '$x = 8$', '$x = 6$'],
          correctIndex: 3,
          explanation: '$90x + 200 = 740$。\n$90x = 540$、$x = 6$。',
          difficulty: 'basic',
        },
        {
        ...
        // === standard（10問）===
        {
          ...
          options: ['$8$ 枚', '$7$ 枚', '$6$ 枚', '$10$ 枚'],
          correctIndex: 0,
          explanation: '$80x + 120(12 - x) = 1120$。\n$-40x = -320$、$x = 8$。',
          difficulty: 'standard',
        },
        {
        ...
        },
        {
          ...
          options: ['$38$ 個', '$40$ 個', '$45$ 個', '$42$ 個'],
          correctIndex: 3,
          explanation: '人数 $x$: $4x + 6 = 5x - 3$、$x = 9$。\n総数 $= 4 \\times 9 + 6 = 42$。',
          difficulty: 'standard',
        },
        {
          id: 'math-g1-eq-apps-q12',
          question: '家から公園まで分速 $80$ m で $15$ 分。分速 $200$ m の自転車なら何分？',
          options: ['$4$ 分', '$5$ 分', '$8$ 分', '$6$ 分'],
          correctIndex: 3,
          explanation: '道のり $= 80 \\times 15 = 1200$ m。\n$1200 \\div 200 = 6$ 分。',
          difficulty: 'standard',
        },
        {
        ...
        },
        {
          ...
          options: ['$8$ 脚', '$7$ 脚', '$6$ 脚', '$9$ 脚'],
          correctIndex: 0,
          explanation: '$4x + 5 = 5(x - 1) + 2$。\n$4x + 5 = 5x - 3$、$x = 8$。',
          difficulty: 'standard',
        },
        // === advanced（7問）===
        {
          ...
          options: ['$6$ km', '$7.5$ km', '$7$ km', '$8$ km'],
          correctIndex: 1,
          explanation: '$\\dfrac{x}{3} + \\dfrac{x}{5} = 4$。\n両辺 $\\times 15$: $5x + 3x = 60$、$x = 7.5$。',
          difficulty: 'advanced',
        },
        {
          id: 'math-g1-eq-apps-q20',
          question: '姉が分速 $60$ m で出発し、$15$ 分後に妹が分速 $90$ m で追いかける。何分後に追いつく？',
          options: ['$20$ 分後', '$30$ 分後', '$25$ 分後', '$45$ 分後'],
          correctIndex: 1,
          explanation: '$60(x + 15) = 90x$。\n$60x + 900 = 90x$、$30x = 900$、$x = 30$。',
          difficulty: 'advanced',
        },
        {
          id: 'math-g1-eq-apps-q21',
          question: 'P と Q が $2400$ m 離れた地点から向かい合って同時出発。分速 $70$ m と分速 $50$ m。何分後に出会う？',
          options: ['$16$ 分', '$18$ 分', '$24$ 分', '$20$ 分'],
          correctIndex: 3,
          explanation: '$(70 + 50)x = 2400$。\n$120x = 2400$、$x = 20$。',
          difficulty: 'advanced',
        },
        {
          ...
          options: ['$14$', '$15$', '$17$', '$16$'],
          correctIndex: 3,
          explanation: '$(x-1) + x + (x+1) = 48$。\n$3x = 48$、$x = 16$。',
          difficulty: 'advanced',
        },
        {
          id: 'math-g1-eq-apps-q23',
          question: '現在、母 $38$ 歳、娘 $8$ 歳。母の年齢が娘の $2$ 倍になるのは何年後？',
          options: ['$22$ 年後', '$20$ 年後', '$18$ 年後', '$24$ 年後'],
          correctIndex: 0,
          explanation: '$38 + x = 2(8 + x)$。\n$38 + x = 16 + 2x$、$x = 22$。',
          difficulty: 'advanced',
        },
        {
          id: 'math-g1-eq-apps-q24',
          question: '$10\\%$ の食塩水 $400$ g に水を加えて $4\\%$ にしたい。水は何 g 必要？',
          options: ['$400$ g', '$500$ g', '$800$ g', '$600$ g'],
          correctIndex: 3,
          explanation: '食塩 $40$ g は変わらない。\n$\\dfrac{40}{400 + x} = 0.04$、$40 = 16 + 0.04x$、$x = 600$。',
          difficulty: 'advanced',
        },
        {
