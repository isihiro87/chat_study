      ...
      questions: [
        {
          ...
          correctIndex: 1,
          explanation: '$x + 5 = 12 \\rightarrow x = 12 - 5 = 7$ だよ。$5$を右辺に移項すると符号が変わって $-5$ になるね。',
        },
        {
          ...
          correctIndex: 1,
          explanation: '$3x = 15 \\rightarrow x = 15 \\div 3 = 5$。両辺を$3$で割るよ。',
        },
        {
          ...
          correctIndex: 2,
          explanation: '$2x - 4 = 10 \\rightarrow 2x = 14 \\rightarrow x = 7$。まず $-4$ を移項して、それから$2$で割ろう。',
        },
        {
        ...
        },
        {
          ...
          correctIndex: 1,
          explanation: '両辺を$10$倍すると $2x = 14 \\rightarrow x = 7$。小数は$10$倍して整数にしてから解くとラクだよ！',
        },
      ],
    },
    examples: {
        ...
        },
        {
          ...
          steps: [
            ...
            },
            {
              ...
              content: '$3x = 12$ の両辺を$3$で割って、$x = 4$ が解だよ。',
              highlight: '$x = 4$',
            },
          ],
          answer: '$x = 4$',
          ...
          steps: [
            {
              ...
              content: '両辺に$2$をかけて分数をはらうよ。\n$2 \\times (\\frac{x}{2} + 1) = 2 \\times 4 \\rightarrow x + 2 = 8$',
              highlight: '$x + 2 = 8$',
            },
            {
              title: 'Step 2: 移項して解く',
