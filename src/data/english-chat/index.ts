...
import { nounsAdvancedChat } from '../subjects/english/grades/grade1/topics/3b-nouns-advanced/chat';
import { questionWordsChat } from '../subjects/english/grades/grade1/topics/4-question-words/chat';
import { questionPatternsChat } from '../subjects/english/grades/grade1/topics/4b-question-patterns/chat';
...
const chatMap: Record<string, HistoryChat> = {
  ...
  [nounsAdvancedChat.id]: nounsAdvancedChat,
  [questionWordsChat.id]: questionWordsChat,
  [questionPatternsChat.id]: questionPatternsChat,
