  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (code === 'auth/popup-blocked') {
        setError('ポップアップがブロックされました。ポップアップを許可してもう一度お試しください');
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F7] flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm p-8 w-full max-w-sm">
        ...
        {/* LINEログイン（準備中） */}
        <button
          onClick={() => alert('LINEログインは現在準備中です。もうしばらくお待ちください。')}
          className="w-full mt-3 flex items-center justify-center gap-3 bg-[#06C755] rounded-full py-3 px-4 text-white font-medium hover:bg-[#05b64c] active:scale-95 transition-all"
          style={{ fontFamily: "'Zen Maru Gothic', sans-serif" }}
        >
