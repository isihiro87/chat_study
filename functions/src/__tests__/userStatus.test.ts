...
describe("daysBetweenJst", () => {
  it("同日 = 0", () => {
    expect(daysBetweenJst(jstDate("2026-05-19"), jstDate("2026-05-19"))).toBe(0);
  });
  it("翌日 = 1", () => {
    expect(daysBetweenJst(jstDate("2026-05-19"), jstDate("2026-05-20"))).toBe(1);
  });
  it("1週間後 = 7", () => {
    expect(daysBetweenJst(jstDate("2026-05-19"), jstDate("2026-05-26"))).toBe(7);
  });
});
