...
const WEAK_REVIEW_EMPTY = [
  "まだ苦手データがないみたい。まずは『1問解く』で挑戦して、間違えた問題が貯まったら戻ってきてね！",
  "苦手データはまだありません。『1問解く』で問題を解いて、間違えた問題が貯まってから来てみてね！",
  "苦手リストはまだ空です。『1問解く』で問題を解くと、復習できる問題が増えていきます。",
  "復習する苦手がまだないよ。『1問解く』で挑戦してから来てみてね！",
  "苦手データ、まだないみたい。先に『1問解く』で問題に挑戦してみよう！",
];
...
const WEAK_REVIEW_CLEARED = [
  ...
  "🎯 苦手リスト、空っぽ達成！『1問解く』でまた挑戦すれば、新しい苦手も少しずつ減らせるよ。",
];
